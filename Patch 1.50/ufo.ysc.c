...
void __EntryFunction__()//Position - 0x0
{
    ...
    fLocal_14 = 0.001f;
    iLocal_17 = -1;
    if (Global_1B3C8.f_27CD.f_F0E == 0)
    {
        func_10();
    }
    ...
    while (true)
    {
        ...
        {
            case 0:
                if (unk_0xA63165E74E9A042B() == 3 && func_9())
                {
                    iLocal_18 = 1;
                }
                break;
            ...
            case 1:
                func_1(152, 1, 0, 1, 0);
                iLocal_18 = 2;
                if (!unk_0x3A2AD14969436A79("AZ_SPECIAL_UFO_03"))
                {
                    unk_0x14BF31FE457B0BF6("AZ_SPECIAL_UFO_03", 1, 1);
                }
                break;
...
void func_1(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xDA
{
    if (iParam0 != 198)
    {
        if (Global_12B21)
        {
            Global_2531AD.f_4B.f_E3[iParam0] = iParam1;
        }
        else
        {
            Global_1B3C8.f_1C58.f_E3[iParam0] = iParam1;
        }
        Global_95DB[iParam0] = iParam2;
        Global_96A2[iParam0] = 1;
        func_4(iParam0, bParam3, iParam4, 0);
        func_2(iParam0, iParam1);
    }
}

void func_2(int iParam0, int iParam1)//Position - 0x135
{
    switch (iParam0)
    {
        case 12:
...
void func_3(int iParam0, bool bParam1)//Position - 0x214
{
    if (bParam1)
    {
...
bool func_4(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x23D
{
    bool bVar0;
    int iVar1;
    int iVar2;
    ...
    if (func_5())
    {
        iVar1 = Global_1B3C8.f_1C58.f_E3[iParam0];
    }
    else
    {
        iVar1 = Global_2531AD.f_4B.f_E3[iParam0];
    }
    iVar2 = Global_9769[iParam0];
    ...
    else
    {
        ...
        if (unk_0xA8C462EF7D9DC564(unk_0x0037AFCBDC61F351()) != unk_0xA8C462EF7D9DC564("standard_global_reg"))
        {
            if (iParam2 == 0)
            {
                if (Global_95DB[iParam0] && unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 0), Var3, true) < 200f)
                {
                    bVar5 = false;
                    Global_1939AB = 1;
                }
        ...
        if (bVar5)
        {
            switch (Var3.f_3)
            {
                ...
                case 1:
                    if (iVar1 == 0)
                    {
                        ...
                        if (unk_0xA8C462EF7D9DC564(&(Var3.f_22)) != unk_0xA8C462EF7D9DC564(""))
                        {
                            if (!unk_0x5DE3F91EB19E0CF2(&(Var3.f_22)))
                            {
                                unk_0xE6B6437B6D597799(&(Var3.f_22));
                                Global_1939AB = 1;
                            }
                        }
                    }
                    else if (iVar1 == 1)
                    {
                        if (unk_0xA8C462EF7D9DC564(&(Var3.f_22)) != unk_0xA8C462EF7D9DC564(""))
                        {
                            if (unk_0x5DE3F91EB19E0CF2(&(Var3.f_22)))
                            {
                                unk_0xB42283119B3F4732(&(Var3.f_22));
                            }
                        }
                    ...
                    Global_9B4E[iParam0] = 1;
                    Global_9C15[iParam0] = 1;
                    bVar0 = true;
                    break;
                
                case 2:
                    iVar6 = unk_0x2BA8B1187A604700(Var3, &(Var3.f_2A));
                    if (iVar6 != 0)
                    {
                        if (unk_0xA8C462EF7D9DC564(&(Var3.f_32)) != unk_0xA8C462EF7D9DC564(""))
                        {
                            if (unk_0xD86ECD84D4B257FF(iVar6, &(Var3.f_32)))
                            {
                                unk_0x2E071EB337E1D1A0(iVar6, &(Var3.f_32));
                            }
                        }
                        if (iVar1 == 0)
                        {
                ...
                case 3:
                    if (unk_0xD34AF93E9BCF12F0(Var3, unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 0), true) < 250f)
                    {
                ...
                case 4:
                    if (iVar1 == 0)
                    {
                        ...
                        unk_0x3B76114EC84D5812(&(Global_94DD[(iParam0 / 32)]), (iParam0 % 32));
                    }
                    else if (iVar1 == 1)
                    {
                        unk_0x1AF0F98D2293DAEF(Var3, 50f, Var3.f_4[0], Var3.f_4[1], 1);
                        unk_0xA1E7A40E1F56E511(&(Global_94DD[(iParam0 / 32)]), (iParam0 % 32));
                    }
                    bVar0 = true;
                    break;
            }
            if (bVar0)
            {
                Global_96A2[iParam0] = 0;
                Global_9769[iParam0] = iVar1;
                if (!func_5())
                {
                    if (!Global_99BE[iParam0])
                    {
                        Global_99BE[iParam0] = 1;
                        Global_9A85++;
                    }
                }
            }
...
int func_6()//Position - 0xBD5
{
    return Global_7811;
}

int func_7()//Position - 0xBE0
{
    return Global_7810;
}

int func_8(var uParam0, int iParam1)//Position - 0xBEB
{
    int iVar0;
...
int func_9()//Position - 0x442B
{
    if (((unk_0x9DC89786A147395D("RAIN") || unk_0x9DC89786A147395D("THUNDER")) || unk_0xD557E753027501C4("RAIN")) || unk_0xD557E753027501C4("THUNDER"))
    {
        return 1;
    }
    return 0;
...
void func_10()//Position - 0x446D
{
    func_1(152, 0, 1, 1, 0);
    if (unk_0x3A2AD14969436A79("AZ_SPECIAL_UFO_03"))
    {
        unk_0x14BF31FE457B0BF6("AZ_SPECIAL_UFO_03", 0, 1);
    }
