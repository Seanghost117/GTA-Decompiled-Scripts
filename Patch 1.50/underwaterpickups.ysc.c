...
void __EntryFunction__()//Position - 0x0
{
    ...
    func_24(vVar0);
    bLocal_4 = func_4();
    vLocal_5 = { unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 0) };
    func_1();
    while (true)
    {
        SYSTEM::WAIT(0);
...
void func_1()//Position - 0x5C
{
    ...
    while (iVar0 < 20)
    {
        if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &uVar5))
        {
            if (func_2(vVar3, 0f, 0f, 0f, 0))
            {
                ...
                if (iVar1 == joaat("pickup_money_case"))
                {
                    if (bLocal_4)
                    {
                        iLocal_3[iVar0] = unk_0xFE261C9FF385EA5E(iVar1, vVar2, iVar4, uVar5, 1, 0);
                    }
                }
                else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
                {
                    ...
                    {
                        iLocal_3[iVar0] = unk_0xFE261C9FF385EA5E(iVar1, vVar2, iVar4, iVar5, 1, 0);
                    }
                    else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
                    {
                        if (bLocal_4)
                        {
                            iLocal_3[iVar0] = unk_0xFE261C9FF385EA5E(iVar1, vVar2, iVar4, -1, 1, 0);
                        }
                    }
                    else
                    {
            ...
            else
            {
                ...
                if (iVar1 == joaat("pickup_money_case"))
                {
                    if (bLocal_4)
                    {
                        iLocal_3[iVar0] = unk_0x007AE20F9BF069CA(iVar1, vVar2, vVar3, iVar4, 10000, 2, 1, 0);
                    }
                }
                else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
                {
                    if (iVar1 == joaat("pickup_armour_standard"))
                    {
                        iLocal_3[iVar0] = unk_0x007AE20F9BF069CA(iVar1, vVar2, vVar3, iVar4, -1, 2, 1, 0);
                    }
                    else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
                    {
                        if (bLocal_4)
...
bool func_2(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x252
{
    if (bParam2)
    {
...
int func_4()//Position - 0x17D8
{
    if (Global_258B01 == -15)
    {
        Global_258B01 = func_23();
        func_15(&Global_258B01, 0, 0, 0, 1, 0, 0);
        return 1;
    }
    if (func_5(func_23(), Global_258B01))
    {
        Global_258B01 = func_23();
        func_15(&Global_258B01, 0, 0, 0, 1, 0, 0);
        return 1;
...
{
    return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_12(unk_0xA2BC31158C8CEFD2(iParam0, 31), -1, 1)) + 2011;
}

int func_12(bool bParam0, int iParam1, int iParam2)//Position - 0x19B7
{
    if (bParam0)
    {
        return iParam1;
...
int func_13(int iParam0)//Position - 0x19CE
{
    int iVar0;
    int iVar1;
    int iVar2;
...
int func_14(int iParam0, int iParam1)//Position - 0x1AAA
{
    if (iParam1 < 0)
    {
        iParam1 = 0;
...
void func_15(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B4C
{
    int iVar0;
    int iVar1;
    int iVar2;
...
void func_16(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1CCE
{
...
void func_17(var uParam0, int iParam1)//Position - 0x1D06
{
    if (iParam1 <= 0)
    {
        return;
...
void func_18(var uParam0, int iParam1)//Position - 0x1D8C
{
    int iVar0;
    int iVar1;
...
void func_19(var uParam0, int iParam1)//Position - 0x1DDD
{
...
void func_20(var uParam0, int iParam1)//Position - 0x1E10
{
...
void func_21(var uParam0, int iParam1)//Position - 0x1E4A
{
...
void func_22(var uParam0, int iParam1)//Position - 0x1E85
{
    if (iParam1 < 0 || iParam1 >= 60)
    {
        return;
...
void func_24(vector3 vParam0)//Position - 0x1F07
{
    vector3 vVar0[12];
    int iVar1;
...
int func_25(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x2056
{
    if (fParam2 < 0f)
    {
        fParam2 = 0f;
...
void func_26()//Position - 0x20D1
{
    func_27();
    unk_0x9C9E32388A7886A2();
}

void func_27()//Position - 0x20E1
{
    int iVar0;
    ...
    while (iVar0 < 20)
    {
        if (unk_0x71FE36FB85146FC0(iLocal_3[iVar0]))
        {
            unk_0xCCD1554A33E9185B(iLocal_3[iVar0]);
        }
        iVar0++;
    }
}
