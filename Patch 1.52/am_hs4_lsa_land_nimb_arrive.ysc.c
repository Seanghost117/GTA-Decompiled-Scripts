...
void func_213(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, var uParam6)
{
	func_214(uParam0, sParam3, iParam4, iParam5, uParam6);
	uParam0->f_7 = { Param1 };
	uParam0->f_10 = { Param2 };
}
