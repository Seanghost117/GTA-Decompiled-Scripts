...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
...
void func_60(int iParam0, var uParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x285D770154CF7612(iParam0, func_65(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xC517E2708E06CD75(iVar5, &Var7) && !func_62(Var7.f_1)) && iVar9 < 51)
			{
...
{
	return (shift_right(iParam0, 26) & 31 * func_101(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
