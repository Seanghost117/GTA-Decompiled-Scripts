...
void __EntryFunction__()
{
	...
	iLocal_323 = -1;
	iLocal_324 = -1;
	if (unk_0x7B70881748D166CD(unk_0x856D5567211886A2("appBunkerBusiness")) > 1)
	{
		func_539(0, 1);
	}
	func_528();
	...
	{
		func_526();
		if (!unk_0xCE990E643CD9D0E5(iLocal_122, 7))
		{
			func_523();
			func_500();
		}
		...
		func_468();
		func_466();
		if (iLocal_137 == -1 && !unk_0xCE990E643CD9D0E5(iLocal_122, 4))
		{
			func_11();
		}
		...
		{
			if (!unk_0xCE990E643CD9D0E5(iLocal_122, 4))
			{
				func_3(unk_0x460153A63B9477BC(), iLocal_134, iLocal_137, 1);
				func_539(0, 0);
			}
			else if (!Global_1678288.f_3140 && unk_0x03DB5C6AABF8DA46())
			{
				func_1();
				Global_1678143 = 1;
				func_539(0, 1);
...
void func_11()
{
	...
	func_464();
	func_463();
	if (unk_0xCE990E643CD9D0E5(iLocal_122, 0))
	{
		if (unk_0x654BC7395AE9BF77(uLocal_316) && unk_0x654BC7395AE9BF77(uLocal_317))
		{
			iVar0 = unk_0x14E3913C604B1108(uLocal_316);
			iVar1 = unk_0x14E3913C604B1108(uLocal_317);
			iLocal_135 = iVar1;
			switch (iVar0)
			{
				case 0:
				...
				case 21:
					if (func_12(iLocal_134, unk_0x460153A63B9477BC()) > 0)
					{
						func_462();
						func_254(7);
					}
...
void func_15()
{
	...
	if (iLocal_126 == 0 || func_35(unk_0x460153A63B9477BC(), iLocal_134) == 0)
	{
		if (func_34(unk_0x460153A63B9477BC(), iLocal_134) == 0)
		{
	...
	else if (func_29(unk_0x460153A63B9477BC(), iLocal_134))
	{
	...
	else if (!unk_0x6914A85D2E17013B(iVar0, false, true, 0, -1, 0))
	{
		func_251("UA_FTR_FAIL_NM", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
	}
	else
	{
		unk_0xBE20AB8238688965(&iLocal_122, 15);
		iLocal_131 = iVar0;
...
int func_36(int iParam0, bool bParam1)
{
	...
	fVar2 = (to_float((100 - iParam0)) / 20f);
	iVar1 = ceil(fVar2);
	return (iVar1 * iVar0);
}
...
void func_37()
{
	if (func_34(unk_0x460153A63B9477BC(), iLocal_134) == 2)
	{
...
void func_47()
{
	if (func_34(unk_0x460153A63B9477BC(), iLocal_134) == 1)
	{
...
void func_49(int iParam0)
{
	...
	if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_4 <= 0)
	{
	...
	else if (func_55(unk_0x460153A63B9477BC(), iLocal_134, iParam0))
	{
		func_251("OR_UPGR_OWN", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
	}
	else if (unk_0x6914A85D2E17013B(func_50(iParam0, iLocal_134), false, true, 0, -1, 0))
	{
...
int func_50(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 5:
			iVar1 = func_54(unk_0x460153A63B9477BC());
			if (unk_0x25DDB354A40FFCDB() && func_53())
			{
				iVar2 = 0;
				iVar3 = 0;
				if (iParam0 == 8)
				...
				iVar5 = unk_0x856D5567211886A2(&sVar4);
				if (unk_0x0CE09529EC41BC4B(iVar5))
				{
					iVar6 = unk_0x3C77025E43BF21B5(iVar5, 426439576, 1);
					return iVar6;
				}
			}
			switch (iParam0)
...
int func_60(int iParam0)
{
	...
	if (!func_234(unk_0x460153A63B9477BC(), iParam0, 0))
	{
		iVar0 = func_68(unk_0x460153A63B9477BC(), 167, 0);
		if (iVar0 == 7)
		{
...
int func_93()
{
	return func_94(unk_0x460153A63B9477BC());
}
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_142(iParam1, iParam2, iParam3, unk_0xF1110FE23C67293A(iParam5), iParam4);
		
		case 233:
			return func_135(iParam1, iParam2, iParam3, unk_0xF1110FE23C67293A(iParam5), iParam4);
		...
		case 243:
			return func_118(iParam1, iParam2, unk_0xF1110FE23C67293A(iParam5), iParam4);
		
		case 158:
			return func_113(iParam1, iParam2, unk_0xF1110FE23C67293A(iParam5), iParam4);
		
		case 181:
			return func_110(iParam1, iParam2, unk_0xF1110FE23C67293A(iParam5), iParam4);
...
int func_153(int iParam0, int iParam1, int iParam2, var uParam3)
{
	switch (iParam0)
	{
		case 1:
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_191(iParam1, iParam3, iParam4, unk_0xF1110FE23C67293A(iParam5), 0, 0, 0);
		
		case 233:
			return func_185(iParam1, iParam3, iParam4, unk_0xF1110FE23C67293A(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_176(iParam1, iParam3, unk_0xF1110FE23C67293A(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_170(iParam1, iParam3, unk_0xF1110FE23C67293A(iParam5), 0, -1, 0, 0);
		
		case 181:
			return func_164(iParam1, iParam3, unk_0xF1110FE23C67293A(iParam5), 0, -1, 0, 0);
...
int func_208(int iParam0, var uParam1)
{
	...
	{
		return (func_165(iParam0, uParam1) + func_209(iParam0, uParam1));
	}
	return 0;
}
...
int func_222(int iParam0, var uParam1)
{
	if (func_187(iParam0))
	{
		return (func_186(iParam0) + func_223(iParam0, uParam1));
	}
	return 0;
}
...
void func_236()
{
	...
	else if (!unk_0x6914A85D2E17013B(iVar1, false, true, 0, -1, 0))
	{
...
void func_239()
{
	...
	else if (func_12(iLocal_134, unk_0x460153A63B9477BC()) > 25)
	{
...
void func_242(int iParam0)
{
	...
	{
		unk_0xBE20AB8238688965(&iLocal_122, 3);
	}
}

void func_243()
{
	unk_0xD2459066EA58CE43(&iLocal_122, 3);
...
void func_244()
{
	...
	else if (Global_1370228[5] <= 0)
	{
		...
		else if (func_34(unk_0x460153A63B9477BC(), iLocal_134) == 1)
		{
	...
	else if (func_34(unk_0x460153A63B9477BC(), iLocal_134) == 0)
	{
...
void func_245()
{
	if (func_246(unk_0x460153A63B9477BC()) == 225 || func_235(5))
	{
		func_251("UA_CANT_SDOWN", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
	}
	else if (func_246(unk_0x460153A63B9477BC()) == 227)
	{
...
int func_249()
{
	if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_4 > 0 || func_250(5))
	{
		return 1;
	}
	return 0;
...
{
	unk_0x830F007E19C63E14(uLocal_315, "SHOW_OVERLAY");
	...
	{
		unk_0x31FC6E647D1E3539(sParam7);
	}
	...
	if (bParam4)
	{
		unk_0xC4CC25B68A91D144(-1, "Click_Link", "DLC_GR_Disruption_Logistics_Sounds", 1);
	}
	else if (bParam3)
	{
		unk_0xC4CC25B68A91D144(-1, "Click_Fail", "DLC_GR_Disruption_Logistics_Sounds", 1);
	}
	func_252(iParam6);
	unk_0xBE20AB8238688965(&iLocal_122, 1);
}
...
void func_254(int iParam0)
{
	...
	{
		iLocal_135 = iParam0;
		unk_0x830F007E19C63E14(uLocal_315, "SHOW_SCREEN");
...
int func_255()
{
	if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_4 == 1 && !func_250(5))
	{
		return 1;
	}
	return 0;
...
void func_257()
{
	...
	switch (func_458())
	{
		case 1:
			if (func_452(225))
			{
				unk_0xC4CC25B68A91D144(-1, "Click_Special", "DLC_GR_Disruption_Logistics_Sounds", 1);
				func_451(5);
				func_450(0);
				func_438(225, 0);
			}
		...
		case 2:
			if (func_452(226))
			{
				...
				func_436(func_437());
				func_243();
				unk_0xBE20AB8238688965(&(Global_1678288.f_1), 14);
			}
			else
			{
				func_251(func_59(), "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
		...
		case 6:
			unk_0xC4CC25B68A91D144(-1, "Business_Shutdown", "DLC_GR_Disruption_Logistics_Sounds", 1);
			if (func_420(unk_0x460153A63B9477BC(), 5) || func_250(5))
			{
				func_404();
				func_403(5, 1);
				func_401(0, -1, 1, 0, 0, func_34(unk_0x460153A63B9477BC(), iLocal_134), 0);
				if (func_400(unk_0x460153A63B9477BC()))
				{
					if (func_399(1))
					{
						iVar0 = func_397(1);
						func_386(iVar0, 1);
						unk_0xBE20AB8238688965(&Global_1678138, 5);
					}
				}
			}
			func_422(0);
		...
		case 7:
			unk_0xC4CC25B68A91D144(-1, "Business_Restart", "DLC_GR_Disruption_Logistics_Sounds", 1);
			func_384(5);
			func_422(0);
			func_403(5, 0);
			func_422(0);
		...
		case 15:
			if (!unk_0x6914A85D2E17013B(func_36(iLocal_126, 0), false, true, 0, -1, 0))
			{
				func_459();
				func_251("UA_FTR_FAIL_NM", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
				return;
			...
			else
			{
				...
				func_299();
				unk_0x830F007E19C63E14(uLocal_315, "ACTIVATE_FAST_TRACK");
				unk_0xE1FDD153F5858534();
...
void func_258(bool bParam0)
{
	...
	if (iVar0 == 1 && iVar1 != 1)
	{
		...
		{
			func_265(18);
			unk_0xBE20AB8238688965(&iVar2, 8);
	...
	else if (iVar1 == 1)
	{
		...
		{
			func_265(19);
			unk_0xBE20AB8238688965(&iVar2, 9);
			func_284(5465, iVar2, -1, 1, 0);
		}
	}
	func_259();
	Global_2462181 = 1;
	func_401(1, iVar1, 0, 0, 0, func_34(unk_0x460153A63B9477BC(), func_54(unk_0x460153A63B9477BC())), bParam0);
	switch (iVar1)
	{
		case 1:
			break;
		...
		case 23:
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_263), 10);
			break;
		
		default:
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_263), 11);
			break;
	}
	if (func_38())
	{
		unk_0xBE20AB8238688965(&(Global_2540384.f_1795), 27);
	}
}
...
int func_260()
{
	...
	if (func_25() < 7)
	{
		...
		switch (func_25())
		{
			case 0:
				...
				fVar5 = Global_262145.f_21280;
				break;
			
			case 1:
				fVar5 = Global_262145.f_21281;
				break;
			
			case 2:
				fVar5 = Global_262145.f_21282;
				break;
			
			case 3:
				fVar5 = Global_262145.f_21283;
				break;
			
			case 4:
				fVar5 = Global_262145.f_21284;
				break;
			
			case 5:
				fVar5 = Global_262145.f_21285;
				break;
			
			case 6:
				fVar5 = Global_262145.f_21286;
				break;
		}
		if (fVar5 > unk_0x658086F2B3C5E4E4(0f, 1f))
		{
			iVar4 = 1;
		}
	}
	...
	while (iVar6 < 51)
	{
		if (!func_39(iVar6) && !func_23(iVar6))
		{
			if (func_25() < 7)
			{
				if (func_262(iVar6) == iVar4)
				{
					fVar0[iVar6] = func_261(iVar6);
				}
				else
				{
					fVar0[iVar6] = 0f;
	...
	fVar3 = unk_0x658086F2B3C5E4E4(0f, fVar2);
	iVar6 = 0;
	while (iVar6 < 51)
	{
...
void func_265(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	unk_0xBE20AB8238688965(&(Global_2540384.f_5188.f_19[iVar0]), iVar1);
}
...
void func_266(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	StringIntConCat(&Global_101789, unk_0x344C570D6F8700DF(0, 3), 16);
}
...
var func_270(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_271(int iParam0, bool bParam1, bool bParam2)
{
	...
	bVar1 = false;
	iVar2 = func_283(unk_0x460153A63B9477BC(), iParam0);
	if (!bParam1)
	{
		func_282(iParam0, 0, bParam2);
	}
	if (bParam1)
	{
		iVar0 = Global_2515430[iParam0];
		iVar0 = func_281(iParam0, bParam2);
		if (iVar0 < 0)
		{
			iVar0 = 0;
		}
		...
		func_280(iParam0, 0, bParam2);
	}
	else if (func_278(iParam0, bParam2))
	{
		iVar0 = func_277(iVar2, 0);
		iVar3 = func_276(unk_0x460153A63B9477BC(), iVar2);
		...
		if (func_32(iVar2) && func_34(unk_0x460153A63B9477BC(), iVar2) == 2)
		{
			iVar0 = (iVar0 / 2);
			bVar1 = true;
		}
		func_282(iParam0, iVar0, bParam2);
	}
	else
	{
		if (func_274(unk_0x460153A63B9477BC(), iVar2) > 0)
		{
			func_273(iParam0, (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[iParam0 /*12*/].f_2 - (func_275(iVar2, bParam2) / 2)));
		}
		iVar0 = (func_277(iVar2, bParam2) / func_274(unk_0x460153A63B9477BC(), iVar2) + 1);
	}
	if (!bVar1)
	{
		if (func_32(iVar2) && func_34(unk_0x460153A63B9477BC(), iVar2) == 2)
	...
	func_272(unk_0x460153A63B9477BC(), iVar2, iVar0, bParam2);
}
...
int func_275(int iParam0, bool bParam1)
{
	...
	switch (iVar1)
	{
		case 1:
			...
			if (func_55(unk_0x460153A63B9477BC(), iParam0, 0))
			{
...
int func_277(int iParam0, bool bParam1)
{
	...
	switch (iVar1)
	{
		case 1:
			...
			if (func_55(unk_0x460153A63B9477BC(), iParam0, 1))
			{
		...
		case 5:
			...
			if (func_34(unk_0x460153A63B9477BC(), iParam0) == 2)
			{
				iVar0 *= 2;
			}
			break;
...
bool func_278(int iParam0, bool bParam1)
{
	...
	return func_41(func_279(iParam0), -1, -1);
}
...
void func_280(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_341(func_279(iParam0), bParam1, -1, 1);
}
...
int func_281(int iParam0, bool bParam1)
{
	...
	iVar0 = Global_2515430[iParam0];
	iVar1 = func_283(unk_0x460153A63B9477BC(), iParam0);
	if (bParam1)
	{
	...
	if (func_32(iVar1))
	{
		if (func_34(unk_0x460153A63B9477BC(), iVar1) == 2)
		{
			iVar0 *= 2;
		}
	}
...
void func_285(int iParam0, int iParam1)
{
	...
	iVar0 = func_54(unk_0x460153A63B9477BC());
	if (iVar0 == 0)
	{
		return;
	}
	fVar1 = (to_float((100 - iParam0)) / 20f);
	iVar2 = ceil(fVar1);
	iVar3 = func_36(iParam0, 0);
	iVar4 = unk_0x856D5567211886A2(func_298(iVar0));
	...
	{
		unk_0x9746B77A8E33DF3D(iVar3, iVar4, 5, iVar2);
	}
}
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_295(struct<67> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	struct<3> Var0;
	int iVar1;
...
void func_299()
{
	unk_0x830F007E19C63E14(uLocal_315, "SET_BUTTON_STATES");
	unk_0xAD291B8F75D737AD(func_300(2));
	unk_0xAD291B8F75D737AD(func_300(3));
	unk_0xAD291B8F75D737AD(func_300(4));
	unk_0xAD291B8F75D737AD(func_300(5));
	unk_0xAD291B8F75D737AD(func_300(6));
	unk_0xAD291B8F75D737AD(func_300(7));
	unk_0xAD291B8F75D737AD(func_300(8));
	unk_0xAD291B8F75D737AD(func_300(21));
	unk_0xAD291B8F75D737AD(func_300(19));
	unk_0xAD291B8F75D737AD(func_300(11));
	unk_0xE1FDD153F5858534();
}
...
int func_300(int iParam0)
{
	switch (iParam0)
	{
		...
		case 21:
			...
			else if (func_12(iLocal_134, unk_0x460153A63B9477BC()) <= 0)
			{
				return 1;
			}
			break;
		...
		case 19:
			if (((!func_249() || func_35(unk_0x460153A63B9477BC(), iLocal_134) < 1) || func_35(unk_0x460153A63B9477BC(), iLocal_134) > 99) || func_301())
			{
				return 1;
			}
			break;
...
bool func_301()
{
	return unk_0xCE990E643CD9D0E5(iLocal_122, 11);
}
...
int func_302()
{
	...
	if (func_53())
	{
		if (iVar1 > 0)
		{
			...
			if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_2 < 0)
			{
				func_273(5, 0);
			}
		}
		...
		func_303(unk_0x460153A63B9477BC(), iLocal_134, 0, 1);
		func_271(5, 0, 1);
	...
	{
		iVar3 = Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_256 + 1;
		func_273(5, (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_2 - iVar1));
		if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_2 < 0)
		{
			func_273(5, 0);
		}
		func_284(5443, iVar3, -1, 1, 0);
		func_284(func_324(5), Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_2, -1, 1, 0);
		func_303(unk_0x460153A63B9477BC(), iLocal_134, 0, 1);
		func_271(5, 0, 1);
		func_319(&Global_2515438);
...
bool func_306(int iParam0, int iParam1)
{
	...
	switch (*iParam1)
	{
		case 0:
			...
			iVar1 = -1003644442;
			iVar2 = func_31(unk_0x460153A63B9477BC(), func_54(unk_0x460153A63B9477BC()));
...
int func_314(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_294(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
...
bool func_317(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	{
		case 0:
			if ((func_316() != -1 || unk_0x7B70881748D166CD(unk_0x856D5567211886A2("appInternet")) > 0) || Global_99007.f_352 > 0)
			{
				return 0;
			}
			else
...
int func_320(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar1 = func_277(iParam1, bParam2);
	iVar2 = func_321(iParam1, Var0, iParam0, bParam2);
	if (iVar2 < 0)
	{
		iVar2 = 0;
	}
	fVar3 = (1f - (to_float((iVar1 - iVar2)) / to_float(iVar1)));
	fVar4 = to_float(func_275(iParam1, bParam2));
	return round((fVar4 * fVar3));
}

int func_321(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_281(iParam3, bParam4) > 0)
	{
		iVar2 = func_281(iParam3, bParam4);
		if (func_32(iParam0) && func_34(unk_0x460153A63B9477BC(), iParam0) == 2)
		{
			iVar2 = (iVar2 / 2);
		}
		iVar1 = (iVar0 - iVar2);
		iVar3 = (func_322(unk_0x460153A63B9477BC(), iParam0, bParam4) - func_323(&uParam1, 0, 0));
		func_282(iParam3, iVar3, bParam4);
	}
	return iVar1;
}
	...
	if (func_6(iParam1))
	{
		...
		while (iVar0 <= 5)
		{
			if (Global_1590682[iParam0 /*883*/].f_274.f_183[iVar0 /*12*/] == iParam1)
			{
				...
				if (func_32(iParam1))
				{
					if (func_34(unk_0x460153A63B9477BC(), iParam1) == 2)
					{
						iVar1 *= 2;
					}
				}
...
void func_325(bool bParam0)
{
	if (bParam0)
	{
		unk_0xBE20AB8238688965(&Global_1678288, 26);
	}
	else
	{
		unk_0xD2459066EA58CE43(&Global_1678288, 26);
	}
}
...
int func_333(int iParam0)
{
	...
	iVar3 = func_50(iParam0, iLocal_134);
	iVar4 = iParam0;
	iVar5 = func_335(5, iVar4 + 1);
	iVar6 = unk_0x856D5567211886A2(&sVar2);
	if (func_53())
	{
		bVar0 = false;
		while (!func_334(-103880010, 235173372, iVar6, 1, iVar3, &iLocal_123, iVar5, 3, 0, 0, 0))
		{
			wait(0);
			func_473();
	...
	if (bVar0)
	{
		if (iVar3 > 0)
		{
			Var7.x = unk_0x856D5567211886A2(func_298(iLocal_134));
			Var7.f_1 = 5;
			Var7.f_2 = iParam0;
			unk_0xCDB4DA4947D9F33E(iVar3, &Var7, 0, 1);
		}
		if (func_53())
		{
			func_289(func_316());
			...
			if (func_308(func_316()))
			{
				if (func_307(func_316()) == 2)
				{
					*iParam5 = 2;
					if (iParam4 != 0)
					{
						unk_0xA6292C176D37A114(func_310(func_316()));
						if (!bParam10)
						{
							...
							{
								unk_0xB0EB7E9A05164E40(iParam4, iParam8, 18, 1, false, 0, 0, iParam9, 0, true);
							}
						}
					}
					func_289(func_316());
...
{
	if (!func_55(unk_0x460153A63B9477BC(), iParam1, iParam0) && unk_0x6914A85D2E17013B(func_50(iParam0, iParam1), false, true, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
void func_342()
{
	...
	iVar0 = func_35(unk_0x460153A63B9477BC(), iLocal_134);
	iVar1 = 0;
	...
	else if (iVar0 == 0 && func_34(unk_0x460153A63B9477BC(), iLocal_134) == 0)
	{
	...
	func_343(iVar2, iVar0, Var4, Var5, Var6, iVar1, iVar3);
}

void func_343(int iParam0, int iParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char* sParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char* sParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15, int iParam16, int iParam17)
{
	unk_0x830F007E19C63E14(uLocal_315, "SET_RESEARCH");
	unk_0xAD291B8F75D737AD(iParam0);
	unk_0xAD291B8F75D737AD(iParam1);
	unk_0x31FC6E647D1E3539(&cParam2);
	unk_0xAD291B8F75D737AD(iParam16);
	func_253(&sParam8);
	func_253(&sParam12);
	unk_0xAD291B8F75D737AD(iParam17);
	unk_0xE1FDD153F5858534();
}
...
void func_345()
{
	...
	Var0 = { func_376(iLocal_134) };
	iVar1 = func_13(unk_0x460153A63B9477BC(), iLocal_134);
	iVar2 = func_35(unk_0x460153A63B9477BC(), iLocal_134);
	iVar3 = Global_1370228[5];
	iVar4 = func_371(iLocal_134);
	sVar5 = func_298(iLocal_134);
	StringCopy(&cVar6, "UA_BUNKER_TXD_", 24);
	iVar7 = func_34(unk_0x460153A63B9477BC(), iLocal_134);
	StringIntConCat(&cVar6, (iLocal_134 - 21), 24);
	iVar8 = func_19();
	iVar9 = func_369(iVar8, 5);
	iVar10 = func_367(iVar8, 5);
	iVar11 = func_365(iVar8, 5);
	iVar12 = func_363(iVar8, 5);
	iVar13 = func_361(iVar8, 5);
	iVar14 = func_359(iVar8, 5);
	iVar15 = func_358(iVar10, iVar9);
	iVar16 = func_358(iVar12, iVar11);
	iVar17 = func_358(iVar13, iVar14);
	iVar18 = func_356(iLocal_134);
	iVar1 = func_238(iVar1, 0, 100);
	iVar2 = func_238(iVar2, 0, 100);
	iVar3 = func_238(iVar3, 0, 100);
	iVar17 = func_238(iVar17, 0, 100);
	iVar16 = func_238(iVar16, 0, 100);
	iVar15 = func_238(iVar15, 0, 100);
	if (iLocal_134 == 31)
	{
		Var0 = { -3101.287f, 1362.676f, 19.2333f };
	}
	unk_0x830F007E19C63E14(uLocal_315, "SET_STATS");
	unk_0x31FC6E647D1E3539(unk_0x72C1D3A1AB8CAA5B(unk_0x460153A63B9477BC()));
	unk_0x31FC6E647D1E3539(func_347(unk_0x460153A63B9477BC()));
	unk_0x31FC6E647D1E3539(&cVar6);
	func_253(sVar5);
	func_253(unk_0x5455B0009696FA6A(Var0));
	...
	unk_0xAD291B8F75D737AD((iVar10 + iVar12));
	unk_0xAD291B8F75D737AD(iVar17);
	unk_0xAD291B8F75D737AD(iVar16);
	unk_0xAD291B8F75D737AD(iVar15);
	unk_0xAD291B8F75D737AD(func_346());
	unk_0xAD291B8F75D737AD(func_25());
	unk_0xAD291B8F75D737AD(func_21());
...
char* func_347(int iParam0)
{
	...
	if (((func_62(iParam0, 28) || func_62(unk_0x460153A63B9477BC(), 28)) || func_350(iParam0)) && !func_348(iParam0))
	{
...
{
	return ceil(((to_float(iParam0) / to_float(iParam1)) * 100f));
}
...
int func_371(int iParam0)
{
	...
	else if (!func_420(unk_0x460153A63B9477BC(), iVar0) && !func_250(iVar0))
	{
		return 2;
	}
...
int func_372(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1370228[iParam0] > 0 && (!func_373(iParam1) || !func_29(unk_0x460153A63B9477BC(), iParam1)))
		{
			if (!Global_262145.f_21086 || func_63(unk_0x460153A63B9477BC()))
			{
				return 1;
			}
		}
	...
	if ((Global_1370228[iParam0] > 0 && !func_373(iParam1)) && (!Global_262145.f_18487 || func_66(unk_0x460153A63B9477BC())))
	{
		return 1;
	}
	return 0;
...
{
	return func_374(unk_0x460153A63B9477BC(), iParam0);
}
...
void func_379(int iParam0, int iParam1)
{
	...
	iVar0 = func_241(iParam0);
	iVar1 = Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[iVar0 /*12*/].f_11;
	if (((iVar0 > -1 && func_33(iParam0) == 5) && func_7(unk_0x460153A63B9477BC(), iParam0)) && iVar1 != iParam1)
	{
		func_381(iVar0, iParam0, &(Global_2515417[iVar0 /*2*/]), 0, 0);
		func_381(iVar0, iParam0, &Global_2515438, 0, 1);
		Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[iVar0 /*12*/].f_11 = iParam1;
...
void func_381(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	var uVar0;
	
	func_280(iParam0, 1, bParam4);
	uVar0 = func_383(iParam1, *uParam2, bParam4);
	func_382(iParam0, uVar0, bParam4);
	func_282(iParam0, uVar0, bParam4);
}

void func_382(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	
	iVar0 = func_283(unk_0x460153A63B9477BC(), iParam0);
	func_272(unk_0x460153A63B9477BC(), iVar0, uParam1, bParam2);
	...
	{
		func_380(&(Global_2515417[iParam0 /*2*/]), 0, 0);
	}
}

int func_383(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	int iVar0;
	
	iVar0 = func_322(unk_0x460153A63B9477BC(), iParam0, bParam3);
...
void func_386(int iParam0, bool bParam1)
{
	...
	iVar0 = func_395(unk_0x460153A63B9477BC(), iParam0);
	if (!func_394(iVar0))
	{
		return;
	}
...
void func_401(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	unk_0x7F177BA08E829AEA(func_19(), &Var0, &(Var0.f_1));
	Var0.f_2 = func_402(iVar3, bParam0, bParam2, bParam3, bParam4, iParam5, bParam6);
	if (iParam1 != -1)
	{
		Var0.f_3 = iParam1 + 1;
	}
...
void func_404()
{
	...
	if (func_53())
	{
		...
		if (iLocal_139 == 2 || iVar0 <= 0)
		{
			...
			{
				func_409(unk_0x460153A63B9477BC(), iLocal_134, 1, 0, 0, 1);
				func_405(5, 0, 0);
			}
		}
	}
			...
			if (func_308(func_316()))
			{
				if (func_307(func_316()) == 2)
				{
					if (iParam2 > 0)
					{
						...
						iVar0 = func_283(unk_0x460153A63B9477BC(), iParam0);
						iVar1 = func_33(iVar0);
						unk_0x04A60A9702B796BA(iParam2, unk_0x856D5567211886A2(func_298(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_289(func_316());
				}
...
void func_424(int iParam0)
{
	...
	unk_0x830F007E19C63E14(uLocal_315, "ADD_RESEARCH_UNLOCKABLE");
	unk_0xAD291B8F75D737AD(iVar0);
	unk_0x31FC6E647D1E3539(&Var2);
	func_253(&Var3);
	func_253(&Var4);
	unk_0xAD291B8F75D737AD(iParam0);
	unk_0xE1FDD153F5858534();
...
void func_427()
{
	...
	iVar0 = func_13(unk_0x460153A63B9477BC(), iLocal_134);
	iVar1 = func_428(unk_0x460153A63B9477BC(), iLocal_134, iVar0);
	fVar2 = (to_float(iVar1) * Global_262145.f_21044);
	fVar3 = (to_float(iVar1) * Global_262145.f_21045);
	iVar4 = round(fVar2);
	iVar5 = round(fVar3);
	unk_0x830F007E19C63E14(uLocal_315, "SET_SELL_PRICES");
...
void func_429()
{
	...
	if (func_55(unk_0x460153A63B9477BC(), iLocal_134, 0))
	{
		iVar0 = -1;
		iVar3 = -1;
	}
	...
	if (func_55(unk_0x460153A63B9477BC(), iLocal_134, 1))
	{
		iVar1 = -1;
		iVar5 = -1;
	}
	...
	if (func_55(unk_0x460153A63B9477BC(), iLocal_134, 2))
	{
		iVar2 = -1;
		iVar4 = -1;
	}
	...
	unk_0x830F007E19C63E14(uLocal_315, "SET_UPGRADES");
	unk_0xAD291B8F75D737AD(iVar0);
...
void func_430()
{
	...
	unk_0x830F007E19C63E14(uLocal_315, "SET_RESUPPLIES");
	unk_0xAD291B8F75D737AD(iVar0);
	unk_0xAD291B8F75D737AD(2);
	unk_0xAD291B8F75D737AD(2);
	unk_0xAD291B8F75D737AD(iVar1);
...
int func_434()
{
	...
	while (iVar2 < 15)
	{
		if (Global_4264051[iVar2 /*85*/].f_66.f_4 == 268924934)
		{
			iLocal_323 = iVar2;
		}
		else
	...
	while (!func_8(&uVar1, 15000, 0))
	{
		...
		{
			if (unk_0x39BE1B4CEB4DAEC8(1, iVar3) == 226)
			{
				if (unk_0x477FAFFE21935947(1, iVar3, &Var0, 7))
				{
					if (Var0.x == iLocal_324 && Var0.x != -1)
					{
						if (Var0.f_2 == 0)
						{
							return 1;
...
void func_435(int iParam0, int iParam1)
{
	...
	iVar4 = unk_0x856D5567211886A2(func_298(iParam0));
	...
	{
		unk_0x9746B77A8E33DF3D(iVar3, iVar4, iVar5, iVar2);
	}
}
...
void func_440(int iParam0, int iParam1)
{
	...
	{
		if (!func_446(unk_0x460153A63B9477BC(), 0))
		{
			func_445(iParam0);
...
void func_441(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<7> Var0;
...
int func_448()
{
	return func_63(unk_0x460153A63B9477BC());
}

void func_449(var uParam0)
{
	Global_1630317[unk_0x460153A63B9477BC() /*595*/].f_11.f_209 = uParam0;
}
...
void func_459()
{
	unk_0x830F007E19C63E14(uLocal_315, "HIDE_OVERLAY");
	unk_0xE1FDD153F5858534();
	func_252(0);
	unk_0xD2459066EA58CE43(&iLocal_122, 1);
	if (func_461())
	{
		func_460(0);
		if (iLocal_140 != -1)
		...
		if (!unk_0xCE990E643CD9D0E5(iLocal_122, 14) && func_38())
		{
			unk_0xBE20AB8238688965(&iLocal_122, 14);
			func_460(1);
			func_251("UA_RES_DONE", "WHOUSE_CONF", "", 0, 0, -1, 0, "ua_research", "UA_RES_DONE_T");
		}
	}
	unk_0xD2459066EA58CE43(&iLocal_122, 15);
	func_433();
}
...
void func_460(bool bParam0)
{
	if (bParam0)
	{
		unk_0xBE20AB8238688965(&iLocal_122, 13);
	}
	else
	{
		unk_0xD2459066EA58CE43(&iLocal_122, 13);
	}
}

bool func_461()
{
	return unk_0xCE990E643CD9D0E5(iLocal_122, 13);
}
...
void func_463()
{
	...
	if (unk_0xCE990E643CD9D0E5(iLocal_122, 11))
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_122, 12))
		{
			unk_0x830F007E19C63E14(uLocal_315, "APP_IS_DEACTIVATED");
			uLocal_318 = unk_0xF4712E16A4C164FE();
			unk_0xBE20AB8238688965(&iLocal_122, 12);
		}
		else if (unk_0x654BC7395AE9BF77(uLocal_318))
		{
			bVar0 = unk_0xB2B59E262969FB65(uLocal_318);
			if (bVar0)
			{
				unk_0xBE20AB8238688965(&iLocal_122, 11);
			}
			else
			{
				...
				MemCopy(&sVar2, {func_426(iLocal_140, 0)}, 4);
				func_460(1);
				func_251(&Var1, "WHOUSE_CONF", "", 0, 0, -1, 0, &sVar2, "UA_FT_TITLE");
			}
			unk_0xD2459066EA58CE43(&iLocal_122, 12);
		}
	}
}
...
void func_464()
{
	if (func_465())
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_122, 0))
		{
			unk_0x830F007E19C63E14(uLocal_315, "GET_CURRENT_SELECTION");
			uLocal_316 = unk_0xF4712E16A4C164FE();
			unk_0x830F007E19C63E14(uLocal_315, "GET_CURRENT_SCREEN_ID");
			uLocal_317 = unk_0xF4712E16A4C164FE();
...
void func_466()
{
	if (unk_0xCE990E643CD9D0E5(iLocal_122, 15))
	{
		if (func_467())
		{
			if (func_29(unk_0x460153A63B9477BC(), iLocal_134))
			{
				func_462();
				func_459();
			}
...
bool func_467()
{
	return unk_0xCE990E643CD9D0E5(iLocal_122, 1);
}
...
void func_468()
{
	...
	if (((unk_0xD3137A576BE9EC5C() % 30) == 0 && !func_301()) && !func_461())
	{
		iVar0 = Global_1370228[5];
		iVar1 = func_12(iLocal_134, unk_0x460153A63B9477BC());
		iVar2 = func_35(unk_0x460153A63B9477BC(), iLocal_134);
		iVar3 = 0;
		if (iVar0 != iLocal_124)
		{
...
void func_469()
{
	...
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 206, 1);
	if (unk_0x1BD7199394D7F19A(2, 206))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		...
		{
			unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_471(2, 187, 1);
		if (unk_0x1BD7199394D7F19A(2, 187))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xC27AEE8B64EE0F8D(2, 187))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xC27AEE8B64EE0F8D(2, 188))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0x1BD7199394D7F19A(2, 188))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_471(2, 187, 1);
		if (unk_0x1BD7199394D7F19A(2, 187))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_471(2, 189, 1);
	if (unk_0x1BD7199394D7F19A(2, 189))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 190, 1);
	if (unk_0x1BD7199394D7F19A(2, 190))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 201, 1);
	if (unk_0x1BD7199394D7F19A(2, 201))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 202, 1);
	...
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 204, 1);
	if (unk_0x1BD7199394D7F19A(2, 204))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		unk_0x830F007E19C63E14(uLocal_315, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			unk_0x830F007E19C63E14(uLocal_315, "SET_ANALOG_STICK_INPUT");
			iLocal_319 = iVar0;
			iLocal_320 = iVar1;
			unk_0xF1B28F753235CE2A(true);
			unk_0xAD291B8F75D737AD(iLocal_319);
			unk_0xAD291B8F75D737AD(iLocal_320);
			unk_0xE1FDD153F5858534();
		}
	}
	func_471(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_321 != 127) || iVar3 != 127) || iLocal_322 != 127)
	{
		...
		unk_0xAD291B8F75D737AD(iLocal_321);
		unk_0xAD291B8F75D737AD(iLocal_322);
...
void func_470()
{
	...
	unk_0xC90636D3CB7D4CEF(uLocal_315, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_473()
{
	...
	unk_0x9D15035C6653D1B1(1);
	unk_0x37FC7E88C7659D33(uLocal_315, 255, 255, 255, 255, 0);
	func_484();
	func_477(0);
	func_474(1);
...
void func_490()
{
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_122, 9) && unk_0xCE990E643CD9D0E5(iLocal_122, 8))
	{
		if (func_499(23))
		{
			sVar0 = "UA_TUT_RESUP";
			iLocal_128 = 9000;
			unk_0xBE20AB8238688965(&Global_1678136, 23);
		...
		else if (func_499(24))
		{
			sVar0 = "UA_TUT_RESEA";
			iLocal_128 = 9000;
			unk_0xBE20AB8238688965(&Global_1678136, 24);
		...
		else if (func_499(25))
		{
			sVar0 = "UA_TUT_FTR";
			iLocal_128 = 8000;
			unk_0xBE20AB8238688965(&Global_1678136, 25);
		...
		else if (func_499(26))
		{
			sVar0 = "UA_TUT_UNLOCK";
			iLocal_128 = 11000;
			unk_0xBE20AB8238688965(&Global_1678136, 26);
		...
		else if (func_499(27))
		{
			sVar0 = "UA_TUT_SELL";
			iLocal_128 = 9000;
			unk_0xBE20AB8238688965(&Global_1678136, 27);
		...
		else if (func_499(28))
		{
			sVar0 = "UA_TUT_STAFF";
			iLocal_128 = 9000;
			unk_0xBE20AB8238688965(&Global_1678136, 28);
		...
		else if (func_499(29))
		{
			sVar0 = "UA_TUT_UPGR";
			iLocal_128 = 8500;
			unk_0xBE20AB8238688965(&Global_1678136, 29);
			func_498(&iLocal_129, &iLocal_130, 57);
		}
	}
	if (!unk_0xCE990E643CD9D0E5(iLocal_122, 9) && !unk_0x7BCC91F3C1CF24E8(sVar0))
	{
		func_495(sVar0, iLocal_128);
		unk_0xBE20AB8238688965(&iLocal_122, 9);
	}
	else if (unk_0xCE990E643CD9D0E5(iLocal_122, 9))
	{
...
{
	return func_494(iParam0, iParam1, uParam2) == 3;
}
...
int func_499(int iParam0)
{
	...
	{
		case 23:
			if ((!func_492(&iLocal_129, &iLocal_130, 39) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 2)
			{
				return 1;
			}
			break;
		...
		case 24:
			if ((!func_492(&iLocal_129, &iLocal_130, 42) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 3)
			{
				return 1;
			}
			break;
		...
		case 25:
			if ((((iLocal_126 > 0 && !func_492(&iLocal_129, &iLocal_130, 45)) && (func_492(&iLocal_129, &iLocal_130, 42) || unk_0xCE990E643CD9D0E5(Global_1678136, 24))) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 3)
			{
				return 1;
			}
			break;
		...
		case 26:
			if ((!func_492(&iLocal_129, &iLocal_130, 48) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 6)
			{
				return 1;
			}
			break;
		...
		case 27:
			if ((!func_492(&iLocal_129, &iLocal_130, 51) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 7)
			{
				return 1;
			}
			break;
		...
		case 28:
			if ((!func_492(&iLocal_129, &iLocal_130, 54) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 4)
			{
				return 1;
			}
			break;
		...
		case 29:
			if ((!func_492(&iLocal_129, &iLocal_130, 57) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && iLocal_135 == 5)
			{
				return 1;
			}
			break;
...
int func_505()
{
	...
	if (func_506(unk_0x460153A63B9477BC()))
	{
		return 0;
	}
...
void func_512()
{
	...
	{
		if (func_515(Global_111858.f_2359.f_539.f_4321) != unk_0x36FE6D3220816ADA(unk_0x9B0761B4C3EB8BC7()))
		{
			iVar0 = func_514(unk_0x9B0761B4C3EB8BC7());
...
void func_521(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_523()
{
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_122, 6) && !func_525())
	{
		if (iLocal_135 == 1)
		{
			if ((!unk_0xCE990E643CD9D0E5(iLocal_122, 8) && !func_249()) && func_41(15375, -1, -1))
			{
				unk_0xD289B55B6AADBA10(1);
	...
	else if (unk_0xCE990E643CD9D0E5(iLocal_122, 6))
	{
...
{
	func_526();
	uLocal_315 = unk_0x5DEA4192B46CB99B("DISRUPTION_LOGISTICS");
	while (!unk_0x95EF219D38B20CFF(uLocal_315))
	{
		wait(0);
	}
	func_478(1);
	...
	func_535(1);
	iLocal_134 = func_54(unk_0x460153A63B9477BC());
	iLocal_124 = Global_1370228[5];
	iLocal_125 = func_12(iLocal_134, unk_0x460153A63B9477BC());
	iLocal_126 = func_35(unk_0x460153A63B9477BC(), iLocal_134);
	iLocal_141 = func_34(unk_0x460153A63B9477BC(), iLocal_134);
	func_422(1);
	func_534();
	func_531();
	if (func_491())
	...
	else if (func_530(unk_0x460153A63B9477BC(), iLocal_134))
	{
		unk_0xBE20AB8238688965(&iLocal_122, 8);
	}
	if (unk_0xF8EDFF98A9C94C74())
...
void func_539(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		unk_0xC4CC25B68A91D144(-1, "Exit", "DLC_GR_Disruption_Logistics_Sounds", 1);
	}
	if (unk_0xF8EDFF98A9C94C74())
	{
		func_529(0, 1, 1, 1);
	...
	iVar0 = func_34(unk_0x460153A63B9477BC(), iLocal_134);
	if (unk_0xF8EDFF98A9C94C74())
	{
		if (unk_0x306BF588BD8151E8("GTAO_Computer_Screen_Active_Scene"))
		{
...
void func_541(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_544() || !unk_0xFC559366953F62B3()) || !func_339(unk_0x460153A63B9477BC(), 0))
	{
		return;
	}
