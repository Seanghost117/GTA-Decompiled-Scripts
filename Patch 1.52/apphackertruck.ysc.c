...
void __EntryFunction__()
{
	...
	iLocal_299 = 1;
	iLocal_300 = -1;
	if (unk_0x7B70881748D166CD(unk_0x856D5567211886A2("appBusinessHub")) > 1)
	{
		func_547(0, 1);
	}
	...
	while (func_535())
	{
		...
		if (func_3(&uLocal_313) && func_1(&uLocal_313, 1800, 0))
		{
			unk_0xBE20AB8238688965(&(Global_1678288.f_3), 28);
			iLocal_129 = 1;
		}
		wait(0);
	}
...
void func_4()
{
	...
	{
		if (unk_0x654BC7395AE9BF77(uLocal_304))
		{
			iVar0 = unk_0x14E3913C604B1108(uLocal_304);
			switch (iVar0)
			{
				case 0:
					func_458();
				...
				case 2:
					func_363(1);
					unk_0xC4CC25B68A91D144(-1, "Log_In", "DLC_GR_MOC_Computer_Sounds", 1);
					break;
				...
				case 4:
					...
					{
						if (func_347(unk_0x460153A63B9477BC()))
						{
				...
				case 6:
					...
					{
						if (func_331(unk_0x460153A63B9477BC()))
						{
							func_358(3);
							func_36(3, -1);
						}
				...
				case 7:
					...
					{
						if (func_34(unk_0x460153A63B9477BC()))
						{
							func_358(4);
							func_36(4, -1);
						}
				...
				case 8:
					...
					else if (func_31())
					{
						...
						else if (func_5(unk_0x460153A63B9477BC()))
						{
...
void func_6()
{
	...
	while (iVar0 < 5)
	{
		...
		iVar2 = iVar0;
		iVar3 = 0;
		if (func_28(unk_0x460153A63B9477BC(), iVar2))
		{
			iVar4 = func_26(unk_0x460153A63B9477BC(), iVar2);
			iVar3 = func_25(unk_0x460153A63B9477BC(), iVar4);
		...
		unk_0x830F007E19C63E14(uLocal_303, "ADD_JOB");
		...
		{
			unk_0xB23270F3D5E62FDE(&Var7);
			unk_0x6A826E35A3096ED0(&Var6);
...
{
	unk_0x830F007E19C63E14(uLocal_303, "SHOW_JOB_OVERLAY");
...
int func_13(int iParam0)
{
	...
	return uLocal_297[iParam0];
}

int func_14(int iParam0, int iParam1, int iParam2)
{
	if (!func_24(unk_0x460153A63B9477BC(), iParam0) && !func_23(iParam1))
	{
		func_22(9, iParam2);
		return 1;
	}
...
void func_29()
{
	...
	unk_0x830F007E19C63E14(uLocal_303, "CLEAR_JOBS");
	unk_0xE1FDD153F5858534();
	iVar0 = 0;
	while (iVar0 < 9)
	{
...
bool func_31()
{
	return func_32(unk_0x460153A63B9477BC());
}
...
void func_37(int iParam0)
{
	...
	iVar0 = iParam0;
	if (func_28(unk_0x460153A63B9477BC(), iVar0))
	{
		iLocal_302 = func_215(unk_0x460153A63B9477BC(), iVar0);
		iVar1 = func_19(unk_0x460153A63B9477BC(), iLocal_302);
		if (!func_24(unk_0x460153A63B9477BC(), iLocal_302) && !func_23(iVar1))
		{
			func_214();
		}
		else if (func_16(unk_0x460153A63B9477BC(), iLocal_302))
		{
			func_214();
		}
		else if (Global_1370228[func_213(iLocal_302)] >= Global_262145.f_17924)
		{
			func_214();
		}
		else if (func_15(func_213(iLocal_302)))
		{
			func_214();
		}
		else if (!func_39(192))
...
int func_39(int iParam0)
{
	...
	if (!func_212(unk_0x460153A63B9477BC(), iParam0, 0))
	{
		iVar0 = func_45(unk_0x460153A63B9477BC(), iParam0, 0);
		if (iVar0 == 7)
		{
			...
			else if (func_43(unk_0x460153A63B9477BC()))
			{
...
int func_68()
{
	return func_69(unk_0x460153A63B9477BC());
}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_117(iParam1, iParam2, iParam3, unk_0xF1110FE23C67293A(iParam5), iParam4);
		
		case 233:
			return func_110(iParam1, iParam2, iParam3, unk_0xF1110FE23C67293A(iParam5), iParam4);
		...
		case 243:
			return func_93(iParam1, iParam2, unk_0xF1110FE23C67293A(iParam5), iParam4);
		
		case 158:
			return func_88(iParam1, iParam2, unk_0xF1110FE23C67293A(iParam5), iParam4);
		
		case 181:
			return func_85(iParam1, iParam2, unk_0xF1110FE23C67293A(iParam5), iParam4);
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_169(iParam1, iParam3, iParam4, unk_0xF1110FE23C67293A(iParam5), 0, 0, 0);
		
		case 233:
			return func_160(iParam1, iParam3, iParam4, unk_0xF1110FE23C67293A(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_151(iParam1, iParam3, unk_0xF1110FE23C67293A(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_145(iParam1, iParam3, unk_0xF1110FE23C67293A(iParam5), 0, -1, 0, 0);
		
		case 181:
			return func_139(iParam1, iParam3, unk_0xF1110FE23C67293A(iParam5), 0, -1, 0, 0);
...
void func_216()
{
	if (!func_24(unk_0x460153A63B9477BC(), func_35(unk_0x460153A63B9477BC())))
	{
...
int func_217()
{
	if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[5 /*12*/].f_4 == 1 && !func_23(5))
	{
		return 1;
	}
	return 0;
...
void func_218()
{
	...
	if (!func_212(unk_0x460153A63B9477BC(), 178, 0))
	{
		iVar0 = func_45(unk_0x460153A63B9477BC(), 178, 0);
		if (iVar0 == 14)
		{
	...
	else if (func_219(unk_0x460153A63B9477BC(), func_222(unk_0x460153A63B9477BC())))
	{
...
void func_224(int iParam0)
{
	...
	{
		iLocal_298 = func_246(iParam0);
		if (!func_245(iLocal_299))
		{
			func_214();
		}
		else if (func_244(iLocal_298))
		{
			func_214();
		}
		else if (!func_39(167))
		...
		{
			Var0 = { func_241(iLocal_300, iLocal_299, func_243()) };
...
void func_225()
{
	...
	else
	{
		...
		else
		{
			...
			StringIntConCat(&Var6, (iLocal_299 - 1), 16);
			cVar7 = { func_235(iLocal_300) };
			if (iLocal_299 == 1 && func_243())
			{
			...
			if (iVar9 <= 0)
			{
				if (!func_226())
				{
					iVar9 = (Global_262145.f_15104 - unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(unk_0x578C4EF320340AF7(), Global_2516617.f_142)));
				}
			}
			if (iVar9 > 0)
			{
			...
			if (unk_0x7BCC91F3C1CF24E8(&cVar7))
			{
				func_8(&Var6);
			}
			else
			{
				unk_0xB23270F3D5E62FDE(&Var6);
				unk_0x6A826E35A3096ED0(&cVar7);
				if (!unk_0x7BCC91F3C1CF24E8(&Var8))
				{
					unk_0x6A826E35A3096ED0(&Var8);
				}
				unk_0x2042E9CA4306F725();
			}
			unk_0xF1B28F753235CE2A(bVar5);
			unk_0xAD291B8F75D737AD(-1);
			unk_0xE1FDD153F5858534();
			iVar0++;
		}
...
bool func_243()
{
	return unk_0xCE990E643CD9D0E5(iLocal_122, 6);
}
...
void func_247(int iParam0)
{
	...
	else if (iLocal_301 != 8 && func_249(iLocal_301))
	{
		func_214();
	}
	else if (!func_39(229))
	...
	else
	{
		...
		if (iLocal_301 != 8)
		{
			...
			Var1 = { func_248(iLocal_301) };
		}
		func_360("HT_AF_P1", &Var0, "WHOUSE_CONF", "WHOUSE_CANC", 0, 1, 2, -1, -1, &Var1, 0);
	}
}
...
void func_253(int iParam0)
{
	...
	else
	{
		...
		func_360("HT_BW_LT", "HT_BW_L0", "WHOUSE_CONF", "WHOUSE_CANC", 0, 1, 1, -1, -1, &Var1, 0);
		func_254(iVar0);
	}
}
...
int func_256(int iParam0, bool bParam1)
{
	...
	{
		if (!func_326(unk_0x460153A63B9477BC()))
		{
			func_22(4, iParam0);
			return 0;
		}
	...
	{
		if (func_45(unk_0x460153A63B9477BC(), iVar0, 0) == 4)
		{
			func_22(7, iParam0);
			return 0;
		}
...
int func_258(int iParam0, int iParam1)
{
	...
	{
		iVar6 = iVar2;
		if (func_325(iVar6, 1, 1))
		{
			bVar9 = ((func_54(iVar6) != iVar5 || iVar5 == func_18()) && iVar6 != unk_0x460153A63B9477BC());
			iVar4 = 0;
			while (iVar4 < 10)
			{
				if (iVar0[iVar4] != -1)
				{
					...
					if (!func_323(Var7))
					{
						if (unk_0x8F678487EEBD8CE4(Global_2416085[iVar6]))
						{
							Var8 = { unk_0x41A1ED9BB4ED4772(Global_2416085[iVar6]) };
							Var8.f_2 = unk_0xDCF41A542B928421(Var8.x, Var8.f_1);
						}
						else
						{
							Var8 = { func_263(iVar6) };
						...
						if (!func_323(Var8))
						{
							if (vdist2(Var8, Var7) < (func_262(iParam0, bVar9) * func_262(iParam0, bVar9)))
							{
								iVar0[iVar4] = -1;
								if (!bVar9)
								{
	...
	if (iVar3 > 0)
	{
		*iParam1 = iVar1[unk_0x344C570D6F8700DF(0, iVar3)];
		return 1;
	}
	else if (bVar10)
	{
...
int func_259(int iParam0, int iParam1)
{
	...
	{
		case 240:
			if (unk_0x8F678487EEBD8CE4(Global_2416085[unk_0x460153A63B9477BC()]))
			{
				Var0 = { unk_0x41A1ED9BB4ED4772(Global_2416085[unk_0x460153A63B9477BC()]) };
				Var0.f_2 = unk_0xDCF41A542B928421(Var0.x, Var0.f_1);
			}
			else
			{
				Var0 = { func_263(unk_0x460153A63B9477BC()) };
			}
			if (vdist2(func_324(iParam0, iParam1), Var0) > (func_260(iParam0) * func_260(iParam0)))
			{
				return 1;
			}
			break;
...
Vector3 func_263(int iParam0)
{
	...
	{
		Var1 = { func_321(func_322(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_28)) };
		if (vmag(Var1) > 0f)
		{
			return Var1;
		}
...
int func_276(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if (((Global_1312896 || Global_2405074.f_2673) && iParam0 == unk_0x460153A63B9477BC()) && func_325(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6;
		}
	}
...
int func_277(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if (((Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_1312896) && iParam0 == unk_0x460153A63B9477BC()) && func_325(iParam0, 1, 0))
		{
			return func_271(Global_2425869[iParam0 /*443*/].f_314.f_6) == 20;
		}
	}
...
int func_317(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if ((Global_1312896 && iParam0 == unk_0x460153A63B9477BC()) && func_325(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_318(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_319(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
void func_332()
{
	...
	while (iVar0 < 3)
	{
		cVar1 = { func_235(iLocal_300) };
		iVar2 = iVar0 + 1;
		iVar3 = func_338(iVar2);
		iVar4 = -1;
		if (iVar2 == 1 && func_243())
		{
			iVar5 = func_242(iLocal_300);
			if (func_337(iVar5))
			{
				iVar4 = func_336(iVar5);
		...
		bVar8 = func_340(unk_0x460153A63B9477BC());
		unk_0x830F007E19C63E14(uLocal_303, "ADD_JOB");
		unk_0xAD291B8F75D737AD(iVar0);
...
int func_341(int iParam0)
{
	if (func_42(unk_0x460153A63B9477BC()))
	{
		return func_342(unk_0x460153A63B9477BC(), iParam0);
	}
	return 0;
}
...
void func_343()
{
	...
	while (iVar0 < 9)
	{
		...
		bVar4 = ((func_347(unk_0x460153A63B9477BC()) && func_345(unk_0x460153A63B9477BC())) && !func_251(unk_0x460153A63B9477BC()));
		iVar5 = 0;
		iVar6 = 0;
		...
		{
			iVar6 = func_344(Global_2516765[iVar8 /*2*/], Global_2516765.f_17[iVar8], 0);
		}
		if (iVar6 > 0)
		{
			iVar5 = 2;
		...
		else if (func_251(unk_0x460153A63B9477BC()))
		{
		...
		{
			unk_0xB23270F3D5E62FDE(&Var3);
			unk_0x6A826E35A3096ED0(&cVar2);
			unk_0x2042E9CA4306F725();
		}
...
int func_344(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	...
	iVar0 = unk_0x44F29CF6A0675F4F((iParam2 - unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(iVar1, iParam0))));
	iVar0 = (iVar0 / 1000);
	return iVar0;
}
...
{
	unk_0x830F007E19C63E14(uLocal_303, "SHOW_OVERLAY");
	func_8(sParam0);
...
void func_363(int iParam0)
{
	...
	{
		unk_0xD2459066EA58CE43(&(Global_1678288.f_3), 28);
	}
	iLocal_129 = iParam0;
	unk_0x830F007E19C63E14(uLocal_303, "SHOW_SCREEN");
	unk_0xAD291B8F75D737AD(iParam0);
	unk_0xE1FDD153F5858534();
}
...
void func_364()
{
	...
	switch (func_457())
	{
		...
		case 3:
			if (func_430(iLocal_298, iLocal_299, func_243(), iLocal_300, 167))
			{
				unk_0xBE20AB8238688965(&(Global_1678288.f_4), 4);
				func_444(167);
			}
			break;
		
		case 4:
			if (func_219(unk_0x460153A63B9477BC(), func_222(unk_0x460153A63B9477BC())))
			{
				func_360("HT_VC_P1", "SEC_V_STEAL_F", "OR_OVRLY_OK", "", 1, 0, 0, -1, -1, 0, 0);
			}
			else if (func_399())
			{
				unk_0xBE20AB8238688965(&(Global_1678288.f_4), 5);
				func_397();
				func_396(1);
				func_547(0, 1);
			}
		...
		case 5:
			if (func_372(func_35(unk_0x460153A63B9477BC()), 225))
			{
		...
		case 6:
			if (func_372(iLocal_302, 192))
			{
				Global_1678139 = iLocal_302;
				Global_1676146.f_53 = 1;
				func_444(192);
				func_365(func_213(iLocal_302), !Global_262145.f_16989);
				func_369(func_213(iLocal_302));
			}
			break;
...
void func_370(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
int func_381()
{
	...
	if (!bVar0)
	{
		if (!unk_0x5053392075AA583C(func_168()) || unk_0x701B05C16EF4F48E())
		{
...
void func_382(struct<67> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	struct<3> Var0;
	int iVar1;
...
int func_389(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_390(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}

int func_390(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_403(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<7> Var0;
...
{
	return func_91(unk_0x460153A63B9477BC(), bParam0);
}

void func_414(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
int func_415(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1630317[unk_0x460153A63B9477BC() /*595*/].f_11.f_327[iVar0] = func_421(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		if (bVar2)
		{
			...
			{
				uVar6 = 2;
				uVar7 = func_416(&iVar1, iVar4, &uVar6);
				iVar0 = 0;
				while (iVar0 < iParam1)
				{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1630317[unk_0x460153A63B9477BC() /*595*/].f_11.f_327[iVar0] = func_416(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
int func_416(int iParam0, int iParam1, var uParam2)
{
	...
	iVar4 = func_54(unk_0x460153A63B9477BC());
	...
	if (func_331(iVar4))
	{
		Var6 = { Global_1678288.f_496[func_419(func_222(iVar4)) /*3*/] };
		Var6.f_2 = 0f;
	}
	else
	{
	...
	if (iParam1 > 0)
	{
		...
		if (iVar3 > 0)
		{
			...
			func_417(uVar2[iVar13], &iVar8, &iVar9);
		...
		else
		{
			...
			if (iVar3 > 0)
			{
				...
				func_417(uVar2[iVar14], &iVar8, &iVar9);
				unk_0xBE20AB8238688965(uParam2[iVar8], iVar9);
				return uVar2[iVar14];
			}
			else
			{
				...
				func_417(uVar2[iVar15], &iVar8, &iVar9);
				unk_0xBE20AB8238688965(uParam2[iVar8], iVar9);
				return uVar2[iVar15];
			}
		}
...
void func_423()
{
	...
	while (iVar0 < 32)
	{
		...
		uVar6 = func_427(iVar4[iVar0], iVar5);
		...
		else if (func_425(unk_0x460153A63B9477BC(), Global_1678221[iVar0]))
		{
			iVar7 = func_424(iVar5, &(Global_1678221[iVar0]));
			if (func_425(unk_0x460153A63B9477BC(), Global_1678221[iVar0]))
			{
				func_424(iVar7, &(Global_1678221[iVar0]));
				if (func_425(unk_0x460153A63B9477BC(), Global_1678221[iVar0]))
				{
					Global_1678221[iVar0] = 0;
				}
...
int func_426(var uParam0)
{
	...
	while (iVar2 < 3)
	{
		if (func_425(unk_0x460153A63B9477BC(), (iVar1 + iVar2)))
		{
			return 1;
		}
		iVar2++;
...
int func_430(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	int iVar0;
	char cVar1[16];
	bool bVar2;
	...
	bVar2 = false;
	iVar3 = func_338(iParam1);
	if (uParam2 && iParam1 == 1)
	{
		iVar3 = func_336(func_242(iParam3));
		bVar2 = true;
	}
	if (iVar3 > 0)
	{
		if (!unk_0x6914A85D2E17013B(iVar3, false, true, 0, -1, 0))
		{
			unk_0xC4CC25B68A91D144(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", 1);
			return 0;
		}
	...
	if (func_395())
	{
		iVar4 = func_439(1, iParam1, bVar2, func_242(iParam3));
		iVar5 = func_438(iVar0);
		iVar6 = -1;
		iVar7 = 0;
		iVar8 = 1;
		while (func_437(&iVar6, iVar3, iVar0, -1799524201, -1018905335, iVar4, iVar5, &iVar8, &iVar7))
		{
			func_468();
			wait(0);
		}
	...
	if (iVar3 >= 0 && (iVar3 == 0 || (iVar3 > 0 && (func_395() || unk_0x6914A85D2E17013B(iVar3, false, true, 0, -1, 0)))))
	{
		if (iVar3 > 0)
		{
			func_431(joaat("MPPLY_INGAMESTORE_MONEYSPENT"), iVar3);
		}
		if (func_395())
		{
			unk_0xA6292C176D37A114(func_385(func_392()));
		}
		unk_0x5D29B7F3C5881B39(iVar3, iParam0, unk_0x856D5567211886A2(&cVar1), 0, 1);
		if (func_395())
		{
			func_377(func_392());
		}
...
int func_439(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	func_440(&sVar0, bParam0, iParam1, bParam2, iParam3);
	return unk_0x856D5567211886A2(&sVar0);
}
...
void func_444(int iParam0)
{
	...
	{
		iVar0 = 0;
		if (func_243() && iLocal_299 == 1)
		{
			iVar0 = 1;
		}
		func_453(iParam0, iLocal_298, iLocal_299, iLocal_300, iVar0);
	}
	else if (iParam0 == 229)
	{
		if (iLocal_301 == 8)
		{
			iLocal_301 = unk_0x344C570D6F8700DF(0, 8);
			func_452(18);
		}
		else
		{
...
void func_453(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	func_454(uParam1, iParam2, iParam3, iParam4);
	func_402(iParam0, uParam1);
}

void func_454(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
void func_458()
{
	unk_0x830F007E19C63E14(uLocal_303, "HIDE_OVERLAY");
	unk_0xE1FDD153F5858534();
	func_361(0);
...
void func_459()
{
	if (func_460())
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_122, 3))
		{
			unk_0x830F007E19C63E14(uLocal_303, "GET_CURRENT_SELECTION");
			uLocal_304 = unk_0xF4712E16A4C164FE();
...
void func_461()
{
	...
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_466(2, 206, 1);
	if (unk_0x1BD7199394D7F19A(2, 206))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		...
		{
			unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_466(2, 187, 1);
		if (unk_0x1BD7199394D7F19A(2, 187))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xC27AEE8B64EE0F8D(2, 187))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xC27AEE8B64EE0F8D(2, 188))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0x1BD7199394D7F19A(2, 188))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_466(2, 187, 1);
		if (unk_0x1BD7199394D7F19A(2, 187))
		{
			unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_466(2, 189, 1);
	if (unk_0x1BD7199394D7F19A(2, 189))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_466(2, 190, 1);
	if (unk_0x1BD7199394D7F19A(2, 190))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_466(2, 201, 1);
	if (unk_0x1BD7199394D7F19A(2, 201))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_466(2, 202, 1);
	...
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_466(2, 204, 1);
	if (unk_0x1BD7199394D7F19A(2, 204))
	{
		unk_0xC90636D3CB7D4CEF(uLocal_303, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		unk_0x830F007E19C63E14(uLocal_303, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_305 != 127) || iVar1 != 127) || iLocal_306 != 127)
		{
			unk_0x830F007E19C63E14(uLocal_303, "SET_ANALOG_STICK_INPUT");
			iLocal_305 = iVar0;
			iLocal_306 = iVar1;
			unk_0xF1B28F753235CE2A(true);
			unk_0xAD291B8F75D737AD(iLocal_305);
			unk_0xAD291B8F75D737AD(iLocal_306);
			unk_0xE1FDD153F5858534();
		}
	}
	func_466(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_307 != 127) || iVar3 != 127) || iLocal_308 != 127)
	{
		...
		unk_0xAD291B8F75D737AD(iLocal_307);
		unk_0xAD291B8F75D737AD(iLocal_308);
		unk_0xF1B28F753235CE2A(bVar4);
		unk_0xE1FDD153F5858534();
	}
...
void func_462()
{
	...
	else if (unk_0xCE990E643CD9D0E5(iLocal_122, 5))
	{
...
void func_463()
{
	unk_0x830F007E19C63E14(uLocal_303, "HIDE_JOB_OVERLAY");
	unk_0xE1FDD153F5858534();
...
bool func_464()
{
	return unk_0xCE990E643CD9D0E5(iLocal_122, 4);
}
...
void func_468()
{
	...
	unk_0x9D15035C6653D1B1(1);
	unk_0x37FC7E88C7659D33(uLocal_303, 255, 255, 255, 255, 0);
	func_479();
	func_472(0);
	func_469(1);
}
...
void func_485(int iParam0)
{
	...
	else
	{
		func_250(&uLocal_311);
		iLocal_125 = 0;
		if (!func_223(12) || unk_0xCE990E643CD9D0E5(iLocal_122, 7))
		{
			if (func_1(&uLocal_309, 500, 0))
			{
				func_250(&uLocal_309);
...
void func_486(int iParam0)
{
	...
	unk_0x830F007E19C63E14(uLocal_303, "UPDATE_MISSION");
	iVar0 = iParam0;
	iVar1 = 0;
...
int func_488(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			return (func_340(unk_0x460153A63B9477BC()) && func_341(0));
			break;
		
		case 3:
			return (func_331(unk_0x460153A63B9477BC()) && func_341(0));
			break;
		
		case 4:
			return ((func_34(unk_0x460153A63B9477BC()) && func_491(1)) && !func_490(5));
			break;
		
		case 5:
			if (func_489(unk_0x460153A63B9477BC()) && func_32(unk_0x460153A63B9477BC()))
			{
				return 1;
			}
			break;
...
int func_491(int iParam0)
{
	...
	if (!func_493(unk_0x460153A63B9477BC(), iParam0))
	{
		return 0;
	}
	switch (iParam0)
	{
		...
		case 6:
			...
			while (iVar0 < 6)
			{
				iVar1 = func_25(unk_0x460153A63B9477BC(), iVar0);
				if (func_20(iVar1))
				{
					if (func_27(iVar1) == func_492(iParam0) && func_21(unk_0x460153A63B9477BC(), iVar1))
					{
						iVar2 = func_19(unk_0x460153A63B9477BC(), iVar1);
						if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[iVar2 /*12*/].f_7 || Global_1370211[iVar2] != 0)
						{
							return Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_183[iVar2 /*12*/].f_4 > 0;
						}
					}
				}
				iVar0++;
		...
		case 0:
			...
			{
				return func_346(unk_0x460153A63B9477BC());
			}
			break;
	}
	return 0;
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 < 6)
			{
				...
				if (func_328(func_330(iVar0), &iVar2))
				{
		...
		case 2:
			...
			while (iVar0 < func_240())
			{
				...
				if (iVar1 <= 0)
				{
					if (!func_226())
					{
						iVar1 = (Global_262145.f_15104 - unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(unk_0x578C4EF320340AF7(), Global_2516617.f_142)));
					}
				}
				if (iVar1 >= 0)
				{
...
{
	unk_0x830F007E19C63E14(uLocal_303, "UPDATE_COOLDOWN");
	unk_0xAD291B8F75D737AD(iParam0);
	...
	switch (iParam0)
	{
		...
		case 5:
			...
			else
			{
				iVar5 = func_13(iLocal_125);
				iVar7 = iLocal_125;
				if (func_28(unk_0x460153A63B9477BC(), iVar7))
				{
					iVar1 = func_26(unk_0x460153A63B9477BC(), iVar7);
					iVar8 = func_25(unk_0x460153A63B9477BC(), iVar1);
				...
				else
				{
					...
					if (!bVar4)
					{
						...
						if (iVar3 <= 0)
						{
							if (!func_226())
							{
								iVar3 = (Global_262145.f_15104 - unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(unk_0x578C4EF320340AF7(), Global_2516617.f_142)));
							}
						}
...
void func_514()
{
	...
	{
		if (func_517(Global_111858.f_2359.f_539.f_4321) != unk_0x36FE6D3220816ADA(unk_0x9B0761B4C3EB8BC7()))
		{
			iVar0 = func_516(unk_0x9B0761B4C3EB8BC7());
...
void func_525()
{
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_122, 8) && !func_533())
	{
		if (unk_0xCE990E643CD9D0E5(iLocal_122, 10))
		{
			if (unk_0xCE990E643CD9D0E5(Global_1678137, 16) || unk_0xCE990E643CD9D0E5(iLocal_122, 12))
			{
				unk_0xBE20AB8238688965(&iLocal_122, 9);
				return;
			}
			else if (unk_0xCE990E643CD9D0E5(Global_1678288.f_3, 28))
			{
				if (!unk_0xCE990E643CD9D0E5(iLocal_122, 11))
				{
					if (func_531())
					{
						if (!unk_0xCE990E643CD9D0E5(Global_1678137, 17))
						{
							bVar0 = true;
							iLocal_126 = 9000;
							iLocal_127 = func_530(1);
							unk_0xBE20AB8238688965(&Global_1678137, 17);
					...
					else if (func_529())
					{
						...
						func_528();
						unk_0xBE20AB8238688965(&Global_1678137, 16);
					}
				}
			}
		}
		else
		{
			...
			if (((unk_0xCE990E643CD9D0E5(iLocal_122, 4) && iLocal_131 == 0) && !func_495(22143, -1, -1)) && !bVar0)
			{
				bVar0 = true;
				iLocal_126 = 9000;
				iLocal_127 = 2;
	...
	else if (unk_0xCE990E643CD9D0E5(iLocal_122, 8))
	{
		if (!func_3(&uLocal_315))
		{
			func_2(&uLocal_315, 0, 0);
		}
		else if (func_1(&uLocal_315, iLocal_126, 0))
		{
...
int func_530(bool bParam0)
{
	...
	return unk_0x344C570D6F8700DF(iVar0, iVar1);
}

int func_531()
{
	if (func_532(unk_0x460153A63B9477BC()) == 0)
	{
...
void func_534()
{
	...
	else if (func_467() || unk_0xC27AEE8B64EE0F8D(2, 199))
	{
		func_547(0, 1);
	}
...
{
	func_534();
	uLocal_303 = unk_0x5DEA4192B46CB99B("hacker_truck_desktop");
	while (!unk_0x95EF219D38B20CFF(uLocal_303))
	{
		wait(0);
	}
	func_473(1);
...
{
	unk_0x2E352DDBBF674246(&uLocal_303);
	func_543(iParam0);
	func_545(0);
	func_548();
