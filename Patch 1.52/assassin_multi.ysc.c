...
void __EntryFunction__()
{
	...
	iLocal_134 = 100;
	iLocal_135 = 3;
	uLocal_725 = unk_0x0CD0167AEB96E096();
	iLocal_726 = unk_0xE66C877C9033DBB0();
	iLocal_968 = 1;
	iLocal_1149 = -1;
	fLocal_1151 = 1f;
	Local_1175 = { -700.1431f, -917.7708f, 18.2147f };
	Local_1176 = { -700.1431f, -917.7708f, 18.2147f };
	fLocal_1177 = 3.283f;
	fLocal_1178 = 42f;
	Local_1181 = { -699.1455f, -917.3423f, 19.7904f };
	Local_1182 = { -5.6096f, -0.1143f, 75.6741f };
	Local_1183 = { -699.1455f, -917.3423f, 19.7904f };
	Local_1184 = { -2.4284f, -0.1143f, 81.9337f };
	Local_1193 = { 0f, 0f, 0f };
	Local_1194 = { 0f, 0f, 0f };
	iLocal_1231 = 540000;
	iLocal_1233 = -1;
	...
	fLocal_1249 = 3f;
	fLocal_1250 = 540000f;
	Local_1253 = { -1208.462f, -1559.661f, 3.6087f };
	Local_1291 = { -702.6807f, -920.2365f, 18.0144f };
	...
	if (unk_0xED06FD5709A59F02(3))
	{
		...
		func_513();
		if (unk_0xAE06B9E39EBDE049(iLocal_1171))
		{
			unk_0x80250B8368A4E611(iLocal_1171, true, 0);
			unk_0x58ADF88C51AAFDC5(iLocal_1171, true, 0);
			unk_0xC62EE91883AF24A2(iLocal_1171, 1);
		}
	...
	iLocal_1266 = unk_0xC08A186299DFDA0A(Local_1253 - Vector(2f, 2f, 2f), Local_1253 + Vector(2f, 2f, 2f), 0, 1, 1, 1);
	func_508();
	iLocal_1150 = 1;
	...
	if (func_511())
	{
		...
		if (iLocal_1242 == 0)
		{
			Local_1254 = { Local_1291 };
			fLocal_1255 = fLocal_1293;
			Local_1256 = { -711.8262f, -920.7407f, 18.0144f };
			fLocal_1257 = 0.0954f;
			func_504(Local_1291, fLocal_1293, 1, 0);
		}
		else if (iLocal_1242 == 1)
		{
			Local_1254 = { -1205.392f, -1548.022f, 3.3229f };
			fLocal_1255 = 30.1673f;
			Local_1256 = { -1192.206f, -1532.933f, 3.4095f };
			fLocal_1257 = 304.364f;
			func_504(Local_1254, fLocal_1255, 1, 0);
		}
		else if (iLocal_1242 == 2)
		{
			Local_1254 = { -2178.855f, -410.6809f, 12.1595f };
			fLocal_1255 = 13.1631f;
			Local_1256 = { -2175.782f, -400.12f, 12.1925f };
			fLocal_1257 = 347.9469f;
			func_504(Local_1254, fLocal_1255, 1, 0);
		}
		else if (iLocal_1242 == 3)
		{
			Local_1254 = { -702.8256f, 224.235f, 79.1613f };
			fLocal_1255 = 291.4638f;
			Local_1256 = { -700.4276f, 229.6938f, 79.2745f };
			fLocal_1257 = 296.3371f;
			func_504(Local_1254, fLocal_1255, 1, 0);
		}
		else if (iLocal_1242 == 4)
		{
			Local_1254 = { -1986.378f, 531.8684f, 108.243f };
			fLocal_1255 = 149.1485f;
			Local_1256 = { -1984.45f, 529.9053f, 107.9867f };
	...
	while (true)
	{
		...
		unk_0xAEF7C45DAFB8E9B0("M_ASS2", 0);
		...
		if (func_499(&uScriptParam_1871))
		{
			if (func_498())
			{
				...
				unk_0x1E337EE68290597A(iLocal_1266, 0);
				func_518();
		...
		else if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				Global_111858.f_19959.f_6 = func_517();
				fLocal_123 = (Global_111858.f_19959.f_6 / 1000f);
...
int func_21(var uParam0)
{
	...
	{
		case 0:
			if (IntToFloat(iLocal_1235) >= ((fLocal_1250 * 1f) / 2f) && !unk_0x2F80DB5A41D045E6())
			{
				func_38(&(uParam0->f_16), 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
...
void func_39(int iParam0, var uParam1, float fParam2, var uParam3, bool bParam4)
{
	if (!*uParam3)
	{
		*iParam0 = unk_0x578C4EF320340AF7();
		*uParam3 = 1;
	}
	*uParam1 = (unk_0x578C4EF320340AF7() - *iParam0);
	iLocal_1245 = (round(*fParam2) - *uParam1);
...
float func_45(int iParam0)
{
	if (func_497(iParam0))
	{
		...
		{
			return (func_46(unk_0xCE990E643CD9D0E5(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
void func_48()
{
	if (!iLocal_1228)
	{
		if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0)
		{
			if (!func_51())
			{
				func_49(unk_0x9B0761B4C3EB8BC7(), "SPOT_POLICE", 24);
				iLocal_1228 = 1;
			}
		}
	}
	...
	if (iLocal_968 > 4)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (unk_0xAE06B9E39EBDE049(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1263 && !unk_0xE72C9284B5143451(iVar0)) && !unk_0x1758275D343D5BA3(iVar0))
					{
						iLocal_1263 = iVar0;
						unk_0x4F3C4F457D44BB0F(iLocal_1263, true, 0);
						unk_0x70B6482C77771EA4(iLocal_1263, 0);
					}
				}
			}
		}
...
void func_53(struct<39> Param0, var uParam1, var uParam2)
{
	...
	switch (iLocal_970)
	{
		...
		case 1:
			...
			if (func_141(&uLocal_139, 1, 0) && unk_0x7017F892E55CEAC8())
			{
...
void func_56(struct<25> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14)
{
	...
	func_57(func_10(), 97, round(fVar0), 0, 0);
}
...
void func_101(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_107(uParam0->f_1, 256) || (func_107(uParam0->f_1, 8192) && unk_0x628AF533B14EF310(2)))
	{
		...
		if (unk_0xF8EDFF98A9C94C74())
		{
			...
			unk_0xF1B28F753235CE2A(func_107(uParam0->f_1, 4096));
			unk_0xE1FDD153F5858534();
		}
		iVar5 = 0;
		iVar6 = 0;
	...
	while (bVar0)
	{
		...
		if ((uParam0->f_565 || uParam0->f_566) && uParam0->f_56 != 0)
		{
			if (IntToFloat(uParam0->f_572) > (IntToFloat(uParam0->f_558 + 1165) - (15000f * fParam2)))
			{
				...
				uParam0->f_559 = func_111((uParam0->f_559 + (((1f / 0.3f) * uParam0->f_573) * timestep())), 0f, 1f);
				uParam0->f_573 = func_111((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
			}
		}
		else
		{
			uParam0->f_559 = func_111((uParam0->f_559 - ((((1f / 0.3f) * uParam0->f_573) * 0.01f) * timestep())), 0f, 1f);
			uParam0->f_573 = func_111((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
		}
...
void func_110(var uParam0, bool bParam1)
{
	...
	func_106(unk_0xED026A379B794F61(2, 215, true));
	func_105("ES_HELP");
	if (unk_0xF8EDFF98A9C94C74())
	{
		unk_0xF1B28F753235CE2A(true);
	...
	if (bParam1)
	{
		unk_0x830F007E19C63E14(uParam0->f_4, "SET_DATA_SLOT");
		unk_0xAD291B8F75D737AD(1);
		func_106(unk_0xED026A379B794F61(2, 216, true));
		func_105("ES_XPAND");
		if (unk_0xF8EDFF98A9C94C74())
		{
			unk_0xF1B28F753235CE2A(true);
...
void func_112(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_127();
		unk_0x8DDE075026DB7EFD(0.5f, (fVar1 - (func_130((2f - 0.5f)) - 0.001388889f)), fVar6, func_125(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
	...
	while (iVar17 < uParam0->f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_122(uParam0, iVar17, (fVar1 + func_130(2f)), fVar9, fVar10, round((IntToFloat(iVar0) * fVar12)));
		}
		else
		{
			return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_111((fVar11 / (0.6f * func_130(25f))), 0f, 1f);
					func_127();
					unk_0x8DDE075026DB7EFD(0.5f, (fVar1 + func_130((2f * 0.5f))), fVar6, func_125(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_130((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_130((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					unk_0xA434CC17B5517E4E(fVar20, (fVar1 + func_130((2f * 2f))), 0);
					break;
...
var func_118(int iParam0, bool bParam1)
{
	...
	if (!unk_0x7BCC91F3C1CF24E8(&(Global_22550.f_7029[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_120(unk_0x460153A63B9477BC()) };
...
char* func_121(int iParam0)
{
	...
	if (!unk_0x7BCC91F3C1CF24E8(&(Global_22550.f_6020[iParam0 /*16*/])))
	{
		...
		{
			Var1 = { func_120(unk_0x460153A63B9477BC()) };
...
void func_122(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	unk_0xBC2BD09DB91678C5(1);
	unk_0x151E2F6EE4A34CFE(1f, func_124(14f));
	unk_0x9CB19F83A6C8E47F(0);
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0x177AA645FB4B3A38("CommonMenu", func_118(7, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_115(5, 0, 1, &fVar5, &fVar6, 0);
			unk_0x177AA645FB4B3A38("CommonMenu", func_118(5, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_115(6, 0, 1, &fVar5, &fVar6, 0);
			unk_0x177AA645FB4B3A38("CommonMenu", func_118(6, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_123(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			unk_0x151E2F6EE4A34CFE(1f, func_124(18f));
...
void func_142(var uParam0)
{
	...
	unk_0x830F007E19C63E14(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xAD291B8F75D737AD(2);
	func_106(unk_0xED026A379B794F61(2, 188, true));
	func_105("ES_HELP_TU");
	unk_0xE1FDD153F5858534();
	unk_0x830F007E19C63E14(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xAD291B8F75D737AD(1);
	func_106(unk_0xED026A379B794F61(2, 187, true));
	func_105("ES_HELP_TD");
	unk_0xE1FDD153F5858534();
	unk_0x830F007E19C63E14(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xAD291B8F75D737AD(0);
	func_106(unk_0xED026A379B794F61(2, 202, true));
	func_105("ES_HELP_AB");
	unk_0xE1FDD153F5858534();
	unk_0x830F007E19C63E14(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	unk_0xE1FDD153F5858534();
...
void func_143(var uParam0)
{
	...
	fVar0 = 0f;
	unk_0xBC2BD09DB91678C5(0);
	unk_0x151E2F6EE4A34CFE(1f, func_124(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_145()
{
	...
	if (!iLocal_128)
	{
		func_151(&uLocal_139, &Local_716, &Global_61732, 0);
		fLocal_123 = (fLocal_123 * 1000f);
		if (Global_93132)
		{
			func_150(&uLocal_139, 6, &(Local_716.f_12), "MTPHPERSKI", floor(fLocal_123), 0, 3, 0);
			func_150(&uLocal_139, 6, &(Local_716.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_150(&uLocal_139, 6, &(Local_716.f_30), "MTPHPERSKI", round((fLocal_125 + fLocal_124)), 0, 3, 0);
			func_149();
		}
		else
		{
			if (bLocal_127)
			{
				func_150(&uLocal_139, 6, &(Local_716.f_12), "MTPHPERRET", floor(fLocal_123), 0, 3, 0);
			}
			else
			{
				func_150(&uLocal_139, 9, &(Local_716.f_12), "", floor(fLocal_123), 0, 0, 0);
			}
			if (!unk_0x7BCC91F3C1CF24E8(&(Local_716.f_18)))
			{
				if (bLocal_126)
				{
					func_150(&uLocal_139, 6, &(Local_716.f_24), "", 0, 0, 2, 0);
					func_150(&uLocal_139, 3, &(Local_716.f_30), "", round((fLocal_125 + fLocal_124)), 0, 2, 0);
				}
				else
				{
					func_150(&uLocal_139, 6, &(Local_716.f_24), "", 0, 0, 1, 0);
					func_150(&uLocal_139, 3, &(Local_716.f_30), "", round(fLocal_124), 0, 0, 0);
				}
			}
			else
			{
...
void func_146()
{
	...
	{
		func_147(38, floor(fLocal_123), 1);
		if (bLocal_126)
		{
			func_147(39, 1, 1);
		}
		...
		if (bLocal_126)
		{
			func_147(40, round((fLocal_125 + fLocal_124)), 1);
		}
		else
		{
			func_147(40, round(fLocal_124), 1);
		}
	...
	{
		func_147(52, floor(fLocal_123), 1);
		if (bLocal_126)
		{
			func_147(53, 1, 1);
		}
		...
		if (bLocal_126)
		{
			func_147(56, round((fLocal_125 + fLocal_124)), 1);
		}
		else
		{
			func_147(56, round(fLocal_124), 1);
		}
	...
	{
		func_147(66, floor(fLocal_123), 1);
		if (bLocal_126)
		{
			func_147(67, 1, 1);
		}
		...
		if (bLocal_126)
		{
			func_147(68, round((fLocal_125 + fLocal_124)), 1);
		}
		else
		{
			func_147(68, round(fLocal_124), 1);
		}
	...
	{
		func_147(81, floor(fLocal_123), 1);
		if (bLocal_126)
		{
			func_147(82, 1, 1);
		}
		...
		if (bLocal_126)
		{
			func_147(83, round((fLocal_125 + fLocal_124)), 1);
		}
		else
		{
			func_147(83, round(fLocal_124), 1);
		}
	...
	{
		func_147(97, floor(fLocal_123), 1);
		if (bLocal_126)
		{
			func_147(98, 1, 1);
		}
		...
		if (bLocal_126)
		{
			func_147(99, round((fLocal_125 + fLocal_124)), 1);
		}
		else
		{
			func_147(99, round(fLocal_124), 1);
		}
...
void func_154(int iParam0)
{
	if (func_497(iParam0))
	{
		if (!func_47(iParam0))
		{
			iParam0->f_2 = (func_46(unk_0xCE990E643CD9D0E5(*iParam0, 4)) - iParam0->f_1);
...
{
	iParam0->f_1 = (func_46(unk_0xCE990E643CD9D0E5(*iParam0, 4)) - fParam1);
...
int func_156(var uParam0, var uParam1)
{
	...
	switch (iLocal_968)
	{
		...
		case 4:
			...
			{
				iLocal_1246 = Global_98955.f_12[0];
				if (iLocal_1242 == 0)
				{
					iLocal_1230 = 0;
				...
				else if (iLocal_1242 == 1)
				{
					...
					{
						fLocal_1250 = to_float(iLocal_1246);
					}
				}
				else if (iLocal_1242 == 2)
				{
			...
			if (bLocal_1204)
			{
				...
				unk_0x555EE41D7C7078E6(Local_1256, 5f, 1, 0, 0, false);
				iVar1 = func_417(Local_1256, fLocal_1257);
		...
		case 6:
			...
			Global_98955.f_12[0] = iLocal_1246;
		...
		case 7:
			...
			if (iLocal_1167 >= 2)
			{
				if (unk_0xAE06B9E39EBDE049(iLocal_1259))
				{
					if (func_281(iLocal_1259, unk_0x9B0761B4C3EB8BC7(), 1) > 500f)
					{
						unk_0xE730EAF558C97567(&iLocal_1259);
					}
				}
			}
			if (!iLocal_1226)
			...
			{
				if ((func_264(uParam0, uParam1) || (unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), *uParam1) && func_263(*uParam1, 1) < 150f)) || (unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), *uParam1) && func_263(*uParam1, 1) < 150f))
				{
					func_262(*uParam1);
					iLocal_968 = 10;
				}
		...
		case 10:
			...
			{
				if (iLocal_1206 && !unk_0x5AEB5DDFFAD43CA5(*uParam1))
				{
					func_258();
					unk_0x798BC6477B831DCB(*uParam1, 1, 0f, 0);
				}
		...
		case 11:
			...
			if (iLocal_1227 || timera() > 1000)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(*uParam1) && iLocal_1167 == 2)
				{
					unk_0x697DA7132EE43ABC(*uParam1, 0, 0);
				}
				if (iLocal_1167 == 1)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(uParam1->f_7))
					{
						unk_0x9DC06E2A59C5AEBB(&uVar0);
						unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_quick_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0x19F29730874AD6F1(uVar0);
						unk_0x9B6EC2CECE1010EF(uParam1->f_7, uVar0);
					...
					if (unk_0xAE06B9E39EBDE049(uParam1->f_1))
					{
						...
						{
							unk_0x70B6482C77771EA4(uParam1->f_1, 0);
						}
					}
				}
				iLocal_1230++;
		...
		case 12:
			...
			{
				unk_0x2D806C94B9A84B20("SCRIPTED_SCANNER_REPORT_ASS_MULTI_01", 0f);
			}
			break;
	}
	return 0;
...
void func_166(var uParam0, int iParam1)
{
	...
	*iParam1 = 0;
	if (iLocal_1167 != 1)
	{
		unk_0xE730EAF558C97567(&(iParam1->f_1));
		if (unk_0xAE06B9E39EBDE049(iLocal_1259))
		{
			unk_0xE730EAF558C97567(&iLocal_1259);
		}
	}
	else if (unk_0xAE06B9E39EBDE049(iParam1->f_1))
	{
		iLocal_1259 = iParam1->f_1;
	}
	if (unk_0xAE06B9E39EBDE049(iLocal_1258))
	{
		unk_0xE730EAF558C97567(&iLocal_1258);
	}
	if (unk_0xAE06B9E39EBDE049(iLocal_1261))
	{
		unk_0xE730EAF558C97567(&iLocal_1261);
	}
	if (unk_0xAE06B9E39EBDE049(iLocal_1260))
	{
		unk_0xE730EAF558C97567(&iLocal_1260);
	}
	iLocal_1208 = 0;
	iLocal_1238 = 0;
	iLocal_132 = 0;
...
void func_177(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (!unk_0x7BCC91F3C1CF24E8((*uParam0)[iVar0]))
		{
...
void func_182(int iParam0, var uParam1)
{
	...
	if (uParam1->f_14 != 0)
	{
		unk_0x74528AC0906CBABE(uParam1->f_14);
	}
	if (unk_0xAE06B9E39EBDE049(*iParam0))
	{
		unk_0x2481907DEE6B85EA(iParam0);
	...
	{
		unk_0x2481907DEE6B85EA(&(iParam0->f_7));
	}
	if (unk_0xAE06B9E39EBDE049(iParam0->f_9))
	{
		unk_0x2481907DEE6B85EA(&(iParam0->f_9));
	}
}
...
void func_183(int iParam0, var uParam1)
{
	...
	unk_0x74528AC0906CBABE(joaat("a_f_y_fitness_02"));
	if (unk_0xAE06B9E39EBDE049(*iParam0))
	{
		unk_0x2481907DEE6B85EA(iParam0);
	}
	...
	while (iVar0 <= 1)
	{
		if (unk_0xAE06B9E39EBDE049(Local_1870[iVar0 /*9*/]))
		{
			unk_0x2481907DEE6B85EA(&(Local_1870[iVar0 /*9*/]));
		}
		iVar0++;
	}
}
...
void func_184()
{
	...
	while (iVar0 < 4)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_1262[iVar0]))
		{
			unk_0xE730EAF558C97567(&(iLocal_1262[iVar0]));
		}
		iVar0++;
	}
}
...
void func_185()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			unk_0x74528AC0906CBABE(iLocal_1265[iVar0]);
		}
		iVar0++;
	}
}
...
void func_190(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_191(uParam0, iParam1, Param2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_191(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_215(iParam1) && unk_0xDC79F755CB11603C(iParam1))
	{
		iVar1 = 0;
		...
		if (!unk_0x28BD5A3E7899F23D())
		{
			...
			{
				func_206(uParam0, iParam1, Param2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
{
	if (func_215(unk_0x9B0761B4C3EB8BC7()))
	{
...
int func_196(char* sParam0)
{
	if (!func_197(1, 1, 0))
	{
		if ((!unk_0x7BCC91F3C1CF24E8(sParam0) && func_217(sParam0)) || func_217("CMN_HINT"))
		{
			unk_0xD289B55B6AADBA10(1);
		}
		return 0;
...
int func_197(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_204() || func_203(Global_4456448.f_129348)) || func_202())
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			iVar1 = func_201(unk_0x9B0761B4C3EB8BC7(), 0);
			if (((unk_0x09F8284D2E03269D(iVar0, iVar1) || (unk_0x36FE6D3220816ADA(iVar0) == joaat("apc") && iVar1 != -1)) || (unk_0x36FE6D3220816ADA(iVar0) == joaat("akula") && iVar1 != -1)) || (((unk_0x36FE6D3220816ADA(iVar0) == joaat("riot2") && iVar1 == 0) && func_200(iVar0, 10)) && unk_0x7F8B14CBFB9813E5(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_198(int iParam0)
{
	if (iParam0 != func_28())
	{
		...
		else if ((Global_1312896 && iParam0 == unk_0x460153A63B9477BC()) && func_199(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_206(var uParam0, int iParam1, struct<3> Param2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_207()
{
	return func_208(unk_0x460153A63B9477BC());
}
...
int func_210(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_213(bParam1, bParam2, bParam3) || unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x578C4EF320340AF7() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1) || func_211(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	switch (iLocal_1168)
	{
		...
		case 1:
			if (func_223(*uParam1, uParam1->f_1, &Local_120, &uLocal_122, 1, 0, 0, 1, 1) || iLocal_1208)
			{
				...
				{
					unk_0xA5EAD2ACE2C8BBB2(*uParam1, 1, 1);
					if (unk_0xE0B3BC41DDA88DF0(*uParam1, uParam1->f_1, 0))
					{
						if (unk_0x80FF6C016CDB0FAF(uParam1->f_1, 0))
						{
							if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
							{
								unk_0xBD204892D76E6303(*uParam1, uParam1->f_1, unk_0x9B0761B4C3EB8BC7(), 8, 35f, 786468, 500f, -1f, 1);
							}
							else
							{
								unk_0x63898068FDE8F8E4(*uParam1, uParam1->f_1, unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 8, 35f, 786468, 500f, -1f, 1);
							}
						}
					}
					else
					{
						unk_0x8B18A80E8EB15510(*uParam1, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
					}
				}
				settimera(0);
				iLocal_1168 = 2;
			...
			{
				if (!unk_0x47DBF174A0CB9D55(*uParam1, 0))
				{
					unk_0x13A4BD6CC31F7B8F(*uParam1, uParam1->f_1, -1);
					unk_0xB11D151E210D4FAC(uParam1->f_1, 1084227584);
				}
				unk_0x316E0389ADF56E20(uParam1->f_1, 4f);
				unk_0x9DC06E2A59C5AEBB(&uVar0);
				unk_0x47107451B20C1093(0, uParam1->f_1, -1637.682f, 1018.619f, 152.1026f, 4, 22f, 786468, 10f, -1f, 1);
				unk_0xD8C1C38EE8BC2AC6(0, uParam1->f_1, 22f, 786468);
				unk_0x19F29730874AD6F1(uVar0);
				unk_0x9B6EC2CECE1010EF(*uParam1, uVar0);
				unk_0x4F83FEE4454169D4(&uVar0);
				iLocal_1207 = 1;
			}
			break;
		...
		case 2:
			...
			else if (!unk_0x5AEB5DDFFAD43CA5(*uParam1))
			{
				if (!iLocal_1216)
				{
					if (!unk_0x47DBF174A0CB9D55(*uParam1, 0))
					{
						if (unk_0x16BC17A8EDC701A2(*uParam1, 780511057) != 1)
						{
							unk_0x6673CC701BC8E9C1(*uParam1, 1, 0);
							unk_0x8B18A80E8EB15510(*uParam1, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
							iLocal_1216 = 1;
						}
					}
				}
				if ((func_263(*uParam1, 1) < 15f && !func_51()) && !unk_0xCED6B5226244381C(*uParam1))
				{
					if (!iLocal_1211)
					{
...
{
	func_44(&iLocal_1267);
	fLocal_1249 = unk_0x658086F2B3C5E4E4(3f, 7f);
}
...
int func_224(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_225(unk_0x9B0761B4C3EB8BC7(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0xCED6B5226244381C(iParam0) && func_263(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_227(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0xC0A3F78AF5448915(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x887D491E579FA61E(iParam0) || func_228(iVar1))
			{
				if (unk_0xC2169C00B643278B(iParam1, unk_0x3E4D3CCC220BDFB1(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x04055E36623F131B(unk_0x9048E8838E822F21(iParam1), iParam0, 120f) && unk_0xD44D03437956A1ED(iParam1, iParam0, 17))
		...
		if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
		{
			if (unk_0x10D3F7E169A49C44(iParam0, -1, 0) != 0)
			{
				if (unk_0x1386E5E658CE3032(unk_0x9B0761B4C3EB8BC7(), &iVar0, 1))
				{
					...
					{
						if (func_281(unk_0x9B0761B4C3EB8BC7(), iParam0, 1) < 40f)
						{
...
void func_230(var uParam0)
{
	...
	unk_0xECC9A00CF1181EC2(uParam0->f_2, 1);
	unk_0x72BEFB9451782F60(uParam0->f_2, 0);
}
...
int func_231(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (unk_0x20F7576FDB52E2B0(iParam0))
	{
		unk_0xFA81E0FBD7F5ACA0(iVar0, func_104(unk_0x25DDB354A40FFCDB(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(iVar0, func_104(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
		unk_0x3060C53EAE54BBE7(iVar0, bParam1);
	}
	else if (unk_0x49116E591C7E1412(iParam0))
	{
...
void func_232(var uParam0)
{
	switch (iLocal_1168)
	{
		...
		case 1:
			if (!iLocal_1206)
			{
				if ((((func_223(*uParam0, 0, &Local_120, &uLocal_122, 0, 1, 0, 1, 1) || unk_0x6F51C53F49CF1153(unk_0x3E4D3CCC220BDFB1(*uParam0, 1), 15f, 0, 1)) || iLocal_1208) || func_263(*uParam0, 1) < 5f) || (unk_0x642A35A076CECC5A(unk_0x9B0761B4C3EB8BC7()) && func_263(*uParam0, 1) <= 35f))
				{
					if (!unk_0x5AEB5DDFFAD43CA5(*uParam0))
					{
						...
						unk_0x756D74A3EF0AB788(*uParam0, "oddjobs@assassinate@multi@windowwasher", "_shot_reaction", 8f, -8f, -1, 2, 0, 0, 0, 0);
						iLocal_1168 = 2;
					}
				}
			}
		...
		case 2:
			...
			if (unk_0x16BC17A8EDC701A2(*uParam0, -2017877118) != 1 && unk_0x16BC17A8EDC701A2(*uParam0, 474215631) != 1)
			{
				unk_0xAEC92B0DA8075AC9(*uParam0, -1);
			}
			break;
	}
	if (bLocal_1215)
...
void func_234(var uParam0, var uParam1)
{
	...
	switch (iLocal_1168)
	{
		case 0:
			...
			{
				unk_0x90A31D246854A730(uParam1->f_1, 1);
			}
			if (!unk_0xA59F96B50B97E63C(*uParam1, 0))
			{
				unk_0x642738D0DCA36EBA(*uParam1, 16);
			}
			if (!unk_0xA59F96B50B97E63C(uParam1->f_7, 0))
			{
				unk_0x642738D0DCA36EBA(uParam1->f_7, 16);
				unk_0x697DA7132EE43ABC(uParam1->f_7, 105, 0);
			}
			unk_0x131ED02492676000("veh@boat@marquis@rps@enter_exit");
			iLocal_1168 = 1;
			break;
		...
		case 1:
			...
			if (((func_223(*uParam1, uParam1->f_1, &Local_120, &uLocal_122, 0, 1, 0, 1, 1) || func_223(uParam1->f_7, uParam1->f_1, &Local_120, &uLocal_122, 0, 1, 0, 1, 1)) || func_243(uParam1)) || (func_242(*uParam1, 50f) && iLocal_1208))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(*uParam1))
				{
					if (fVar1 <= 75f)
					{
						if (!unk_0xA59F96B50B97E63C(uParam1->f_1, 0))
						{
							if (unk_0xC614DDE265D18415("veh@boat@marquis@rps@enter_exit"))
							{
								iLocal_1294 = unk_0xF341A134A5B8D4F6(0f, 0f, 0f, 0f, 0f, 0f, 2);
								unk_0x3198407FE9E09FCF(iLocal_1294, uParam1->f_1, unk_0x0724529FC474C803(uParam1->f_1, "seat_dside_r"));
								unk_0xDFDB9C533700BC17(*uParam1, iLocal_1294, "veh@boat@marquis@rps@enter_exit", "jump_out", 4f, -4f, 0, 1, 1148846080, 0);
							}
						}
					}
					else
					{
						...
						if (!unk_0xA59F96B50B97E63C(uParam1->f_1, 0))
						{
							iLocal_1294 = unk_0xF341A134A5B8D4F6(0f, 0f, 0f, 0f, 0f, 0f, 2);
							unk_0x3198407FE9E09FCF(iLocal_1294, uParam1->f_1, unk_0x0724529FC474C803(uParam1->f_1, "seat_dside_r"));
							unk_0xDFDB9C533700BC17(*uParam1, iLocal_1294, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_m", 4f, -1000f, 0, 1, 1148846080, 0);
						}
					}
				}
				if (!unk_0x5AEB5DDFFAD43CA5(uParam1->f_7))
				{
					...
					{
						unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					}
					unk_0x19F29730874AD6F1(uVar0);
					unk_0x9B6EC2CECE1010EF(uParam1->f_7, uVar0);
					unk_0x4F83FEE4454169D4(&uVar0);
					unk_0xCBA6B2B569DCAFD8(uParam1->f_7, 1);
				...
				if (!unk_0x5AEB5DDFFAD43CA5(uParam1->f_9))
				{
					if (unk_0x16BC17A8EDC701A2(uParam1->f_9, 1805844857) != 1)
					{
						unk_0x9B94F6169B0DAEFD(uParam1->f_9);
						unk_0x8B18A80E8EB15510(uParam1->f_9, unk_0x9B0761B4C3EB8BC7(), 200f, -1, 0, 0);
						unk_0xCBA6B2B569DCAFD8(uParam1->f_9, 1);
					}
				}
				iLocal_1232 = 0;
				unk_0xA5EAD2ACE2C8BBB2(*uParam1, 1, 1);
			...
			else
			{
				...
				if (!iLocal_1212)
				{
					if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_1258, 0))
					{
						if (!unk_0x5AEB5DDFFAD43CA5(uParam1->f_9))
						{
							if (unk_0x16BC17A8EDC701A2(uParam1->f_9, 1805844857) != 1)
		...
		case 2:
			if (!unk_0xA59F96B50B97E63C(*uParam1, 0))
			{
				if (!unk_0xA59F96B50B97E63C(uParam1->f_1, 0))
				{
					if (unk_0x10D3F7E169A49C44(uParam1->f_1, -1, 0) != *uParam1)
					{
						if (bLocal_1221)
						{
							if (unk_0xFC5D6FB6EECB392F(iLocal_1294))
							{
								fVar2 = unk_0x369E69441C066912(iLocal_1294);
							}
							if (fVar2 > 0.8f)
							{
								unk_0x9B94F6169B0DAEFD(*uParam1);
								unk_0x13A4BD6CC31F7B8F(*uParam1, uParam1->f_1, -1);
							}
						}
						else
						{
							...
							if (fVar2 > 0.9f)
							{
								if (unk_0x16BC17A8EDC701A2(*uParam1, 1805844857) != 1)
								{
									unk_0x8B18A80E8EB15510(*uParam1, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
								}
							}
					...
					else if (unk_0x16BC17A8EDC701A2(*uParam1, -1273030092) != 1)
					{
						unk_0x47107451B20C1093(*uParam1, uParam1->f_1, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), 8, 20f, 786468, 500f, -1f, 1);
					}
				}
				if (!iLocal_1210)
				{
	...
	switch (iLocal_1234)
	{
		case 0:
			if (!func_51())
			{
				if (iLocal_1233 == -1)
				{
					iLocal_1233 = unk_0x344C570D6F8700DF(0, 4);
				}
		...
		case 2:
			if (func_220())
			{
				if (iLocal_1233 == -1)
				{
					iLocal_1233 = unk_0x344C570D6F8700DF(0, 3);
				}
				else if (iLocal_1233 == 0)
				{
...
int func_241(int iParam0)
{
	switch (*iParam0)
	{
		case 0:
			...
			unk_0xA785552633ED203B(Local_971, unk_0x9B0761B4C3EB8BC7(), 5000, 0, 2);
			*iParam0++;
			break;
...
int func_242(int iParam0, float fParam1)
{
	...
	if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
		{
			...
			if (unk_0x2975580CCA617F3B((Var0.x - fParam1), (Var0.f_1 - fParam1), (Var0.f_2 - fParam1), (Var0.x + fParam1), (Var0.f_1 + fParam1), (Var0.f_2 + fParam1)))
			{
				return 1;
			}
		}
...
int func_243(var uParam0)
{
	...
	{
		if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, 1) || unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1))
		{
			return 1;
		}
	}
...
void func_244(var uParam0, var uParam1)
{
	...
	switch (iLocal_1168)
	{
		...
		case 1:
			if (((((func_223(*uParam1, 0, &Local_120, &uLocal_122, 1, 0, 0, 1, 1) || func_254(&bLocal_1213)) || func_253(*uParam1, &iLocal_1273, 1f, 20f, &uLocal_1214)) || (func_242(*uParam1, 25f) && iLocal_1208)) || unk_0x2FABF7C63A9F9FE5(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1208)
			{
				unk_0xBE4122AC23440E7D(false);
				...
				if (unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()) || (iVar2 && iVar1 != joaat("weapon_unarmed")))
				{
					unk_0x8B18A80E8EB15510(*uParam1, unk_0x9B0761B4C3EB8BC7(), 500f, -1, 0, 0);
				}
				else
				{
					unk_0x8FF9CE1C0F94F59A(*uParam1, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				}
				func_266(0);
				unk_0xA5EAD2ACE2C8BBB2(*uParam1, 1, 1);
				iLocal_1208 = 1;
		...
		case 2:
			...
			{
				iVar0 = func_249(0, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), 20f);
				if (iVar0 != 0)
				{
		...
		if (!func_51())
		{
			if (!iLocal_1208)
			{
				if (!iLocal_1209)
				{
					...
					else if (func_263(*uParam0, 1) < 20f && !unk_0x2F80DB5A41D045E6())
					{
						func_248(uParam0);
					}
				}
			...
			else
			{
				...
				if (!iLocal_1211)
				{
					if (unk_0x16BC17A8EDC701A2(*uParam0, 780511057) == 1)
					{
...
void func_246(var uParam0)
{
	if (!unk_0x5AEB5DDFFAD43CA5(*uParam0))
	{
		...
		{
			if (unk_0x9934470AA0A08B57(*uParam0, "misscommon@response", "bring_it_on", 3))
			{
		...
		{
			if (unk_0x16BC17A8EDC701A2(*uParam0, -2017877118) != 1 && !func_51())
			{
		...
		{
			if (unk_0x9934470AA0A08B57(*uParam0, "misscommon@response", "threaten", 3))
			{
		...
		{
			if (unk_0x16BC17A8EDC701A2(*uParam0, -2017877118) != 1)
			{
...
void func_247(int iParam0, char* sParam1, char* sParam2)
{
	...
	unk_0x756D74A3EF0AB788(0, sParam1, sParam2, 4f, -4f, -1, 0, 0, 0, 0, 0);
	unk_0x19F29730874AD6F1(uVar0);
...
void func_248(var uParam0)
{
	...
	else if (iLocal_1238 < 7)
	{
		if (func_45(&iLocal_1267) > fLocal_1249 && !func_51())
		{
			...
			func_44(&iLocal_1267);
			fLocal_1249 = unk_0x658086F2B3C5E4E4(5f, 8f);
			iLocal_1238++;
		}
	}
}

var func_249(bool bParam0, struct<3> Param1, float fParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(Local_1870[iVar0 /*9*/]))
		{
			if ((bParam0 && unk_0xE080FA9EB010F041(Local_1870[iVar0 /*9*/])) || (!bParam0 && !unk_0xE080FA9EB010F041(Local_1870[iVar0 /*9*/])))
			{
				fVar2 = func_250(Local_1870[iVar0 /*9*/], Param1, 1);
				if (fVar2 <= fVar1)
				{
...
float func_250(int iParam0, struct<3> Param1, bool bParam2)
{
	if (unk_0xA59F96B50B97E63C(iParam0, 0))
	{
		return -1f;
	...
	if (!unk_0x5AEB5DDFFAD43CA5(Local_1870[iVar0 /*9*/]))
	{
		switch (Local_1870[iVar0 /*9*/].f_8)
		{
			case 0:
				...
				{
					if (unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], 242628503) != 1)
					{
						unk_0x9B94F6169B0DAEFD(Local_1870[iVar0 /*9*/]);
						unk_0x9DC06E2A59C5AEBB(&uVar1);
						unk_0x9FBD956DCE20684B(0, Local_1870[iVar0 /*9*/].f_1, 1f, 0, 0, 786603, -1082130432);
						unk_0xB53E642F4F50E7C0(0, Local_1253, 0);
						unk_0x19F29730874AD6F1(uVar1);
						unk_0x9B6EC2CECE1010EF(Local_1870[iVar0 /*9*/], uVar1);
						unk_0x4F83FEE4454169D4(&uVar1);
					}
				}
				else if (unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], 242628503) != 1 && unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 1:
				if (unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 2:
				if (unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], -1146898486) != 1)
				{
					unk_0x30291E2E564E9B47(Local_1870[iVar0 /*9*/], 1193033728, 0);
				}
				break;
			}
	}
	...
	if (!unk_0xCED6B5226244381C(iParam0))
	{
		if (bParam1)
		{
			if (unk_0xE080FA9EB010F041(iParam0))
			{
				...
				if (iVar0 == 0)
				{
					unk_0x756D74A3EF0AB788(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_a", 4f, -4f, -1, 1, unk_0x658086F2B3C5E4E4(0f, 1f), 0, 0, 0);
				}
				else if (iVar0 == 1)
				{
					unk_0x756D74A3EF0AB788(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_b", 4f, -4f, -1, 1, unk_0x658086F2B3C5E4E4(0f, 1f), 0, 0, 0);
				}
				else
				{
					unk_0x756D74A3EF0AB788(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_c", 4f, -4f, -1, 1, unk_0x658086F2B3C5E4E4(0f, 1f), 0, 0, 0);
				}
			}
			else
			{
				...
				if (iVar0 == 0)
				{
					unk_0x756D74A3EF0AB788(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, unk_0x658086F2B3C5E4E4(0f, 1f), 0, 0, 0);
				}
				else
				{
					unk_0x756D74A3EF0AB788(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, unk_0x658086F2B3C5E4E4(0f, 1f), 0, 0, 0);
...
void func_255()
{
	if (unk_0xAE06B9E39EBDE049(Local_971))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(Local_971))
		{
			unk_0x8342E6CB98CD545C(Local_971, 187, 1);
			unk_0x8342E6CB98CD545C(Local_971, 155, 1);
		}
	}
}
...
void func_260(var uParam0)
{
	...
	if (unk_0x80FF6C016CDB0FAF(uParam0->f_1, 0))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(*uParam0))
		{
			if (!unk_0x9934470AA0A08B57(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 3))
			{
				unk_0x756D74A3EF0AB788(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (!unk_0xB77B1396EAA80D8F(*uParam0))
			{
				unk_0xF8A652CE310FFC53(*uParam0, uParam0->f_1, 0, Var0, Var1, 1, 1, 0, 0, 2, 1);
			}
		}
		if (!unk_0x5AEB5DDFFAD43CA5(uParam0->f_7))
		{
			if (!unk_0x9934470AA0A08B57(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 3))
			{
				unk_0x756D74A3EF0AB788(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (!unk_0xB77B1396EAA80D8F(uParam0->f_7))
			{
				unk_0xF8A652CE310FFC53(uParam0->f_7, uParam0->f_1, 0, Var2, Var3, 1, 1, 1, 0, 2, 1);
			}
		}
	}
}
...
void func_261(var uParam0, var uParam1)
{
	...
	{
		case 0:
			if (unk_0x16BC17A8EDC701A2(*uParam1, 242628503) != 1)
			{
				fVar1 = unk_0xEF7858F25585F853(*uParam1);
				if (fVar1 < (uParam0->f_4 - 20f) || fVar1 > (uParam0->f_4 + 20f))
				{
					if (unk_0x16BC17A8EDC701A2(*uParam1, 1920390111) != 1)
					{
						unk_0xF4726838A5A40509(*uParam1, uParam0->f_4, 0);
					}
				}
				else
				{
					unk_0x9DC06E2A59C5AEBB(&uVar0);
					unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@", "idle_a", 4f, -4f, -1, 1, 0, 0, 0, 0);
					unk_0x19F29730874AD6F1(uVar0);
					unk_0x9B6EC2CECE1010EF(*uParam1, uVar0);
					unk_0x4F83FEE4454169D4(&uVar0);
				}
...
{
	return func_281(unk_0x1FA7B77001D60F9D(unk_0x2639A2323BEA8CC6()), iParam0, bParam1);
}
...
int func_265(int iParam0)
{
	if (iLocal_1167 == 0)
	{
		if ((func_223(*iParam0, 0, &Local_120, &uLocal_122, 0, 0, 0, 1, 1) || func_254(&bLocal_1213)) || unk_0x3628D28B8671F14F(-1, Local_1253, 25f))
		{
			return 1;
		}
	}
	...
	if (!iLocal_1217)
	{
		...
		while (iVar0 <= 1)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(Local_1870[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					if (unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], 1805844857) != 1)
					{
						unk_0x8B18A80E8EB15510(Local_1870[iVar0 /*9*/], unk_0x9B0761B4C3EB8BC7(), 200f, -1, 0, 0);
						unk_0xCBA6B2B569DCAFD8(Local_1870[iVar0 /*9*/], 1);
					}
				}
				else if (unk_0x16BC17A8EDC701A2(Local_1870[iVar0 /*9*/], 1805844857) != 1)
				{
					unk_0x9FBD956DCE20684B(Local_1870[iVar0 /*9*/], func_267(), 2f, 0, 0, 786603, -1082130432);
					unk_0xCBA6B2B569DCAFD8(Local_1870[iVar0 /*9*/], 1);
				}
			}
			if (bParam0)
...
Vector3 func_267()
{
	...
	iVar1 = (unk_0x344C570D6F8700DF(0, 65535) % 6);
	switch (iVar1)
	{
		case 0:
...
int func_268(int iParam0, var uParam1)
{
	if (unk_0x87F0CB19476706C3())
	{
		...
		else if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (unk_0x5AEB5DDFFAD43CA5(*iParam0))
			{
				if (unk_0x80FF6C016CDB0FAF(iParam0->f_1, 0) && unk_0xCDF860E56BBCC6B4(*iParam0, iParam0->f_1, 1))
				{
					iLocal_953 = 1;
				}
			...
			else if (unk_0x80FF6C016CDB0FAF(iParam0->f_1, 0))
			{
				...
				{
					if (unk_0xF3A639BEE7AADF55(iParam0->f_1) > 10f && unk_0xA65352E7FEA59881(iParam0->f_1, *iParam0))
					{
						if (unk_0x47DBF174A0CB9D55(*iParam0, 0))
						{
							unk_0x79925417897509E3(*iParam0);
						}
						unk_0x697DA7132EE43ABC(*iParam0, 0, 0);
						iLocal_953 = 1;
						unk_0xBE1CA603598C1441(3f, 1073741824, 3);
						return 1;
					}
...
int func_271(var uParam0)
{
	...
	if (unk_0x7D167B9A0CCDA347(*uParam0) && unk_0x7D167B9A0CCDA347(uParam0->f_14))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_1167)
	{
		case 0:
			if (!unk_0x5AEB5DDFFAD43CA5(*iParam1))
			{
				...
				unk_0xC1080142F19925ED(*iParam1, 7, 1f);
		...
		case 1:
			if (!unk_0xAE06B9E39EBDE049(iParam1->f_9))
			{
				iParam1->f_9 = unk_0xB3116B49FE00E2F1(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, 1, true);
				unk_0x1322CA891C5DF18A(iParam1->f_9, 0, 0);
				unk_0x3605DDBB702E6DDF(iParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, 0, 1);
				unk_0x6673CC701BC8E9C1(iParam1->f_9, 17, 1);
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iParam1->f_7))
			{
				unk_0x4E65320BC9AD521C(iParam1->f_7, 1);
				unk_0xB1AC1F996633F5B4(iParam1->f_7, 0);
				unk_0x45F588C0DD767737(iParam1->f_7, 0, 1, 0, 0);
				unk_0x45F588C0DD767737(iParam1->f_7, 2, 1, 2, 0);
				unk_0x45F588C0DD767737(iParam1->f_7, 3, 0, 3, 0);
				unk_0x45F588C0DD767737(iParam1->f_7, 4, 0, 3, 0);
				unk_0x45F588C0DD767737(iParam1->f_7, 8, 1, 0, 0);
			}
			if (unk_0xAE06B9E39EBDE049(iParam1->f_1))
			{
				unk_0x0A9768A52FEE2064(iParam1->f_1, 1);
				unk_0xC4DB45F7A0864686(iParam1->f_1, 1);
				unk_0x7C47E49129337557(iParam1->f_1, 1);
			}
			if (!unk_0x5AEB5DDFFAD43CA5(*iParam1))
			{
				unk_0xB1AC1F996633F5B4(*iParam1, 0);
			...
			iLocal_1258 = unk_0xCE4780E24AFDFBF9(joaat("seashark"), -2190.741f, -470.3163f, -0.4779f, 308.1181f, 1, 1, 0);
			unk_0x1E337EE68290597A(iLocal_1266, 0);
			iLocal_1266 = unk_0xC08A186299DFDA0A(Vector(-0.10296f, -468.8926f, -2182.363f) - Vector(15f, 15f, 15f), Vector(-0.10296f, -468.8926f, -2182.363f) + Vector(15f, 15f, 15f), 0, 1, 1, 1);
			iLocal_1233 = -1;
			iLocal_1234 = 0;
			break;
		
		case 2:
			if ((!unk_0x5AEB5DDFFAD43CA5(*iParam1) && unk_0xAE06B9E39EBDE049(iParam1->f_11[0])) && unk_0xAE06B9E39EBDE049(iParam1->f_11[1]))
			{
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlWASHER", 0, 1);
				unk_0xF8A652CE310FFC53(*iParam1, iParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, 1, 1, 0, 0, 2, 1);
				unk_0x756D74A3EF0AB788(*iParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x1CCBC799127EA27B(iParam1->f_11[0], 225);
				unk_0x1CCBC799127EA27B(iParam1->f_11[1], 225);
			}
			break;
		...
		case 3:
			if (!unk_0x5AEB5DDFFAD43CA5(*iParam1))
			{
				unk_0x6673CC701BC8E9C1(*iParam1, 6, 1);
				unk_0xB28186F95B71B19D(*iParam1, 0, 4096, -1);
				unk_0x6A4846EF125EA7E6(*iParam1, 1);
				...
				{
					unk_0x13A4BD6CC31F7B8F(*iParam1, iParam1->f_1, -1);
					unk_0xB11D151E210D4FAC(iParam1->f_1, 1084227584);
				}
			}
			iLocal_1260 = unk_0xCE4780E24AFDFBF9(joaat("camper"), -1400.575f, 738.8264f, 182.1478f, 194.607f, 1, 1, 0);
			unk_0xB11D151E210D4FAC(iLocal_1260, 1084227584);
			iLocal_1261 = unk_0xCE4780E24AFDFBF9(joaat("bjxl"), -1371.269f, 734.4243f, 182.5433f, 182.766f, 1, 1, 0);
			unk_0xB11D151E210D4FAC(iLocal_1261, 1084227584);
			break;
	}
	if (!unk_0x5AEB5DDFFAD43CA5(*iParam1))
	{
		unk_0x82FF25D1808866E5(*iParam1, 1, 0);
	}
}
...
void func_273()
{
	...
	Local_1870[0 /*9*/] = unk_0xB3116B49FE00E2F1(5, joaat("a_f_y_fitness_02"), Local_1870[0 /*9*/].f_1, 169.9513f, 1, true);
	func_252(Local_1870[0 /*9*/], 1);
	Local_1870[1 /*9*/] = unk_0xB3116B49FE00E2F1(5, joaat("a_f_y_beach_01"), Local_1870[1 /*9*/].f_1, 257.4617f, 1, true);
	func_252(Local_1870[1 /*9*/], 1);
	unk_0x6673CC701BC8E9C1(Local_1870[0 /*9*/], 17, 1);
	unk_0x6673CC701BC8E9C1(Local_1870[0 /*9*/], 1, 0);
	unk_0x4E65320BC9AD521C(Local_1870[0 /*9*/], 1);
	unk_0x6673CC701BC8E9C1(Local_1870[1 /*9*/], 17, 1);
	unk_0x6673CC701BC8E9C1(Local_1870[1 /*9*/], 1, 0);
	unk_0x4E65320BC9AD521C(Local_1870[1 /*9*/], 1);
}
...
void func_274(var uParam0, int iParam1)
{
	...
	func_38(&(iParam1->f_16), 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (uParam0->f_274 == 1)
	{
		unk_0xB023F5C66F5716C7(iParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	{
		if (!unk_0xAE06B9E39EBDE049(iParam1->f_7))
		{
			iParam1->f_7 = unk_0xB3116B49FE00E2F1(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, 1, true);
			if (uParam0->f_274 == 1)
			{
				unk_0x756D74A3EF0AB788(iParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
				unk_0xE61672E3FEF081AC(iParam1->f_7, 1);
				func_38(&(iParam1->f_16), 4, iParam1->f_7, "OJAhkHOOKER", 0, 1);
				unk_0x4E65320BC9AD521C(iParam1->f_7, 1);
				unk_0x6673CC701BC8E9C1(iParam1->f_7, 17, 1);
				unk_0x6AC7395A8E313A46(iParam1->f_7, 128, true);
				unk_0x694113444F21E39F(iParam1->f_7, 134, true);
			}
		}
	}
	if (uParam0->f_15 != 0)
	{
		if (uParam0->f_274 != 0)
		{
			iParam1->f_8 = unk_0xCE4780E24AFDFBF9(uParam0->f_15, uParam0->f_26, uParam0->f_29, 1, 1, 0);
		}
		if (uParam0->f_274 == 1)
		{
			unk_0xF242CEB863060ABC(iParam1->f_8, 3, false);
			unk_0xADCDA8AF77C0D19D(iParam1->f_8, 1);
			unk_0xADCDA8AF77C0D19D(iParam1->f_8, 0);
			iLocal_955 = unk_0x6A7A2C83BD302BA4(iParam1->f_8, 4, uParam0->f_16, -1, 1, true);
			unk_0x4E65320BC9AD521C(iLocal_955, 1);
	...
	if (uParam0->f_274 == 2)
	{
		if (!unk_0x8F678487EEBD8CE4(iParam1->f_2))
		{
			...
			unk_0x06B9B7C215BA4E0A(iParam1->f_2, 1);
			unk_0xECC9A00CF1181EC2(iParam1->f_2, 1);
		}
	}
	else if (uParam0->f_274 == 0)
	{
		iParam1->f_2 = unk_0x6820C712C1DD618A(uParam0->f_6);
		unk_0x72BEFB9451782F60(iParam1->f_2, 1);
		unk_0x06B9B7C215BA4E0A(iParam1->f_2, 3);
		unk_0xECC9A00CF1181EC2(iParam1->f_2, 3);
		unk_0xB023F5C66F5716C7(iParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		iParam1->f_2 = unk_0x6820C712C1DD618A(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			iParam1->f_11[iVar0] = unk_0x79CC07752E7432A1(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], 1, true, 0);
			unk_0x1AE0DF53CEB9AECE(iParam1->f_11[iVar0], 1);
			unk_0x58ADF88C51AAFDC5(iParam1->f_11[iVar0], true, 0);
			if (iVar0 == 1)
			{
				unk_0x6A8F948698B360B4(iParam1->f_11[iVar0], true);
			}
			if (uParam0->f_262[iVar0] != 0f)
			{
				unk_0xE922BAA80E8F9324(iParam1->f_11[iVar0], uParam0->f_262[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_277(var uParam0, var uParam1)
{
	if (!unk_0xAE06B9E39EBDE049(*uParam1))
	{
		*uParam1 = unk_0xB3116B49FE00E2F1(4, *uParam0, uParam0->f_1, uParam0->f_4, 1, true);
		...
		if (!iLocal_957)
		{
			unk_0xDE8F8016287F771F("Target", &iLocal_967);
			iLocal_957 = 1;
		}
		unk_0xEFBCE8F8316F89EA(5, iLocal_967, 1862763509);
		unk_0xEFBCE8F8316F89EA(5, 1862763509, iLocal_967);
		unk_0xD3D9D7C84656DAE5(*uParam1, iLocal_967);
		if (uParam0->f_268)
		{
...
void func_278(var uParam0, struct<3> Param1, var uParam2)
{
	if (unk_0x8F678487EEBD8CE4(*uParam0))
	{
		Global_110894 = *uParam0;
		Global_110899 = { Param1 };
		Global_110903 = uParam2;
	}
}
...
int func_279(var uParam0)
{
	...
	unk_0x78FCB2E22C41B9D5(joaat("a_f_y_fitness_02"));
	if ((unk_0x7D167B9A0CCDA347(*uParam0) && unk_0x7D167B9A0CCDA347(joaat("a_f_y_beach_01"))) && unk_0x7D167B9A0CCDA347(joaat("a_f_y_fitness_02")))
	{
		return 1;
	}
	return 0;
...
float func_280(struct<3> Param0, bool bParam1)
{
	return func_250(unk_0x1FA7B77001D60F9D(unk_0x2639A2323BEA8CC6()), Param0, bParam1);
}
...
void func_282()
{
	...
	if (func_497(&iLocal_1279))
	{
		if (func_45(&iLocal_1279) > 30f)
		{
			...
			if (iLocal_1230 == 1)
			{
				if (vdist(Var0, Local_1292[0 /*3*/]) < 100f || unk_0x642A35A076CECC5A(unk_0x9B0761B4C3EB8BC7()))
				{
					if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
					{
			...
			{
				if (vdist(Var0, Local_1292[1 /*3*/]) < 100f || unk_0x642A35A076CECC5A(unk_0x9B0761B4C3EB8BC7()))
				{
					if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
					{
						unk_0xCAD5C18968E57C30(unk_0x460153A63B9477BC(), 2, 0);
			...
			{
				if (vdist(Var0, Local_1292[2 /*3*/]) < 100f || unk_0x642A35A076CECC5A(unk_0x9B0761B4C3EB8BC7()))
				{
					if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
					{
						unk_0xCAD5C18968E57C30(unk_0x460153A63B9477BC(), 2, 0);
...
void func_283()
{
	if (iLocal_1167 == 2)
	{
		if (!unk_0x30647B4CD9609B8E(&uLocal_1252))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(Local_971))
			{
				if (!iLocal_1206)
				{
					unk_0xA5EAD2ACE2C8BBB2(Local_971, 1, 1);
					unk_0xF3FE01181D2D2479(Local_971, 1, 1, 0, 1, 1, 0);
				}
			}
			if (unk_0x33CDB98869100CA5("WINDOWWASHERFALL_MASTER", 0))
			{
				unk_0x313FEE6D490EE85B(-648.59f, 305.73f, 120f);
			}
			if (unk_0xE8CD061CB2B99F32())
			{
				unk_0x480F9EB82BE05983(1f);
			}
			iLocal_1206 = 1;
		}
		else if (!unk_0x30647B4CD9609B8E(&uLocal_1251))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(Local_971))
			{
				if (!iLocal_1206)
			...
			if (unk_0x33CDB98869100CA5("WINDOWWASHERFALL_MASTER", 0))
			{
				unk_0x313FEE6D490EE85B(-638.1931f, 306.014f, 121.4236f);
			}
			if (unk_0xE8CD061CB2B99F32())
			{
				unk_0x480F9EB82BE05983(1f);
...
void func_284(var uParam0, var uParam1)
{
	...
	if (unk_0xAE06B9E39EBDE049(uParam1->f_11[0]))
	{
		Var3 = { unk_0x3E4D3CCC220BDFB1(uParam1->f_11[0], 1) };
	}
	else
	{
	...
	if (!unk_0xA59F96B50B97E63C(*uParam1, 0))
	{
		Var1 = { unk_0x3E4D3CCC220BDFB1(*uParam1, 1) };
	}
	switch (iLocal_1240)
	{
		case 0:
			if (!bLocal_1215)
			{
				if (iLocal_1167 == 2)
				{
					if (vdist2(Var0, Var1) < 40000f)
					{
						if (unk_0xAE06B9E39EBDE049(uParam1->f_11[0]))
						{
							if (unk_0xAE06B9E39EBDE049(uParam1->f_11[1]))
							{
								...
								else
								{
									if (!unk_0x30647B4CD9609B8E(&uLocal_1252))
									{
										uLocal_1252 = unk_0xB56DD7F11C10E77E(-648.59f, 305.73f, fVar5, 0f, 90f, 0f, fVar6, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (!unk_0x30647B4CD9609B8E(&uLocal_1251))
									{
										uLocal_1251 = unk_0xB56DD7F11C10E77E(-638.93f, 304.92f, fVar5, 0f, 90f, 0f, fVar6, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (unk_0x30647B4CD9609B8E(&uLocal_1251) && unk_0x30647B4CD9609B8E(&uLocal_1252))
									{
										unk_0x407030EF10A39021(uLocal_1252, uParam1->f_11[1], uParam1->f_11[0], -648.59f, 305.73f, fVar5, -648.59f, 305.73f, Var3.f_2, fVar6, 0, 0, 0, 0);
										unk_0x407030EF10A39021(uLocal_1251, uParam1->f_11[1], uParam1->f_11[0], -638.93f, 304.92f, fVar5, -638.93f, 304.92f, Var3.f_2, fVar6, 0, 0, 0, 0);
										bLocal_1215 = true;
										iLocal_1240 = 1;
									}
								}
		...
		case 1:
			if (vdist2(Var0, Var1) < 18225f)
			{
				if (unk_0xA38BFCB05DBE439D(uParam1->f_11[0]))
				{
					if (iLocal_1168 < 2)
					{
						if (!unk_0x5AEB5DDFFAD43CA5(*uParam1))
						{
							...
							unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@windowwasher", "_idle_to_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
							unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@windowwasher", "_up_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
							unk_0x19F29730874AD6F1(uVar4);
							unk_0x9B6EC2CECE1010EF(*uParam1, uVar4);
		...
		case 2:
			Var2 = { unk_0x3E4D3CCC220BDFB1(uParam1->f_11[0], 1) };
			if (unk_0xA59F96B50B97E63C(*uParam1, 0))
			{
				iLocal_1240 = 3;
			}
			if (unk_0x30647B4CD9609B8E(&uLocal_1252) && unk_0x30647B4CD9609B8E(&uLocal_1251))
			{
				unk_0x6D4AF3FC50404B1A(uLocal_1252);
				unk_0x6D4AF3FC50404B1A(uLocal_1251);
				if (Var2.f_2 >= 125f)
				{
					if (iLocal_1168 < 2)
					{
						...
						{
							unk_0x9DC06E2A59C5AEBB(&uVar4);
							unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@windowwasher", "_up_to_wash", 8f, -8f, -1, 0, 0, 0, 0, 0);
							unk_0x756D74A3EF0AB788(0, "oddjobs@assassinate@multi@windowwasher", "_wash_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
							unk_0x19F29730874AD6F1(uVar4);
							unk_0x9B6EC2CECE1010EF(*uParam1, uVar4);
							unk_0x4F83FEE4454169D4(&uVar4);
						}
					}
					unk_0xE7B4737F5DB519A1(uLocal_1252);
					unk_0xE7B4737F5DB519A1(uLocal_1251);
					iLocal_1240 = 3;
					unk_0x8B77B020136E915A(uParam1->f_11[0], 2, -20f, 0f, -20f, -4.78f, 0.65f, -0.78f, 0, 0, 0, 1, 0, 1);
				}
			}
			else
			{
...
void func_285()
{
	if (!unk_0xAE06B9E39EBDE049(iLocal_1264))
	{
		if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				iLocal_1264 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
				if (unk_0xAE06B9E39EBDE049(iLocal_1264) && !unk_0xA59F96B50B97E63C(iLocal_1264, 0))
				{
	...
	while (iVar0 < 9)
	{
		if (unk_0xAE06B9E39EBDE049(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x36FE6D3220816ADA(iParam0) == func_293(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		*uParam1 = unk_0x999BFF5D72C9701A(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_296(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_302()
{
	...
	if (!unk_0xAE06B9E39EBDE049(iLocal_1172))
	{
		return;
	}
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	...
	if (vdist2(Var0, Local_1175) > 10000f)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_1172))
		{
			unk_0x74528AC0906CBABE(joaat("p_phonebox_01b_s"));
			unk_0x315F7D8C33F0AB37(&iLocal_1172);
		}
		if (unk_0xAE06B9E39EBDE049(iLocal_1171))
		{
			unk_0x80250B8368A4E611(iLocal_1171, true, 0);
...
void func_304(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_371(unk_0x6C5C6B207AA78253(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_364(unk_0x6C5C6B207AA78253(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_362(&(Global_98955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_306(&Global_105407, unk_0x6C5C6B207AA78253(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_306(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_10();
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		func_324(unk_0x9B0761B4C3EB8BC7());
		func_317(unk_0x9B0761B4C3EB8BC7(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_316())
		{
			func_312(unk_0x9B0761B4C3EB8BC7(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_313(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2587834[iParam0 /*3*/][func_65(iParam1)];
...
void func_318(int iParam0, var uParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x285D770154CF7612(iParam0, func_323(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xC517E2708E06CD75(iVar5, &Var7) && !func_320(Var7.f_1)) && iVar9 < 51)
			{
...
int func_326(struct<3> Param0, char* sParam1, struct<3> Param2)
{
	int iVar0;
	int iVar1;
...
int func_330(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x25DDB354A40FFCDB())
	{
		if (func_332() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_70(func_331(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_334(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_349(iVar0))
		{
			...
			{
				fVar1 = unk_0x272784C60C397DB6(Param0, func_335(iVar0, 0), true);
...
int func_338(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	Var3 = { Var2 - Var0 };
	Var3 = { func_339(Var3, -Var0.f_3.f_2) };
	Var3 = { func_339(Var3, Var1.f_3.f_2) };
	*uParam2 = { unk_0x1BAE5C94E38E44FE(Var1, 0f, Var3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_339(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
{
	return (shift_right(iParam0, 26) & 31 * func_357(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_366(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_376(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19865)
	{
		...
		{
			func_380(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_378(1);
			func_380(Global_19662, "DISPLAY_VIEW", 1f, to_float(Global_19661), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (Global_2462245)
							{
								if (iVar1 == 14)
								{
									func_379(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_379(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_379(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_379(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_379(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_379(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[iVar0] = 1;
						}
					}
...
int func_389()
{
	unk_0x78FCB2E22C41B9D5(joaat("premier"));
	unk_0x78FCB2E22C41B9D5(joaat("dilettante"));
	unk_0x78FCB2E22C41B9D5(joaat("vigero"));
	while ((!unk_0x7D167B9A0CCDA347(joaat("premier")) || !unk_0x7D167B9A0CCDA347(joaat("dilettante"))) || !unk_0x7D167B9A0CCDA347(joaat("vigero")))
	{
		return 0;
	}
	return 1;
...
int func_398(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!unk_0xF5EE205091CE6DB2(3) && !func_394(&(uParam0->f_34))) && !func_390(uParam1))
	{
		func_501(uParam1);
		return 0;
	}
...
void func_416()
{
	if (!unk_0xAE06B9E39EBDE049(iLocal_1262[0]))
	{
		iLocal_1262[0] = unk_0xCE4780E24AFDFBF9(iLocal_1265[0], -723.8201f, -916.5402f, 18.0145f, 267.798f, 1, 1, 0);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_1262[1]))
	{
		iLocal_1262[1] = unk_0xCE4780E24AFDFBF9(iLocal_1265[1], -735.5003f, -931.6205f, 18.0173f, 359.3239f, 1, 1, 0);
		unk_0x1CCBC799127EA27B(iLocal_1262[1], 100);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_1262[2]))
	{
		iLocal_1262[2] = unk_0xCE4780E24AFDFBF9(iLocal_1265[0], -726.7143f, -940.2681f, 18.0173f, 178.3615f, 1, 1, 0);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_1262[3]))
	{
		iLocal_1262[3] = unk_0xCE4780E24AFDFBF9(iLocal_1265[2], -730.5711f, -909.9425f, 18.0349f, 357.4066f, 1, 1, 0);
	}
}

int func_417(struct<3> Param0, float fParam1)
{
	return func_418(&(Global_105407.f_2890), Param0, fParam1, 0);
}

int func_418(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_401(uParam0))
	{
		...
		if (func_400(uParam0))
		{
			...
			if (unk_0xAE06B9E39EBDE049(iVar0))
			{
				...
				else if ((!func_435(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0xF005CCA4263DF67F(unk_0x6C5C6B207AA78253(), "startup_positioning"))
				{
...
{
	if ((((((((((!unk_0xAE06B9E39EBDE049(iParam0) || !unk_0x80FF6C016CDB0FAF(iParam0, 0)) || func_310(iParam0, 0, 0)) || func_310(iParam0, 1, 0)) || func_310(iParam0, 2, 0)) || func_291(iParam0) != 145) || func_425(iParam0)) || func_424(iParam0)) || func_423(iParam0)) || func_422(iParam0)) || !func_421(unk_0x36FE6D3220816ADA(iParam0)))
	{
		if (func_424(iParam0))
		{
		}
...
int func_435(int iParam0, struct<3> Param1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_436(iParam0, uVar1[iVar3], 1) && func_402(unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_209(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), true) < 10f)
					{
...
void func_438(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xAE06B9E39EBDE049(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x36FE6D3220816ADA(Global_96286[iVar0]) == func_293(iParam0, iParam1))
				{
...
void func_439(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(iVar1 + 1)))
			{
			}
			else
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_296(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(iVar2)))
				{
				}
				else
				{
					unk_0xBE20AB8238688965(&(uParam1->f_77), func_296(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(iVar3)))
				{
				}
				else
				{
					unk_0xBE20AB8238688965(&(uParam1->f_77), func_296(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(iVar4)))
					{
					}
					else
					{
						unk_0xBE20AB8238688965(&(uParam1->f_77), func_296(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(4)))
			{
			}
			else
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_296(4));
			}
		}
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_447(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_446())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!unk_0x442D6659150AF4B3(uParam1->f_66) && !unk_0x5874D60325749F00(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (unk_0xCE990E643CD9D0E5(uParam1->f_77, func_296(iVar5 + 1)))
				{
...
int func_440(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_444(unk_0x36FE6D3220816ADA(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_443(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x8DFB45E7317A7ED7(*iParam0, 24, func_443(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_442(iParam0);
	if (func_441(*iParam0))
	{
...
int func_448(int iParam0)
{
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!func_454(unk_0x460153A63B9477BC(), -1))
		{
	...
	if (func_450(unk_0x460153A63B9477BC()) == 3)
	{
		if (unk_0xAE06B9E39EBDE049(iParam0) && unk_0x80FF6C016CDB0FAF(iParam0, 0))
		{
...
void func_456(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!unk_0xF5EE205091CE6DB2(3) || !func_394(&(uParam0->f_34))) || !func_390(uParam1))
	{
		func_501(uParam1);
		wait(0);
	}
...
void func_463()
{
	Local_1292[0 /*3*/] = { -1208.462f, -1559.661f, 3.6087f };
	Local_1292[1 /*3*/] = { -2164.723f, -405.4532f, 12.3954f };
	Local_1292[2 /*3*/] = { -693.613f, 233.9349f, 79.7011f };
}
...
void func_468(var uParam0)
{
	*uParam0 = joaat("s_m_y_winclean_01");
	...
	unk_0x33CDB98869100CA5("WINDOWWASHERFALL_MASTER", 0);
	fLocal_1248 = 500f;
}
...
void func_472()
{
	...
	while (iVar0 < 3)
	{
		unk_0x78FCB2E22C41B9D5(iLocal_1265[iVar0]);
		iVar0++;
	}
}
...
void func_475(var uParam0)
{
	if (iLocal_1170 < 3)
	{
		unk_0xA5F6E8D458A63A6D(-717.8348f, -932.1736f, 18.01735f, 26f);
	}
	switch (iLocal_1170)
	{
		case 0:
			unk_0x131ED02492676000("oddjobs@assassinate@multi@call");
			unk_0x78FCB2E22C41B9D5(joaat("p_phonebox_01b_s"));
			func_474();
			settimera(0);
			unk_0x8B917081F9836EDD("SCRIPT\ASSASSINATION_MULTI", false, -1);
			if ((unk_0xC614DDE265D18415("oddjobs@assassinate@multi@call") && unk_0x7D167B9A0CCDA347(joaat("p_phonebox_01b_s"))) && func_389())
			{
				bLocal_1225 = true;
			}
			if (bLocal_1225)
			{
				if (unk_0xAE06B9E39EBDE049(iLocal_1171))
				{
					...
					unk_0x555EE41D7C7078E6(-700.1226f, -916.8699f, 18.1667f, 5f, 1, 0, 0, false);
					...
					if (unk_0xAE06B9E39EBDE049(iLocal_1171))
					{
						unk_0x80250B8368A4E611(iLocal_1171, false, 0);
						unk_0x58ADF88C51AAFDC5(iLocal_1171, false, 0);
						unk_0xC62EE91883AF24A2(iLocal_1171, 0);
						iLocal_1172 = unk_0x79CC07752E7432A1(joaat("p_phonebox_01b_s"), -700.1226f, -916.8699f, 18.1667f, 1, true, 0);
						unk_0xC82085403E46A869(iLocal_1172, 0f, 0f, 0f, 2, 1);
						unk_0x58ADF88C51AAFDC5(iLocal_1172, false, 0);
						unk_0xC62EE91883AF24A2(iLocal_1172, 0);
					}
					uLocal_1196 = unk_0x258EC7AE452957A6(-700.1226f, -916.8699f, 18.1667f, 350f, 12, 127);
					func_481(1, 1, 1, 0, 0, 0, 0);
					if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 0, 0);
						unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), Local_1176, 1, 0, 0, 1);
						unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), fLocal_1177);
						unk_0x69C71C91F56D82B9(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), true);
						unk_0x9EB88E485EDFD7EB(unk_0x9B0761B4C3EB8BC7(), 1);
					}
					iLocal_1195 = unk_0xF341A134A5B8D4F6(Local_1193, Local_1194, 2);
					if (unk_0xAE06B9E39EBDE049(iLocal_1172))
					{
						unk_0x3198407FE9E09FCF(iLocal_1195, iLocal_1172, -1);
					}
					unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), iLocal_1195, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					unk_0x1FEB07A1AF22700F(iLocal_1172, iLocal_1195, "ass_multi_target_call_phone", "oddjobs@assassinate@multi@call", 1000f, -2f, 0, 1148846080);
					if (!unk_0x40397A9A17EEC1C5(iLocal_1173))
					{
						iLocal_1174 = unk_0xB5B018137EBE06D3(26379945, Local_1181, Local_1182, 35f, 1, 2);
						iLocal_1173 = unk_0xB5B018137EBE06D3(26379945, Local_1183, Local_1184, 35f, 0, 2);
						unk_0xF674D9B2033F5F86(iLocal_1173, iLocal_1174, 2500, 1, 1);
						unk_0x3ED9330214992278(true, 0, 3000, 1, 0, 0);
						unk_0x2311A669433389E8(iLocal_1173, "HAND_SHAKE", 0.2f);
					}
					func_416();
					func_38(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_38(&(uParam0->f_16), 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
				...
				else
				{
					...
					if (!unk_0xAE06B9E39EBDE049(iLocal_1171))
					{
						iLocal_1171 = unk_0x5BBA0055476D633A(Local_1175, 5f, joaat("prop_phonebox_01b"), 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1192)
			{
				if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (unk_0xFC5D6FB6EECB392F(iLocal_1195))
					{
						if (unk_0x369E69441C066912(iLocal_1195) > 0.05f)
						{
			...
			if (((func_497(&iLocal_1185) && func_45(&iLocal_1185) > fLocal_1178) || (unk_0xFC5D6FB6EECB392F(iLocal_1195) && unk_0x369E69441C066912(iLocal_1195) >= 0.978f)) || bLocal_1191)
			{
				iLocal_1170 = 3;
			}
			break;
		...
		case 2:
			...
			if (bLocal_1191)
			{
				if (unk_0x03DB5C6AABF8DA46())
				{
					...
					{
						unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 0, 0);
						unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -700.2628f, -917.5313f, 18.2147f, 1, 0, 0, 1);
						unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), 73.3924f);
					}
					unk_0x1CD098484842AE0B(iLocal_1172, -1000f, 1);
					wait(0);
		...
		case 3:
			...
			if (unk_0x86F247DFAD57449B(uLocal_1196))
			{
				unk_0x53BA4C977A9AB012(uLocal_1196);
			}
			unk_0x58ADF88C51AAFDC5(iLocal_1172, true, 0);
			unk_0x60A74C88F1360132();
			...
			unk_0x95178967C65CAD85(&iLocal_1171);
			iLocal_968 = 4;
			break;
	}
}
...
int func_479(int iParam0, float fParam1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5, float fParam6)
{
	if (unk_0x40397A9A17EEC1C5(*iParam0))
	{
		if (func_497(&iLocal_1188))
		{
			...
			{
				unk_0x8A3898631CCEC253(iLocal_1173, Param2);
				unk_0xBF92D2A60C7C686E(iLocal_1173, Param3, 2);
				unk_0xD64C2E5B5BA2D347(iLocal_1173, fParam4);
				if (bParam5)
				{
					unk_0x2311A669433389E8(iLocal_1173, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_481(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0x25DDB354A40FFCDB())
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_485(unk_0x460153A63B9477BC())) && !func_483(unk_0x460153A63B9477BC(), 0)) && !func_482()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_485(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_489(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_490(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_490(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (unk_0xAE06B9E39EBDE049(iVar0))
	{
		...
		if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_491(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_491(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		if (((((((((((((((func_492(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_492(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_492(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_492(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_492(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_492(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_492(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_492(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_492(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_492(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_492(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_492(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_492(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_492(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_492(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_492(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
void func_504(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	if (func_511())
	{
...
void func_512(var uParam0)
{
	...
	unk_0x4D5DDC0BF2001F78(uLocal_954);
...
float func_517()
{
	return to_float((540000 - iLocal_1245));
}
