...
void __EntryFunction__()
{
	...
	func_451();
	if (unk_0xAE06B9E39EBDE049(Local_39.f_35[0]))
	{
	...
	if (unk_0xAE06B9E39EBDE049(Local_39.f_35[1]))
	{
		func_423(&(Local_56[0 /*29*/]), &(Local_39.f_35[1]));
	}
	if (unk_0xAE06B9E39EBDE049(Local_39.f_28[0]))
	{
		func_422(&(Local_56[0 /*29*/].f_1), &(Local_39.f_28[0]));
	}
	if (unk_0xAE06B9E39EBDE049(Local_39.f_28[1]))
	{
	...
	while (true)
	{
		unk_0xAEF7C45DAFB8E9B0("SF_GRTP", 0);
...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&iLocal_42);
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) < 1)
				{
					iLocal_241 = 1;
					iLocal_242 = 0;
					iLocal_42 = func_213(Local_53, 5, 1);
				}
				else
				{
					iLocal_241 = 1;
					iLocal_242 = 1;
					if (unk_0xFCBF95335DD16537(203) == 0 || !func_212())
					{
						func_210(2);
						iLocal_240 = 0;
					}
		...
		case 1:
			if (!func_207(Local_43.f_4, Local_53, 125f))
			{
			...
			else if (!iLocal_241)
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
				{
					...
					{
						iLocal_242 = 0;
						if (unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0))
						{
							func_214(&iLocal_42);
							iLocal_41 = 0;
							iLocal_40 = 6;
			...
			else if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				unk_0xB80B2936A29B2666();
				iLocal_241 = 0;
				iLocal_240 = 1;
			...
			else if (unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0))
			{
				func_214(&iLocal_42);
				iLocal_41 = 0;
				iLocal_40 = 6;
...
bool func_207(int iParam0, struct<3> Param1, float fParam2)
{
...
void func_210(int iParam0)
{
	if (func_209(iParam0))
	{
		func_211(Local_55[iParam0 /*3*/].f_2, 7500, 1);
...
int func_213(struct<3> Param0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_215()
{
	...
	{
		case 0:
			if (unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 10f, 10f, 2f, 0, 1, 0))
			{
				func_214(&iLocal_42);
		...
		case 1:
			if (unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				{
					func_217();
					if (!func_216(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 55f, 1) && !unk_0xA38BFCB05DBE439D(Local_43.f_4))
					{
						iLocal_41 = 2;
					}
					else if ((iLocal_237 && func_209(5)) && (unk_0xFCBF95335DD16537(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
bool func_216(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_217()
{
	if (!iLocal_238)
	{
		iLocal_239 = unk_0x578C4EF320340AF7() + 3500;
		iLocal_238 = 1;
	}
	else if (!iLocal_237)
	{
		if (unk_0x578C4EF320340AF7() > iLocal_239)
		{
			if (iLocal_233 == 1)
			{
...
int func_221()
{
	...
	if (unk_0x460153A63B9477BC() == func_224())
	{
		return 0;
	}
...
int func_235()
{
	...
	while (iLocal_62 <= 5)
	{
		if (func_236(Local_55[iLocal_62 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_62++;
...
void func_237()
{
	...
	{
		case 0:
			if (unk_0x6167DCEE85C18365(Local_43.f_4) < 1f)
			{
				unk_0x4A9F6CA267EF14FE(Local_43.f_4, 10f);
			}
			if (unk_0xDAD5E5518E960CD1(Local_43.f_4) < 1f)
			{
				unk_0x0FC504FAF5EB94FB(Local_43.f_4, 10f);
			}
...
void func_242()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&iLocal_42);
			if (!func_212() || unk_0xFCBF95335DD16537(203) == 0)
			{
				func_210(2);
				func_253(&uLocal_254);
				iLocal_235 = 0;
			...
			iLocal_233 = 1;
			iLocal_61 = unk_0x578C4EF320340AF7() + 2500;
			iLocal_41 = 1;
			break;
		
		case 1:
			func_248(&uLocal_254, &uLocal_63, "BAR3AAU", &sLocal_255, &cLocal_261);
			if (!iLocal_60 && unk_0x578C4EF320340AF7() > iLocal_61)
			{
				unk_0x2D806C94B9A84B20("SCRIPTED_SCANNER_REPORT_BARRY_3A_01", 0f);
				iLocal_60 = 1;
			}
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
...
void func_245()
{
	...
	{
		if (!func_212() && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
		{
			if (!iLocal_229)
			{
				iLocal_229 = 1;
				iLocal_231 = unk_0x578C4EF320340AF7();
			}
			if ((unk_0x578C4EF320340AF7() - iLocal_231) > Local_228[iLocal_230 /*2*/].f_1 && (func_247() || iLocal_230 == 0))
			{
				if (iLocal_230 != 2 || unk_0xF3A639BEE7AADF55(Local_43.f_4) > 10f)
				{
					if (func_235() || unk_0xFCBF95335DD16537(203) == 0)
					{
...
int func_247()
{
	if (unk_0x2975580CCA617F3B(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) - Vector(70f, 70f, 70f), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_248(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!unk_0x6A5CC4A2C9D9ED8D() && func_249(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_254()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&iLocal_42);
			iLocal_42 = func_208(Local_43.f_4, 1, 5);
			unk_0x72BEFB9451782F60(iLocal_42, 1);
			if (func_209(3) && (unk_0xFCBF95335DD16537(203) == 0 || !func_212()))
			{
				func_210(3);
				func_253(&uLocal_254);
			}
	...
	switch (iLocal_41)
	{
		case 0:
			...
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				func_214(&iLocal_42);
				iLocal_42 = func_213(Local_53, 5, 1);
				if (func_209(0) && (unk_0xFCBF95335DD16537(203) == 0 || !func_212()))
				{
					func_210(0);
					func_253(&uLocal_254);
				}
		...
		case 1:
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				...
				else
				{
					...
					if (unk_0xACBCFA3095C5A434(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4) && unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0))
					{
						iLocal_243 = 0;
						iLocal_41 = 2;
					}
					if (!iLocal_236)
					{
						if (((unk_0x578C4EF320340AF7() - iLocal_231) > 8000 && iLocal_230 >= 4) && !func_212())
						{
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_331(unk_0x6C5C6B207AA78253(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_201(unk_0x6C5C6B207AA78253(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_328(&(Global_98955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_260(&Global_105407, unk_0x6C5C6B207AA78253(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_260(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_230();
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		func_290(unk_0x9B0761B4C3EB8BC7());
		func_283(unk_0x9B0761B4C3EB8BC7(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_282())
		{
			func_278(unk_0x9B0761B4C3EB8BC7(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (unk_0xAE06B9E39EBDE049(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x36FE6D3220816ADA(iParam0) == func_269(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		*uParam1 = unk_0x999BFF5D72C9701A(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_272(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_279(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2587834[iParam0 /*3*/][func_68(iParam1)];
...
void func_283(int iParam0, bool bParam1)
{
	...
	iVar0 = func_148(iParam0);
	if (func_151(iVar0) && !unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		if (iParam0 == unk_0x9B0761B4C3EB8BC7())
		{
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x285D770154CF7612(iParam0, func_289(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xC517E2708E06CD75(iVar5, &Var7) && !func_286(Var7.f_1)) && iVar9 < 51)
			{
...
int func_292(struct<3> Param0, char* sParam1, struct<3> Param2)
{
	int iVar0;
	int iVar1;
...
bool func_294(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
int func_295(var uParam0)
{
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_316())
		{
			*uParam0 = func_300(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x25DDB354A40FFCDB())
	{
		if (func_7() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_69(func_298(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_300(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_315(iVar0))
		{
			...
			{
				fVar1 = unk_0x272784C60C397DB6(Param0, func_301(iVar0, 0), true);
...
int func_304(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	Var3 = { Var2 - Var0 };
	Var3 = { func_305(Var3, -Var0.f_3.f_2) };
	Var3 = { func_305(Var3, Var1.f_3.f_2) };
...
int func_312()
{
	return func_313(unk_0x460153A63B9477BC());
}
...
var func_317()
{
	...
	func_327(&uVar0, unk_0x1D3A3697182AD8B3());
	func_326(&uVar0, unk_0x81F2E25F8C019191());
	func_325(&uVar0, unk_0x1F596C965B00E290());
	func_320(&uVar0, unk_0x371CFD525753F70C());
	func_319(&uVar0, unk_0xF225116F449A5CC6());
	func_318(&uVar0, unk_0x2E48CFA70ABFC06A());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_323(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_335(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	var uVar1;
	...
	if (unk_0xAE06B9E39EBDE049(Global_102423.f_4))
	{
		if (unk_0x80FF6C016CDB0FAF(Global_102423.f_4, 0))
		{
			if (func_362(24) != Global_102423.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_359(unk_0x3E4D3CCC220BDFB1(Global_102423.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_336(Global_102423.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_336(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)
{
	...
	if (unk_0xAE06B9E39EBDE049(iParam0) && unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		func_355(iParam3, &Var0, Param1, fParam2, func_267(iParam0));
...
{
	if ((((((((((!unk_0xAE06B9E39EBDE049(iParam0) || !unk_0x80FF6C016CDB0FAF(iParam0, 0)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_353(iParam0)) || func_352(iParam0)) || func_351(iParam0)) || func_350(iParam0)) || !func_340(unk_0x36FE6D3220816ADA(iParam0)))
	{
		if (func_352(iParam0))
		{
		}
...
void func_355(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_354(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
int func_359(struct<3> Param0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	
	iVar0 = func_360(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_360(struct<3> Param0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_365()
{
	...
	{
		unk_0xAF7D4BF357E8B79E(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, false, 1);
		iLocal_42 = func_208(Local_43.f_4, 1, 5);
		iLocal_40 = 1;
		iLocal_41 = 0;
	}
...
void func_366()
{
	...
	if ((iLocal_57 && Local_56[0 /*29*/].f_24 == 1) && Local_56[1 /*29*/].f_24 == 1)
	{
		...
		unk_0x74528AC0906CBABE(iLocal_58);
		iLocal_57 = 0;
	}
}
...
void func_367(int iParam0)
{
	...
	{
		case 0:
			if (!unk_0xAE06B9E39EBDE049(Local_56[iParam0 /*29*/].f_1))
			{
				if (func_204(Local_56[iParam0 /*29*/]))
				{
					if (unk_0x7D167B9A0CCDA347(iLocal_59))
					{
						Local_56[iParam0 /*29*/].f_1 = unk_0x6A7A2C83BD302BA4(Local_56[iParam0 /*29*/], 6, iLocal_59, -1, 1, true);
						Local_56[iParam0 /*29*/].f_2 = unk_0x6A7A2C83BD302BA4(Local_56[iParam0 /*29*/], 6, iLocal_59, 0, 1, true);
					}
				}
				else if (unk_0x7D167B9A0CCDA347(iLocal_58))
				{
					Local_56[iParam0 /*29*/] = unk_0xCE4780E24AFDFBF9(iLocal_58, Local_56[iParam0 /*29*/].f_3, Local_56[iParam0 /*29*/].f_6, 1, 1, 0);
				}
			}
			else if (!unk_0xA59F96B50B97E63C(Local_56[iParam0 /*29*/].f_1, 0))
			{
				unk_0xD78F28ADCAD8C88C(Local_56[iParam0 /*29*/].f_1, 1);
				unk_0x4E65320BC9AD521C(Local_56[iParam0 /*29*/].f_1, 1);
				unk_0xEB879F62C8DFA9E2(Local_56[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, true);
				unk_0xF94DFEAE3DD1EE7E(Local_56[iParam0 /*29*/].f_1, 10);
				if (func_204(Local_56[iParam0 /*29*/].f_2))
				{
					unk_0xD78F28ADCAD8C88C(Local_56[iParam0 /*29*/].f_2, 1);
					unk_0x4E65320BC9AD521C(Local_56[iParam0 /*29*/].f_2, 1);
					unk_0xEB879F62C8DFA9E2(Local_56[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, true);
					unk_0xF94DFEAE3DD1EE7E(Local_56[iParam0 /*29*/].f_2, 10);
				}
		...
		case 1:
			if (func_207(unk_0x9B0761B4C3EB8BC7(), Local_56[iParam0 /*29*/].f_3, 275f))
			{
				if (func_386(iParam0))
				{
					Local_56[iParam0 /*29*/].f_25 = unk_0x578C4EF320340AF7() + 1750;
			...
			{
				if (!Local_56[iParam0 /*29*/].f_26 && unk_0xAE06B9E39EBDE049(Local_56[iParam0 /*29*/].f_1))
				{
					func_369(&(Local_56[iParam0 /*29*/].f_1));
					Local_56[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_27 && unk_0xAE06B9E39EBDE049(Local_56[iParam0 /*29*/].f_2))
				{
					func_369(&(Local_56[iParam0 /*29*/].f_2));
					Local_56[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_28 && unk_0xAE06B9E39EBDE049(Local_56[iParam0 /*29*/]))
				{
		...
		case 2:
			if (unk_0x578C4EF320340AF7() > Local_56[iParam0 /*29*/].f_25)
			{
				func_370(iParam0, 1);
			}
...
void func_370(int iParam0, int iParam1)
{
	...
	{
		unk_0x4E65320BC9AD521C(Local_56[iParam0 /*29*/].f_1, 0);
		unk_0x17253AF44F6ED2DA(Local_56[iParam0 /*29*/].f_1, 1);
		func_368(&(Local_56[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_204(Local_56[iParam0 /*29*/].f_2))
	{
		unk_0xD78F28ADCAD8C88C(Local_56[iParam0 /*29*/].f_2, 1);
		unk_0x4E65320BC9AD521C(Local_56[iParam0 /*29*/].f_2, 0);
		unk_0x17253AF44F6ED2DA(Local_56[iParam0 /*29*/].f_2, 1);
		func_368(&(Local_56[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_204(Local_56[iParam0 /*29*/]))
	{
		unk_0xC160551F55D6365A(Local_56[iParam0 /*29*/], true, 1, 0);
...
int func_372(int iParam0)
{
	...
	if (func_204(iParam0))
	{
		...
		if (unk_0xC0736D5851285045(iParam0) && func_216(iParam0, unk_0x9B0761B4C3EB8BC7(), 2f, 1))
		{
			return 1;
		}
		...
		else if (unk_0x5AC0C31BB5BC0343(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), 1))
		{
			return 1;
		}
...
int func_373(int iParam0, float fParam1)
{
	...
	if (func_204(unk_0x9B0761B4C3EB8BC7()) && func_204(iParam0))
	{
		if (func_384(iParam0) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iParam0))
		{
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_376(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_381(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var1 = { func_381(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_385(int iParam0)
{
	...
	if (unk_0xAE06B9E39EBDE049(iParam0))
	{
		...
		else if (unk_0x5AC0C31BB5BC0343(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), 1))
		{
			return 1;
		}
	}
...
{
	if (unk_0x1037B9D45CE6B788(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	else if (Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && unk_0x1037B9D45CE6B788(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_389()
{
	if (unk_0x1ADEE74BA60EE218(Local_43.f_4))
	{
		if (iLocal_47)
		{
			if ((unk_0x578C4EF320340AF7() - iLocal_48) > 7000)
			{
				return 1;
			}
		}
...
int func_390()
{
	switch (iLocal_243)
	{
		...
		case 1:
			iLocal_244 = unk_0xFD4F66ED3A6F0B81() * 120;
			iLocal_244 = (iLocal_244 + unk_0x578C4EF320340AF7());
			iLocal_245 = (iLocal_244 - unk_0xFD4F66ED3A6F0B81() * 30);
		...
		case 2:
			if (unk_0x578C4EF320340AF7() >= iLocal_244)
			{
				return 1;
			}
			else
			{
				if ((!iLocal_247 && unk_0x578C4EF320340AF7() >= iLocal_245) && !func_212())
				{
...
void func_391()
{
	...
	if (iVar0 >= iLocal_250)
	{
		if ((iVar0 - iLocal_251) > 500)
		{
			...
			iLocal_251 = unk_0x578C4EF320340AF7() + 1000;
		}
	}
	else if (iVar0 >= iLocal_249)
	{
		if ((iVar0 - iLocal_251) > 500)
		{
			...
			iLocal_251 = unk_0x578C4EF320340AF7();
		}
	}
	...
	switch (iLocal_41)
	{
		case 0:
			if (!func_398())
			{
				...
				if (unk_0x7BCC91F3C1CF24E8(sLocal_253))
				{
					sLocal_253 = "DEFAULT";
				}
				if (unk_0xF005CCA4263DF67F(sLocal_253, "DEFAULT"))
				{
					func_472(1);
				}
				else
...
void func_393(bool bParam0)
{
	...
	unk_0xAF7D4BF357E8B79E(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, true, 1);
}
...
void func_399()
{
	...
	if (iLocal_246)
	{
		if ((!unk_0x3EBB66F936A3436E() && !func_403(0)) && !func_398())
		{
			iVar0 = (iLocal_244 - unk_0x578C4EF320340AF7());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
			unk_0x5060C01D5DD55F30();
			if (unk_0x578C4EF320340AF7() >= iLocal_245)
			{
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x03DB5C6AABF8DA46())
			{
				...
				Var4 = { func_406(Global_77088, Global_77090, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_417(0) || Global_77102) || Global_77091 == 1) || !unk_0x87F0CB19476706C3())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((unk_0x3EBB66F936A3436E() || func_403(0)) || func_416(1))
			{
			}
			else
			{
...
void func_420()
{
	if (func_204(Local_43.f_4))
	{
		unk_0xAEBB7D261688301C(Local_43.f_4, 1);
		unk_0x494ACC4552B7881B(Local_43.f_4, 1);
		unk_0x96189C0E26D4F3D3(Local_43.f_4, 0);
		unk_0x430613D76B5175B8(Local_43.f_4, 0);
		if (!bLocal_46)
		{
			unk_0x7C4F70F41134C357(Local_43.f_4);
		}
...
void func_427(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_428(unk_0x9B0761B4C3EB8BC7()))
	{
...
void func_429(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0x25DDB354A40FFCDB())
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_433(unk_0x460153A63B9477BC())) && !func_431(unk_0x460153A63B9477BC(), 0)) && !func_430()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_433(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_437(bool bParam0)
{
	...
	{
		unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -1243.316f, -1041.637f, 7.5121f, 1, 0, 0, 1);
		unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), 28.2f);
	}
	func_426(500, 1);
}
...
void func_442(struct<3> Param0, float fParam1, bool bParam2)
{
	unk_0x78FCB2E22C41B9D5(Local_43.f_5);
	unk_0x78FCB2E22C41B9D5(iLocal_51);
	while (!unk_0x7D167B9A0CCDA347(Local_43.f_5) || !unk_0x7D167B9A0CCDA347(iLocal_51))
	{
		wait(0);
	}
	if (func_204(Local_43.f_4))
	{
		if (bLocal_46)
		{
			unk_0x54123F77C25DD02B(Local_43.f_4);
			bLocal_46 = false;
		}
	}
	if (bParam2)
	...
	func_206(&iLocal_49);
	func_203(&(Local_43.f_4));
	Local_43.f_4 = unk_0xCE4780E24AFDFBF9(Local_43.f_5, Param0, fParam1, 1, 1, 0);
	unk_0x29897D845D2C290B(Local_43.f_4, 1);
	if (bParam2)
	{
		func_443(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, -1, 0);
	}
	unk_0x96189C0E26D4F3D3(Local_43.f_4, 0);
	unk_0x430613D76B5175B8(Local_43.f_4, 0);
	unk_0xAEBB7D261688301C(Local_43.f_4, 1);
	unk_0x494ACC4552B7881B(Local_43.f_4, 1);
	unk_0x7C4F70F41134C357(Local_43.f_4);
	unk_0xF242CEB863060ABC(Local_43.f_4, 1, true);
	unk_0xF242CEB863060ABC(Local_43.f_4, 2, true);
	unk_0xF242CEB863060ABC(Local_43.f_4, 3, true);
	iLocal_49 = unk_0x79CC07752E7432A1(iLocal_51, Param0, 1, true, 0);
	unk_0xF8A652CE310FFC53(iLocal_49, Local_43.f_4, 0, Local_50, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	unk_0x58ADF88C51AAFDC5(iLocal_49, true, 0);
	bLocal_46 = true;
	func_421(Local_43.f_4, 0);
	unk_0x74528AC0906CBABE(Local_43.f_5);
...
void func_446(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!unk_0xAE06B9E39EBDE049(Local_43.f_4))
		{
...
void func_451()
{
	unk_0xBAA4D421B8B8A744("BARR3A", 0);
	Local_43.f_5 = joaat("dloader");
	Local_43 = { 1199.8f, -1259.22f, 34.23f };
	Local_43.f_3 = 174.7f;
	if (func_204(unk_0x9B0761B4C3EB8BC7()))
	{
		func_238(&uLocal_63, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	iLocal_236 = 0;
	iLocal_247 = 0;
	iLocal_230 = 0;
	...
	sLocal_253 = "DEFAULT";
	func_452(49, 1, 0);
	iLocal_54[0] = unk_0xC08A186299DFDA0A(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_54[1] = unk_0xC08A186299DFDA0A(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_460()
{
	Local_55[0 /*3*/] = { func_461("B3ADELV", 1) };
	Local_55[1 /*3*/] = { func_461("B3AGETIN", 1) };
	Local_55[2 /*3*/] = { func_461("B3AWAN1", -1) };
	Local_55[3 /*3*/] = { func_461("B3ARTV", 1) };
	Local_55[4 /*3*/] = { func_461("B3AEXIT", 1) };
	Local_55[5 /*3*/] = { func_461("B3ALEAVE", 1) };
}
...
void func_463()
{
	...
	unk_0x1E337EE68290597A(iLocal_54[0], 0);
	unk_0x1E337EE68290597A(iLocal_54[1], 0);
	unk_0x076EA622594A949E(0);
...
void func_472(bool bParam0)
{
	...
	if (!func_490())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_473(unk_0x6C5C6B207AA78253(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_474(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_477())
	{
		...
		{
			iVar2 = func_328(unk_0x6C5C6B207AA78253());
			if (iVar2 > -1)
			{
