...
{
	return unk_0x1037B9D45CE6B788(iParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_73()
{
	if (Global_1590525 != func_60())
	{
		if (unk_0x1B2EFC1EEC84CBE3("base_corridor_seats", Global_1590525, 1, 0))
		{
			return 0;
		}
