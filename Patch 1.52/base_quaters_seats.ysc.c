...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 1:
			if (func_51(uParam0))
			{
				uParam0->f_29.f_6 = unk_0x578C4EF320340AF7();
				func_52(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_50(unk_0x9B0761B4C3EB8BC7(), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				...
				{
					if ((unk_0x578C4EF320340AF7() - uParam0->f_29.f_6) > 150)
					{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				Var3 = { unk_0xD7D25254A712E758(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0, 2) };
				Var4 = { unk_0xD78F5800B90C4843(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				iVar5 = Var4.f_2;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_29.f_1 = unk_0xAA579EC5104BFDA9(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uParam0->f_29.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
				unk_0xB88AF19828BF16ED(uParam0->f_29.f_1);
				uParam0->f_29.f_8.f_4 = unk_0x578C4EF320340AF7();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = unk_0xAB6BAF5BFCAFB141(uParam0->f_29.f_1);
			if (unk_0xFC5D6FB6EECB392F(iVar7))
			{
				if (unk_0x369E69441C066912(iVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_29.f_1 = unk_0xAA579EC5104BFDA9(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
					unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uParam0->f_29.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0xB88AF19828BF16ED(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 7:
			unk_0x71B9CAADD460F7CC(uParam0->f_29.f_1);
			func_52(uParam0, 8);
			break;
		
		case 8:
			iVar8 = unk_0xAB6BAF5BFCAFB141(uParam0->f_29.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((unk_0x578C4EF320340AF7() - uParam0->f_29.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_29.f_8.f_1)
			{
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_29.f_4 == 6)
	{
		...
		fVar1 = vmag(Var0);
		if ((uParam0->f_29.f_4 == 6 && !unk_0x39CABCD7925B9200(unk_0x9B0761B4C3EB8BC7(), -1322051853)) && !func_8(&(uParam0->f_29), 12))
		{
			if (fVar1 >= 0.35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!unk_0xF0C12886E5C1B20E() && !func_8(&(uParam0->f_29), 0)) && !func_8(&(uParam0->f_29), 4)) && !func_21()) && !func_19(1)) && uParam0->f_29.f_8.f_2 != 3)
			{
...
void func_24(var uParam0)
{
	...
	uParam0->f_29.f_1 = unk_0xAA579EC5104BFDA9(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
	func_41(uParam0, &sVar0);
	unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uParam0->f_29.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_29.f_1);
	func_9(&(uParam0->f_29.f_5));
	func_52(uParam0, 8);
}
...
int func_43(var uParam0)
{
	...
	switch (uParam0->f_29.f_8)
	{
		...
		default:
			iVar0 = unk_0x344C570D6F8700DF(0, func_14(uParam0->f_29.f_8));
	}
	return iVar0;
}
...
int func_47(var uParam0)
{
	...
	while (iVar0 < unk_0xEFA28384DDD283E1())
	{
		if (unk_0xBD09DF93F957A0CF(unk_0x628A51AC66E80772(iVar0)))
		{
			...
			if ((iVar1 != unk_0x460153A63B9477BC() && func_48(iVar1, 1, 1)) && func_50(unk_0x1FA7B77001D60F9D(iVar1), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_54(var uParam0)
{
	...
	else if (uParam0->f_29.f_4 > 4)
	{
		...
		uParam0->f_29.f_7 = unk_0xD3137A576BE9EC5C();
	}
	...
	else if ((unk_0xD3137A576BE9EC5C() - uParam0->f_29.f_7) < 5)
	{
		unk_0xE1A91D6D0E2CF9AE(unk_0x9B0761B4C3EB8BC7(), func_55(uParam0));
	}
}
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_29), 1, unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0));
	func_57(&(uParam0->f_29), 3, unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1));
	func_57(&(uParam0->f_29), 0, func_36(0));
	func_57(&(uParam0->f_29), 2, unk_0x4D71E6F618DC5C0E(unk_0x9B0761B4C3EB8BC7()));
}
...
{
	return unk_0x1037B9D45CE6B788(iParam0, 362.0188f, 4823.182f, -59.98693f, 374.756f, 4823.096f, -56.23059f, 9f, 0, 1, 0);
}
...
int func_73()
{
	if (Global_1590525 != func_60())
	{
		if (unk_0x1B2EFC1EEC84CBE3("base_quaters_seats", Global_1590525, 1, 0))
		{
			return 0;
		}
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_80(func_81(), fVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_80(func_79(), fVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_80(func_78(), fVar1) + Var0 };
...
Vector3 func_80(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
void func_85(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_80(func_88(), fVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_80(func_87(), fVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_80(func_86(), fVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
...
{
	return unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_274.f_271.f_1, 0);
}
