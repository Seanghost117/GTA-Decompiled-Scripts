	...
	while (true)
	{
		if (Global_41631 != 15)
		{
			if (Global_41594 != 0)
			{
				if (Global_41593 != -1)
				{
					if (!unk_0x7FD2BDF03806FD9D(Global_41594))
					{
		...
		if (Global_41592 > 0)
		{
			...
			if (Global_41592 == iVar0)
			{
				...
				if (Global_41592 > 1)
				{
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < Global_41592)
					{
						if (func_15(Global_41598[iVar4 /*4*/].f_2))
						{
							iVar2[iVar4] = 0;
						}
						else
					...
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < (Global_41592 - 1))
					{
						if (!iVar2[iVar4 + 1])
						{
							if (Global_41598[iVar4 + 1 /*4*/].f_1 < Global_41598[iVar5 /*4*/].f_1)
							{
								iVar5 = iVar4 + 1;
							}
						}
					...
					iVar3 = iVar5;
					if (Global_41598[iVar3 /*4*/].f_2 == 15)
					{
						iVar3 = -1;
					}
					if (iVar3 != -1)
					{
						if (!func_15(Global_41598[iVar3 /*4*/].f_2))
						{
							iVar3 = -1;
						}
					}
				...
				if (iVar3 > -1)
				{
					Global_41593 = Global_41598[iVar3 /*4*/];
					Global_41594 = Global_41598[iVar3 /*4*/].f_3;
					Global_41631 = Global_41598[iVar3 /*4*/].f_2;
					Global_41592 = 0;
					Global_41597 = 0;
				}
				else
		...
		Global_31243 = unk_0x92857E82C024821B();
		wait(0);
	}
	Global_41597 = 0;
}
...
var func_1()
{
	...
	func_11(&uVar0, unk_0x1D3A3697182AD8B3());
	func_10(&uVar0, unk_0x81F2E25F8C019191());
	func_9(&uVar0, unk_0x1F596C965B00E290());
	func_4(&uVar0, unk_0x371CFD525753F70C());
	func_3(&uVar0, unk_0xF225116F449A5CC6());
	func_2(&uVar0, unk_0x2E48CFA70ABFC06A());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_7(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
