...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_5(Global_111858.f_18529[iVar0], &Var2, &fVar3))
			{
...
{
	iParam0->f_1 = (func_68(unk_0xCE990E643CD9D0E5(*iParam0, 4)) - fParam1);
...
void func_90(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	while (iVar4 < 47)
	{
		if (unk_0x7BCC91F3C1CF24E8(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0x7BCC91F3C1CF24E8(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0x7BCC91F3C1CF24E8(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
struct<4> func_95(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_96(&(Global_111858.f_19957), iVar1, 1);
	}
...
struct<4> func_106(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_111(&(Global_111858.f_19957), 8) && iParam1) && iParam0 != 4) && func_109(3) > 0) && unk_0x658086F2B3C5E4E4(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
	...
	if (bParam2)
	{
		func_107(&(Global_111858.f_19957), iVar1, 1);
	}
...
int func_117(char* sParam0)
{
	...
	if (unk_0xF005CCA4263DF67F(sParam0, "DRF_SOL1"))
	{
		iVar0 = 1;
	}
	else if (unk_0xF005CCA4263DF67F(sParam0, "DRF_EXILE"))
	{
		iVar0 = 2;
	}
	else if (unk_0xF005CCA4263DF67F(sParam0, "DRF_SOL2"))
	{
		iVar0 = 1;
	}
	else if (unk_0xF005CCA4263DF67F(sParam0, "DRF_MIC2"))
	{
		iVar0 = 1;
	}
	return iVar0;
