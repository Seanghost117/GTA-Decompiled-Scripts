...
void __EntryFunction__()
{
	...
	iLocal_90 = unk_0xB3A5FF195E1A8192(iLocal_89);
	sLocal_91 = "empty";
	iLocal_269 = 1;
	iLocal_426 = -1;
	iLocal_427 = -1;
	...
	iLocal_426 = unk_0x5700FF65A7E1B390(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_427 = unk_0x5700FF65A7E1B390(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_428 = unk_0x5700FF65A7E1B390(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	if (!unk_0x306BF588BD8151E8("EPSILONISM_04_MIX"))
	{
		func_402("Starting dynamic mix EPSILONISM_04_MIX");
		unk_0x17E478571720218F("EPSILONISM_04_MIX");
	}
	unk_0xA0E955FEBF04F874(0);
	unk_0xEFBCE8F8316F89EA(1, 1862763509, 1862763509);
	unk_0x34FEEAC2548C3789(0.5f);
	uLocal_290 = unk_0xC17FAAEE5A1D3683(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_399();
	func_382();
	func_381();
	Local_434 = 0;
	...
	func_377(&(Local_298[0 /*8*/]), Local_85, fLocal_86, Local_81.f_28[0], 0);
	func_377(&(Local_298[1 /*8*/]), Local_87, fLocal_88, Local_81.f_28[1], 0);
	if (func_414())
	{
		if (func_376() == 0)
		{
			func_375(Local_83, fLocal_84, 1, 0);
			func_374(1);
	...
	while (true)
	{
		unk_0xAEF7C45DAFB8E9B0("SF_Epsilon4", 0);
		func_349(Local_81.f_9, 0, 0, 0, 0, 0);
		unk_0xA438CF6ADDB3B55C(unk_0x460153A63B9477BC());
		if (func_348())
		{
		...
		{
			if (func_346(unk_0x9B0761B4C3EB8BC7()) == iLocal_89)
			{
...
void func_1()
{
	...
	switch (Local_434.f_1)
	{
		case 0:
			...
			if (unk_0xF005CCA4263DF67F(sVar0, sLocal_91))
			{
				func_418(1);
			}
			else
...
void func_11()
{
	...
	unk_0x131ED02492676000("weapons@holster_1h");
	while (func_346(unk_0x9B0761B4C3EB8BC7()) == iLocal_89)
	{
		wait(0);
		unk_0x4CB4237D8858ADA6(2);
		if (unk_0xC614DDE265D18415("weapons@holster_1h"))
		{
			if (!unk_0x9934470AA0A08B57(unk_0x9B0761B4C3EB8BC7(), "weapons@holster_1h", "holster", 3))
			{
				unk_0x756D74A3EF0AB788(unk_0x9B0761B4C3EB8BC7(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (unk_0x4C06B15B376AA145(unk_0x9B0761B4C3EB8BC7(), "weapons@holster_1h", "holster") >= 0.5f)
			{
	...
	if (iVar0 < 12)
	{
		unk_0x6000E4684CB4330B(joaat("NUM_EPSILON_STEP"), 12, 1);
		func_12(23, 12);
	}
	func_415();
}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_19(&iVar2);
		iVar3 = func_18(Var1, Global_111858.f_7684.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_16(Global_111858.f_7684.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_14(Global_111858.f_7684.f_765[iVar2 /*10*/]))
				{
					Global_111858.f_7684.f_765[iVar2 /*10*/] = { Var1 };
					func_15(&Var1);
					return 1;
...
void func_25()
{
	...
	if (!unk_0xC4A02490EB1F450B())
	{
		if (!Global_76833)
		{
			if (func_26() == 2 == 0 && !unk_0x25DDB354A40FFCDB())
			{
...
int func_217()
{
	return func_218(unk_0x6C5C6B207AA78253(), 0);
}
...
void func_227()
{
	unk_0xC5E5600D1CF5CEF9(Local_301.f_2);
	unk_0xC5E5600D1CF5CEF9(Local_301.f_3);
	unk_0xC5E5600D1CF5CEF9(Local_301.f_4);
	unk_0xC5E5600D1CF5CEF9(Local_301.f_5);
	Local_301.f_6 = 0;
	Local_301.f_7 = 0;
}
...
void func_229()
{
	switch (Local_434.f_1)
	{
		case 0:
			...
			unk_0x4CB4237D8858ADA6(2);
			unk_0x5EB178758AAA183E(unk_0x9B0761B4C3EB8BC7(), iLocal_89);
			Local_434.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (unk_0xA59F96B50B97E63C(Local_298[0 /*8*/], 0))
			{
				func_239(6);
				Local_434.f_9 = 2;
				Local_434.f_1 = 3;
			}
			else if (unk_0xA59F96B50B97E63C(Local_298[1 /*8*/], 0))
			{
				func_239(6);
				Local_434.f_9 = 3;
				Local_434.f_1 = 3;
			}
			else if (unk_0xCDF860E56BBCC6B4(Local_298[0 /*8*/], unk_0x9B0761B4C3EB8BC7(), 1) && unk_0xA71AC4B230E98432(Local_298[0 /*8*/], 0, 2))
			{
				func_239(6);
				Local_434.f_9 = 4;
				Local_434.f_1 = 3;
			}
			else if (unk_0xCDF860E56BBCC6B4(Local_298[1 /*8*/], unk_0x9B0761B4C3EB8BC7(), 1) && unk_0xA71AC4B230E98432(Local_298[1 /*8*/], 0, 2))
			{
				func_239(6);
				Local_434.f_9 = 5;
				Local_434.f_1 = 3;
			...
			{
				if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_298[0 /*8*/], 1) >= 50f)
				{
...
int func_236(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_238(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	...
	{
		Var1 = { func_238(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_237(Var1, Var0);
...
float func_237(struct<3> Param0, struct<3> Param1)
{
...
void func_240()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (unk_0x06BC339A53519E4E())
		{
			...
			{
				func_294("Michael", unk_0x9B0761B4C3EB8BC7(), 0, 2);
			}
	...
	if (Local_434.f_1 == 0)
	{
		...
		func_290(1);
		func_289();
		unk_0x3E6F6B3156C4F772(0, 200, 150);
		if (unk_0x06BC339A53519E4E())
		{
			func_402("Trying to set player component variation");
			if (func_231(unk_0x9B0761B4C3EB8BC7()))
		...
		{
			iLocal_292 = unk_0xCE4780E24AFDFBF9(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1, 0);
			unk_0x38633C69DE516059(iLocal_292, 157, 157);
			unk_0x88FCE2696F59472E(iLocal_292, 5, 157);
		...
		if (func_347(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			unk_0x9FFB2D9E208F0988(unk_0x460153A63B9477BC(), 1);
			iVar0 = unk_0x578C4EF320340AF7();
			while ((unk_0x578C4EF320340AF7() - iVar0) < 500)
			{
			...
			if (iLocal_283 == 0)
			{
				...
				{
					unk_0xFA3AB7AE2A01375E(Local_298[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
				}
				if (func_231(Local_298[0 /*8*/]))
				{
					unk_0xFA3AB7AE2A01375E(Local_298[0 /*8*/], "Marnie", 0, 0, 0);
				}
				if (func_231(unk_0x9B0761B4C3EB8BC7()))
				{
				...
				{
					iLocal_303 = func_271(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					unk_0xFA3AB7AE2A01375E(iLocal_303, "Artefact_Detector", 0, 0, 0);
				}
				if (func_231(Local_293[iLocal_283 /*43*/].f_1))
				{
					unk_0xFA3AB7AE2A01375E(Local_293[iLocal_283 /*43*/].f_1, "EPS_TV", 0, 0, 0);
				}
			}
			else if (iLocal_283 == 1)
			{
				...
				if (func_231(Local_293[iLocal_283 /*43*/].f_1))
				{
					unk_0xFA3AB7AE2A01375E(Local_293[iLocal_283 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
				}
			}
			else
			{
				...
				if (func_231(Local_293[iLocal_283 /*43*/].f_1))
				{
					unk_0xFA3AB7AE2A01375E(Local_293[iLocal_283 /*43*/].f_1, "Old_Boot", 0, 0, 0);
				}
			}
			unk_0x6EEEEDB625F825CC(0);
			unk_0x182DD1CBC93CF936(1);
			iVar0 = unk_0x578C4EF320340AF7();
			while ((unk_0x578C4EF320340AF7() - iVar0) < 1)
			{
				unk_0x4CB4237D8858ADA6(2);
				wait(0);
				unk_0xAEF7C45DAFB8E9B0("SF_Epsilon4", 0);
			...
			if (iLocal_283 >= 2)
			{
				if (func_231(unk_0x9B0761B4C3EB8BC7()))
				{
					unk_0x92BD213E6A0E666B(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), -1, true, true);
				}
			}
			unk_0x9FFB2D9E208F0988(unk_0x460153A63B9477BC(), 0);
	...
	if (Local_434.f_1 == 1)
	{
		...
		else
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					if (unk_0x9BEEC39E5B3F1C3C() > 17000)
					{
						if (!unk_0xE9159DB182CF0841())
						{
							unk_0x73287EF8736B0258(1847.472f, 4756.157f, 36.6968f, func_255(271.4718f), 145f, 0);
						}
					}
				}
			}
			...
			if (Local_434.f_2 == -1)
			{
				...
				if (iLocal_283 >= 2)
				{
					unk_0x21723EF7B2FCC4CC("EPS4_STOP");
...
void func_242(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_246(unk_0x460153A63B9477BC())) && !func_244(unk_0x460153A63B9477BC(), 0)) && !func_243()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_246(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_250()
{
	unk_0x830F007E19C63E14(iLocal_95, "SET_COLOUR");
	...
	unk_0x830F007E19C63E14(iLocal_95, "SET_DISTANCE");
	unk_0x49B9B8101B158AEE(10f);
	unk_0xE1FDD153F5858534();
	unk_0xCA1F114B668562E5(iLocal_96);
	unk_0xE6A03BA84586E67B(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
	...
	if (func_231(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x10447A1CD8175FC0("Michael", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				unk_0x854FB153F2EA838B(unk_0x9B0761B4C3EB8BC7(), -1871534317, 0, 1, 0);
				return 1;
			}
			else
			{
				...
				if (func_346(unk_0x9B0761B4C3EB8BC7()) != iLocal_89)
				{
					unk_0x92BD213E6A0E666B(unk_0x9B0761B4C3EB8BC7(), iLocal_89, -1, true, true);
				}
				unk_0x854FB153F2EA838B(unk_0x9B0761B4C3EB8BC7(), -1871534317, 0, 1, 0);
				return 1;
			}
	...
	if (func_231(Local_298[1 /*8*/]))
	{
		if (unk_0x10447A1CD8175FC0("Jimmy_Boston", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					unk_0x9DC06E2A59C5AEBB(&uLocal_435);
					unk_0xD405561A89A769B1(0, iLocal_292, 0);
					unk_0x19F29730874AD6F1(uLocal_435);
					unk_0x9B6EC2CECE1010EF(Local_81.f_28[1], uLocal_435);
					unk_0x4F83FEE4454169D4(&uLocal_435);
					func_402("Did Jimmy pass exit");
				}
			}
			else
			{
				unk_0x83CAF206A9B8748C(Local_81.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				func_402("Did Jimmy regular exit");
			}
			unk_0x854FB153F2EA838B(Local_298[1 /*8*/], -668482597, 0, 1, 0);
		}
	}
}
	...
	if (func_231(Local_298[0 /*8*/]))
	{
		if (unk_0x10447A1CD8175FC0("Marnie", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					unk_0x9DC06E2A59C5AEBB(&uLocal_435);
					unk_0xD405561A89A769B1(0, iLocal_292, -1);
					unk_0xDEFE57D3575A1A8A(0, iLocal_292, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					unk_0xD8C1C38EE8BC2AC6(0, iLocal_292, 30f, 262275);
					unk_0x19F29730874AD6F1(uLocal_435);
					unk_0x9B6EC2CECE1010EF(Local_81.f_28[0], uLocal_435);
					unk_0x4F83FEE4454169D4(&uLocal_435);
			...
			{
				unk_0x3C1B180EE30D36EF(Local_81.f_28[0], unk_0x7EC595B99EA7C4B1(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
				func_402("Did Marnie regular exit");
			}
			unk_0x854FB153F2EA838B(Local_298[0 /*8*/], -668482597, 0, 1, 0);
		}
	}
}
...
void func_254()
{
	...
	{
		if (unk_0x10447A1CD8175FC0("Artefact_Detector", 0))
		{
			if (iLocal_283 < 2)
			{
				func_402("*** Detector exit");
				unk_0xDF1EDBFFB5215C2C(iLocal_303, unk_0x9B0761B4C3EB8BC7());
				func_5(&iLocal_303);
				if (!unk_0xAE06B9E39EBDE049(Local_301))
				{
					func_402("*** Recreating gDetector.hObj after cutscene...");
					Local_301 = unk_0x04E8D2DEA9062B86(unk_0x9B0761B4C3EB8BC7(), 1);
				}
			}
			else
			{
...
void func_257(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (unk_0x5A228A6A51E757C8(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			unk_0x773B9DEB93E81B2F(func_259(unk_0x2639A2323BEA8CC6()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_262(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_263(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}
	...
	if (unk_0xAE06B9E39EBDE049(iVar0))
	{
		...
		if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_267(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_267(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		if (((((((((((((((func_268(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_268(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_268(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_268(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_268(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_268(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_268(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_268(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_268(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_268(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_268(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_268(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_268(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_268(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_268(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_268(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_271(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_275(iVar2, iVar6) != 0)
	{
		if (!unk_0xA59F96B50B97E63C(iParam0, 0))
		{
			if (unk_0x0BCEF4D1482DACD2(iParam0, iVar2, func_275(iVar2, iVar6)))
			{
				if (func_274(func_275(iVar2, iVar6)))
				{
					iVar7 = unk_0x85CB1D50AB0A0A5B(func_275(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_275(iVar2, iVar8) != 0)
	{
		if (!unk_0xA59F96B50B97E63C(iParam0, 0))
		{
			if (unk_0x0BCEF4D1482DACD2(iParam0, iVar2, func_275(iVar2, iVar8)))
			{
				unk_0xC53D054996356072(iVar1, func_275(iVar2, iVar8));
...
int func_278(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_285(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_284(unk_0x9B0761B4C3EB8BC7(), -828834893))
				{
...
void func_287(var uParam0, bool bParam1)
{
	if (func_347(*uParam0))
	{
		...
		if (bParam1)
		{
			unk_0x2BB0EF9DE445EA13(*uParam0);
		}
		else
		{
		...
		if (unk_0x7DA97DBB7F7D2DE5(*uParam0))
		{
...
{
	unk_0x830F007E19C63E14(iLocal_95, "SET_COLOUR");
	unk_0xAD291B8F75D737AD(67);
	unk_0xAD291B8F75D737AD(200);
	unk_0xAD291B8F75D737AD(255);
	unk_0xAD291B8F75D737AD(255);
	unk_0xAD291B8F75D737AD(209);
	unk_0xAD291B8F75D737AD(67);
	unk_0xAD291B8F75D737AD(255);
...
void func_290(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_291())
		{
			if ((unk_0xF005CCA4263DF67F(Local_301.f_14, "NO_RECENT_ANIM") || !unk_0x9934470AA0A08B57(Local_301, "rcm_epsilonism4", Local_301.f_14, 3)) || unk_0x4C06B15B376AA145(Local_301, "rcm_epsilonism4", Local_301.f_14) >= 0.98f)
			{
				if (fLocal_302 > 80f)
				{
				...
				unk_0x97B8FF2D794A65A7(Local_301, Local_301.f_14, "rcm_epsilonism4", 16f, false, 0, 0, 0f, 0);
			}
		}
	}
	else if (func_291())
	{
		if (!unk_0xF005CCA4263DF67F(Local_301.f_14, "NO_RECENT_ANIM"))
		{
			if (unk_0x9934470AA0A08B57(Local_301, "rcm_epsilonism4", Local_301.f_14, 1))
			{
				if (unk_0x4C06B15B376AA145(Local_301, "rcm_epsilonism4", Local_301.f_14) <= 0.05f)
				{
					unk_0x81AFEA3A8897B1F9(Local_301, Local_301.f_14, "rcm_epsilonism4", -4f);
...
void func_294(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar1 < 12)
	{
		unk_0x931CABC5DE105C79(sParam0, iVar1, Var0.f_13[iVar1], Var0[iVar1], iParam2);
		iVar1++;
	}
	iVar1 = 0;
	while (iVar1 < 9)
	{
		...
		{
			unk_0x8289CFFF7D89F1C7(sParam0, iVar1, -1, 0, iParam2);
		}
		else
		{
			unk_0x8289CFFF7D89F1C7(sParam0, iVar1, Var0.f_39[iVar1], Var0.f_49[iVar1], iParam2);
		}
		iVar1++;
	}
}
...
int func_297(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2587834[iParam0 /*3*/][func_86(iParam1)];
...
void func_303()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (iLocal_283 == 0)
		{
			if (!func_335())
			{
				...
				unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), fLocal_84);
			}
			func_287(&(Local_298[1 /*8*/]), 1);
			func_287(&(Local_298[0 /*8*/]), 1);
			if (func_347(Local_298[1 /*8*/]))
			{
				unk_0x6A8F948698B360B4(Local_81.f_28[1], false);
				unk_0x03D382CB0B44E2FC(Local_298[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, 0, 0, 1);
				unk_0xE922BAA80E8F9324(Local_298[1 /*8*/], 27.46f);
				Var2 = { unk_0x3E4D3CCC220BDFB1(Local_298[1 /*8*/], true) };
				unk_0xE5CC8E2D904E42CE(1829.75f, 4693.5f, 38.51f, &fVar1, 0, 0);
				unk_0x03D382CB0B44E2FC(Local_298[1 /*8*/], Var2.x, Var2.f_1, fVar1, 1, 0, 0, 1);
				func_402("Setting Jimmy position (0)");
			}
			if (func_347(Local_298[0 /*8*/]))
			{
				unk_0x03D382CB0B44E2FC(Local_298[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, 0, 0, 1);
				unk_0xE922BAA80E8F9324(Local_298[0 /*8*/], 171.22f);
				func_402("Setting Marnie position (0)");
			}
		}
		else if (iLocal_283 == 1)
		{
			unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), 1754.634f, 4675.789f, 42.9068f, 1, 0, 0, 1);
			unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), 293.2275f);
			if (func_347(Local_298[1 /*8*/]))
			{
				unk_0x03D382CB0B44E2FC(Local_298[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, 0, 0, 1);
				unk_0xE922BAA80E8F9324(Local_298[1 /*8*/], 262.4368f);
				func_402("Setting Jimmy position (1)");
			}
			if (func_347(Local_298[0 /*8*/]))
			{
				unk_0x03D382CB0B44E2FC(Local_298[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, 0, 0, 1);
				unk_0xE922BAA80E8F9324(Local_298[0 /*8*/], 148.3211f);
				func_402("Setting Marnie position (1)");
			}
		}
		else if (iLocal_283 == 2)
		{
			unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), 1758.454f, 4829.431f, 39.729f, 1, 0, 0, 1);
			unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), 168.2012f);
			if (func_347(Local_298[0 /*8*/]))
			{
				unk_0x03D382CB0B44E2FC(Local_298[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, 0, 0, 1);
				unk_0xE922BAA80E8F9324(Local_298[0 /*8*/], 169.6486f);
	...
	if (Local_434.f_1 == 0)
	{
		...
		iLocal_415 = 0;
		iLocal_416 = 0;
		iLocal_417 = unk_0x578C4EF320340AF7();
		iLocal_419 = unk_0x578C4EF320340AF7();
		iLocal_420 = 0;
		if (iLocal_283 == 0)
		{
			if (func_347(unk_0x9B0761B4C3EB8BC7()))
			...
			if (func_347(Local_298[1 /*8*/]))
			{
				unk_0x5EB178758AAA183E(Local_298[1 /*8*/], iLocal_89);
				unk_0x3C1B180EE30D36EF(Local_298[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
		...
		func_330(&uLocal_98, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
		...
		iLocal_409 = unk_0x578C4EF320340AF7() + 1000;
	...
	if (Local_434.f_1 == 1)
	{
		...
		else if (!func_328(&uLocal_356, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true)))
		{
			func_239(6);
			Local_434.f_9 = 8;
			Local_434.f_1 = 3;
		...
		else
		{
			...
			if (unk_0xAE06B9E39EBDE049(Local_293[iLocal_283 /*43*/].f_1))
			{
				if (iLocal_283 == 0)
				{
					if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0x9893D61ACB9FB52A())
						{
							unk_0x85D9FC15836825C1("EPS_4_MCS_1", 8);
							func_402("Requesting midtro now");
						}
					}
					else if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
					{
						if (unk_0x9893D61ACB9FB52A())
						{
				...
				else if (iLocal_283 == 1)
				{
					if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0x9893D61ACB9FB52A())
						{
							unk_0x85D9FC15836825C1("EPS_4_MCS_2", 8);
							func_402("Requesting midtro now");
						}
					}
					else if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
				...
				else if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
				{
					if (!unk_0x9893D61ACB9FB52A())
					{
						unk_0x85D9FC15836825C1("EPS_4_MCS_3", 8);
						func_402("Requesting midtro now");
					}
				}
				else if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
			...
			if (iLocal_283 == 0)
			{
				if (iLocal_408 == 0)
				{
					if (iLocal_409 < unk_0x578C4EF320340AF7())
					{
						if (!func_348())
						{
							func_323("EPS4_T0");
							iLocal_409 = unk_0x578C4EF320340AF7() + 7500;
							iLocal_408++;
							iLocal_421 = unk_0x578C4EF320340AF7();
						}
						else
						{
							iLocal_408 = 2;
				...
				{
					if (unk_0x1BD7199394D7F19A(0, 25) || iLocal_409 < unk_0x578C4EF320340AF7())
					{
						unk_0xD289B55B6AADBA10(1);
						iLocal_409 = unk_0x578C4EF320340AF7() + 1000;
						iLocal_408++;
			...
			{
				func_322(&iLocal_94);
				if (!func_328(&uLocal_304, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true)))
				{
					iLocal_269 = 0;
					unk_0xBE4122AC23440E7D(false);
					unk_0xB80B2936A29B2666();
				...
				{
					if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_36, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_36, sLocal_91))
						{
							if (func_231(iLocal_291))
							{
								unk_0xA785552633ED203B(iLocal_291, unk_0x9B0761B4C3EB8BC7(), 10000, 0, 2);
							}
						}
						iLocal_421 = unk_0x578C4EF320340AF7();
						iLocal_270 = 1;
				...
				{
					if (!func_282() && (unk_0x578C4EF320340AF7() - iLocal_288) >= 7500)
					{
						if ((unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_291, 30f, 30f, 30f, 0, 1, 0)) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_37, sLocal_91))
							{
								if (func_231(iLocal_291))
								{
									unk_0xA785552633ED203B(iLocal_291, unk_0x9B0761B4C3EB8BC7(), 5000, 0, 2);
								}
							}
							iLocal_271 = 1;
							iLocal_421 = unk_0x578C4EF320340AF7();
				...
				else if (iLocal_268 == 0 && !func_306(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_2, 9f))
				{
					if (func_306(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_2, 20f))
					{
						if (!iLocal_273)
						{
							if (!func_282())
							{
								if (func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_42, 7, 0, 0, 0))
								{
									...
									unk_0xBE1CA603598C1441(3f, 5f, 0);
									iLocal_273 = 1;
								}
							}
						}
					...
					{
						if (func_305(unk_0x9B0761B4C3EB8BC7(), iLocal_291, 30f, 1) || iLocal_283 == 2)
						{
							if (!func_282() && (unk_0x578C4EF320340AF7() - iLocal_286) > 15000)
							{
								if (bLocal_266)
								{
									if (iLocal_282 == 0)
									{
										...
										{
											if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_347(iLocal_291))
												{
													unk_0xA785552633ED203B(iLocal_291, unk_0x9B0761B4C3EB8BC7(), 3000, 0, 2);
												}
												iLocal_286 = unk_0x578C4EF320340AF7();
												iLocal_412++;
												if (iLocal_283 == 2)
									...
									{
										if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_286 = unk_0x578C4EF320340AF7();
											iLocal_414++;
										}
								...
								{
									if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_41, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_347(iLocal_291))
										{
											unk_0xA785552633ED203B(iLocal_291, unk_0x9B0761B4C3EB8BC7(), 3000, 0, 2);
							...
							else if (bLocal_266 != Local_301.f_1)
							{
								...
								if (bLocal_266)
								{
									if (iLocal_287 < unk_0x578C4EF320340AF7())
									{
										if (func_282())
										{
											unk_0xBE4122AC23440E7D(true);
										}
										iLocal_286 = (unk_0x578C4EF320340AF7() - 7500);
										iLocal_287 = unk_0x578C4EF320340AF7();
									}
								}
								else
								{
					...
					{
						iLocal_286 = (unk_0x578C4EF320340AF7() - 5000);
					}
				}
				if (iLocal_283 == 0)
				{
					if (iLocal_415 < 5)
					{
						if (((unk_0x578C4EF320340AF7() - iLocal_417) > 7500 && !func_282()) && !unk_0x2F80DB5A41D045E6())
						{
							if (func_231(Local_298[0 /*8*/]))
							{
								if (func_230(Local_298[0 /*8*/], unk_0x9B0761B4C3EB8BC7(), 1) < 4f)
								{
				...
				else if (iLocal_283 == 1)
				{
					if (iLocal_415 < 4)
					{
						if (((unk_0x578C4EF320340AF7() - iLocal_417) > 7500 && !func_282()) && !unk_0x2F80DB5A41D045E6())
						{
							if (func_231(Local_298[1 /*8*/]))
							{
								if (func_230(Local_298[1 /*8*/], unk_0x9B0761B4C3EB8BC7(), 1) < 4f)
								{
				...
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, false, 1))
				{
					if (iLocal_289 == -1)
					{
						iLocal_289 = unk_0x578C4EF320340AF7();
					}
					else if ((unk_0x578C4EF320340AF7() - iLocal_289) >= 1500)
					{
						if (func_282())
						{
							func_280();
				...
				else if (!func_306(unk_0x9B0761B4C3EB8BC7(), Local_293[iLocal_283 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_267 = 0;
				}
			}
			else
			{
				...
				{
					iLocal_94 = func_304(Local_82, 5, 0);
				}
				bLocal_266 = Local_301.f_1;
				if (func_328(&uLocal_304, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true)))
				{
				...
				else if (iLocal_274 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_291, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_282() && !unk_0x2F80DB5A41D045E6())
							{
								if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_274 = 1;
								}
							}
					...
					else if (!func_282() && !unk_0x2F80DB5A41D045E6())
					{
						if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_274 = 1;
				...
				else if (iLocal_275 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_291, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_282() && (unk_0x578C4EF320340AF7() - iLocal_288) >= 7500) && !unk_0x2F80DB5A41D045E6())
							{
								if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_275 = 1;
								}
							}
					...
					else if ((!func_282() && (unk_0x578C4EF320340AF7() - iLocal_288) >= 7500) && !unk_0x2F80DB5A41D045E6())
					{
						if (unk_0xF005CCA4263DF67F(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_275 = 1;
	...
	if (Local_434.f_1 == 3)
	{
		...
		func_289();
		unk_0x3E6F6B3156C4F772(0, 200, 150);
		if ((unk_0x578C4EF320340AF7() - iLocal_295) > 750)
		{
			func_227();
			unk_0xBE1CA603598C1441(5f, 5f, 0);
...
int func_304(struct<3> Param0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_306(int iParam0, struct<3> Param1, float fParam2)
{
...
int func_311()
{
	...
	if (unk_0x460153A63B9477BC() == func_314())
	{
		return 0;
	}
	if (func_312(unk_0x460153A63B9477BC()))
	{
		return 0;
	}
...
void func_324(var uParam0)
{
	...
	fVar0 = vdist(uParam0->f_2, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true));
	Var1 = { unk_0x2E6A35AC161797A7(unk_0x9B0761B4C3EB8BC7()) };
	if (fVar0 > Local_301.f_11)
	{
		fVar3 = 0f;
		if (Local_301.f_8 > 0f)
		{
			fVar3 = (fVar3 + (sin(((fVar0 - Local_301.f_11) * (360f / Local_301.f_8))) * Local_301.f_10));
		}
		if (Local_301.f_9 > 0f)
		{
			fVar3 = (fVar3 + (sin(((fVar0 - Local_301.f_11) * (360f / Local_301.f_9))) * (Local_301.f_10 * -0.7f)));
		}
		Var2.x = ((Var1.x * cos(fVar3)) - (Var1.f_1 * sin(fVar3)));
		Var2.f_1 = ((Var1.f_1 * cos(fVar3)) + (Var1.x * sin(fVar3)));
	}
	else
	{
		Var2 = { Var1 };
	}
	Var4 = { uParam0->f_2 - unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
	Var5 = { uParam0->f_2 - unk_0x7EC595B99EA7C4B1(unk_0x9B0761B4C3EB8BC7(), 0f, -5f, 0f) };
	bVar6 = ((Var4.x * Var2.x) + (Var4.f_1 * Var2.f_1)) > 0f;
	fVar7 = (1f - (unk_0xED4B54A984E6E361(Var2.x, Var2.f_1, Var5.x, Var5.f_1) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_284 < unk_0x578C4EF320340AF7())
	{
		if (fVar0 <= 6.5f && bVar8)
		{
			unk_0xC5E5600D1CF5CEF9(Local_301.f_3);
			unk_0x2DB2D4C3CB88500D(Local_301.f_4, "CONTINUAL_BEEP", unk_0x9B0761B4C3EB8BC7(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_301.f_6 = 1;
		}
		else
		{
			...
			iVar10 = (125 + round(((fVar9 / 40f) * (1250f - 125f))));
			if (iVar10 > 1250)
			{
				iVar10 = 1250;
			}
			iLocal_284 = (unk_0x578C4EF320340AF7() + iVar10);
			iVar10 = (iVar10 / 3);
			if (iVar10 < 100)
			{
				iVar10 = 100;
			}
			iLocal_285 = (unk_0x578C4EF320340AF7() + iVar10);
			unk_0x2DB2D4C3CB88500D(Local_301.f_3, "IDLE_BEEP", unk_0x9B0761B4C3EB8BC7(), "EPSILONISM_04_SOUNDSET", 0, 0);
			if (bVar8)
			{
				unk_0x3E6F6B3156C4F772(0, 200, 150);
			}
			...
			{
				unk_0x3E6F6B3156C4F772(0, 200, 100);
			}
		}
	}
	if (iLocal_285 > 0 && unk_0x578C4EF320340AF7() > iLocal_285)
	{
		unk_0xC5E5600D1CF5CEF9(Local_301.f_3);
		iLocal_285 = 0;
	}
	if (unk_0x5BFE1F305D18843B())
	{
		if (Local_301.f_7 == 0)
		{
			unk_0x2DB2D4C3CB88500D(Local_301.f_5, "SCAN", unk_0x9B0761B4C3EB8BC7(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_301.f_7 = 1;
		}
		else if (bVar8)
		{
			unk_0xD4974F3117C9F232(Local_301.f_5, "IsOnTarget", 1f);
		}
		else
		{
			unk_0xD4974F3117C9F232(Local_301.f_5, "IsOnTarget", 0f);
		}
		iLocal_421 = unk_0x578C4EF320340AF7();
	}
	...
	else
	{
		...
		unk_0x830F007E19C63E14(iLocal_95, "SET_DISTANCE");
		unk_0x49B9B8101B158AEE(fLocal_302);
		unk_0xE1FDD153F5858534();
		unk_0xCA1F114B668562E5(iLocal_96);
		unk_0xE6A03BA84586E67B(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
	if (unk_0x22D6FB6153F774D3(0, 25))
	{
		unk_0x94D1A5176CE89859(unk_0x9B0761B4C3EB8BC7(), 1f);
		unk_0x779660A9E5364C4D(0, 22, 1);
		if (bLocal_281)
		{
			unk_0x7965943E39128B42(15f, 1065353216);
...
void func_325(var uParam0)
{
	...
	if (func_347(*uParam0) && unk_0x7DA97DBB7F7D2DE5(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = unk_0x344C570D6F8700DF(0, iLocal_297);
				while (uParam0->f_3 == -1)
				{
					if (Local_296[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!unk_0xC2169C00B643278B(*uParam0, Local_296[iVar0 /*6*/], 3f, 3f, 3f, 0, true, 0))
							{
				...
				unk_0x3C1B180EE30D36EF(*uParam0, Local_296[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (unk_0x16BC17A8EDC701A2(*uParam0, 713668775) == 7)
					{
				...
				else if (unk_0x16BC17A8EDC701A2(*uParam0, 2106541073) == 7)
				{
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				unk_0x9DC06E2A59C5AEBB(&uLocal_97);
				if (Local_296[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_298[1 /*8*/])
					{
						unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 2)
				{
					unk_0xF4726838A5A40509(0, Local_296[uParam0->f_3 /*6*/].f_3, 0);
					unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 3)
				{
					unk_0x756D74A3EF0AB788(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				unk_0x19F29730874AD6F1(uLocal_97);
				unk_0x9B6EC2CECE1010EF(*uParam0, uLocal_97);
				unk_0x4F83FEE4454169D4(&uLocal_97);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (unk_0x16BC17A8EDC701A2(*uParam0, 242628503) == 7)
				{
					Local_296[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), uParam0->f_4, 1f, 1f, 1f, 0, true, 0) || iLocal_283 > 0)
				{
					if (!unk_0x7DA97DBB7F7D2DE5(*uParam0))
					{
						unk_0x9B94F6169B0DAEFD(*uParam0);
						unk_0xE19B69814D61BBA5(*uParam0, func_326());
						unk_0x694113444F21E39F(*uParam0, 167, true);
					}
					iLocal_418 = unk_0x578C4EF320340AF7();
					if (iLocal_283 == 0)
					{
						unk_0x4BC21A0A3ECED9D5(func_326(), 0);
					}
					else
					{
						unk_0x4BC21A0A3ECED9D5(func_326(), 0);
					}
					unk_0xB8A8330F76877CDE(func_326(), 4f, -1f, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x9B5FCBF3AD978FCA(*uParam0))
				{
					if (!iLocal_280)
					{
						if ((unk_0x578C4EF320340AF7() - iLocal_418) > 6000)
						{
							unk_0x9DC06E2A59C5AEBB(&uLocal_97);
							if (*uParam0 == Local_298[1 /*8*/])
							{
				...
				if (unk_0x7587087519CF4F83(unk_0x9B0761B4C3EB8BC7()) || unk_0x5F662D6A37C32195(unk_0x9B0761B4C3EB8BC7()))
				{
					if ((((unk_0x578C4EF320340AF7() - iLocal_419) > 7500 && !func_282()) && !unk_0x2F80DB5A41D045E6()) && !iLocal_267)
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
				...
				if ((unk_0x578C4EF320340AF7() - iLocal_421) > 15000)
				{
					if ((((iLocal_420 < 4 && !func_282()) && !unk_0x2F80DB5A41D045E6()) && !iLocal_267) && !func_348())
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
		...
		case 5:
			...
			{
				unk_0xE021DCE1063D5DC2(*uParam0, unk_0x9B0761B4C3EB8BC7(), 20000, 4.5f, 2f, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_347(iParam0) && func_231(unk_0x9B0761B4C3EB8BC7()))
	{
		if (iLocal_299 == 0)
		{
			if (unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iParam0) && unk_0xCED6B5226244381C(iParam0))
			{
		...
		{
			if (unk_0x12C99794D883929B(iLocal_300) || unk_0xEEB37DB9533AA764(iLocal_300))
			{
				if (!func_282() && !unk_0x2F80DB5A41D045E6())
				{
...
{
	unk_0x2DB2D4C3CB88500D(Local_301.f_2, "DEVICE", unk_0x9B0761B4C3EB8BC7(), "EPSILONISM_04_SOUNDSET", 0, 0);
	if (Local_301.f_13 == 0)
	{
...
void func_331(var uParam0, int iParam1)
{
	if (func_347(*uParam0))
	{
		...
		unk_0x2BB0EF9DE445EA13(*uParam0);
		unk_0x03D382CB0B44E2FC(*uParam0, Local_296[iParam1 /*6*/], 1, 0, 0, 1);
		unk_0xE922BAA80E8F9324(*uParam0, Local_296[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
{
	if (func_347(*uParam0) && func_347(unk_0x9B0761B4C3EB8BC7()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		unk_0xA785552633ED203B(*uParam0, unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
		if (bParam1)
		{
			unk_0xD08E9EAF091A1AAB(*uParam0, unk_0x9B0761B4C3EB8BC7(), 0);
		}
		uParam0->f_4 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
	}
	else
	{
		uParam0->f_1 = 0;
...
int func_337()
{
	...
	unk_0x131ED02492676000("rcm_epsilonism4leadinout");
	if (unk_0xC614DDE265D18415("rcm_epsilonism4") && unk_0xC614DDE265D18415("rcm_epsilonism4leadinout"))
	{
		return 1;
	}
	return 0;
...
int func_338()
{
	...
	while (iVar0 < iLocal_294)
	{
		unk_0x78FCB2E22C41B9D5(Local_293[iVar0 /*43*/]);
		iVar0++;
	}
	...
	while (iVar0 < iLocal_294)
	{
		if (!unk_0x7D167B9A0CCDA347(Local_293[iVar0 /*43*/]))
		{
			return 0;
		}
		iVar0++;
	}
	if (!unk_0x7D167B9A0CCDA347(iLocal_90) || !unk_0x7D167B9A0CCDA347(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
void func_340()
{
	...
	if (Local_434.f_1 == 0)
	{
		if (!unk_0xFFDFD8490027DBA5())
		{
			unk_0x85D9FC15836825C1("ep_4_rcm_concat", 8);
		}
		...
		if (func_278(1, 1093140480, 0))
		{
			...
			{
				unk_0xFA3AB7AE2A01375E(Local_81.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_347(Local_81.f_28[1]))
			{
				unk_0x6A8F948698B360B4(Local_81.f_28[1], false);
				if (func_231(unk_0x04E8D2DEA9062B86(Local_81.f_28[1], 1)))
				{
					iLocal_303 = func_271(Local_81.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					unk_0xFA3AB7AE2A01375E(iLocal_303, "Artefact_Detector", 0, 0, 0);
				}
				unk_0xFA3AB7AE2A01375E(Local_81.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			if (func_347(unk_0x9B0761B4C3EB8BC7()))
			{
				unk_0xFA3AB7AE2A01375E(unk_0x9B0761B4C3EB8BC7(), "Michael", 0, 0, 0);
			}
			unk_0x21723EF7B2FCC4CC("EPS4_START");
			func_344();
			unk_0x182DD1CBC93CF936(1);
			unk_0x6EEEEDB625F825CC(0);
			wait(0);
	...
	if (Local_434.f_1 == 1)
	{
		...
		if (func_231(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				func_402("*** Forcing Michael's move state");
				func_343(unk_0x9B0761B4C3EB8BC7(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				unk_0x92BD213E6A0E666B(unk_0x9B0761B4C3EB8BC7(), iLocal_89, -1, true, true);
			}
		}
...
void func_341()
{
	...
	if (func_231(Local_298[1 /*8*/]))
	{
		if (unk_0x10447A1CD8175FC0("Jimmy_Boston", 0))
		{
			unk_0xE5CC8E2D904E42CE(1829.8f, 4693.48f, 38.5f, &fVar0, 0, 0);
			unk_0x03D382CB0B44E2FC(Local_298[1 /*8*/], 1829.8f, 4693.48f, fVar0, 1, 0, 0, 1);
		}
	}
}
...
void func_342()
{
	if (func_231(Local_298[0 /*8*/]))
	{
		if (unk_0x10447A1CD8175FC0("Marnie", 0))
		{
			...
			unk_0x83CAF206A9B8748C(Local_298[0 /*8*/], Local_296[Local_298[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			unk_0x854FB153F2EA838B(Local_298[0 /*8*/], -668482597, 0, 1, 1);
			Local_298[0 /*8*/].f_7 = 1;
...
int func_343(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_345()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (!func_413(0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
	...
	if (Local_434.f_1 == 1)
	{
		if ((unk_0x578C4EF320340AF7() - iLocal_284) > 1250)
		{
			unk_0x057194D526464DC0(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
			iLocal_284 = unk_0x578C4EF320340AF7();
		}
		if (!func_413(0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
			if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 1) >= 3f)
			{
				if (!unk_0x28BD5A3E7899F23D())
				{
					if (!iLocal_263)
					{
						...
						{
							unk_0xF1B800B6646C4019(Local_81.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							unk_0x89F30480E0C49A16(fLocal_429);
							unk_0x8AA2C5E3C6438257(fLocal_430);
							unk_0x6053F87294B7C143(fLocal_431);
							unk_0xE2AA8012BC8A9464(fLocal_432);
							unk_0x381A07A730FA08C0(fLocal_433);
							unk_0x3506E790BAAF404A(1);
							if (func_231(unk_0x9B0761B4C3EB8BC7()))
							{
								unk_0x9DC06E2A59C5AEBB(&uLocal_97);
								unk_0xA785552633ED203B(0, Local_81.f_28[0], 15000, 0, 2);
								unk_0x3C1B180EE30D36EF(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								unk_0xD08E9EAF091A1AAB(0, Local_81.f_28[0], 0);
								unk_0x19F29730874AD6F1(uLocal_97);
								unk_0x9B6EC2CECE1010EF(unk_0x9B0761B4C3EB8BC7(), uLocal_97);
								unk_0x4F83FEE4454169D4(&uLocal_97);
			...
			if (!iLocal_264)
			{
				...
				{
					unk_0xA785552633ED203B(Local_81.f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 48, 2);
					unk_0x756D74A3EF0AB788(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					unk_0xA389D93286499741();
					unk_0xDDBEE500B2E6E7FA("EP_4_RCM_CONCAT", 2, 8);
			...
			{
				if (unk_0x9934470AA0A08B57(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (unk_0x4C06B15B376AA145(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_265)
						{
					...
					if (unk_0x4C06B15B376AA145(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						func_402("Leadin done, launch cutscene");
						func_239(1);
						Local_434.f_1 = 3;
					}
					if (func_230(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 1) <= 1.5f)
					{
						unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 0);
						unk_0x9B94F6169B0DAEFD(unk_0x9B0761B4C3EB8BC7());
					}
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x03DB5C6AABF8DA46())
			{
				...
				Var4 = { func_351(Global_77088, Global_77090, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_362(0) || Global_77102) || Global_77091 == 1) || !unk_0x87F0CB19476706C3())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((unk_0x3EBB66F936A3436E() || func_225(0)) || func_361(1))
			{
			}
			else
			{
...
int func_377(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)
{
	if (iParam3 != 0)
	{
		*uParam0 = iParam3;
	...
	{
		*uParam0 = unk_0xB3116B49FE00E2F1(5, iParam4, Param1, fParam2, 1, true);
		func_402("*** Epsilonist does not exist, creating new");
	}
	if (func_347(*uParam0))
	{
		unk_0x694113444F21E39F(*uParam0, 132, true);
		unk_0xD3D9D7C84656DAE5(*uParam0, 1862763509);
		unk_0xDAE36360F0F8C1ED(*uParam0, true);
		unk_0x0DC39BE87E4C5599(*uParam0, false);
		unk_0x5A5A1DD32AC33C2B(*uParam0, 1);
...
void func_378(var uParam0)
{
	...
	uParam0->f_1 = unk_0x6E52E47D436A2C77(*uParam0, Var0, 1, true, 0);
	if (unk_0xAE06B9E39EBDE049(uParam0->f_1))
	{
		unk_0xC82085403E46A869(uParam0->f_1, uParam0->f_5, 0, 1);
		func_379("Rock rot vector: ", unk_0x090239DEAF625B17(uParam0->f_1, 0));
		func_379("Rock actual position: ", unk_0x3E4D3CCC220BDFB1(uParam0->f_1, false));
		unk_0xC62EE91883AF24A2(uParam0->f_1, 0);
...
void func_380()
{
	Local_301.f_2 = unk_0x5E54B0823F46079E();
	Local_301.f_3 = unk_0x5E54B0823F46079E();
	Local_301.f_4 = unk_0x5E54B0823F46079E();
	Local_301.f_5 = unk_0x5E54B0823F46079E();
	Local_301.f_12 = 0.92f;
	Local_301.f_13 = 0;
	Local_301.f_14 = "NO_RECENT_ANIM";
	iLocal_95 = unk_0x5DEA4192B46CB99B("digiscanner");
	while (!unk_0x95EF219D38B20CFF(iLocal_95))
	{
		wait(0);
	}
	if (!unk_0xA9A353D835A7867C("digiscanner"))
	{
		unk_0x3FF471D4A18A5ED5("digiscanner", 0);
	}
	unk_0xC7DE5B846819A9B2(iLocal_90);
	if (unk_0xA9A353D835A7867C("digiscanner"))
	{
		iLocal_96 = unk_0x2BC38EC678978375("digiscanner");
	}
}
...
void func_383(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_328(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
...
int func_387(struct<3> Param0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_394(struct<3> Param0, struct<3> Param1, float fParam2)
{
	int iVar0;
...
void func_395(struct<3> Param0, float fParam1)
{
	int iVar0;
...
void func_397(struct<3> Param0, struct<3> Param1, float fParam2)
{
	int iVar0;
...
void func_398(int iParam0, struct<3> Param1, struct<3> Param2)
{
	int iVar0;
...
void func_400()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_285(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_403(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
...
int func_404()
{
	return unk_0xC08A186299DFDA0A(1789.2f, 4658f, 30.73f, 1871.87f, 4745.51f, 40.17f, 0, 1, 1, 1);
}
...
int func_405(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (func_347(unk_0x9B0761B4C3EB8BC7()))
			{
				iVar3 = unk_0x86FB3A0D4870FE62(unk_0x9B0761B4C3EB8BC7());
			}
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[0]))
			{
				...
				{
					unk_0xD3D9D7C84656DAE5(uParam0->f_28[0], iVar3);
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[1]))
			{
				...
				{
					unk_0xD3D9D7C84656DAE5(uParam0->f_28[1], iVar3);
					unk_0x694113444F21E39F(uParam0->f_28[1], 132, true);
					unk_0x78024EFD31A7FAD4(uParam0->f_28[1], 1, 0, 0, false);
					unk_0x9B94F6169B0DAEFD(uParam0->f_28[1]);
					unk_0x92BD213E6A0E666B(uParam0->f_28[1], joaat("weapon_digiscanner"), -1, true, true);
					unk_0x756D74A3EF0AB788(uParam0->f_28[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
int func_406(int iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_407(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*iParam0, 0))
...
int func_407(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_415()
{
	...
	if (func_347(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		unk_0x69C71C91F56D82B9(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), true);
		unk_0x9B94F6169B0DAEFD(unk_0x9B0761B4C3EB8BC7());
		unk_0xE1A91D6D0E2CF9AE(unk_0x9B0761B4C3EB8BC7(), 0f);
	}
	if (unk_0xE9159DB182CF0841())
	{
		unk_0xF990EDED7D25FB88();
	}
	unk_0xDEE1792A90945C34(uLocal_290);
	if (func_231(Local_298[0 /*8*/]) && func_231(Local_298[1 /*8*/]))
	{
		if (unk_0x7DA97DBB7F7D2DE5(Local_298[0 /*8*/]))
		{
			unk_0x59478CBBF96AF7D1(Local_298[0 /*8*/]);
		}
		else if (unk_0x7DA97DBB7F7D2DE5(Local_298[1 /*8*/]))
		{
			unk_0x59478CBBF96AF7D1(Local_298[1 /*8*/]);
		}
	}
	func_416(&(Local_298[0 /*8*/]), 1, 1, 1);
	func_416(&(Local_298[1 /*8*/]), 1, 1, 1);
	unk_0x07FF72DF7F314523("digiscanner");
	unk_0x1E337EE68290597A(iLocal_92, 0);
	unk_0x1E337EE68290597A(iLocal_93, 0);
	unk_0x9142D74AFE3ACF6B(iLocal_426);
	unk_0x9142D74AFE3ACF6B(iLocal_427);
	unk_0x9142D74AFE3ACF6B(iLocal_428);
	if (unk_0x306BF588BD8151E8("EPSILONISM_04_MIX"))
	{
		func_402("Stopping dynamic mix EPSILONISM_04_MIX");
		unk_0xFA07F8BEBDAAFBA8("EPSILONISM_04_MIX");
	}
...
void func_418(bool bParam0)
{
	...
	if (!func_433())
	{
		...
		{
			func_177(iVar0, 1, 0);
			func_419(unk_0x6C5C6B207AA78253(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_420(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_426())
	{
		...
		{
			iVar2 = func_421(unk_0x6C5C6B207AA78253());
			if (iVar2 > -1)
			{
