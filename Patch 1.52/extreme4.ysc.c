...
void __EntryFunction__()
{
	...
	fLocal_82 = 328.7801f;
	iLocal_289 = unk_0x5E54B0823F46079E();
	...
	if (!func_335())
	{
		if ((func_317(Local_80.f_28[0]) && func_317(unk_0x9B0761B4C3EB8BC7())) && !func_316(unk_0x9B0761B4C3EB8BC7(), Local_80.f_28[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	...
	{
		wait(0);
		unk_0xAEF7C45DAFB8E9B0("SF_UR", 0);
		...
		{
			if (func_317(unk_0x9B0761B4C3EB8BC7()) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, true, 0))
			{
				if (func_317(Local_91))
				{
					if (func_316(unk_0x9B0761B4C3EB8BC7(), Local_91, 10f, 1))
					{
						func_297();
					}
				}
...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			if (unk_0x7BCC91F3C1CF24E8(sLocal_92))
			{
				func_351(1);
			}
			else
...
void func_8()
{
	switch (iLocal_85)
	{
		...
		case 1:
			...
			{
				if (!unk_0xA59F96B50B97E63C(iLocal_102, 0))
				{
					if (func_316(unk_0x9B0761B4C3EB8BC7(), iLocal_102, 1f, 1))
					{
			...
			if (func_317(unk_0x9B0761B4C3EB8BC7()))
			{
				if (iLocal_297 == 0)
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, true, 0) && unk_0x5B5B4E37C1CCA675(unk_0x9B0761B4C3EB8BC7()) == 2)
					{
						iLocal_297 = 1;
					}
				}
				if (func_228(Local_91))
				{
					if (timera() > 5000)
					{
						if ((unk_0x578C4EF320340AF7() > iLocal_292 + 25000 || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
						{
							iLocal_85 = 2;
						}
					}
				}
				else if ((unk_0x578C4EF320340AF7() > iLocal_292 + 25000 || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
				{
					iLocal_85 = 2;
				}
			}
			if (unk_0x578C4EF320340AF7() < iLocal_292 + 5000)
			{
				if (unk_0xCF9EB097E33B913A())
				{
		...
		case 2:
			if (((!unk_0xEC787E1D3B804A72(unk_0x9B0761B4C3EB8BC7()) && !unk_0xAACBFCE60AF94F2D(unk_0x9B0761B4C3EB8BC7())) && unk_0x586155E4A4CB828E(unk_0x9B0761B4C3EB8BC7()) < 2f) && !unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7()))
			{
...
void func_9()
{
	if (iLocal_297 == 1)
	{
		unk_0xBE1CA603598C1441(10f, 4f, 0);
		func_210(762);
	}
	func_2(1);
	func_10(84, 1);
...
void func_229()
{
	...
	iVar0 = 0;
	fVar1 = 1f;
	iLocal_296 = unk_0x578C4EF320340AF7();
	if (!unk_0x40397A9A17EEC1C5(iLocal_274))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_275))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_276))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_277))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_278))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_279))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_280))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_281))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_282))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_283))
	{
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_284))
	{
	}
	unk_0x01BFF6CEF1167310(fVar1);
	unk_0x644F1D0C5427A242(false);
	unk_0x8CFF639CEFF5CF16(false);
	unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 128);
	unk_0xFA07F8BEBDAAFBA8("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_244(800, 0);
	iLocal_298 = 0;
	iLocal_299 = 0;
	iLocal_301 = 0;
	...
	iLocal_299 = 0;
	iLocal_304 = 0;
	unk_0xC2712DACFB125A39("SLOWMO_EXTREME_04");
	unk_0x182DD1CBC93CF936(0);
	while (unk_0x578C4EF320340AF7() < iLocal_296 + 11000 && !unk_0x03DB5C6AABF8DA46())
	{
		if (!unk_0xFC5D6FB6EECB392F(iLocal_293) && !unk_0xFC5D6FB6EECB392F(iLocal_294))
		{
			if (func_242(400))
			{
				bLocal_303 = true;
		...
		if (!iLocal_301)
		{
			...
			{
				if (unk_0x369E69441C066912(iLocal_293) == 1f)
				{
					if (func_317(Local_91))
					{
						iLocal_294 = unk_0xF341A134A5B8D4F6(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						iLocal_286 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", true);
						unk_0xDFDB9C533700BC17(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0x882281B10B0A5932(iLocal_294, 0);
						unk_0x856549C07003344B(iLocal_286, true);
						unk_0x00736EE41CC355ED(iLocal_286, iLocal_294, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0x3ED9330214992278(true, false, 3000, 1, 0, 0);
						unk_0x1322CA891C5DF18A(Local_91, 0, 0);
						unk_0xB8B0F7C8C1548C5B(iLocal_285, 0);
						iLocal_301 = 1;
					}
				}
			}
		...
		{
			if (unk_0xFC5D6FB6EECB392F(iLocal_294) && unk_0x369E69441C066912(iLocal_294) >= 0.2f)
			{
				if (!unk_0xFC5D6FB6EECB392F(iLocal_295))
				{
					unk_0x42C7D5C87BE92EE5("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0xFC5D6FB6EECB392F(iLocal_294) && unk_0x369E69441C066912(iLocal_294) == 1f)
			{
				if (func_317(Local_91))
				{
					iLocal_295 = unk_0xF341A134A5B8D4F6(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					iLocal_287 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", true);
					unk_0xDFDB9C533700BC17(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0x882281B10B0A5932(iLocal_295, 1);
					unk_0x856549C07003344B(iLocal_287, true);
					unk_0x00736EE41CC355ED(iLocal_287, iLocal_295, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0xD81D795E0D0F31CC(iLocal_295);
					unk_0x3ED9330214992278(true, false, 3000, 1, 0, 0);
					unk_0x1322CA891C5DF18A(Local_91, 0, 0);
					unk_0xB8B0F7C8C1548C5B(iLocal_286, 0);
					iLocal_302 = 1;
				}
			}
		}
		else if (unk_0xFC5D6FB6EECB392F(iLocal_295) && unk_0x369E69441C066912(iLocal_295) >= 0.323f)
		{
			if (!iLocal_298)
			{
				unk_0x02280E55667C5CE3("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0xDB452DC43CC534A2(1f);
				func_240();
				iLocal_298 = 1;
			}
			else if (!iLocal_304)
			{
				if (unk_0xFC5D6FB6EECB392F(iLocal_295) && unk_0x369E69441C066912(iLocal_295) >= 0.44f)
				{
					iLocal_104 = unk_0x2B77926F2F13AC48("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0xF8B3E22FA17FA0B3(iLocal_104, 1f);
					iLocal_304 = 1;
				}
			}
		}
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 600 && fVar1 == 1f)
		{
			if (!iLocal_299)
			{
				iLocal_299 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0x9E3DAF75EFC49F5B() / fVar2);
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 630)
		{
		...
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&iLocal_99);
		...
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_317(Local_91))
		...
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_317(Local_91))
		...
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x578C4EF320340AF7() > iLocal_296 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0xB8B0F7C8C1548C5B(iLocal_287, 0);
				iLocal_284 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", true);
				unk_0x3FD8029C7A771A0E(iLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0x3ED9330214992278(true, false, 3000, 1, 0, 0);
				unk_0x856549C07003344B(iLocal_284, true);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_303)
	{
		if (unk_0xFC5D6FB6EECB392F(iLocal_295))
		{
			unk_0x1226CE8F3C423BE9(iLocal_295);
		}
		unk_0x296C8A46F264E8F7("EXT4_JUMPED_OS");
		func_240();
		iLocal_284 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", true);
		unk_0x3FD8029C7A771A0E(iLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0x3ED9330214992278(true, false, 3000, 1, 0, 0);
	...
	unk_0xC82D76A93B55C4F7("SLOWMO_EXTREME_04");
	func_3(&iLocal_99);
	if (func_317(Local_91))
	{
		if (iVar0 < 3)
		{
			unk_0x697DA7132EE43ABC(Local_91, 101, 0);
			Var4 = { unk_0x3E4D3CCC220BDFB1(Local_91, true) };
			if (Var4.f_2 > 155f)
			{
				fVar5 = 155f;
			}
			...
			unk_0x03D382CB0B44E2FC(Local_91, 1657.046f, -17.4571f, fVar5, 1, false, 0, 1);
		}
	}
	...
	unk_0x644F1D0C5427A242(true);
	unk_0x8CFF639CEFF5CF16(true);
	unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), true, 128);
	unk_0x01BFF6CEF1167310(1f);
	if (func_228(Local_91))
	{
		if (unk_0xFC5D6FB6EECB392F(iLocal_295))
		{
			unk_0x8430A80C3E4F5F98(iLocal_295, 1f);
		}
		unk_0x2BB0EF9DE445EA13(Local_91);
		unk_0x1322CA891C5DF18A(Local_91, 0, 0);
		unk_0x03D382CB0B44E2FC(Local_91, 1655.77f, -20.04f, 135.8f, 1, false, 0, 1);
		unk_0x697DA7132EE43ABC(Local_91, 0, 0);
	}
	func_230(&uLocal_106, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
...
void func_232(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_236(unk_0x460153A63B9477BC())) && !func_234(unk_0x460153A63B9477BC(), 0)) && !func_233()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_236(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_245()
{
	if (iLocal_85 < 2)
	{
		unk_0x1BDBFE8EFF10BC95("EXT4_JUMPED_OS");
	}
	switch (iLocal_85)
	{
		case 0:
			iLocal_87 = 0;
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, true, 0))
			{
				unk_0xDDBEE500B2E6E7FA("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0xDDBEE500B2E6E7FA("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0xC5E5600D1CF5CEF9(iLocal_289);
			if (unk_0x06BC339A53519E4E())
			{
				unk_0x931CABC5DE105C79("Dom", 8, 2, 0, 0);
			}
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_305 || unk_0x578C4EF320340AF7() > iLocal_306 + 3000) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, true, 0))
					{
						unk_0x182DD1CBC93CF936(1);
						unk_0x6EEEEDB625F825CC(2048);
						if (func_317(Local_91))
						{
							unk_0xFA3AB7AE2A01375E(Local_91, "Dom", 0, joaat("cs_dom"), 0);
						}
						wait(0);
						iLocal_305 = 0;
						unk_0x8B4966914EE5EB9F(0);
						unk_0x17E478571720218F("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_317(Local_91))
						{
							unk_0x6A8F948698B360B4(Local_91, false);
						}
						if (unk_0xAE06B9E39EBDE049(iLocal_103) && !unk_0xA59F96B50B97E63C(iLocal_103, 0))
						{
							unk_0x80250B8368A4E611(iLocal_103, false, 0);
						}
						if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							iLocal_96 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
							iLocal_105 = unk_0x36FE6D3220816ADA(iLocal_96);
							if (unk_0xB86B8E85030B1552(iLocal_105) == 1 || unk_0x97AFEF6099069369(iLocal_105) == 1)
							{
							...
							func_251(1654.721f, 4.166876f, 172.5245f, 1662.562f, -8.920052f, 178.2742f, 6.25f, Local_272, fLocal_273, 1, 1, 1, 0, 0);
						}
						else
						{
							Local_272 = { 1649.793f, 11.7826f, 172.7745f };
							fLocal_273 = 220.9923f;
							func_250(Local_272, fLocal_273);
						}
						func_247(1660.186f, -7.492f, 172.774f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
						unk_0x773B9DEB93E81B2F(1660.186f, -7.492f, 172.774f, 200f, 0);
						iLocal_288 = unk_0xC08A186299DFDA0A(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_85 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x3EBB66F936A3436E())
			{
				if (unk_0x59B0C38F9A3B22DB(0))
				{
					if (!iLocal_90)
					{
						if (!unk_0xFC5D6FB6EECB392F(iLocal_293))
						{
							if (func_317(Local_91))
							{
								if (!unk_0x40397A9A17EEC1C5(iLocal_285))
								{
									iLocal_285 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", true);
								}
								unk_0x856549C07003344B(iLocal_285, true);
								unk_0x3ED9330214992278(true, false, 3000, 1, 0, 0);
								iLocal_293 = unk_0xF341A134A5B8D4F6(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0xDFDB9C533700BC17(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0x882281B10B0A5932(iLocal_293, 1);
								unk_0x856549C07003344B(iLocal_285, true);
								unk_0x00736EE41CC355ED(iLocal_285, iLocal_293, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0x3ED9330214992278(true, false, 3000, 1, 0, 0);
								unk_0x1322CA891C5DF18A(Local_91, 0, 0);
								iLocal_90 = 1;
							}
				...
				if (func_317(Local_91))
				{
					if (unk_0x10447A1CD8175FC0("Dom", 0))
					{
						iLocal_85 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0xAE06B9E39EBDE049(iLocal_103) && !unk_0xA59F96B50B97E63C(iLocal_103, 0))
			{
				unk_0x80250B8368A4E611(iLocal_103, true, 0);
			}
			if (iLocal_87 == 0)
			{
				unk_0x21723EF7B2FCC4CC("EXT4_JUMPED_OS");
				func_246(3);
			}
			break;
	}
...
void func_247(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (unk_0x5A228A6A51E757C8(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			unk_0x773B9DEB93E81B2F(func_248(unk_0x2639A2323BEA8CC6()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_250(struct<3> Param0, float fParam1)
{
	int iVar0;
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (unk_0xAE06B9E39EBDE049(iVar0))
		{
			...
			{
				unk_0x03D382CB0B44E2FC(iVar0, Param0, 1, false, 0, 1);
...
void func_251(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_252(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_252(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_256(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_264(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_263(unk_0x9B0761B4C3EB8BC7(), -828834893))
				{
...
void func_267()
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		{
			if (((((((unk_0x22D6FB6153F774D3(0, 30) || unk_0x22D6FB6153F774D3(0, 31)) || unk_0x22D6FB6153F774D3(0, 23)) || unk_0x22D6FB6153F774D3(0, 21)) || unk_0x22D6FB6153F774D3(0, 22)) || (func_279() && unk_0x22D6FB6153F774D3(0, 1))) || (func_279() && unk_0x22D6FB6153F774D3(0, 2))) || (func_279() && unk_0x22D6FB6153F774D3(0, 32)))
			{
	...
	switch (iLocal_85)
	{
		case 0:
			...
			{
				unk_0x6673CC701BC8E9C1(Local_80.f_28[0], 17, true);
			}
			iLocal_290 = 0;
			iLocal_305 = 1;
		...
		case 1:
			...
			if (func_317(unk_0x9B0761B4C3EB8BC7()))
			{
				if (func_317(Local_91))
				{
					if (func_316(unk_0x9B0761B4C3EB8BC7(), Local_91, 100f, 1))
					{
						unk_0xDDBEE500B2E6E7FA("es_4_rcm_p2_concat", 6, 8);
						if (unk_0x06BC339A53519E4E())
						{
					...
					if (unk_0xCED6B5226244381C(Local_91))
					{
						unk_0x697DA7132EE43ABC(Local_91, 0, 0);
					}
					if (func_316(unk_0x9B0761B4C3EB8BC7(), Local_91, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_300)
							{
								if (func_316(unk_0x9B0761B4C3EB8BC7(), Local_91, 30f, 1) && !func_266())
								{
							...
							func_269();
							if (!unk_0x60D775F2D5B6439B(unk_0x9B0761B4C3EB8BC7(), Local_91))
							{
								unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), Local_91, -1, 0, 2);
							}
						}
					}
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, true, 0))
					{
						if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							iLocal_85 = 2;
		...
		case 2:
			...
			if (func_317(unk_0x9B0761B4C3EB8BC7()))
			{
				if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					unk_0xD4C86DEC93F19FB0(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 5f, 1, 0);
					wait(600);
					unk_0x0AB756271BADC8DF(unk_0x9B0761B4C3EB8BC7(), 0, 0);
				}
			}
...
void func_268()
{
	if (func_317(Local_91))
	{
		if (unk_0x16BC17A8EDC701A2(Local_91, 242628503) != 1)
		{
			unk_0x9B6EC2CECE1010EF(Local_91, uLocal_95);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_290 < 5)
		{
			if (unk_0x578C4EF320340AF7() > (iLocal_291 + (8000 + unk_0x344C570D6F8700DF(0, 2000))))
			{
				if (unk_0x046706CBB367B768(iLocal_289))
				{
	...
	if (!func_266())
	{
		if ((unk_0x8B917081F9836EDD("EXTREME_04_DOM_A", false, -1) && unk_0x8B917081F9836EDD("EXTREME_04_DOM_B", false, -1)) && unk_0x8B917081F9836EDD("EXTREME_04_DOM_C", false, -1))
		{
			if (unk_0x046706CBB367B768(iLocal_289))
			{
				unk_0x2DB2D4C3CB88500D(iLocal_289, "DOM", Local_91, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_271(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(unk_0x9B0761B4C3EB8BC7()) && func_228(iParam0))
	{
...
int func_274(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_258(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	...
	{
		Var1 = { func_258(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_280()
{
	...
	else
	{
		...
		unk_0x3C1B180EE30D36EF(unk_0x9B0761B4C3EB8BC7(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
		func_244(800, 0);
		iLocal_88 = 1;
		func_287(1, 1, 1);
	}
...
void func_281()
{
	...
	unk_0x3C1B180EE30D36EF(Local_80.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 1048576000, 0, 1193033728);
	unk_0x1572226BDDE6B540("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0xF27E737981AFB47D(Local_91.f_1, 20f, 0, 0, 0, 0, false, 0);
	if (!unk_0xAE06B9E39EBDE049(iLocal_97))
	{
		iLocal_97 = unk_0xCE4780E24AFDFBF9(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_98))
	{
		iLocal_98 = unk_0xCE4780E24AFDFBF9(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_100))
	{
		iLocal_100 = unk_0x79CC07752E7432A1(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, true, 0);
		unk_0xC82085403E46A869(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_101))
	{
		iLocal_101 = unk_0x79CC07752E7432A1(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, true, 0);
		unk_0xC82085403E46A869(iLocal_101, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_317(Local_91))
	{
		if (unk_0x16BC17A8EDC701A2(Local_91, 242628503) != 1)
		{
			unk_0x9DC06E2A59C5AEBB(&uLocal_95);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x62726974410B1305(uLocal_95, 1);
			unk_0x19F29730874AD6F1(uLocal_95);
			unk_0x9B6EC2CECE1010EF(Local_91, uLocal_95);
		}
	}
	if (func_317(Local_91))
	{
		unk_0x5A5A1DD32AC33C2B(Local_91, 0);
		func_230(&uLocal_106, 4, Local_91, "DOM", 0, 1);
		unk_0xD3D9D7C84656DAE5(Local_91, unk_0x86FB3A0D4870FE62(unk_0x9B0761B4C3EB8BC7()));
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_103))
	{
		iLocal_103 = unk_0x51B950B3EF2796B4(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0xC82085403E46A869(iLocal_103, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0x97B8FF2D794A65A7(iLocal_103, "Chute_Off_Bag", "skydive@parachute@", 4f, false, 1, 0, 0.99f, 0);
	func_246(1);
}

void func_282(int iParam0, struct<3> Param1, float fParam2)
{
	func_283(iParam0, iLocal_79, Param1, fParam2, 26);
	unk_0x6D2F52D05ED0E1F6(*iParam0);
	unk_0x5A5A1DD32AC33C2B(*iParam0, 0);
	unk_0x14EFF93E9B692DAD(*iParam0, "EXTREME LAUNCHER RC");
}

void func_283(int iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_284(iParam0);
...
int func_285(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_290(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	if (func_335())
	{
...
void func_291()
{
	switch (iLocal_86)
	{
		case 0:
			...
			{
				if (!iLocal_305 || unk_0x578C4EF320340AF7() > iLocal_306 + 3500)
				{
					func_292();
					unk_0x182DD1CBC93CF936(1);
					...
					if (func_228(Local_80.f_28[0]))
					{
						unk_0xFA3AB7AE2A01375E(Local_80.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					wait(0);
					unk_0x8B4966914EE5EB9F(0);
		...
		case 2:
			func_285(unk_0x9B0761B4C3EB8BC7(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0x854FB153F2EA838B(unk_0x9B0761B4C3EB8BC7(), -668482597, 0, 1, 0);
			unk_0x675CCBC7D80F079E(unk_0x9B0761B4C3EB8BC7(), 1f);
			unk_0x3C1B180EE30D36EF(unk_0x9B0761B4C3EB8BC7(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
			unk_0x7965943E39128B42(0f, 1065353216);
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_80.f_28[0])) && func_317(unk_0x9B0761B4C3EB8BC7())) && iLocal_305 == 1)
	{
		if (!unk_0x28BD5A3E7899F23D())
		{
			unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 0);
			unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), Local_80.f_28[0], -1, 0, 2);
			unk_0x5596A69ED9CF00FF(unk_0x9B0761B4C3EB8BC7(), Local_80.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0x3506E790BAAF404A(1);
			unk_0xF1B800B6646C4019(Local_80.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0x89F30480E0C49A16(fVar0);
			unk_0x8AA2C5E3C6438257(fVar1);
			unk_0x6053F87294B7C143(fVar2);
			unk_0xE2AA8012BC8A9464(fVar3);
			unk_0x381A07A730FA08C0(fVar4);
			iLocal_306 = unk_0x578C4EF320340AF7();
		}
		else
		{
			if (func_316(unk_0x9B0761B4C3EB8BC7(), Local_80.f_28[0], 4f, 1))
			{
...
void func_297()
{
	...
	if (iLocal_305)
	{
		if (!unk_0x28BD5A3E7899F23D())
		{
			unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 0);
			unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), Local_91, -1, 0, 2);
			unk_0x3C1B180EE30D36EF(unk_0x9B0761B4C3EB8BC7(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0x3506E790BAAF404A(1);
			unk_0xF1B800B6646C4019(Local_91, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0x89F30480E0C49A16(fVar0);
			unk_0x8AA2C5E3C6438257(fVar1);
			unk_0x6053F87294B7C143(fVar2);
			unk_0xE2AA8012BC8A9464(fVar3);
...
void func_298()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(Local_91, true), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			{
				unk_0x009A89A6CD1E6C3E(iLocal_94, 0);
			}
		}
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, true, 0))
		{
			sLocal_92 = "EXT4_F2";
			iLocal_84 = 4;
		}
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x03DB5C6AABF8DA46())
			{
				...
				Var4 = { func_301(Global_77088, Global_77090, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_313(0) || Global_77102) || Global_77091 == 1) || !unk_0x87F0CB19476706C3())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((unk_0x3EBB66F936A3436E() || func_312(0)) || func_311(1))
			{
			}
			else
			{
...
void func_318()
{
	...
	unk_0xBAA4D421B8B8A744("EXT4", 0);
	while (!unk_0xF5EE205091CE6DB2(0))
	{
		wait(0);
	}
	unk_0x78FCB2E22C41B9D5(joaat("prop_box_guncase_03a"));
	unk_0x78FCB2E22C41B9D5(joaat("prop_box_wood01a"));
	unk_0x78FCB2E22C41B9D5(joaat("p_parachute_s"));
	unk_0x78FCB2E22C41B9D5(joaat("bmx"));
	while (((!unk_0x7D167B9A0CCDA347(joaat("prop_box_guncase_03a")) || !unk_0x7D167B9A0CCDA347(joaat("prop_box_wood01a"))) || !unk_0x7D167B9A0CCDA347(joaat("p_parachute_s"))) || !unk_0x7D167B9A0CCDA347(joaat("bmx")))
	{
		wait(0);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_99))
	{
		iLocal_99 = unk_0x6E52E47D436A2C77(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, true, 0);
		unk_0xC82085403E46A869(iLocal_99, 90f, 0f, -63f, 2, 1);
		unk_0x6A8F948698B360B4(iLocal_99, true);
		unk_0x80250B8368A4E611(iLocal_99, false, 0);
	}
	func_322(1);
	if (!unk_0xAE06B9E39EBDE049(Local_91))
	{
		func_319(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
		unk_0x6A8F948698B360B4(Local_91, true);
		unk_0x4E65320BC9AD521C(Local_91, 1);
		unk_0xD5D11F714F236D78(Local_91, 1);
		unk_0x45F588C0DD767737(Local_91, 8, 2, 0, 0);
		unk_0x316DB01C35390C36(Local_91, true);
		unk_0x694113444F21E39F(Local_91, 137, true);
		unk_0x694113444F21E39F(Local_91, 118, false);
		unk_0x694113444F21E39F(Local_91, 208, true);
		unk_0x055A73D4AFD214F1(Local_91, 5000);
	}
	if (func_228(unk_0x9B0761B4C3EB8BC7()))
	{
		func_230(&uLocal_106, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
...
int func_319(int iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_320(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*iParam0, 0))
...
int func_320(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
{
	unk_0x78FCB2E22C41B9D5(Local_91.f_5);
	unk_0x131ED02492676000("rcmextreme4");
	unk_0x131ED02492676000("skydive@parachute@");
	unk_0x78FCB2E22C41B9D5(joaat("sanchez"));
	unk_0x22043B0E5A2FE456();
	if (iParam0 == 1)
	{
		while ((((!unk_0x7D167B9A0CCDA347(Local_91.f_5) || !unk_0x7D167B9A0CCDA347(joaat("sanchez"))) || !unk_0xC614DDE265D18415("rcmextreme4")) || !unk_0xC614DDE265D18415("skydive@parachute@")) || !unk_0x4F144789C4312F35())
		{
			wait(0);
		}
	}
...
void func_336(int iParam0)
{
	...
	unk_0x1E337EE68290597A(iLocal_288, 0);
	unk_0x08020BC2A66F5B71();
	func_348(&iLocal_100, 0);
	func_348(&iLocal_101, 0);
	func_348(&iLocal_102, 0);
	unk_0x1572226BDDE6B540("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
...
void func_351(bool bParam0)
{
	...
	if (!func_372())
	{
		...
		{
			func_167(iVar0, 1, 0);
			func_352(unk_0x6C5C6B207AA78253(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_353(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_359())
	{
		...
		{
			iVar2 = func_354(unk_0x6C5C6B207AA78253());
			if (iVar2 > -1)
			{
