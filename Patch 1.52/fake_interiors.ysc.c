...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_23(unk_0x460153A63B9477BC()) && unk_0xAE06B9E39EBDE049(func_22()))
		{
			iLocal_31 = func_22();
		}
		else
		{
			iLocal_31 = unk_0x9B0761B4C3EB8BC7();
		}
		if (unk_0xA59F96B50B97E63C(iLocal_31, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_31, false) };
		...
		if (vdist2(Var1, Var0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0x1037B9D45CE6B788(iLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), 0, true, 0))
					{
						bVar2 = true;
					}
				}
			...
			if (bVar2)
			{
				unk_0xFB66346733DDE6FA(unk_0x856D5567211886A2(func_13(iLocal_29)), Var1.x, Var1.f_1, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
	if (unk_0x25DDB354A40FFCDB())
	{
		if (func_2())
		{
			if (unk_0xCE990E643CD9D0E5(iLocal_32, 1))
			{
				unk_0xD2459066EA58CE43(&iLocal_32, 1);
			}
			if (unk_0xF0C12886E5C1B20E())
			{
				if (!unk_0xCE990E643CD9D0E5(iLocal_32, 0))
				{
					unk_0x1D319098EA3986CC(15, 1, -1);
					unk_0xBE20AB8238688965(&iLocal_32, 0);
				}
			}
			else if (unk_0xCE990E643CD9D0E5(iLocal_32, 0))
			{
				unk_0x1D319098EA3986CC(15, 0, -1);
				unk_0xD2459066EA58CE43(&iLocal_32, 0);
			}
		}
		else if (!unk_0xCE990E643CD9D0E5(iLocal_32, 1))
		{
			unk_0x1D319098EA3986CC(15, 0, -1);
			unk_0xD2459066EA58CE43(&iLocal_32, 0);
			unk_0xBE20AB8238688965(&iLocal_32, 1);
		}
	}
}
...
int func_2()
{
	...
	if (func_5(unk_0x460153A63B9477BC(), 1))
	{
		iVar0 = func_4();
		if (iVar0 != func_3())
		{
...
void func_10(int iParam0)
{
	...
	Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_31, false) };
	unk_0x4108C56B7A50DC24(Var0.x, Var0.f_1);
	switch (iParam0)
	{
		case 0:
			break;
