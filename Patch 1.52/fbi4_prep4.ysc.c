	...
	switch (iLocal_81)
	{
		case 0:
			...
			if (!unk_0x7BCC91F3C1CF24E8(sLocal_187))
			{
				...
				{
					while ((unk_0x578C4EF320340AF7() - iLocal_199) < 3000)
					{
						wait(0);
					}
				}
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_8(Global_111858.f_18529[iVar0], &Var2, &fVar3))
			{
...
void func_23()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (func_93(unk_0x9B0761B4C3EB8BC7(), Local_196, 2f) && func_87(21))
			{
			...
			else
			{
				...
				if (bLocal_190)
				{
					iLocal_198 = unk_0x578C4EF320340AF7();
					iLocal_81 = 2;
				}
				else if (!func_93(unk_0x9B0761B4C3EB8BC7(), Local_195, 75f))
				{
					if (!iLocal_201)
					{
						func_22(&iLocal_192);
				...
				else if (func_93(unk_0x9B0761B4C3EB8BC7(), Local_196, 12f))
				{
					if (iLocal_201)
					{
						func_22(&iLocal_192);
					...
					if (unk_0x8F678487EEBD8CE4(iLocal_192))
					{
						unk_0xECC9A00CF1181EC2(iLocal_192, 2);
						unk_0x06B9B7C215BA4E0A(iLocal_192, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((unk_0x578C4EF320340AF7() - iLocal_198) > 2000)
			{
				func_22(&iLocal_192);
...
void func_84(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!unk_0x8F678487EEBD8CE4(*iParam0))
	{
		*iParam0 = func_85(Param1, 5, bParam2);
		if (bParam3)
		{
			unk_0xB023F5C66F5716C7(*iParam0, sParam4);
		}
	}
}

int func_85(struct<3> Param0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_93(int iParam0, struct<3> Param1, float fParam2)
{
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (bParam1)
			{
				func_95(unk_0x9B0761B4C3EB8BC7(), Local_196, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_95(int iParam0, struct<3> Param1, float fParam2)
{
	if (func_234(iParam0))
	{
...
int func_96(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_97(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			...
			unk_0xBAA4D421B8B8A744(sLocal_203, 6);
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_93(unk_0x9B0761B4C3EB8BC7(), Local_195, 60f))
				{
		...
		case 3:
			func_95(unk_0x9B0761B4C3EB8BC7(), Local_196, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
void func_114(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_194(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
...
int func_115(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (unk_0x7D167B9A0CCDA347(Var2))
			{
				...
				*iParam0 = unk_0xCE4780E24AFDFBF9(Var2, Param2, fParam3, 1, 1, 0);
				...
				func_176(iParam0, &(Var2.f_31), &(Var2.f_81));
				unk_0x80E6F5AEA0C688D0(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
int func_176(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_145(unk_0x36FE6D3220816ADA(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_179(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x8DFB45E7317A7ED7(*iParam0, 24, func_179(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_178(iParam0);
	if (func_177(*iParam0))
	{
...
void func_184(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_197(int iParam0, struct<3> Param1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_198(iParam0, uVar1[iVar3], 1) && func_98(unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_193(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, true), unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], true), true) < 10f)
					{
	...
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			if (!bLocal_190)
			{
				...
				{
					iLocal_199 = unk_0x578C4EF320340AF7();
					func_227(4);
					return;
				}
			}
			...
			if (!bLocal_190)
			{
				if (!func_93(unk_0x9B0761B4C3EB8BC7(), Local_195, 150f))
				{
					func_227(2);
				}
				else if (!func_93(unk_0x9B0761B4C3EB8BC7(), Local_195, 75f))
...
void func_270(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	if (func_271())
	{
...
void func_277(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_285(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_278(&(Global_76647[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_285(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2621445 = Var5;
				func_278(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x4D0432E34C5996D9(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			Global_2621445 = Var9;
			func_278(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x4D0432E34C5996D9(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_286(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_344(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_345(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
...
void func_352(bool bParam0)
{
	...
	if (unk_0x40397A9A17EEC1C5(iLocal_193))
	{
		unk_0x3ED9330214992278(false, false, 3000, 1, 0, 0);
		unk_0xB8B0F7C8C1548C5B(iLocal_193, 0);
	}
}
