...
void __EntryFunction__()
{
	...
	{
		func_312();
		if (func_302() || !func_301(unk_0x460153A63B9477BC(), 0, 1))
		{
			func_299();
		}
		switch (func_298(unk_0x59E2AD1A8ACEDA31()))
		{
			case 0:
				if (func_297() == 2)
				{
					iLocal_140[unk_0x59E2AD1A8ACEDA31()] = 2;
				}
				else if (func_297() == 6)
				{
					iLocal_140[unk_0x59E2AD1A8ACEDA31()] = 5;
				}
				break;
			...
			case 2:
				if (func_297() == 2)
				{
					...
					{
						if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 4))
						{
							func_33(1);
							func_32(0);
							func_25();
			...
			case 5:
				...
				{
					iLocal_140[unk_0x59E2AD1A8ACEDA31()] = 6;
				}
				break;
...
int func_1()
{
	if (unk_0xCE990E643CD9D0E5(Local_65.f_1, 0))
	{
		return 1;
	}
	return 0;
...
void func_2()
{
	...
	if (unk_0xAFF96FDC3971E7EA())
	{
		...
		{
			case 0:
				if (!unk_0xCE990E643CD9D0E5(Local_65.f_5.f_3, 1))
				{
					iVar0 = 0;
					while (iVar0 <= 31)
					{
					...
					unk_0xBE20AB8238688965(&(Local_65.f_5.f_3), 1);
				}
				if (Global_2540384.f_1785)
				{
					unk_0xBE20AB8238688965(&(Local_65.f_5.f_3), 0);
					Global_2540384.f_1785 = 0;
				}
				if (unk_0xCE990E643CD9D0E5(Local_65.f_5.f_3, 1))
				{
					if (unk_0xCE990E643CD9D0E5(Local_65.f_5.f_3, 0))
					{
						if (!func_20(&(Local_65.f_5)) || func_19(&(Local_65.f_5), 5000, 0))
						{
							...
							{
								Local_65.f_5.f_72 = 0;
								unk_0xD2459066EA58CE43(&(Local_65.f_5.f_3), 2);
								unk_0xD2459066EA58CE43(&(Local_65.f_5.f_3), 3);
							}
							iVar0 = Local_65.f_5.f_4;
							iVar1 = iVar0;
							if (unk_0x166E920FB00B2DBB(iVar1))
							{
								if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 0))
								{
									unk_0xBE20AB8238688965(&(Local_65.f_5.f_73), iVar1);
									Local_65.f_5.f_72++;
									if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 6))
									{
										Local_65.f_5.f_5[iVar0] = -1;
									}
								}
			...
			case 1:
				...
				iVar0 = Local_65.f_5.f_4;
				if (unk_0xCE990E643CD9D0E5(Local_65.f_5.f_73, iVar0))
				{
					if (func_301(iVar0, 1, 1))
					{
						if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 8))
						{
							if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 0))
							{
								if (Local_65.f_5.f_5[iVar0] == -1)
								{
									...
									if (iVar2 > -1)
									{
										...
										unk_0xBE20AB8238688965(&(Local_65.f_5.f_3), 2);
									}
								}
								else
								{
				...
				if (Local_65.f_5.f_4 == 32)
				{
					if (unk_0xCE990E643CD9D0E5(Local_65.f_5.f_3, 2))
					{
					}
					Local_65.f_5.f_4 = 0;
					Local_65.f_5.f_2 = 2;
			...
			case 2:
					...
					if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 0))
					{
						if (func_301(iVar0, 1, 1))
						{
							if (Local_65.f_5.f_38[iVar0] == -1)
							{
								...
								if (iVar3 > -1)
								{
									if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 0))
									{
										if (Local_65.f_5.f_38[iVar0] == -1)
										{
											...
											if (iVar2 > -1)
											{
												...
												unk_0xBE20AB8238688965(&(Local_65.f_5.f_3), 3);
												func_8(iVar2);
											}
										}
										...
										else if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 3))
										{
											Local_65.f_5.f_38[iVar0] = Local_65.f_5.f_38[iVar3];
										}
										else if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 3))
										{
				...
				if (Local_65.f_5.f_4 == 32)
				{
					if (unk_0xCE990E643CD9D0E5(Local_65.f_5.f_3, 3))
					{
						func_3();
						unk_0xD2459066EA58CE43(&(Local_65.f_5.f_3), 0);
						Local_65.f_5.f_2 = 0;
					}
					else
					{
...
void func_3()
{
	...
	unk_0xB802750B43D4047C(1, &Var0, 2, func_4(1, 1));
}
...
{
	unk_0xBE20AB8238688965(&(Local_65.f_2), iParam0);
}
...
int func_9(int iParam0, int iParam1)
{
	...
	if (iVar3 > -1)
	{
		if (iVar3 != iParam0)
		{
			...
			{
				iVar10 = iVar3;
				iVar11 = unk_0x1FA7B77001D60F9D(iVar10);
				iVar1 = 0;
				while (iVar1 <= 19)
				{
					if (!bVar0)
					{
						if (unk_0xCE990E643CD9D0E5(*iParam1, iVar1))
						{
							if (!func_13(iVar1))
							{
								unk_0xD2459066EA58CE43(iParam1, iVar1);
							}
						}
						if (func_12(iVar1))
						{
							...
							if (iVar12 != -1)
							{
								if (Global_2425698.f_87[iVar12] == 0)
								{
									if (!unk_0xCE990E643CD9D0E5(*iParam1, iVar1))
									{
										if (!unk_0x5AEB5DDFFAD43CA5(iVar9))
										{
											if (!unk_0x5AEB5DDFFAD43CA5(iVar11))
											{
												Var7 = { func_10(iVar1) };
												fVar4 = vdist2(unk_0x3E4D3CCC220BDFB1(iVar9, true), Var7);
												if (fVar4 > fVar6)
												{
													fVar5 = vdist2(unk_0x3E4D3CCC220BDFB1(iVar11, true), Var7);
													if (fVar5 > fVar6)
													{
														iVar2 = iVar1;
														bVar0 = true;
														unk_0xBE20AB8238688965(iParam1, iVar1);
													}
												}
											}
										}
...
int func_12(int iParam0)
{
	...
	if (iVar0 != -1)
	{
		if (unk_0xCE990E643CD9D0E5(Global_2425698.f_64, iVar0))
		{
			if (!unk_0xCE990E643CD9D0E5(Global_2425698.f_62, iVar0))
			{
				return 1;
			}
		}
...
int func_13(int iParam0)
{
	...
	while (iVar1 <= 31)
	{
		...
		if (Local_65.f_5.f_38[iVar1] == iParam0)
		{
			...
			{
				if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar1 /*883*/].f_146, 4))
				{
					if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar1 /*883*/].f_146, 3))
					{
						iVar0 = 1;
					}
				}
...
{
	return unk_0xCE990E643CD9D0E5(Local_65.f_2, iParam0);
}
...
int func_16(int iParam0, var uParam1)
{
	...
	while (iVar0 <= 31)
	{
		if (iVar1 == -1)
		{
			if (iVar0 != iParam0)
			{
				if (unk_0xCE990E643CD9D0E5(*uParam1, iVar0))
				{
					if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 0))
					{
						if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 3))
						{
							if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 2))
							{
								if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 8))
								{
									if (Local_65.f_5.f_5[iVar0] == -1)
...
void func_21()
{
	...
	if (unk_0xAFF96FDC3971E7EA())
	{
		if (iLocal_139 == 0)
		{
			unk_0xD2459066EA58CE43(&iLocal_165, 0);
			unk_0xBE20AB8238688965(&iLocal_165, 1);
		}
		iVar1 = iLocal_139;
		...
		if (func_301(iVar1, 0, 1))
		{
			...
			{
				unk_0xD2459066EA58CE43(&iLocal_165, 1);
			}
		}
		if (unk_0xCE990E643CD9D0E5(Global_1590682[iLocal_139 /*883*/].f_146, 0))
		{
			if (func_301(iVar1, 0, 1))
			{
				if (iVar2 > -1)
		...
		{
			if (unk_0xCE990E643CD9D0E5(Global_1590682[iLocal_139 /*883*/].f_146, 12))
			{
				if (Local_65.f_5.f_5[iLocal_139] != -1)
				{
					Local_65.f_5.f_5[iLocal_139] = -1;
		...
		if (iLocal_139 == 32)
		{
			if (unk_0xCE990E643CD9D0E5(iLocal_165, 1))
			{
				unk_0xBE20AB8238688965(&(Local_65.f_1), 0);
			}
			unk_0xBE20AB8238688965(&iLocal_165, 0);
			iLocal_139 = 0;
		}
	}
}
...
void func_32(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 0))
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 0);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 0))
	{
		unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 0);
	}
}
...
void func_33(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 4))
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 4);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 4))
	{
		unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 4);
	}
}
...
int func_34(var uParam0)
{
	...
	if (*uParam0 > 0)
	{
		...
		if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 2))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				if ((func_293(unk_0x460153A63B9477BC(), 1, 0) || func_292()) || func_291() != 0)
				{
					func_289(uParam0);
					unk_0xBE20AB8238688965(&(uParam0->f_1), 2);
					unk_0xD2459066EA58CE43(&(uParam0->f_1), 12);
					unk_0xD2459066EA58CE43(&iLocal_165, 11);
				}
			}
		}
		else if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				if (!func_293(unk_0x460153A63B9477BC(), 1, 0))
				{
					if (!func_292())
					{
						if (func_291() == 0)
						{
							unk_0xD2459066EA58CE43(&(uParam0->f_1), 2);
							unk_0xD2459066EA58CE43(&(uParam0->f_1), 1);
							unk_0xD2459066EA58CE43(&(uParam0->f_1), 0);
							unk_0xD2459066EA58CE43(&(uParam0->f_1), 3);
							unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 2);
							if (*uParam0 > 1)
							{
								*uParam0 = 1;
							}
		...
		iVar3 = unk_0x460153A63B9477BC();
		if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 5))
		{
			if (func_293(unk_0x460153A63B9477BC(), 1, 0) || func_292())
			{
				unk_0xBE20AB8238688965(&(Global_1590682[iVar3 /*883*/].f_146), 5);
				*uParam0 = 0;
				func_32(0);
				func_288(0);
				func_24(8, 0);
		...
		if (*uParam0 < 3)
		{
			if (Local_65.f_5.f_5[unk_0x460153A63B9477BC()] == -1)
			{
		...
		if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 9))
		{
	...
	switch (*uParam0)
	{
		case 0:
			iVar3 = unk_0x460153A63B9477BC();
			if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 13))
			{
				if (unk_0xCE990E643CD9D0E5(Global_2540384.f_1786, 6) || unk_0xCE990E643CD9D0E5(Global_2540384.f_1788, 31))
				{
					if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 0))
					{
						if (!func_286())
									...
									if (func_291() == 0)
									{
										if (func_164())
										{
											if (func_147(uParam0))
											{
												...
												if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 5))
												{
													unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 5);
												}
											}
										}
									}
				...
				if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 0))
				{
					if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 13))
					{
						if (!unk_0xDABD547F0DF2906C())
						{
							...
							unk_0xBE20AB8238688965(&(uParam0->f_1), 13);
						}
					}
					if (unk_0xCE990E643CD9D0E5(Global_1655114, 1))
					{
						iVar3 = unk_0x460153A63B9477BC();
						...
						if (iVar1 > -1)
						{
							...
							unk_0xD2459066EA58CE43(&iVar6, 1);
							unk_0xD2459066EA58CE43(&iVar6, 2);
							unk_0xD2459066EA58CE43(&iVar6, 3);
							unk_0xD2459066EA58CE43(&iVar6, 5);
							unk_0xD2459066EA58CE43(&iVar6, 6);
							*uParam0 = 1;
							func_143(1190, iVar6, -1, 1, 0);
							iLocal_331 = func_144(1167, -1, 0);
						}
			...
			else
			{
				if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 0))
				{
					unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 0);
					unk_0xD2459066EA58CE43(&(uParam0->f_1), 0);
					unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 2);
					unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 16);
					func_32(0);
				}
				if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 12))
				{
					if (Local_65.f_5.f_38[iVar3] == -1 && Local_65.f_5.f_5[iVar3] == -1)
					{
						unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 12);
					}
				}
				...
				{
					unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 13);
					func_18(&(uParam0->f_6));
				}
			}
			break;
		...
		case 1:
			...
			{
				if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 16))
				{
					unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 16);
				}
				if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 14))
				{
					unk_0xD2459066EA58CE43(&(uParam0->f_1), 14);
				}
				if (!unk_0x8F678487EEBD8CE4(uParam0->f_4))
				{
					if (iVar1 >= 0)
					{
						uParam0->f_4 = unk_0x6820C712C1DD618A(func_10(iVar1));
						unk_0x72BEFB9451782F60(uParam0->f_4, true);
						unk_0xE346A71235BB8065(uParam0->f_4, 9);
					}
				}
				if (iVar0 > -1 && func_141(iVar0, 1))
				{
					...
					if (unk_0x166E920FB00B2DBB(iVar4))
					{
						...
						{
							if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 4) && !unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 5))
							{
								func_140("FM_HTUT_GO", 0);
								unk_0xBE20AB8238688965(&(uParam0->f_1), 0);
							}
						}
					}
				}
			...
			else
			{
				...
				if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 2))
				{
					if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
					{
						if ((vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), func_10(iVar1)) < (15f * 15f) || (iVar0 == -1 && func_139(25f))) || func_138(1101004800, 1117126656))
						{
							if (unk_0x8F678487EEBD8CE4(uParam0->f_4))
							{
								unk_0x93370FA10F15BE44(&(uParam0->f_4));
							}
							if (iVar0 > -1 && func_141(iVar0, 1))
							{
								iVar4 = iVar0;
								if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 2))
								{
									if (unk_0x166E920FB00B2DBB(iVar4))
									{
										if (func_301(iVar4, 1, 1))
										{
											...
											{
												Var5 = { func_136(iVar4) };
												if (unk_0x78A7795C9C51946D(&Var5))
												{
							...
							unk_0xBE20AB8238688965(&(Global_1590682[iVar3 /*883*/].f_146), 2);
						}
					}
				}
				else
				{
					if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
					{
						if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 2))
						{
							if ((!unk_0xCE990E643CD9D0E5(iLocal_165, 18) && vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), func_10(iVar1)) > (35f * 35f)) || (unk_0xCE990E643CD9D0E5(iLocal_165, 18) && vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), func_10(iVar1)) > (90f * 90f)))
							{
								unk_0xD2459066EA58CE43(&(uParam0->f_1), 0);
								unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 2);
								unk_0xD2459066EA58CE43(&iLocal_165, 18);
							}
						}
					}
					if (unk_0xCE990E643CD9D0E5(Global_1655114, 15))
					{
			...
			if (iVar0 > -1 && func_141(iVar0, 1))
			{
					...
					if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 2))
					{
						if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 12))
						{
							if (func_20(&(uParam0->f_10)))
							{
								...
								{
									unk_0xBE20AB8238688965(&(Global_1590682[iVar3 /*883*/].f_146), 12);
									unk_0xBE20AB8238688965(&(Global_1590682[iVar3 /*883*/].f_146), 13);
									if (unk_0x8F678487EEBD8CE4(uParam0->f_4))
									{
										unk_0x93370FA10F15BE44(&(uParam0->f_4));
									}
								...
								else if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 2))
								{
									if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 12))
									{
										if (func_19(&(uParam0->f_10), (iLocal_64 - 60000), 0))
										{
											unk_0xBE20AB8238688965(&(uParam0->f_1), 12);
										}
										else if (!unk_0xCE990E643CD9D0E5(iLocal_165, 11))
										{
											if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 2))
											{
												if (!func_19(&(uParam0->f_10), (iLocal_64 - 420000), 0))
												{
													func_18(&(uParam0->f_10));
													func_17(&(uParam0->f_10), 0, 0);
													unk_0xBE20AB8238688965(&iLocal_165, 11);
													iLocal_64 = 180000;
												}
											}
										}
				...
				if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 12))
				{
					if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 2) && unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 2))
					{
						unk_0xD2459066EA58CE43(&(uParam0->f_1), 12);
						unk_0xD2459066EA58CE43(&iLocal_165, 11);
						unk_0xBE20AB8238688965(&(uParam0->f_1), 4);
						*uParam0 = 3;
						func_289(uParam0);
						func_17(&uLocal_159, 0, 0);
						unk_0xBE20AB8238688965(&(uParam0->f_1), 6);
						func_126(1);
						func_17(&uLocal_159, 0, 0);
						if (func_141(iVar0, 1))
						{
							if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 15))
							{
								if (func_125(iVar0, 0))
								{
					...
					else if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 2))
					{
						if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 2))
						{
							func_116();
			...
			{
				unk_0xBE20AB8238688965(&(uParam0->f_1), 4);
				unk_0xBE20AB8238688965(&(uParam0->f_1), 5);
				unk_0xBE20AB8238688965(&(uParam0->f_1), 6);
				func_289(uParam0);
				func_126(1);
				*uParam0 = 3;
		...
		case 3:
			...
			iVar0 = Local_65.f_5.f_5[iVar3];
			iVar1 = Local_65.f_5.f_38[iVar3];
			if (!unk_0xCE990E643CD9D0E5(iLocal_165, 8))
			{
				if (func_139(35f))
				{
					iVar2 = func_11(iVar1);
					...
					unk_0xBE20AB8238688965(&iLocal_165, 8);
				}
			}
			if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 16))
			{
			...
			if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 3))
			{
				if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 14))
				{
					if (!func_111())
					{
						if (iVar0 > -1 && func_141(iVar0, 1))
						{
							...
							if (unk_0x166E920FB00B2DBB(iVar4))
							{
								if (func_301(iVar4, 1, 1))
								{
									if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 16))
									{
										Var5 = { func_136(iVar4) };
										if (unk_0x78A7795C9C51946D(&Var5))
										{
										...
										unk_0xBE20AB8238688965(&(uParam0->f_1), 3);
									}
									else if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 14))
									{
										unk_0xBE20AB8238688965(&(uParam0->f_1), 14);
										func_130("FM_HTUT_HLC", iVar4, 1, 0);
									}
								}
							}
						}
						if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 3) && !unk_0xCE990E643CD9D0E5(uParam0->f_1, 14))
						{
							func_140("FM_HTUT_HLS", 0);
							unk_0xBE20AB8238688965(&(uParam0->f_1), 3);
							unk_0xBE20AB8238688965(&(Global_1590682[iVar3 /*883*/].f_146), 8);
						}
					}
				}
				else
	...
	if (*uParam0 > 0)
	{
		...
		if (!func_296())
		{
			if (func_86(uParam0))
			{
				...
				if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 15))
				{
					iVar0 = Local_65.f_5.f_5[unk_0x460153A63B9477BC()];
					if (func_125(iVar0, 1))
					{
					}
				}
				...
				if (unk_0xCE990E643CD9D0E5(iLocal_165, 12))
				{
					unk_0x873FC7B9D84F77F0(true);
					unk_0xD2459066EA58CE43(&iLocal_165, 12);
				}
				func_25();
				func_33(1);
				func_288(0);
...
void func_35(bool bParam0)
{
	...
	iVar1 = func_79(unk_0x460153A63B9477BC(), bParam0);
...
int func_45(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x25DDB354A40FFCDB())
	{
		if (func_40() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_144(func_39(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
bool func_60(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_262145.f_7687 == 1)
	{
		...
		if (func_62(unk_0x460153A63B9477BC(), 85))
		{
...
void func_67(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			func_68(unk_0x460153A63B9477BC(), 12);
...
void func_85(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 17))
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 17);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 17))
	{
		unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 17);
	}
}
...
int func_86(var uParam0)
{
	...
	iVar0 = Local_65.f_5.f_5[unk_0x460153A63B9477BC()];
	if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x59E2AD1A8ACEDA31() /*883*/].f_146, 2))
	{
		if (func_144(1167, -1, 0) > iLocal_331)
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 10);
			if (iVar0 > -1)
			{
				iVar1 = iVar0;
				if (unk_0x166E920FB00B2DBB(iVar1))
				{
					if (func_301(iVar1, 1, 1))
					{
						if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 2))
						{
							...
							unk_0xBE20AB8238688965(&Global_1655114, 14);
						}
					}
				}
			}
	...
	if (*uParam0 > 1)
	{
		if (func_88())
		{
			if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 8))
			{
				if (iVar0 > -1)
				{
					iVar1 = iVar0;
	...
	if ((unk_0xCE990E643CD9D0E5(uParam0->f_1, 7) && !unk_0xCE990E643CD9D0E5(uParam0->f_1, 10)) && !unk_0xCE990E643CD9D0E5(uParam0->f_1, 9))
	{
		...
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 11);
			return 1;
		}
	}
	return 0;
...
int func_87()
{
	...
	if (iVar0 > -1)
	{
		if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 11))
		{
			return 1;
		}
	}
...
int func_88()
{
	...
	if (iVar0 > -1)
	{
		if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar0 /*883*/].f_146, 10))
		{
			return 1;
		}
	}
...
void func_89(var uParam0)
{
	...
	if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 6))
	{
		if (!unk_0x8F678487EEBD8CE4(uParam0->f_5))
		{
			if (!func_111())
			{
				iVar0 = Local_65.f_5.f_38[unk_0x460153A63B9477BC()];
				if (iVar0 > -1)
				{
					Var1 = { func_91(iVar0) };
					if (!func_90(Var1, 0f, 0f, 0f, 0))
					{
						if (!unk_0x8F678487EEBD8CE4(uParam0->f_5))
						{
							unk_0x42F1820231D40974(1);
							uParam0->f_5 = unk_0x6820C712C1DD618A(Var1);
							unk_0xE7B8403ABCA0391D(uParam0->f_5, 52);
							unk_0xFA81E0FBD7F5ACA0(uParam0->f_5, 1f);
							unk_0xE346A71235BB8065(uParam0->f_5, 7);
							unk_0x72BEFB9451782F60(uParam0->f_5, true);
						}
					}
				}
			}
...
bool func_90(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
void func_92(var uParam0)
{
	...
	{
		case 0:
			if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 4))
			{
			...
			if (!unk_0xDABD547F0DF2906C())
			{
				if (!unk_0xF0C12886E5C1B20E())
				{
					if (func_94())
					{
						...
						if (!unk_0xCE990E643CD9D0E5(iVar0, 1))
						{
				...
				if (!unk_0xF0C12886E5C1B20E())
				{
					if (func_94())
					{
						if (func_139(1089470464))
						{
							...
							else if (!unk_0xCE990E643CD9D0E5(iLocal_165, 7) || unk_0xB9C0D9B37277621D(0, 37))
							{
								func_146("FM_PASS_DBL", -1);
								unk_0xBE20AB8238688965(&iLocal_165, 7);
							}
						}
					}
				}
...
int func_94()
{
	if (((((((((((((((!func_301(unk_0x460153A63B9477BC(), 1, 1) || unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7())) || !unk_0x4DC4117F94CD5B84(unk_0x460153A63B9477BC())) || func_100(8, -1)) || func_100(15, -1)) || func_99()) || func_100(3, -1)) || unk_0xDABD547F0DF2906C()) || func_293(unk_0x460153A63B9477BC(), 1, 0)) || func_292()) || func_98()) || func_97()) || func_96()) || unk_0xF0C12886E5C1B20E()) || unk_0xD0E70037A973A810()) || func_95())
	{
		return 0;
	}
	return 1;
...
bool func_95()
{
	return unk_0xCE990E643CD9D0E5(Global_2540384.f_1792, 12);
}
...
void func_101(var uParam0)
{
	...
	if (func_88())
	{
		if (*uParam0 <= 1)
		{
			if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 8))
			{
				unk_0xBE20AB8238688965(&(uParam0->f_1), 8);
			}
		}
	}
	if (func_64())
	{
		...
		{
			if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 2))
			{
				if (iLocal_331 > -1)
				{
	...
	if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 7))
	{
		if (!func_109())
		{
			...
			{
				if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 2) && ((unk_0x7B70881748D166CD(joaat("am_hold_up")) == 0 && !unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 16)) && !func_108()))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_1), 9);
					unk_0xBE20AB8238688965(&(uParam0->f_1), 7);
				}
				else if (*uParam0 >= 1)
				{
					if ((!func_111() && !unk_0xCE990E643CD9D0E5(uParam0->f_1, 8)) && unk_0x7B70881748D166CD(joaat("am_hold_up")) == 0)
					{
						unk_0xBE20AB8238688965(&(uParam0->f_1), 9);
						unk_0xBE20AB8238688965(&(uParam0->f_1), 7);
					}
	...
	else if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 10))
	{
		if (func_109())
		{
			if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 7))
			{
				unk_0xD2459066EA58CE43(&(uParam0->f_1), 7);
				unk_0xD2459066EA58CE43(&(uParam0->f_1), 9);
				unk_0xD2459066EA58CE43(&(uParam0->f_1), 10);
			}
		}
	}
	if (unk_0xCE990E643CD9D0E5(uParam0->f_1, 9))
	{
		if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 10))
		{
			if (*uParam0 > 1)
			{
				if (func_139(10f))
				{
					iVar2 = unk_0xCCF088254BE59A9B(func_107(), -1, 0);
					if (iVar2 != func_106())
					{
						unk_0xD2459066EA58CE43(&(uParam0->f_1), 9);
						unk_0xBE20AB8238688965(&(uParam0->f_1), 10);
						func_103();
					}
				}
			}
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_165, 12))
	{
		if (func_111())
		{
			...
			unk_0xBE20AB8238688965(&iLocal_165, 12);
		}
	}
	else if (!func_111())
	{
...
void func_102(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_2540384.f_1792, 21))
		{
			unk_0xBE20AB8238688965(&(Global_2540384.f_1792), 21);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_2540384.f_1792, 21))
	{
		unk_0xD2459066EA58CE43(&(Global_2540384.f_1792), 21);
	}
}
...
void func_103()
{
	...
	if (Local_65.f_5.f_38[unk_0x460153A63B9477BC()] > -1)
	{
		iVar0 = func_11(Local_65.f_5.f_38[unk_0x460153A63B9477BC()]);
		func_104(iVar0, 1, func_105(unk_0xCCF088254BE59A9B(func_107(), -1, 0)));
	}
}
...
bool func_108()
{
	return unk_0xCE990E643CD9D0E5(Global_2540384.f_1792, 21);
}
...
int func_109()
{
	...
	iVar0 = Local_65.f_5.f_38[unk_0x460153A63B9477BC()];
	iVar1 = func_11(iVar0);
	if (unk_0xCE990E643CD9D0E5(Global_2425698.f_65, iVar1))
	{
		return 1;
	}
	if (iVar0 > -1)
...
void func_110(var uParam0)
{
	...
	if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 1) && !unk_0xCE990E643CD9D0E5(Global_1590682[iVar1 /*883*/].f_146, 8))
	{
		if (iVar0 > -1)
		{
			if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar1 /*883*/].f_146, 6))
			{
				unk_0xD2459066EA58CE43(&(Global_1590682[iVar1 /*883*/].f_146), 6);
			}
			if (!func_141(iVar0, 1))
			{
				unk_0xD2459066EA58CE43(&(uParam0->f_1), 0);
	...
	else
	{
		if (*uParam0 < 3)
		{
			if (!unk_0xCE990E643CD9D0E5(Global_1590682[iVar1 /*883*/].f_146, 6))
			{
				unk_0xBE20AB8238688965(&(Global_1590682[iVar1 /*883*/].f_146), 6);
			}
		}
		else if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar1 /*883*/].f_146, 6))
		{
			unk_0xD2459066EA58CE43(&(Global_1590682[iVar1 /*883*/].f_146), 6);
		}
		if (iVar0 > -1)
...
int func_111()
{
	...
	Var1 = { func_91(Local_65.f_5.f_38[unk_0x460153A63B9477BC()]) };
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!func_90(Var1, 0f, 0f, 0f, 0))
		{
			...
			if (iVar0 != 0)
			{
				if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), Var1, true) < 25f)
				{
					return 1;
				}
			}
...
void func_112(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_20(&iParam1))
	{
		iVar0 = (iParam0 - unk_0x624736CA66E14161(unk_0x6CAAB7E78B5D978A(), iParam1));
		if (iVar0 >= 0)
		{
...
void func_116()
{
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_165, 14))
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_165, 15))
		{
			iVar0 = 0;
			while (iVar0 <= 31)
			{
				...
				if (func_301(iVar1, 1, 1))
				{
					if (iVar1 != unk_0x460153A63B9477BC())
					{
						if (unk_0x56B60AE958412839(unk_0x460153A63B9477BC(), iVar1))
						{
							if (func_124(iVar1))
							{
								unk_0xBE20AB8238688965(&iLocal_165, 15);
							}
						}
					}
				}
		...
		else if (func_117(0, 1, 1, 1))
		{
			...
			unk_0xBE20AB8238688965(&iLocal_165, 14);
		}
	}
}
...
{
	return unk_0x8F678487EEBD8CE4(Global_2416085[iParam0]);
}
...
int func_125(int iParam0, int iParam1)
{
	...
	if (iParam0 > -1)
	{
		...
		if (unk_0x166E920FB00B2DBB(iVar0))
		{
			if (func_301(iVar0, 0, 1))
			{
				unk_0x46E5E2D7B31743C8(unk_0x9B0761B4C3EB8BC7(), iVar0, iParam1);
				return 1;
			}
		}
	}
...
void func_126(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 7))
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 7);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 7))
	{
		unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 7);
	}
}
...
{
	func_131(sParam0, unk_0x72C1D3A1AB8CAA5B(iParam1), bParam3, 1);
}
		...
		if (unk_0x6E0C5E7AAF8B6214(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (iVar1 > -1 && func_141(iVar1, 1))
			{
				...
				if (unk_0x166E920FB00B2DBB(iVar3))
				{
					...
					{
						iVar4 = unk_0x1FA7B77001D60F9D(iVar3);
						if (!unk_0x5AEB5DDFFAD43CA5(iVar4))
						{
							if (unk_0x6E0C5E7AAF8B6214(iVar4))
							{
								if (unk_0xA5D5B1042E8F47BD(iVar4, 0) == iVar2)
								{
									return 1;
								}
							}
...
int func_138(float fParam0, float fParam1)
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x6E0C5E7AAF8B6214(unk_0x9B0761B4C3EB8BC7()))
		{
			if (unk_0xF3A639BEE7AADF55(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)) > fParam0)
			{
				if (func_139(fParam1))
				{
					if (!unk_0xCE990E643CD9D0E5(iLocal_165, 18))
					{
						unk_0xBE20AB8238688965(&iLocal_165, 18);
					}
					return 1;
				}
			}
...
int func_139(float fParam0)
{
	...
	if (iVar0 > -1)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (vdist2(Var2, Var1) < (fParam0 * fParam0))
			{
				return 1;
			}
		}
...
int func_141(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_146, 4))
		{
			return 0;
		}
	}
	if (unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_146, 8))
	{
		return 0;
	}
	if (unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_146, 5))
	{
		return 0;
	}
	if (unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_146, 12))
	{
		return 0;
	}
	return 1;
...
void func_142()
{
	if (!unk_0xCE990E643CD9D0E5(iLocal_165, 16))
	{
		if (func_117(0, 1, 1, 1))
		{
			func_146("FM_IHELP_INV", 10000);
			unk_0xBE20AB8238688965(&iLocal_165, 16);
		}
	}
	if (!unk_0xCE990E643CD9D0E5(iLocal_165, 6))
	{
		if (unk_0xCE990E643CD9D0E5(iLocal_165, 13))
		{
			...
			else if (func_19(&uLocal_163, 15000, 0))
			{
				if (func_117(0, 1, 1, 1))
				{
					unk_0xBE20AB8238688965(&iLocal_165, 6);
				}
			}
		}
	}
		...
		case 0:
			...
			else if (func_19(&(uParam0->f_14), 7000, 0))
			{
				if (func_162())
				{
					...
					else if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 16))
					{
						func_140("FM_IHELP_LCP", 0);
						unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 16);
		...
		case 1:
			...
			else if (func_162())
			{
				if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
				{
					...
					if ((!func_20(&uLocal_332) || func_19(&uLocal_332, 20000, 0)) || unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 16))
					{
						if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 16))
						{
							unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 16);
...
int func_148(int iParam0, int iParam1)
{
	...
	func_149(iVar0);
	Global_2395345 = unk_0x578C4EF320340AF7() + 1500;
	return 1;
}
...
void func_149(int iParam0)
{
	...
	{
		unk_0xB6B2734989D2EBCB(Global_2394180[iParam0 /*46*/].f_26);
	}
	iVar0 = iParam0;
	iVar1 = iVar0 + 1;
...
void func_151(int iParam0)
{
	...
	if (unk_0x25DDB354A40FFCDB())
	{
		Global_2394180[iParam0 /*46*/].f_38 = unk_0x6CAAB7E78B5D978A();
	}
}
...
void func_155(int iParam0, int iParam1, bool bParam2, char* sParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8, var uParam9, var uParam10)
{
	...
	if (bParam2)
	{
		iVar0 = unk_0xF1110FE23C67293A(iParam1);
	}
	else
	{
		iVar1 = iParam1;
	...
	Global_2394180[iVar4 /*46*/].f_38 = unk_0x6CAAB7E78B5D978A();
	...
	if (unk_0xC6C08C02733D02C8())
	{
		if (bParam2)
		{
			...
			{
				Var7 = { func_136(iVar0) };
				iVar8 = unk_0x984A66C012D8ADA4(&Var7);
				if (iVar8 != -1)
				{
...
int func_157()
{
	...
	StringCopy(&cVar0, "", 24);
	cVar0 = { func_159() };
	if (unk_0x7BCC91F3C1CF24E8(&cVar0) || unk_0xF005CCA4263DF67F(".", &cVar0))
	{
		return -1;
	}
	iVar1 = 0;
...
char* func_158(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2589152[iParam0 /*3*/][func_51(iParam1)];
	return unk_0x277E7CF64BB97AD2(uVar0, -1);
}
...
struct<6> func_159()
{
	...
	if (unk_0x7BCC91F3C1CF24E8(&(Global_1669820.f_10)))
	{
		...
		else
		{
			...
			while (iVar1 < 1218)
			{
				if ((Global_794709.f_4[iVar1 /*88*/].f_65 == 0 && Global_794709.f_4[iVar1 /*88*/].f_68 == 1) && unk_0xCE990E643CD9D0E5(Global_794709.f_4[iVar1 /*88*/].f_76, 13))
				{
...
bool func_164()
{
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_165, 2))
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_165, 10))
		{
			if (func_284(1103626240))
			{
				unk_0xBE20AB8238688965(&iLocal_165, 9);
			}
			unk_0xBE20AB8238688965(&iLocal_165, 10);
		}
		else if (!unk_0xCE990E643CD9D0E5(iLocal_165, 9))
		{
			if (!unk_0xCE990E643CD9D0E5(iLocal_165, 3))
			{
				if (!unk_0xCE990E643CD9D0E5(iLocal_165, 5) || (unk_0xCE990E643CD9D0E5(iLocal_165, 5) && func_19(&uLocal_161, 60000, 0)))
				{
					if (func_280())
					{
						if (!unk_0xCE990E643CD9D0E5(iLocal_165, 4))
						{
							func_274(19, 3, 0);
							func_273(&uLocal_166, 1, 0, "Lamar", 0, 1);
							unk_0xBE20AB8238688965(&iLocal_165, 4);
						}
						else
						{
							...
							{
								unk_0xBE20AB8238688965(&iLocal_165, 3);
								unk_0xD2459066EA58CE43(&iLocal_165, 5);
							}
						}
					}
				}
			...
			else if (!func_286())
			{
				if (func_268())
				{
					unk_0xBE20AB8238688965(&iLocal_165, 2);
					func_267(0);
				}
				else
				{
					...
					unk_0xD2459066EA58CE43(&iLocal_165, 3);
					unk_0xBE20AB8238688965(&iLocal_165, 5);
				}
			}
		}
		else if (func_280())
	...
	return unk_0xCE990E643CD9D0E5(iLocal_165, 2);
}
...
int func_182(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19865)
	{
		if (Global_19681.f_1 == 6)
		{
			...
			func_187(1);
			func_191(Global_19662, "DISPLAY_VIEW", 1f, to_float(Global_19661), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (Global_2462245)
							{
								if (iVar1 == 14)
								{
									func_188(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_188(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_188(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_188(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_188(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_188(Global_19662, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7558[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[iVar0] = 1;
						}
					}
...
void func_200()
{
	...
	{
		if (func_203(Global_111858.f_2359.f_539.f_4321) != unk_0x36FE6D3220816ADA(unk_0x9B0761B4C3EB8BC7()))
		{
			iVar0 = func_202(unk_0x9B0761B4C3EB8BC7());
...
void func_213(int iParam0)
{
	...
	func_214(&(Global_1389221[iVar2 /*5*/]));
...
void func_267(bool bParam0)
{
	if (bParam0)
	{
		unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 28);
	}
	else
	{
		unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 28);
	}
}
...
int func_280()
{
	...
	if (func_281(unk_0x460153A63B9477BC(), 0))
	{
		return 0;
	}
	return 1;
		...
		while (iVar0 < 32)
		{
			...
			if (func_301(iVar1, 1, 1))
			{
				if (iVar1 != unk_0x460153A63B9477BC())
				{
					if (func_285(iVar1))
					{
						if (vdist2(Var2, unk_0x3E4D3CCC220BDFB1(unk_0x1FA7B77001D60F9D(iVar1), true)) < (fParam0 * fParam0))
						{
							return 1;
						}
					}
...
{
	return unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_146, 28);
}
...
void func_287()
{
	...
	Var0.x = 356132005;
	Var0.f_1 = unk_0x460153A63B9477BC();
	Var0.f_2 = unk_0xD3137A576BE9EC5C();
	unk_0xB802750B43D4047C(1, &Var0, 3, func_4(1, 1));
}
...
void func_288(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 3))
		{
			unk_0xBE20AB8238688965(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 3);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146, 3))
	{
		unk_0xD2459066EA58CE43(&(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_146), 3);
	}
}
...
void func_299()
{
	unk_0x42F1820231D40974(0);
	func_25();
	func_24(8, 0);
	unk_0x873FC7B9D84F77F0(true);
	if (func_285(unk_0x460153A63B9477BC()))
	{
		func_267(0);
	}
	func_300();
...
int func_302()
{
	...
	if (func_303() != 0)
	{
		if (unk_0x7B70881748D166CD(func_303()) == 0)
		{
			return 1;
		}
	}
...
void func_313(struct<21> Param0)
{
	...
	func_315(0, -1, 0);
	unk_0x97D2F2E2C92FD519(&Local_65, 79);
	unk_0xBB96A3ECD45D0317(&iLocal_140, 33);
	unk_0x3A396632EB359434(0);
	if (!func_314())
	{
		func_299();
	}
	unk_0xD2459066EA58CE43(&Global_1655114, 1);
	unk_0xD2459066EA58CE43(&Global_1655114, 15);
	unk_0xD2459066EA58CE43(&Global_1655114, 14);
	func_24(8, 1);
	if (!func_285(unk_0x460153A63B9477BC()))
	{
		func_267(1);
