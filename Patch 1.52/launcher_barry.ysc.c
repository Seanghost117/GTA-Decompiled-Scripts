...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 2 || Var0 == 3)
		{
			...
			{
				unk_0x8289CFFF7D89F1C7("Barry", 1, 0, 0, 0);
			}
		}
		else if (Var0 == 4)
		{
		...
		if (func_205(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_203(&Var0, unk_0x3E4D3CCC220BDFB1(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_203(&Var0, unk_0x3E4D3CCC220BDFB1(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_188(&uLocal_58, unk_0x3E4D3CCC220BDFB1(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_187(Var0))
		{
			if ((unk_0x578C4EF320340AF7() - iLocal_54) > 5000)
			{
				iVar2 = 1;
...
void func_188(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3)
{
	...
	{
		case 0:
			if ((unk_0x578C4EF320340AF7() - iLocal_224) > 5000)
			{
				*uParam0 = 1;
			}
			break;
		...
		case 1:
			if (func_201(unk_0x9B0761B4C3EB8BC7(), Param1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_201(unk_0x9B0761B4C3EB8BC7(), Param1, 1) >= 25f)
			{
				func_143();
				*uParam0 = 0;
			}
...
int func_192()
{
	...
	if (func_193(unk_0x460153A63B9477BC()))
	{
		return 0;
	}
...
void func_202(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	...
	uParam1.f_7 = unk_0x344C570D6F8700DF(0, uParam1.f_6);
	unk_0x9DC06E2A59C5AEBB(&iVar0);
	unk_0x756D74A3EF0AB788(0, iParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0, 0, 0, 0);
	unk_0x756D74A3EF0AB788(0, iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 1 | iVar1, 0, 0, 0, 0);
	unk_0x19F29730874AD6F1(iVar0);
	unk_0x9B6EC2CECE1010EF(iParam0->f_28[iParam10], iVar0);
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(unk_0x9B0761B4C3EB8BC7()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0x578C4EF320340AF7() - iParam0->f_60) > iParam6) && func_201(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_206(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (!unk_0x7BCC91F3C1CF24E8(sParam1))
		{
			...
			{
				if (func_201(unk_0x9B0761B4C3EB8BC7(), Param2, 1) <= 100f)
				{
					func_209(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_201(unk_0x9B0761B4C3EB8BC7(), Param2, 1) > 120f)
				{
					func_211(iParam0);
				}
			}
...
void func_252()
{
	...
	if (func_205(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_253(unk_0x9B0761B4C3EB8BC7(), Var0, fVar1))
		{
			func_150();
		}
	}
...
void func_254(int iParam0)
{
	if (func_205(iParam0->f_28[0]))
	{
		unk_0x8342E6CB98CD545C(iParam0->f_28[0], 64, true);
		unk_0x8342E6CB98CD545C(iParam0->f_28[0], 249, true);
...
void func_255(var uParam0)
{
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		...
		while (iVar0 <= 5)
		{
			if (func_205(uParam0->f_41[iVar0]))
			{
				unk_0x6A8F948698B360B4(uParam0->f_41[iVar0], false);
			}
			iVar0++;
		}
		...
		{
			unk_0x6A8F948698B360B4(uParam0->f_28[0], false);
			unk_0xF3FE01181D2D2479(uParam0->f_28[0], 100, 500, 0, 1, 1, 0);
			unk_0x8B18A80E8EB15510(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), 10000f, -1, 0, 0);
		}
		func_220(&(uParam0->f_41[2]));
	}
}
...
int func_262(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			while (iVar7 <= (iVar0 - 1))
			{
				unk_0x78FCB2E22C41B9D5(iVar0[iVar7]);
				iVar7++;
			}
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				if (unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
				{
					unk_0xC0EF63F41F0AB614(uParam0->f_35[0], 0);
					unk_0x410A1E7AD7D5C774(iVar0[0], true);
					unk_0x81ADFFC4F7331618(uParam0->f_35[0], "WEED STASH VEHICLE");
					...
					unk_0x1515637D39F697C4(uParam0->f_35[0], 1);
				}
				else
				{
					bVar8 = false;
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_41[0]))
			{
				...
				if (unk_0xAE06B9E39EBDE049(uParam0->f_41[0]) && unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
				{
					unk_0xF8A652CE310FFC53(uParam0->f_41[0], uParam0->f_35[0], 0, Var3, Var4, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar8 = false;
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[1]))
			{
				...
				unk_0x38633C69DE516059(uParam0->f_35[1], 39, 43);
			}
			if (bVar8)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			while (iVar7 <= (iVar0 - 1))
			{
				unk_0x74528AC0906CBABE(iVar0[iVar7]);
				iVar7++;
			}
			return 1;
			break;
...
void func_263(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_220(iParam0);
...
void func_264(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_265(iParam0);
...
int func_267(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			while (iVar6 <= (iVar0 - 1))
			{
				unk_0x78FCB2E22C41B9D5(iVar0[iVar6]);
				iVar6++;
			}
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				unk_0xF242CEB863060ABC(uParam0->f_35[0], 2, true);
				unk_0xF242CEB863060ABC(uParam0->f_35[0], 3, true);
			}
			else
			{
				bVar7 = false;
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_41[0]))
			{
				...
				if (unk_0xAE06B9E39EBDE049(uParam0->f_41[0]) && unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
				{
					unk_0xF8A652CE310FFC53(uParam0->f_41[0], uParam0->f_35[0], 0, Var2, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar7 = false;
		...
		case 3:
			if (func_205(uParam0->f_35[1]))
			{
				if (func_205(uParam0->f_28[0]))
				{
					unk_0xD78F28ADCAD8C88C(uParam0->f_28[0], 1);
					unk_0x13A4BD6CC31F7B8F(uParam0->f_28[0], uParam0->f_35[1], -1);
					unk_0xEB879F62C8DFA9E2(uParam0->f_28[0], joaat("weapon_pistol"), 100, true);
				}
				if (func_205(uParam0->f_28[1]))
				{
					unk_0xD78F28ADCAD8C88C(uParam0->f_28[1], 1);
					unk_0x13A4BD6CC31F7B8F(uParam0->f_28[1], uParam0->f_35[1], 0);
					unk_0xEB879F62C8DFA9E2(uParam0->f_28[1], joaat("weapon_pistol"), 100, true);
				}
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
				unk_0x74528AC0906CBABE(iVar0[iVar6]);
				iVar6++;
			}
			return 1;
			break;
...
void func_268(int iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_269(iParam0);
...
int func_271(int iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_272(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*iParam0, 0))
...
int func_272(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				unk_0x03D382CB0B44E2FC(uParam0->f_28[0], Var1, 1, false, 0, 1);
...
void func_277(int iParam0, int iParam1)
{
	...
	fVar1 = 23.45f;
	func_263(iParam0, iParam1, Var0, fVar1);
}
...
int func_279(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[0]))
			{
				if (func_271(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER: BARRY 1", 1))
				{
					unk_0x78024EFD31A7FAD4(uParam0->f_28[0], 1, 0, 0, false);
				}
				else
