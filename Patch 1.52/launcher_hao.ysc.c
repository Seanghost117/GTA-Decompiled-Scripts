...
void __EntryFunction__()
{
	...
	iVar2[0] = 24;
	if (!func_256(&iVar2, &Var0, Var1, 1f))
	{
		func_255();
	...
	iLocal_54 = unk_0xC08A186299DFDA0A(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_199(-72.323f, -1258.643f, 28.648f, unk_0x3E4D3CCC220BDFB1(Var0.f_35[0], true), 1056964608))
			{
		...
		func_195(Var0);
		func_188(&iLocal_53, &(Var0.f_9), Var1);
		func_183(&Var0, Var1, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_183(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(uParam0->f_28[0])) && !func_146()) && (unk_0x578C4EF320340AF7() - uParam0->f_60) > iParam6) && func_187(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_187(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
int func_237(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_244(&iVar0) || !unk_0xC614DDE265D18415(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 0, 2, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 1, 1, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 2, 1, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 3, 1, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 4, 1, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 6, 0, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 7, 2, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 10, 0, false);
				unk_0x8DFB45E7317A7ED7(uParam0->f_35[0], 23, 20, false);
				unk_0x136FC3422AADC5DD(uParam0->f_35[0], 18, true);
				unk_0x136FC3422AADC5DD(uParam0->f_35[0], 17, true);
				unk_0x136FC3422AADC5DD(uParam0->f_35[0], 22, true);
		...
		case 3:
			...
			{
				iVar5 = unk_0x0724529FC474C803(uParam0->f_35[0], "chassis_dummy");
				Var6 = { unk_0xBB88AFC535E469A3(uParam0->f_35[0], iVar5) };
				iVar2 = unk_0xF341A134A5B8D4F6(Var6, unk_0x090239DEAF625B17(uParam0->f_35[0], 2), 2);
				unk_0x81493F39713559B1(iVar2, true);
				unk_0x882281B10B0A5932(iVar2, false);
				unk_0xDFDB9C533700BC17(uParam0->f_28[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_239(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_240(iParam0);
...
int func_241(int iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_242(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*iParam0, 0))
...
int func_242(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_256(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_257((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_257((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_257(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_258(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_258(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_259(int iParam0, bool bParam1)
{
	...
	unk_0x1E337EE68290597A(iLocal_54, 0);
	if (bParam1)
	{
		func_195(*iParam0);
	}
