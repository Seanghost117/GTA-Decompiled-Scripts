...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0xB3A5FF195E1A8192(joaat("weapon_sniperrifle"));
	iLocal_55 = unk_0x85CB1D50AB0A0A5B(joaat("component_at_scope_large"));
	iLocal_56 = unk_0x85CB1D50AB0A0A5B(joaat("component_at_ar_supp_02"));
	...
	unk_0x555EE41D7C7078E6(Var1, 3f, 1, 0, 0, false);
	while (true)
	{
		wait(0);
		if (!func_197(&Var0, 1))
		...
		func_196(Var0);
		func_189(&iLocal_59, &(Var0.f_9), Var1);
		if (Var0 == 25)
		{
			func_184(&Var0, Var1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (Var0 == 25)
		{
			if (vdist2(Var1, Var3) < (10f * 10f))
			{
				unk_0x94D1A5176CE89859(unk_0x9B0761B4C3EB8BC7(), 1f);
			}
			else
			{
				unk_0x94D1A5176CE89859(unk_0x9B0761B4C3EB8BC7(), 3f);
			}
		}
		if (func_169(&Var0, 0) && unk_0x0D77CDCF403AEBD2((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x578C4EF320340AF7() - iParam0->f_60) > iParam6) && func_188(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_198(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_199(iParam2) && !unk_0x04055E36623F131B(iParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						unk_0xD08E9EAF091A1AAB(iParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_199(iParam2) || unk_0x04055E36623F131B(iParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x756D74A3EF0AB788(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xAE06B9E39EBDE049(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_206(unk_0x9B0761B4C3EB8BC7(), uParam0->f_35[iVar0]))
							{
...
int func_209(int iParam0, float fParam1)
{
	...
	{
		if (func_220(iParam0) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iParam0))
		{
...
{
	return func_211(iParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}
...
bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_212(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x578C4EF320340AF7() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_212(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_217(unk_0x3E4D3CCC220BDFB1(iParam1, true) - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	...
	{
		Var1 = { func_217(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_216(Var1, Var0);
...
float func_216(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_224(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_217(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_243(&iVar0) || !unk_0xC614DDE265D18415("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				iLocal_58 = unk_0xA3E0B448E324D459(joaat("weapon_sniperrifle"), 0, Local_57, 0, 1065353216, 0, 0, 1);
				unk_0xC53D054996356072(iLocal_58, joaat("component_at_scope_large"));
				unk_0xC53D054996356072(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			if (unk_0x8865B8E834909D76(Local_57, 1f, iLocal_54, 0))
			{
				unk_0xC82085403E46A869(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	func_238(iParam0, iLocal_53, Param1, fParam2);
	if (unk_0xAE06B9E39EBDE049(*iParam0))
	{
...
void func_238(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_239(iParam0);
...
int func_240(int iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_241(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*iParam0, 0))
...
int func_241(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_244(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_243(&iVar0) || !func_245(&(uParam0->f_48))) || !unk_0xC614DDE265D18415("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
