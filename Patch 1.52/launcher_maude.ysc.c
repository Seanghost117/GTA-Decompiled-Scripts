...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_192(Var0);
		func_184(&iLocal_53, &(Var0.f_9), Var1);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_196(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_196(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_208(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x578C4EF320340AF7() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_208(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_213(unk_0x3E4D3CCC220BDFB1(iParam1, true) - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	...
	{
		Var1 = { func_213(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_212(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_220(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_213(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_233(int iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_234(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*iParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*iParam0, 0))
...
int func_234(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_236(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_199(iParam0);
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_52 = unk_0xC08A186299DFDA0A(Var0, Var1, 0, 1, 1, 1);
...
int func_250(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_251(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_252(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_252(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
