...
void __EntryFunction__()
{
	...
	iVar2[0] = 35;
	if (!func_243(&iVar2, &Var0, Var1, 1f))
	{
		func_242();
	...
	func_231(&Var0);
	iLocal_52 = unk_0xC08A186299DFDA0A(Var1 - Vector(20f, 20f, 20f), Var1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_192(Var0);
		func_184(&iLocal_51, &(Var0.f_9), Var1);
		if (func_169(&Var0, 0))
		{
			if (Var0 == 35)
			{
...
int func_243(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_244((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_244((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_244(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_245(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_245(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
