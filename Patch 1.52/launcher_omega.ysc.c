...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_202(Var0);
		func_195(&iLocal_53, &(Var0.f_9), Var1);
		if (Var0 == 44)
		{
			func_187(&Var0, Var1, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_54);
			func_186();
		}
		else if (Var0 == 45)
		{
			func_187(&Var0, Var1, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_55);
			func_184(&Var0);
		}
		if (func_169(&Var0, 0))
		{
...
void func_184(int iParam0)
{
	...
	if ((unk_0x578C4EF320340AF7() - iLocal_58) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0xA38BFCB05DBE439D(iParam0->f_28[0]))
		{
			if (func_127(unk_0x9B0761B4C3EB8BC7()) && !func_185(unk_0x9B0761B4C3EB8BC7(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0x3E4D3CCC220BDFB1(iParam0->f_28[0], true) };
				Var1 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
				fVar3 = (Var1.x - Var0.x);
				fVar4 = (Var1.f_1 - Var0.f_1);
				if (fVar4 != 0f)
				{
					fVar2 = unk_0x8C91FF3D82E6FB27(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				unk_0xE922BAA80E8F9324(iParam0->f_28[0], fVar2);
			}
		}
...
void func_186()
{
	...
	unk_0x830F007E19C63E14(iLocal_56, "SET_COLOUR");
	...
	unk_0x830F007E19C63E14(iLocal_56, "SET_DISTANCE");
	unk_0x49B9B8101B158AEE(10f);
	unk_0xE1FDD153F5858534();
	unk_0xCA1F114B668562E5(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0xE6A03BA84586E67B(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x578C4EF320340AF7() - iLocal_58) > 1250)
	{
		unk_0x057194D526464DC0(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, 0);
		iLocal_58 = unk_0x578C4EF320340AF7();
	}
}

int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && func_194(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f)
				{
			...
			if (func_194(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
void func_204(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !unk_0x04055E36623F131B(iParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						unk_0xD08E9EAF091A1AAB(iParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || unk_0x04055E36623F131B(iParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x756D74A3EF0AB788(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xAE06B9E39EBDE049(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(unk_0x9B0761B4C3EB8BC7(), uParam0->f_35[iVar0]))
							{
...
int func_215(int iParam0, float fParam1)
{
	...
	{
		if (func_226(iParam0) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iParam0))
		{
...
{
	return func_217(iParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}
...
int func_218(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(unk_0x3E4D3CCC220BDFB1(iParam1, true) - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	...
	{
		Var1 = { func_223(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_222(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_230(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_223(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_242()
{
	iLocal_56 = unk_0x5DEA4192B46CB99B("digiscanner");
	while (!unk_0x95EF219D38B20CFF(iLocal_56))
	{
		wait(0);
	}
	...
	if (unk_0xA9A353D835A7867C("digiscanner"))
	{
		iLocal_57 = unk_0x2BC38EC678978375("digiscanner");
	}
	iLocal_59 = unk_0x5E54B0823F46079E();
	iLocal_58 = unk_0x578C4EF320340AF7();
}
...
void func_245(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_246(iParam0);
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if ((func_127(uParam0->f_28[0]) && unk_0xAE06B9E39EBDE049(uParam0->f_41[0])) && unk_0xAE06B9E39EBDE049(uParam0->f_41[1]))
			{
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0xAE06B9E39EBDE049(iParam0->f_41[1]))
		{
			unk_0x95178967C65CAD85(&(iParam0->f_41[1]));
		}
