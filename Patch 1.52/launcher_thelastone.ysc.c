...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_198(Var0);
		func_191(&iLocal_53, &uLocal_54, &(Var0.f_9), Var1, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_184(&Var0, Var1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_184(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(uParam0->f_28[0])) && (unk_0x578C4EF320340AF7() - uParam0->f_60) > iParam6) && func_190(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_185(sParam3))
		{
			...
			{
				if (func_190(unk_0x9B0761B4C3EB8BC7(), Param1, 1) >= 20f)
				{
					func_144();
				}
			}
...
void func_191(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (!unk_0x7BCC91F3C1CF24E8(sParam2))
		{
			...
			{
				if (func_190(unk_0x9B0761B4C3EB8BC7(), Param3, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_190(unk_0x9B0761B4C3EB8BC7(), Param4, 1);
					fVar1 = func_190(unk_0x9B0761B4C3EB8BC7(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xA389D93286499741();
								unk_0xDDBEE500B2E6E7FA(sParam2, 5, 8);
								func_192(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xA389D93286499741();
							unk_0xDDBEE500B2E6E7FA(sParam2, 6, 8);
							func_192(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_190(unk_0x9B0761B4C3EB8BC7(), Param3, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_241(&iVar0) || !unk_0xC614DDE265D18415("rcmlastone1")) || !unk_0x1EC187FFFA21C230(joaat("weapon_pumpshotgun"))) || !unk_0x1EC187FFFA21C230(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0xB3116B49FE00E2F1(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
...
int func_252(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_253(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_254(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
