	...
	switch (iLocal_43)
	{
				...
				if (unk_0x87F0CB19476706C3())
				{
					if (!func_20())
					{
						if (((!unk_0x6B12213471F330A3() && !func_14()) && !func_13()) && !func_12())
						{
							...
							iLocal_55 = unk_0x5DEA4192B46CB99B("LETTER_SCRAPS");
							while (!unk_0x95EF219D38B20CFF(iLocal_55))
							{
								wait(0);
							}
							unk_0x830F007E19C63E14(iLocal_55, "SET_LETTER_TEXT");
							func_11(sLocal_57[0]);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				unk_0x37FC7E88C7659D33(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
...
bool func_18(int iParam0, char* sParam1, int iParam2)
{
	unk_0x69476B1CA6A9FF80(sParam1);
...
bool func_19(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	unk_0x69476B1CA6A9FF80(sParam1);
	unk_0x6A826E35A3096ED0(iParam2);
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						unk_0x75D61761E9E63196((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
...
int func_40(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((vdist2(Param2, unk_0xC8C0D624848783ED((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
...
void func_75()
{
	...
	unk_0x2E352DDBBF674246(&iLocal_55);
