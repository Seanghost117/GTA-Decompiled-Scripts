			...
			switch (iLocal_80)
			{
				case 0:
					if (func_223(1, 1093140480, 0))
					{
						...
						{
							unk_0x6ADE529A7C2BA641(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, true, 0);
						}
						if (unk_0x60C47897C07F44B1(1736361794))
						{
							unk_0xCCD157619BAD6BE2(1736361794, 0f, true, false);
							unk_0xDC5C33A98881772F(1736361794, 0, true, false);
						}
				...
				case 2:
					if (unk_0x3EBB66F936A3436E())
					{
						if (unk_0x10447A1CD8175FC0("Trevor", 0))
						{
							...
							unk_0xF0C2AEEDB4BDCF16(unk_0x460153A63B9477BC(), 1f, 4000, 0, 1, false);
...
void func_2()
{
	...
	{
		unk_0xCCD157619BAD6BE2(1736361794, 0f, true, false);
		unk_0xDC5C33A98881772F(1736361794, 1, true, false);
	}
	func_3(110, 1);
	func_250();
}
...
int func_216(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_217(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_223(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
	{
		...
		{
			if (!func_230(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x03DB5C6AABF8DA46())
			{
				...
				Var4 = { func_235(Global_77088, Global_77090, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_268(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_274())
	{
		...
		{
			iVar2 = func_269(unk_0x6C5C6B207AA78253());
			if (iVar2 > -1)
			{
