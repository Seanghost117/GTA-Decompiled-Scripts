...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 3:
			if (!func_76(iLocal_71))
			{
				if (((func_73() && !func_72()) && func_71()) && !func_70(0))
				{
					if (iLocal_73 != 0)
					{
						if (unk_0x4C202AA4294FA480(iLocal_73))
						{
		...
		case 4:
			...
			{
				unk_0xE1A91D6D0E2CF9AE(iLocal_66, 0.75f);
			}
			if (!func_76(4))
			{
		...
		case 6:
			if (!func_34(3))
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, 0, true, 0))
				{
					func_33(3, 1);
				}
			}
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0))
			{
				if (func_34(3))
				{
			...
			if (!func_34(2))
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0) || unk_0x03DB5C6AABF8DA46())
				{
					unk_0x4E32F872FFCBC513(Local_58, 200f, joaat("prop_mineshaft_door"), 0);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
			...
			if (func_34(1))
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, 0, true, 0))
				{
...
void func_3()
{
	switch (Global_111858.f_10045.f_134)
	{
		...
		case 1:
			...
			unk_0xC4CC25B68A91D144(-1, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
...
void func_25(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		unk_0xBE20AB8238688965(&iLocal_78, iParam0);
	}
	else
	{
		unk_0xD2459066EA58CE43(&iLocal_78, iParam0);
	}
}

bool func_34(int iParam0)
{
	return unk_0xCE990E643CD9D0E5(iLocal_78, iParam0);
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_51, Local_57, true, true, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_52, Local_57, true, true, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(unk_0x9B0761B4C3EB8BC7(), Local_55, fLocal_56);
				...
				unk_0xF16CDD1D05F4411A(Local_55, 20f, 0);
				func_39(24, &iLocal_59);
				unk_0x05549C0F30BB285D(iLocal_59);
				iLocal_72 = (unk_0x578C4EF320340AF7() + 40000);
				while ((!unk_0x0C7F95EB5CFEFB8B() || !unk_0xEF928B5F0219FDF7(iLocal_59)) && iLocal_72 > unk_0x578C4EF320340AF7())
				{
					wait(0);
				}
				unk_0xF990EDED7D25FB88();
				if (iLocal_72 <= unk_0x578C4EF320340AF7())
				{
					unk_0x1F083D57FD823427(iLocal_59);
					func_44(unk_0x9B0761B4C3EB8BC7(), Local_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_36(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0, struct<3> Param1, float fParam2)
{
...
void func_49()
{
	...
	{
		case 0:
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Var0, Var1, fVar2, 0, true, 0) && !func_5(0))
			{
				func_53(sLocal_76);
				iLocal_61++;
			}
		...
		case 2:
			...
			if (unk_0x1BD7199394D7F19A(2, 51))
			{
				...
				{
					iLocal_72 = unk_0x578C4EF320340AF7() + 300;
					unk_0x0A794A8277A63161("CamPushInNeutral", 0, 0);
					unk_0xC4CC25B68A91D144(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", false);
				}
				else
				{
					iLocal_72 = 0;
...
int func_63()
{
	...
	if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_70(0))
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		...
		if (!bParam2)
		{
			unk_0xC4CC25B68A91D144(iLocal_69, sLocal_67, sLocal_68, false);
		}
		func_69();
	}
	else
...
int func_72()
{
	if (func_67(unk_0x9B0761B4C3EB8BC7()))
	{
		return unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false);
	}
	return 0;
}
...
bool func_73()
{
	return vdist2(func_75(iLocal_71), Local_70) < func_74(iLocal_71);
}
...
bool func_79()
{
	return vdist2(func_81(iLocal_71), Local_70) < func_80(iLocal_71);
}
...
void func_82()
{
	if (func_67(unk_0x9B0761B4C3EB8BC7()))
	{
		Local_70 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false) };
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 4:
			...
			func_85(sLocal_74);
			iLocal_66 = unk_0xB3116B49FE00E2F1(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, 1, true);
			unk_0x74528AC0906CBABE(joaat("u_f_m_drowned_01"));
			unk_0x756D74A3EF0AB788(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			unk_0x4E65320BC9AD521C(iLocal_66, true);
			unk_0xCBA6B2B569DCAFD8(iLocal_66, true);
			unk_0x6A8F948698B360B4(iLocal_66, true);
			unk_0x44225B42FE388400(iLocal_66, true);
			unk_0x316DB01C35390C36(iLocal_66, true);
			unk_0x694113444F21E39F(iLocal_66, 118, false);
			unk_0x694113444F21E39F(iLocal_66, 208, true);
			unk_0x0312E5501F93E5AB(iLocal_66, true);
			unk_0xD3D9D7C84656DAE5(iLocal_66, 1862763509);
			break;
		
		case 5:
			iLocal_63 = 731806707;
			unk_0x6ADE529A7C2BA641(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, true, 0);
			unk_0xDC5C33A98881772F(iLocal_63, 1, true, false);
			iLocal_62 = unk_0xB5B018137EBE06D3(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(joaat("u_m_o_filmnoir"));
			iLocal_64 = unk_0xB3116B49FE00E2F1(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, 1, true);
			unk_0x78024EFD31A7FAD4(iLocal_64, 0, 0, 0, false);
			unk_0x74528AC0906CBABE(joaat("u_m_o_filmnoir"));
			unk_0x44225B42FE388400(iLocal_64, true);
			unk_0x316DB01C35390C36(iLocal_64, true);
			unk_0xD528E9BCD43ECDC3(iLocal_64, joaat("weapon_sniperrifle"));
			unk_0xD3D9D7C84656DAE5(iLocal_64, 1862763509);
			iLocal_65 = unk_0x6E52E47D436A2C77(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, true, true, false);
			break;
	}
}
...
void func_87(int iParam0, struct<3> Param1, float fParam2)
{
	*iParam0 = unk_0x1EAC0A580058C30D();
	...
	{
		unk_0xE23B584346A0950F(*iParam0, Param1, fParam2);
	}
}

bool func_88(struct<3> Param0, struct<3> Param1, float fParam2)
{
	return vdist(Param0, Param1) <= fParam2;
}
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			unk_0x81989634D322A6F1(iLocal_73);
			iLocal_73 = 0;
			break;
		...
		case 4:
			...
			{
				unk_0x2481907DEE6B85EA(&iLocal_66);
			}
			unk_0x1082C25039B168F8(sLocal_74);
			break;
		
		case 5:
			if (unk_0x60C47897C07F44B1(iLocal_63))
			{
				unk_0x830F38EF3826B066(iLocal_63);
			}
			if (unk_0x40397A9A17EEC1C5(iLocal_62))
			{
		...
		case 6:
			if (unk_0xAE06B9E39EBDE049(iLocal_64))
			{
				unk_0x2481907DEE6B85EA(&iLocal_64);
			}
			if (unk_0xAE06B9E39EBDE049(iLocal_65))
			{
				unk_0x95178967C65CAD85(&iLocal_65);
			}
			if (func_34(2))
			{
				unk_0x6F9154B612B4F06F(Local_58, 200f, joaat("prop_mineshaft_door"), false);
			}
			break;
	}
}
