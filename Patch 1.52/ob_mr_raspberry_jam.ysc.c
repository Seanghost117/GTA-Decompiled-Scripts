...
void __EntryFunction__()
{
	...
	Local_274 = { 0f, 0f, 0f };
	Local_275 = { 0f, 0f, 0f };
	iLocal_280 = unk_0x344C570D6F8700DF(0, 4);
	func_76();
	...
	if (unk_0xAE06B9E39EBDE049(iScriptParam_286))
	{
		iLocal_41 = iScriptParam_286;
		unk_0x6A8F948698B360B4(iLocal_41, true);
		iLocal_40 = unk_0x36FE6D3220816ADA(iLocal_41);
	}
	func_68(&uLocal_108, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
	while (true)
	{
		wait(0);
		if (unk_0xAE06B9E39EBDE049(iLocal_41))
		{
			if (((((unk_0xED07D558B3EDDF8A(iLocal_41) && !unk_0xA59F96B50B97E63C(iLocal_41, 0)) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7())) && func_63()) && func_62(0)) && !unk_0x9CC4D06F5338CA6B())
			{
				switch (iLocal_276)
				{
					case 0:
...
void func_1()
{
	...
	{
		case 0:
			if (func_52(Var0, Var1) && unk_0xC21B6E3EB2C43175(unk_0x9B0761B4C3EB8BC7(), unk_0x3E4D3CCC220BDFB1(iLocal_41, true), 90f))
			{
				func_76();
		...
		case 2:
			...
			iLocal_278 = unk_0xF341A134A5B8D4F6(func_37(), func_36(), 2);
			unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), iLocal_278, func_35(), func_34(iLocal_280), 8f, -2f, 0, 0, 1148846080, 0);
			unk_0x1FEB07A1AF22700F(iLocal_41, iLocal_278, func_33(iLocal_280), func_35(), 8f, -2f, 0, 1148846080);
			if (unk_0xB76701815E89AE8C(iLocal_278))
			{
				unk_0x882281B10B0A5932(iLocal_278, false);
			}
			if (unk_0xA860C15A1C027CBB() != 4)
			{
				iLocal_279 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", true);
				unk_0x00736EE41CC355ED(iLocal_279, iLocal_278, func_30(iLocal_280), func_35());
			...
			iLocal_283 = 0;
			iLocal_284 = (unk_0x578C4EF320340AF7() + func_29());
			iLocal_277 = 3;
			break;
		...
		case 3:
			...
			unk_0xA86915034F55A3BF();
			unk_0x779660A9E5364C4D(1, 0, 1);
			if (unk_0xFC5D6FB6EECB392F(iLocal_278))
			{
				func_27();
				if (iLocal_281)
				{
					fVar2 = unk_0x369E69441C066912(iLocal_278);
					if (unk_0x2ECACCBBE69F9A16(func_35(), func_34(iLocal_280), "WalkInterruptible", &fVar3, &fVar4))
					{
				...
				if (!iLocal_283 && unk_0x578C4EF320340AF7() > iLocal_284)
				{
		...
		case 5:
			...
			if (unk_0xD2F202166691EDB2(joaat("NUM_SH_MR_JAM_USED"), &iLocal_285, -1))
			{
				unk_0x6000E4684CB4330B(joaat("NUM_SH_MR_JAM_USED"), iLocal_285 + 1, 1);
			}
			...
			iLocal_281 = 0;
			if (unk_0x4F5F2FB7AE0EB7AB(unk_0x9B0761B4C3EB8BC7()) < (unk_0xB4BD22A5188A2545(unk_0x9B0761B4C3EB8BC7()) - 10))
			{
				unk_0x697DA7132EE43ABC(unk_0x9B0761B4C3EB8BC7(), unk_0x4F5F2FB7AE0EB7AB(unk_0x9B0761B4C3EB8BC7()) + 10, 0);
			}
...
{
	if (unk_0xA860C15A1C027CBB() != 4 && unk_0x40397A9A17EEC1C5(iParam0))
	{
		return 1;
	}
	return 0;
...
char* func_31()
{
	...
	fVar2 = unk_0x272784C60C397DB6(Var1, Local_273[0 /*3*/], true);
	fVar3 = unk_0x272784C60C397DB6(Var1, Local_273[1 /*3*/], true);
	if (fVar2 < fVar3)
	{
...
void func_40(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_45(unk_0x460153A63B9477BC())) && !func_42(unk_0x460153A63B9477BC(), 0)) && !func_41()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_45(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
int func_52(struct<3> Param0, float fParam1, var uParam2, var uParam3)
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if ((!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false) && !unk_0x0922C2E075A5F18C(unk_0x9B0761B4C3EB8BC7())) && unk_0x4DC4117F94CD5B84(unk_0x460153A63B9477BC()))
		{
			...
			{
				if ((((unk_0xC337F69A1938DDA2() && !unk_0x3EBB66F936A3436E()) && !unk_0xF41C1CE0EE0A23A8()) && !func_56(0)) && !func_55())
				{
					if ((Global_95883 && Global_95884) || func_54())
					{
						return 0;
					}
					if (func_53(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), Param0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_53(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_58()
{
	if (unk_0x39F82CCA08464EF6(func_59(), 0, -1))
	{
		return 1;
	}
	return 0;
...
int func_61()
{
	...
	while (!unk_0xC614DDE265D18415(sVar0))
	{
		wait(0);
	}
	return 1;
...
int func_62(int iParam0)
{
	...
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		...
		{
			if (func_53(unk_0x3E4D3CCC220BDFB1(iLocal_41, false), func_57(), 5f, 0))
			{
				return 1;
			}
		}
...
void func_75()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if ((!unk_0x4DC4117F94CD5B84(unk_0x460153A63B9477BC()) && func_49(1, 0, 1)) && iLocal_36)
		{
			func_40(0, 1, 1, 0, 0, 0, 0);
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
