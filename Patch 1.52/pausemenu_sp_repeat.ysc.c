		...
		case 1:
			switch (ScriptParam_30.f_1)
			{
				...
				case 52:
					...
					{
						unk_0x51C2ECA26CBBDE99(ScriptParam_30.f_3);
					}
					break;
				...
				case 76:
					if (Global_77099 != -1)
					{
						...
						if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
						{
							...
							{
								Global_77084 = { unk_0x97C0B1E5FCD8E08A(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)) };
							}
						}
...
int func_8()
{
	...
	if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 207.4336f, -1019.795f, -100.4728f, 189.9338f, -1019.623f, -95.56883f, 17.1875f, 0, true, 0) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 3;
			}
		}
...
void func_35()
{
	...
	{
		case 1:
			Global_77083 = func_36(&Local_29, 1, 0, 1);
			break;
		
		case 7:
			Global_77083 = func_36(&Local_29, 0, 1, 1);
			break;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	unk_0xAD291B8F75D737AD(ceil(fVar0));
	if (iParam6 == 0)
	{
		unk_0xB23270F3D5E62FDE("PM_RP_STATD");
		unk_0x6A826E35A3096ED0(sParam4);
