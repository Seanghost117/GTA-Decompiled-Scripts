...
void __EntryFunction__()
{
	...
	{
		if (func_551(unk_0x460153A63B9477BC(), 1))
		{
			unk_0xD39E529EBE5DB04F();
		}
		if (func_550(unk_0x460153A63B9477BC(), 1))
		{
			unk_0xD39E529EBE5DB04F();
		}
	}
	...
	if (!func_548() && !unk_0x25DDB354A40FFCDB())
	{
	...
	wait(0);
	iLocal_90 = iScriptParam_613;
	if (unk_0x25DDB354A40FFCDB())
	{
		func_532();
		unk_0xA88557896B79E30D(2, 0, unk_0x460153A63B9477BC());
		func_527(0, -1, 0);
	...
	while (iLocal_60)
	{
		...
		if (func_548())
		{
			if (func_521(1024))
			{
				...
				{
					if (unk_0x36E2FC4B39D3018D(unk_0x9B0761B4C3EB8BC7()) && unk_0x51E339346E2220A4(unk_0x9B0761B4C3EB8BC7()))
					{
						func_525(1024);
						unk_0x46468389F464E317(unk_0x9B0761B4C3EB8BC7());
					}
				}
			}
			...
			else if (!unk_0xAA5B806352173DEA(iLocal_90))
			{
				bVar0 = false;
				unk_0xDE298EE8EAAC0776(iLocal_90);
			}
		}
				...
				if (bVar0)
				{
					...
					switch (iLocal_285)
					{
						case 0:
							if (iLocal_284 == -1)
							{
								if (unk_0x71F7FCEF2AC163AF(iLocal_90))
								{
									iLocal_284 = func_498();
								}
								else if (func_496())
							...
							else if (func_491())
							{
								if (func_490())
								{
									if (func_548())
									{
										if (unk_0xAA5B806352173DEA(iLocal_90))
										{
											unk_0x3964C1CAAE858CB1(iLocal_90, "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", 0, 0);
										}
										else
										{
											unk_0xDE298EE8EAAC0776(iLocal_90);
...
void func_3()
{
	if (iLocal_286 > 0)
	{
		...
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
			{
				if (!unk_0xE0B3BC41DDA88DF0(iLocal_91, iLocal_92, false))
				{
					func_97();
				}
			}
	...
	switch (iLocal_286)
	{
		...
		case 6:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
			{
				if (unk_0x16BC17A8EDC701A2(iLocal_90, 242628503) == 7)
				{
					iLocal_63 = unk_0x578C4EF320340AF7();
					iLocal_64 = (iLocal_63 - iLocal_62);
					if (iLocal_64 >= 10000 || !unk_0x910DFF8E55ABB8EC(iLocal_90, iLocal_91, 12f, 12f, 5f, 0, 1, 0))
					{
		...
		case 7:
			if (!unk_0x71B5E9AB554C28B8(func_58(0), func_58(1), func_58(2), func_58(3)))
			{
				unk_0xB65F86FFF1334E95(func_58(0), func_58(1), func_58(2), func_58(3));
			}
			else
			{
				unk_0xDEFE57D3575A1A8A(iLocal_91, iLocal_92, Local_88, (unk_0x0A68E34D0BB50B1C(iLocal_92) * 0.65f), 0, 0, 786859, 4f, -1f);
				iLocal_286 = 8;
			}
			break;
		
		case 8:
			if (vdist2(Local_88, unk_0x3E4D3CCC220BDFB1(iLocal_90, true)) < 25f && unk_0x16BC17A8EDC701A2(iLocal_91, -1817882002) != 1)
			{
				iLocal_288 = unk_0x344C570D6F8700DF(1, 3);
				iLocal_286 = 11;
			}
		...
		case 15:
			if (unk_0xAE06B9E39EBDE049(iLocal_90) && unk_0xAE06B9E39EBDE049(iLocal_92))
			{
				if (unk_0xE0B3BC41DDA88DF0(iLocal_90, iLocal_92, false))
				{
					if (!unk_0xA59F96B50B97E63C(iLocal_91, 0))
					{
						if (unk_0x16BC17A8EDC701A2(iLocal_91, -828834893) != 1)
						{
							unk_0x0AB756271BADC8DF(iLocal_90, 0, 16842752);
						}
					}
				}
				else
...
void func_4()
{
	...
	{
		case 0:
			unk_0xFD3B8338D84A6D8F(iLocal_90, 0.916f);
		...
		case 1:
			if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), unk_0x3E4D3CCC220BDFB1(iLocal_90, false)) < 22500f)
			{
				func_38();
			}
			func_35(iLocal_92);
...
int func_33(int iParam0)
{
	if (func_34())
	{
		if (!unk_0x57CE9BB39C5D1674(unk_0x36FE6D3220816ADA(iParam0), unk_0x3E4D3CCC220BDFB1(iParam0, true), 1))
		{
			return 1;
		}
	}
...
void func_36(var uParam0)
{
	...
	if (unk_0x80FF6C016CDB0FAF(*uParam0, 0))
	{
		Var0 = { 0f, 0f, -0.1f };
		Var1 = { 0f, 0f, 0f };
		unk_0x8B77B020136E915A(*uParam0, 1, Var0, Var1, 0, 1, 1, 1, 1, 0);
	}
}

bool func_37()
{
	return unk_0x39CABCD7925B9200(iLocal_90, 876132797);
}
...
{
	if (unk_0x7BCC91F3C1CF24E8(sLocal_61))
	{
		sLocal_61 = func_50(iParam0, 0, 0);
		return 0;
	}
	if (!unk_0xC614DDE265D18415(sLocal_61))
	{
		return 0;
	}
	else
...
void func_43(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	iLocal_48 = unk_0xA860C15A1C027CBB();
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), true) && func_48(0, 1))
	{
		if (iLocal_48 != 4)
		{
	...
	else
	{
		...
		unk_0x756D74A3EF0AB788(0, sVar2, func_44(0, bParam2, bParam1, bVar1), 8f, -8f, -1, 0, 0, 0, 0, 0);
		unk_0x756D74A3EF0AB788(0, sVar2, func_44(1, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x756D74A3EF0AB788(0, sVar2, func_44(2, bParam2, bParam1, bVar1), 8f, -4f, iParam3, 1, 0, 0, 0, 0);
		unk_0x756D74A3EF0AB788(0, sVar2, func_44(3, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x756D74A3EF0AB788(0, sVar2, func_44(4, bParam2, bParam1, bVar1), 4f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_55(int iParam0)
{
	...
	if (!unk_0xA59F96B50B97E63C(iParam0, 0))
	{
		if (unk_0xC0736D5851285045(iParam0) || !func_57(iParam0, iLocal_92, -1))
		{
			Var0 = { unk_0x3E4D3CCC220BDFB1(iParam0, true) };
			unk_0x6AC7395A8E313A46(iParam0, 196624, true);
			if (func_56())
			{
				unk_0xD66FADEF7D42D49B(iParam0, Var0, 300f, -1, 1, 1);
			}
			else if (!unk_0xA59F96B50B97E63C(unk_0x754A4975FB27D0BA(iParam0), 0))
			{
				unk_0x8FF9CE1C0F94F59A(iParam0, unk_0x754A4975FB27D0BA(iParam0), 0, 16);
			}
			else
			{
				unk_0xD66FADEF7D42D49B(iParam0, Var0, 300f, -1, 1, 1);
...
float func_58(int iParam0)
{
	...
	Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_90, true) };
	Var1 = { Local_88 };
	if (iParam0 == 0)
	{
		if (Var0.x < Var1.x)
...
void func_59()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_91, iLocal_92, false))
			{
				if (unk_0x16BC17A8EDC701A2(iLocal_90, 242628503) == 1)
				{
					if (unk_0x18B8D57C51EEB5CC(iLocal_90) > 0)
					{
						if (unk_0xE0B3BC41DDA88DF0(iLocal_90, iLocal_92, false))
						{
							func_489("prostitute WAITING TO END   - DRIVING OFF (WANDER)");
							unk_0x9DC06E2A59C5AEBB(&iLocal_95);
							unk_0xD8C1C38EE8BC2AC6(0, iLocal_92, 10f, 786603);
							unk_0x19F29730874AD6F1(iLocal_95);
							unk_0x9B6EC2CECE1010EF(iLocal_91, iLocal_95);
							unk_0x4F83FEE4454169D4(&iLocal_95);
							Local_88 = { func_60(unk_0x3E4D3CCC220BDFB1(iLocal_90, true)) };
							unk_0x131ED02492676000(func_50(iLocal_90, 0, 0));
							iLocal_286 = 7;
...
Vector3 func_60(struct<3> Param0)
{
	...
	while (iVar1 < 32)
	{
		if (vdist2(Param0, func_61(iVar1)) < vdist2(Param0, func_61(iVar0)))
		{
			iVar0 = iVar1;
		}
		iVar1++;
...
void func_62()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_91, iLocal_92, false))
			{
				fVar0 = unk_0xF3A639BEE7AADF55(iLocal_92);
				if (unk_0x910DFF8E55ABB8EC(iLocal_91, iLocal_90, 15f, 15f, 5f, 0, 1, 0) && fVar0 <= 1f)
				{
					func_69(iLocal_90);
					iLocal_63 = unk_0x578C4EF320340AF7();
					iLocal_64 = (iLocal_63 - iLocal_62);
					if (iLocal_64 >= iLocal_66)
					{
						if (func_548())
						{
							if (unk_0xAA5B806352173DEA(iLocal_91))
							{
								unk_0xE2348E4036041923(iLocal_91);
							}
						}
						else
						{
						...
						iLocal_66 = unk_0x344C570D6F8700DF(0, 10000);
						if (iLocal_66 > 2500)
						{
							unk_0x9B94F6169B0DAEFD(iLocal_90);
							unk_0x4F83FEE4454169D4(&iLocal_95);
							unk_0x9DC06E2A59C5AEBB(&iLocal_95);
							unk_0xC584E49FC3559A86(0, iLocal_92, -1, 0, 1f, 8388609, 0);
							unk_0xC1C7DE768F7675E5(0, -1);
							unk_0x19F29730874AD6F1(iLocal_95);
							unk_0x9B6EC2CECE1010EF(iLocal_90, iLocal_95);
							unk_0x4F83FEE4454169D4(&iLocal_95);
							...
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
							{
								if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
								{
									if (unk_0xE0B3BC41DDA88DF0(iLocal_91, iLocal_92, false))
									{
										unk_0x4F83FEE4454169D4(&iLocal_95);
										unk_0x9DC06E2A59C5AEBB(&iLocal_95);
										unk_0xC1C7DE768F7675E5(0, unk_0x344C570D6F8700DF(500, 2000));
										unk_0xD8C1C38EE8BC2AC6(0, iLocal_92, 10f, 786603);
										unk_0x19F29730874AD6F1(iLocal_95);
										unk_0x9B6EC2CECE1010EF(iLocal_91, iLocal_95);
										unk_0x4F83FEE4454169D4(&iLocal_95);
...
int func_63()
{
	...
	if (!unk_0xAE06B9E39EBDE049(iLocal_90) || unk_0x5AEB5DDFFAD43CA5(iLocal_90))
	{
		return 1;
	}
	if (!func_548())
	{
		if (unk_0x47DBF174A0CB9D55(iLocal_90, true))
		{
			unk_0x30291E2E564E9B47(iLocal_90, 1193033728, 0);
		}
		else if (func_488(iLocal_49, 4194304))
		{
			...
			{
				unk_0x756D74A3EF0AB788(0, func_67(iLocal_284), func_66(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
			}
			func_64(1);
			unk_0x19F29730874AD6F1(iVar0);
			unk_0x9B6EC2CECE1010EF(iLocal_90, iVar0);
	...
	switch (iLocal_54)
	{
		...
		case 1:
			if (func_488(iLocal_73, 524288))
			{
				if (unk_0xAA5B806352173DEA(iLocal_90))
				{
					unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
					unk_0xDE298EE8EAAC0776(iLocal_90);
		...
		case 2:
			if (func_488(iLocal_73, 524288))
			{
				if (unk_0xAA5B806352173DEA(iLocal_90))
				{
					if (unk_0x16BC17A8EDC701A2(iLocal_90, -2017877118) == 7)
					{
						func_64(0);
						iLocal_54 = 3;
					}
...
void func_64(bool bParam0)
{
	...
	if (((unk_0x8FEFEB4E679E1544(iLocal_90) || unk_0x71F7FCEF2AC163AF(iLocal_90)) || unk_0xA91FE8E813825AD4(iLocal_90, func_65(0))) || unk_0xA91FE8E813825AD4(iLocal_90, func_65(1)))
	{
		return;
	}
	Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_90, true) };
	if (!unk_0x54F52A5BEDE97CCE(Var0, func_65(0), 20f, 1) && !unk_0x54F52A5BEDE97CCE(Var0, func_65(1), 20f, 1))
	{
		if (bParam0)
		{
	...
	if (!bParam0)
	{
		unk_0x1AC55EB440F64E41(iLocal_90, Var0, 20f, 0);
	}
	else
	{
		unk_0x1AC55EB440F64E41(0, Var0, 20f, 0);
	}
}
...
void func_68()
{
	if (unk_0x5AEB5DDFFAD43CA5(iLocal_90))
	{
		return;
	}
	if (!unk_0xF282AA6FECA1EF23(iLocal_90))
	{
		if (func_23() == 2)
		{
			unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_DECLINED_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_DECLINED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
void func_69(int iParam0)
{
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		if (func_70(iParam0))
		{
			unk_0x8342E6CB98CD545C(iParam0, 109, true);
		}
	}
}
...
int func_70(int iParam0)
{
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		if ((unk_0x9934470AA0A08B57(iParam0, func_67(iLocal_284), func_66(1), 3) || unk_0x9934470AA0A08B57(iParam0, func_67(iLocal_284), func_66(2), 3)) || unk_0x9934470AA0A08B57(iParam0, func_67(iLocal_284), func_66(3), 3))
		{
			return 1;
		}
	}
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_91, iLocal_92, false))
			{
				if (unk_0x16BC17A8EDC701A2(iLocal_90, 242628503) == 1)
				{
					if (unk_0x18B8D57C51EEB5CC(iLocal_90) > 1)
					{
						if (unk_0x910DFF8E55ABB8EC(iLocal_90, iLocal_91, 20f, 20f, 10f, 0, 1, 0))
						{
							fVar0 = unk_0xF3A639BEE7AADF55(iLocal_92);
							if (fVar0 <= 1f)
							{
								func_72(0);
								iLocal_62 = unk_0x578C4EF320340AF7();
								iLocal_66 = unk_0x344C570D6F8700DF(4000, 8000);
...
int func_72(bool bParam0)
{
	...
	if (!func_548())
	{
		if (bParam0)
		{
			unk_0xD0C464B4E09878D6(iLocal_90, "PROSTITUTE_GROUP", 0);
		...
		if (func_488(iLocal_49, 4194304))
		{
			...
			unk_0x756D74A3EF0AB788(0, func_67(iLocal_284), func_66(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, func_67(iLocal_284), func_66(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, func_67(iLocal_284), func_66(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x19F29730874AD6F1(iVar1);
			unk_0x9B6EC2CECE1010EF(iLocal_90, iVar1);
	...
	switch (iLocal_53)
	{
		...
		case 1:
			if (func_488(iLocal_49, 4194304))
			{
				if (unk_0xAA5B806352173DEA(iLocal_90))
				{
					unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_53 = 2;
				}
				else
				{
		...
		case 2:
			if (unk_0xAA5B806352173DEA(iLocal_90))
			{
				...
				{
					iVar0 = unk_0x344C570D6F8700DF(1, 4);
					unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_53 = 3;
				}
			}
			else
		...
		case 3:
			if (unk_0xAA5B806352173DEA(iLocal_90))
			{
				if (unk_0x16BC17A8EDC701A2(iLocal_90, -2017877118) == 7)
				{
					unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
					iLocal_53 = 4;
				}
			}
			else
	...
	if (!unk_0xF282AA6FECA1EF23(iLocal_90))
	{
		switch (func_23())
		{
			case 0:
				...
				{
					unk_0xFDCFA91E51EDB61F(iLocal_90, "SOLICIT_MICHAEL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xFDCFA91E51EDB61F(iLocal_90, "SOLICIT_MICHAEL_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 1:
				if (!func_74(iLocal_90))
				{
					unk_0xFDCFA91E51EDB61F(iLocal_90, "SOLICIT_FRANKLIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xFDCFA91E51EDB61F(iLocal_90, "SOLICIT_FRANKLIN_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 2:
				if (!func_74(iLocal_90))
				{
					unk_0xFDCFA91E51EDB61F(iLocal_90, "SOLICIT_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xFDCFA91E51EDB61F(iLocal_90, "SOLICIT_TREVOR_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			}
	}
...
{
	if (unk_0xE95077C1E15F6307(iParam0, Global_111858.f_10045.f_1[iParam1 /*11*/].f_10))
	{
		return 1;
	}
	return 0;
...
bool func_80(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x79AFA009D186C4FB(iParam0, iVar0) == func_81(iParam1, iParam2);
}
...
bool func_84(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x3FB4D40A857CEA77(iParam0, iVar0) == func_85(iParam1, iParam2);
}
...
void func_88()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
		{
			...
			{
				fVar0 = unk_0xF3A639BEE7AADF55(iLocal_92);
				if (unk_0x16BC17A8EDC701A2(iLocal_91, -272084098) == 7 || fVar0 <= 1f)
				{
					unk_0x140662B520844E45(unk_0x36FE6D3220816ADA(iLocal_92), &Var2, &Var1);
					Var3 = { Var1 - Var2 };
					Var3 = { Var3 / Vector(2f, 2f, 2f) };
					Var4 = { unk_0x7EC595B99EA7C4B1(iLocal_92, 0.2f, 0.2f, 0f) };
					Var5 = { unk_0x7EC595B99EA7C4B1(iLocal_92, 0.2f, 0.2f, 0f) };
					Var6 = { unk_0x3E4D3CCC220BDFB1(iLocal_90, true) };
					if (vdist(Var6, Var5) < vdist(Var6, Var4))
					{
						Var4 = { Var5 };
					}
					unk_0x9DC06E2A59C5AEBB(&iLocal_95);
					unk_0x3C1B180EE30D36EF(0, Var4.x, Var4.f_1, Var4.f_2, 1f, -1, 0.5f, 8192, 1193033728);
					unk_0xD08E9EAF091A1AAB(0, iLocal_91, 0);
					unk_0xC1C7DE768F7675E5(0, -1);
					unk_0x19F29730874AD6F1(iLocal_95);
					unk_0x9B6EC2CECE1010EF(iLocal_90, iLocal_95);
					unk_0x4F83FEE4454169D4(&iLocal_95);
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_91, iLocal_92, false))
			{
				...
				{
					if (func_90(unk_0x3E4D3CCC220BDFB1(iLocal_91, true), 1106247680))
					{
						return;
					}
					Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_90, true) };
					if (unk_0x30EE2C844B9C410B(Var0, &Var0, 8, 1077936128, 0))
					{
						unk_0x8F4C441CE8099187(iLocal_91, 1f);
						unk_0x3A8635CDD5709E7C(iLocal_91, 0.2f);
						unk_0x75E6FF0E97AA6956(iLocal_91, 0.05f);
						unk_0x2976DB62CAE67C30(iLocal_91, iLocal_92, Var0, 0f, 3, 360f, 1);
						unk_0xA785552633ED203B(iLocal_91, iLocal_90, -1, 2048, 4);
...
bool func_90(struct<3> Param0, int iParam1)
{
	if (func_548())
	{
		return unk_0x2975580CCA617F3B(Param0 - Vector(iParam1, iParam1, iParam1), Param0 + Vector(iParam1, iParam1, iParam1));
	}
	return (unk_0x597467025C9DE24C(Param0 - Vector(iParam1, iParam1, iParam1), Param0 + Vector(iParam1, iParam1, iParam1)) || unk_0x2975580CCA617F3B(Param0 - Vector(iParam1, iParam1, iParam1), Param0 + Vector(iParam1, iParam1, iParam1)));
}
...
int func_91(int iParam0)
{
	...
	if (unk_0x80FF6C016CDB0FAF(*iParam0, 0))
	{
		...
		{
			if (unk_0x99E61B3887CC8E71(*iParam0) > 0)
			{
				iVar1 = unk_0xBFBFB3EA52D66EB5(*iParam0);
				if (((iVar1 == 0 && unk_0xB064AF9925F5537B(*iParam0, 0, 0)) && (!unk_0x63D2DBD5A2F21BB5(*iParam0, 1) && !unk_0x63D2DBD5A2F21BB5(*iParam0, 0))) || unk_0x10D3F7E169A49C44(*iParam0, 0, 0) == iLocal_90)
				{
					if (func_47(*iParam0))
					{
						if (!func_488(iLocal_49, 32768))
						{
							...
							{
								unk_0x08E33007524DAD35(func_92());
					...
					else
					{
						...
						if (func_488(iLocal_49, 8))
						{
							if (unk_0x8FBC2B79465DEB9E(func_92()))
							{
								unk_0x8300D71BCDF3F00B(func_92());
								func_5(&iLocal_49, 8);
							}
						}
					}
...
void func_97()
{
	if (func_548())
	{
		...
		{
			unk_0x9B94F6169B0DAEFD(iLocal_90);
			unk_0xE2348E4036041923(iLocal_90);
		}
	}
	else
	{
	...
	iLocal_91 = 0;
	iLocal_92 = 0;
	unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(4), 2f, -2f, -1, 1, unk_0x658086F2B3C5E4E4(0f, 0.9f), 0, 0, 0);
	func_96(0);
	iLocal_287 = 0;
	iLocal_285 = 1;
}
...
void func_98(var uParam0)
{
	...
	switch (iLocal_286)
	{
		...
		case 11:
			...
			if (func_548())
			{
				unk_0x8342E6CB98CD545C(unk_0x9B0761B4C3EB8BC7(), 433, true);
				func_226(uParam0);
			}
			break;
...
void func_99(var uParam0)
{
	if (!func_548())
	{
		if (unk_0x9934470AA0A08B57(unk_0x9B0761B4C3EB8BC7(), func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_101(1), 3))
		{
			return;
		}
	}
...
void func_102()
{
	if (!unk_0xF282AA6FECA1EF23(unk_0x9B0761B4C3EB8BC7()))
	{
		if (iLocal_70 == 0)
		{
			...
			{
				unk_0x6AC7395A8E313A46(iLocal_90, 32768, false);
				unk_0x6AC7395A8E313A46(iLocal_90, 196624, true);
			}
			unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_LEAVES_ANGRY", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			func_96(15);
		}
	}
}
...
void func_103()
{
	...
	{
		case 0:
			if (!unk_0xF282AA6FECA1EF23(iLocal_90) || func_121(&iLocal_101) > 4f)
			{
				func_116(iLocal_90);
		...
		case 1:
			func_113();
			if (unk_0xF282AA6FECA1EF23(iLocal_90) || func_112())
			{
...
void func_106(bool bParam0)
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_90))
	{
		...
		{
			unk_0x586DDC617E714637(&iLocal_90);
		}
		else
		{
...
void func_107(int iParam0, bool bParam1)
{
	...
	if (unk_0x9934470AA0A08B57(unk_0x9B0761B4C3EB8BC7(), func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_110(1), 3))
	{
		unk_0x756D74A3EF0AB788(unk_0x9B0761B4C3EB8BC7(), func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_101(1), 4f, -8f, -1, 0, 0, 0, 0, 0);
	}
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		if (func_548())
		{
			...
			{
				unk_0x8579A8624726DC76(iParam0);
			}
		}
		else
		{
		...
		if (bParam1)
		{
			fVar1 = unk_0x658086F2B3C5E4E4(0.1f, 2f);
			if (fVar1 <= 0.25f)
			{
		...
		if (func_488(iLocal_49, 134217728))
		{
			unk_0x6AC7395A8E313A46(iParam0, 32768, true);
			unk_0x8B18A80E8EB15510(iParam0, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 1, 0);
		}
		else
		{
			unk_0x6AC7395A8E313A46(iParam0, 196624, true);
			...
			{
				if (!unk_0xFD7B900D58065E3B(unk_0xA5D5B1042E8F47BD(iParam0, false)))
				{
					func_109(iParam0, 1);
				}
				else
				{
					if (unk_0x9934470AA0A08B57(iParam0, func_50(iParam0, 0, 0), func_110(0), 3))
					{
						if (iLocal_70 > 0)
						{
							unk_0x756D74A3EF0AB788(0, func_50(iParam0, 0, 0), func_101(0), 4f, -4f, -1, 0, 0, 0, 0, 0);
						}
						else
						{
							unk_0x756D74A3EF0AB788(0, func_50(iParam0, 0, 0), func_108(0), 4f, -4f, -1, 0, 0, 0, 0, 0);
						}
					}
					func_109(iParam0, 1);
				}
		...
		if (func_548())
		{
			if (unk_0x0AA24CBDD7C7F44D(iLocal_90))
			{
				if (unk_0x663F84E7375B82E6(unk_0xFC4D82355252F6DC(iLocal_90)))
				{
...
{
	if (!unk_0xC7C55C82599F980F(iParam0, unk_0xA5D5B1042E8F47BD(iParam0, false), 0, 0, false))
	{
		unk_0x0AB756271BADC8DF(0, 0, 16842752);
	}
	else
	{
...
void func_111()
{
	...
	iVar0 = unk_0x344C570D6F8700DF(0, 1000);
	if ((iVar0 <= 333 && iLocal_297 == 0) || iLocal_297 == 3)
	{
		unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "HOOKER_STORY_REVULSION_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
	else if (((iVar0 > 333 && iVar0 <= 666) && iLocal_297 == 0) || iLocal_297 == 1)
	{
		unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "HOOKER_STORY_SARCASTIC_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
	else if (iLocal_297 == 0 || iLocal_297 == 2)
	{
		unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "HOOKER_STORY_SYMPATHETIC_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_113()
{
	if (iLocal_297 == 0)
	{
		...
		unk_0x779660A9E5364C4D(0, 80, 1);
		unk_0x26A60F42A1132477(2, 203);
		unk_0x26A60F42A1132477(2, 201);
		unk_0x26A60F42A1132477(2, 202);
		if (unk_0xC27AEE8B64EE0F8D(2, 203))
		{
			unk_0xD289B55B6AADBA10(1);
...
void func_116(int iParam0)
{
	...
	if (iVar0 > -1)
	{
		if (unk_0xF282AA6FECA1EF23(iParam0))
		{
...
void func_122(var uParam0)
{
	...
	if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
		{
			...
			{
				if (unk_0x10D3F7E169A49C44(iVar1, -1, 0) != unk_0x9B0761B4C3EB8BC7())
				{
					bVar0 = true;
				}
				if (unk_0x10D3F7E169A49C44(iVar1, 0, 0) != iLocal_90)
				{
					bVar0 = true;
				}
				if (unk_0xBFBFB3EA52D66EB5(iVar1) > 2)
				{
					bVar0 = true;
				}
				if (bVar0)
...
void func_123(bool bParam0)
{
	...
	if (bParam0)
	{
		Var0 = { unk_0x090239DEAF625B17(iLocal_93, 2) };
		unk_0x4C4FC7841A5FB983(180f);
		unk_0x7965943E39128B42((-5.5f - Var0.x), 1065353216);
	}
...
void func_125()
{
	if (unk_0x80FF6C016CDB0FAF(iLocal_93, 0))
	{
		unk_0xFD13BD5261D4B71A(iLocal_93, 1);
	}
	if (iLocal_293 != 5)
	{
		...
		{
			if (!unk_0x6E0C5E7AAF8B6214(iLocal_90) || unk_0xB3770DEEECFB052B(unk_0x9B0761B4C3EB8BC7()))
			{
				iLocal_293 = 5;
			}
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
		...
		case 1:
			...
			if (func_7(&iLocal_113) > 1f)
			{
				if (func_132())
				{
					...
					{
						func_129();
						unk_0x05591EC8C770AA11(iLocal_48);
						iLocal_293 = 3;
					}
				}
			}
...
void func_126()
{
	...
	if (!unk_0xF282AA6FECA1EF23(unk_0x9B0761B4C3EB8BC7()))
	{
		if (iLocal_70 == 0)
		{
			unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "HOOKER_DECLINE_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else if (func_127(iLocal_90))
		{
			func_40(&iLocal_101);
			unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 768);
			func_480(&iLocal_49, 2048);
			iLocal_286 = 13;
		}
	}
...
void func_129()
{
	...
	if (!unk_0xF282AA6FECA1EF23(iLocal_90))
	{
		unk_0xFDCFA91E51EDB61F(iLocal_90, "SEX_FINISHED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_130()
{
	...
	if (!unk_0xF282AA6FECA1EF23(iLocal_90))
	{
		unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_HAD_ENOUGH", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_134()
{
	...
	if (unk_0x7BCC91F3C1CF24E8(func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0)))
	{
		return;
	}
	if (!unk_0xC614DDE265D18415(func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0)))
	{
		return;
	}
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	...
	switch (iLocal_296)
	{
		...
		case 5:
			...
			{
				func_182(iLocal_90, 0);
				unk_0x756D74A3EF0AB788(iLocal_90, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(iLocal_296, 1, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_182(unk_0x9B0761B4C3EB8BC7(), -1);
				unk_0x756D74A3EF0AB788(unk_0x9B0761B4C3EB8BC7(), func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(iLocal_296, 0, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_123(1);
				iLocal_50 = 0;
				iLocal_71 = 0;
				iLocal_59 = 0;
...
void func_142(int iParam0)
{
	...
	func_150(iVar0);
	unk_0x14EFF93E9B692DAD(iParam0, func_147(iVar0));
	Global_111858.f_10045.f_1[iVar0 /*11*/].f_10 = unk_0x36FE6D3220816ADA(iParam0);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		iVar1 = iVar2;
...
{
	return unk_0x79AFA009D186C4FB(iParam0, func_82(iParam1));
}
...
{
	return unk_0x3FB4D40A857CEA77(iParam0, func_86(iParam1));
}
...
void func_152()
{
	...
	{
		func_154(13, floor(Global_111858.f_10190.f_3853));
	}
	if (!unk_0xC4A02490EB1F450B())
	{
		if (!Global_76833)
		{
			if (func_153() == 2 == 0 && !unk_0x25DDB354A40FFCDB())
			{
...
void func_157(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_79, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_158(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	{
		unk_0xDFDB9C533700BC17(iParam0, iParam1, sParam2, sParam3, fParam4, fParam5, iParam6, iParam7, iParam8, iParam9);
	}
}
...
void func_159(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_79, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
...
void func_160(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8)
{
	if (func_548())
	{
		unk_0x54D6514F20DE2E13(iParam0, iParam1, sParam2, sParam3, fParam4, fParam5, iParam6, iParam7, iParam8, 0);
	}
}
...
void func_161(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	*iParam0 = func_164(Var0, 0f, 0f, 0f, bParam3, bParam2, 2);
	if (iParam1 == 0)
	{
		func_163(*iParam0, iLocal_93, unk_0x0724529FC474C803(iLocal_93, "seat_dside_f"));
	}
	else if (iParam1 == 1)
	{
		func_163(*iParam0, iLocal_93, unk_0x0724529FC474C803(iLocal_93, "seat_pside_f"));
	}
	func_162(*iParam0, Var0, 0f, 0f, 0f, 0);
}

void func_162(int iParam0, struct<3> Param1, struct<3> Param2, int iParam3)
{
	if (!func_548())
	{
		unk_0x3796C3212BCFD4A1(iParam0, Param1, Param2, iParam3);
	}
}
...
void func_163(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_548())
	{
		unk_0x49102068758976EB(iParam0, iParam1, iParam2);
	}
	else
	{
		unk_0x3198407FE9E09FCF(iParam0, iParam1, iParam2);
	}
}
...
int func_164(struct<3> Param0, struct<3> Param1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_548())
	{
		...
		iVar0 = unk_0xAA579EC5104BFDA9(Param0, Param1, iParam4, bParam2, bParam3, 1065353216, 0, 1065353216);
	}
	else
	{
		iVar0 = unk_0xF341A134A5B8D4F6(Param0, Param1, iParam4);
		unk_0x882281B10B0A5932(iVar0, bParam2);
		unk_0x81493F39713559B1(iVar0, bParam3);
	}
	return iVar0;
}
...
void func_165(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_78, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_166(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_78, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
...
void func_174(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_77, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_175(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_77, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
...
void func_176(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_76, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_177(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_76, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
...
float func_178(int iParam0)
{
	...
	if (func_548())
	{
		fVar0 = unk_0x369E69441C066912(unk_0xAB6BAF5BFCAFB141(iParam0));
	}
	else
	{
		fVar0 = unk_0x369E69441C066912(iParam0);
	}
	return fVar0;
}
...
void func_180(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_74, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
...
void func_181(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_74, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_44(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
...
{
	if (!unk_0xE0B3BC41DDA88DF0(iParam0, iLocal_93, false))
	{
		if (!func_548())
		{
			unk_0x13A4BD6CC31F7B8F(iParam0, iLocal_93, iParam1);
		}
		else if (!unk_0xE0B3BC41DDA88DF0(iParam0, iLocal_93, false))
		{
			unk_0xC584E49FC3559A86(iParam0, iLocal_93, -1, iParam1, 2f, 16, 0);
		}
	}
}
...
void func_183(int iParam0)
{
	...
	uVar0 = func_185(func_186(2), unk_0xBB88AFC535E469A3(iLocal_93, unk_0x0724529FC474C803(iLocal_93, "windscreen")));
	uVar1 = func_185(func_186(1), unk_0xBB88AFC535E469A3(iLocal_93, unk_0x0724529FC474C803(iLocal_93, "windscreen")));
	Var2 = { unk_0x090239DEAF625B17(iLocal_93, 2) };
	fVar3 = unk_0xEF7858F25585F853(iLocal_93);
	if (fVar3 >= 180f)
	{
		fVar4 = (fVar3 - 180f);
	}
...
void func_184(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	...
	*uParam0 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", false);
	...
	unk_0x3FD8029C7A771A0E(*uParam0, Param1, uParam0->f_1, fParam3, 0, 1, 1, 2);
	unk_0x3ED9330214992278(true, false, 3000, true, 0, 0);
}
...
Vector3 func_186(int iParam0)
{
	...
	if (!unk_0xA59F96B50B97E63C(iLocal_90, 0))
	{
	}
	if (!unk_0x80FF6C016CDB0FAF(iLocal_93, 0))
	{
	}
	unk_0x140662B520844E45(unk_0x36FE6D3220816ADA(iLocal_93), &uVar1, &Var2);
	Var3 = { unk_0xBB88AFC535E469A3(iLocal_93, unk_0x0724529FC474C803(iLocal_93, "windscreen")) };
	Var4 = { unk_0x71C23069714A27B9(iLocal_93, Var3) };
	switch (iParam0)
	{
		case 0:
			Var0 = { unk_0x7EC595B99EA7C4B1(iLocal_93, 0f, (Var2.f_1 + 1.4f), Var4.f_2) };
			break;
		
		case 1:
			Var0 = { unk_0x7EC595B99EA7C4B1(iLocal_93, 1.5f, (Var2.f_1 + 1.2f), (Var4.f_2 - 0.1f)) };
			break;
		
		case 2:
			Var0 = { unk_0x7EC595B99EA7C4B1(iLocal_93, -3.7f, 0.7f, Var4.f_2) };
			break;
...
Vector3 func_187()
{
	...
	unk_0x140662B520844E45(unk_0x36FE6D3220816ADA(iLocal_93), &Var2, &uVar3);
	Var0 = { unk_0xBB88AFC535E469A3(iLocal_93, unk_0x0724529FC474C803(iLocal_93, "windscreen")) };
	Var1 = { unk_0x71C23069714A27B9(iLocal_93, Var0) };
	Var1.f_2 = (Var1.f_2 + 0.09f);
	Var2.f_1 = (Var2.f_1 - 1f);
	return unk_0x7EC595B99EA7C4B1(iLocal_93, 0f, -unk_0x0D77CDCF403AEBD2(Var2.f_1), Var1.f_2);
}
...
{
	if (!unk_0x40397A9A17EEC1C5(Local_300[*iParam0 /*7*/]))
	{
		return;
	}
	if (!unk_0x09F689AE170A62EC(Local_300[*iParam0 /*7*/]))
	{
		return;
	}
	unk_0x2311A669433389E8(Local_300[*iParam0 /*7*/], "HAND_SHAKE", 0.25f);
	...
	else
	{
		...
		if ((unk_0x79800E51B3B6D197(2, 0) && !unk_0xF0C12886E5C1B20E()) && !func_48(0, 1))
		{
			func_190(iParam0);
			unk_0x856549C07003344B(Local_300[*iParam0 /*7*/], true);
		}
...
void func_192(var uParam0)
{
	...
	Var1.f_2 = (-(to_float(uVar0[2]) / 127f) * 10f);
	Var1.f_1 = ((-Var1.f_2 * 3f) / 10f);
	if (unk_0xB12E59C58CB342A4())
	{
		Var1.x = ((to_float(uVar0[3]) / 127f) * 10f);
	}
	else
	{
		Var1.x = (-(to_float(uVar0[3]) / 127f) * 10f);
	...
	unk_0xBF92D2A60C7C686E(*uParam0, uParam0->f_1 + uParam0->f_4, 2);
}
...
void func_195()
{
		...
		if (func_199(iLocal_90))
		{
			if (!func_488(iLocal_49, 256))
			{
				...
				if (iLocal_70 == 1)
				{
					if (!func_548())
					{
						unk_0xEF5931DD6E17343E(unk_0x460153A63B9477BC(), 15, 1, 0);
					}
					unk_0x3E6F6B3156C4F772(0, 4000, 252);
				}
				else if (iLocal_70 == 2)
				{
					if (!func_548())
					{
						unk_0xEF5931DD6E17343E(unk_0x460153A63B9477BC(), 10, 1, 0);
					}
					unk_0x3E6F6B3156C4F772(0, 4000, 210);
				}
				else
				{
					if (!func_548())
					{
						unk_0xEF5931DD6E17343E(unk_0x460153A63B9477BC(), 5, 1, 0);
					}
					unk_0x3E6F6B3156C4F772(0, 3000, 168);
				}
	...
	else
	{
		...
		{
			case 0:
				if (unk_0x39CABCD7925B9200(iLocal_90, 876132797))
				{
					unk_0x3E6F6B3156C4F772(0, 200, 84);
					unk_0x8B77B020136E915A(iLocal_93, 1, 0f, 0f, -0.05f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
					func_197();
				}
				break;
			...
			case 2:
				if (func_488(iLocal_49, 32768))
				{
					if (func_548())
					{
						iVar0 = unk_0xAB6BAF5BFCAFB141(iLocal_77);
					}
					else
					{
						iVar0 = iLocal_77;
					...
					{
						fVar1 = unk_0x369E69441C066912(iVar0);
						if ((((((((((((((fVar1 > 0.01f && fVar1 < 0.019f) || (fVar1 > 0.093f && fVar1 < 0.1f)) || (fVar1 > 0.165f && fVar1 < 0.172f)) || (fVar1 > 0.231f && fVar1 < 0.239f)) || (fVar1 > 0.308f && fVar1 < 0.317f)) || (fVar1 > 0.37f && fVar1 < 0.378f)) || (fVar1 > 0.437f && fVar1 < 0.443f)) || (fVar1 > 0.507f && fVar1 < 0.518f)) || (fVar1 > 0.58f && fVar1 < 0.587f)) || (fVar1 > 0.651f && fVar1 < 0.659f)) || (fVar1 > 0.72f && fVar1 < 0.729f)) || (fVar1 > 0.788f && fVar1 < 0.794f)) || (fVar1 > 0.862f && fVar1 < 0.87f)) || (fVar1 > 0.937f && fVar1 < 0.946f))
						{
							if (!func_521(512))
							{
								unk_0x3E6F6B3156C4F772(0, 200, 252);
								unk_0x8B77B020136E915A(iLocal_93, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
								func_197();
								func_196(512);
							}
						}
				...
				else if (unk_0x39CABCD7925B9200(iLocal_90, 876132797))
				{
					unk_0x3E6F6B3156C4F772(0, 200, 252);
					unk_0x8B77B020136E915A(iLocal_93, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
					func_197();
...
void func_197()
{
	...
	iVar0 = unk_0x4F5F2FB7AE0EB7AB(unk_0x9B0761B4C3EB8BC7());
	iVar0 = (iVar0 + (1 + iLocal_288));
	if (iVar0 > unk_0x2A82FAC1E55962C6(unk_0x9B0761B4C3EB8BC7()))
	{
		iVar0 = unk_0x2A82FAC1E55962C6(unk_0x9B0761B4C3EB8BC7());
	}
	unk_0x697DA7132EE43ABC(unk_0x9B0761B4C3EB8BC7(), iVar0, 0);
	func_198();
}
...
void func_198()
{
	...
	if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
	{
		iLocal_57 = unk_0x4F5F2FB7AE0EB7AB(unk_0x9B0761B4C3EB8BC7());
	}
}

bool func_199(int iParam0)
{
	return (((unk_0x9934470AA0A08B57(iParam0, func_54(), func_46(11), 3) || unk_0x9934470AA0A08B57(iParam0, func_54(), func_46(21), 3)) || unk_0x9934470AA0A08B57(iParam0, func_52(), func_45(11), 3)) || unk_0x9934470AA0A08B57(iParam0, func_52(), func_45(21), 3));
}

bool func_200()
{
	return unk_0x9934470AA0A08B57(iLocal_90, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_201(iLocal_90, func_49(), 1), 3);
}
...
char* func_201(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!unk_0xA59F96B50B97E63C(iParam0, 0))
	{
		iVar1 = unk_0xA5D5B1042E8F47BD(iParam0, true);
...
void func_202()
{
	...
	if (unk_0xF282AA6FECA1EF23(iLocal_90) || unk_0xF282AA6FECA1EF23(unk_0x9B0761B4C3EB8BC7()))
	{
		return;
	}
	if (unk_0x344C570D6F8700DF(0, 5000) > 2500)
	{
		func_203();
	}
}
...
void func_203()
{
	...
	if (!unk_0xF282AA6FECA1EF23(iLocal_90) && !unk_0xF282AA6FECA1EF23(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		else if (func_7(&iLocal_101) > unk_0x658086F2B3C5E4E4(2f, 5f))
		{
			if (!func_488(iLocal_49, 65536))
			{
				func_480(&iLocal_49, 65536);
				unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "SEX_GENERIC", "SPEECH_PARAMS_FORCE_NORMAL_CLEAR", 1);
				func_204(iLocal_289);
			}
			else
			{
...
void func_204(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				unk_0xFDCFA91E51EDB61F(iLocal_90, "SEX_ORAL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				unk_0xFDCFA91E51EDB61F(iLocal_90, "SEX_ORAL_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
		...
		case 2:
			if (func_205(unk_0x460153A63B9477BC()))
			{
				unk_0xFDCFA91E51EDB61F(iLocal_90, "SEX_GENERIC", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				unk_0xFDCFA91E51EDB61F(iLocal_90, "SEX_GENERIC_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
	}
}
...
int func_207(float fParam0)
{
	...
	if (func_208(unk_0x460153A63B9477BC(), 1, 1))
	{
		fVar0 = unk_0xD65774609B1D945A(unk_0x460153A63B9477BC());
		if (fVar0 > fParam0)
		{
			return 1;
		}
...
bool func_219(int iParam0)
{
	...
	if (func_548())
	{
		bVar0 = unk_0xFC5D6FB6EECB392F(unk_0xAB6BAF5BFCAFB141(iParam0));
	}
	else
	{
		bVar0 = unk_0xFC5D6FB6EECB392F(iParam0);
	}
	return bVar0;
}
...
void func_220()
{
	if (unk_0x03DB5C6AABF8DA46())
	{
		...
		unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), func_222(), 1, false, 0, 1);
		unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), func_221());
		func_539();
		unk_0x3ED9330214992278(false, false, 3000, true, 0, 0);
		unk_0x586DDC617E714637(&iLocal_90);
	}
...
void func_223()
{
	...
	if (func_225(&iLocal_98, 3f) && !unk_0xC516FEEB950FFD58(iLocal_97))
	{
		iVar0 = floor(((func_224() - 2f) * 1000f));
		unk_0x856549C07003344B(iLocal_96, false);
		unk_0xF674D9B2033F5F86(iLocal_97, iLocal_96, iVar0, 1, 1);
	}
	...
	if (unk_0xAE06B9E39EBDE049(*uParam0))
	{
		if (unk_0x20F7576FDB52E2B0(*uParam0))
		{
			if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false) == unk_0xEA90A5DC55A2F652(*uParam0))
					{
						func_123(0);
						unk_0x9B94F6169B0DAEFD(unk_0x9B0761B4C3EB8BC7());
						func_539();
...
void func_229(var uParam0)
{
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_90))
	{
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
		{
			iVar0 = unk_0x4F5F2FB7AE0EB7AB(iLocal_90);
...
void func_232()
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
	{
		iLocal_93 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false);
		if (func_548())
		{
			if (unk_0xAA5B806352173DEA(iLocal_93))
			{
				unk_0xAAA20773FBB4CFA4(iLocal_93, true);
				unk_0x289D342D7C2DA52A(iLocal_93, 4);
				unk_0x0155E49186C056FA(iLocal_93, 1);
				unk_0x74172B5AFD503628(iLocal_93, false, 0);
			}
		}
		else
		{
		...
		if (!func_378() || !unk_0xE0B3BC41DDA88DF0(iLocal_90, iLocal_93, false))
		{
			func_471(0);
			return;
		}
	...
	func_213(0);
	if ((!unk_0xFD7B900D58065E3B(iLocal_93) && unk_0x4DC4117F94CD5B84(unk_0x460153A63B9477BC())) && !func_488(iLocal_49, 1024))
	{
		iLocal_286 = 7;
		func_376(1, -1);
		unk_0x8B917081F9836EDD("SCRIPT\HUD_321_GO", true, -1);
		iLocal_292 = 0;
	...
	switch (iLocal_292)
	{
		...
		case 1:
			if (func_548())
			{
				if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
				{
					...
					{
						if (unk_0x4349BF35C5B9A49B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
						{
							if (unk_0x10D3F7E169A49C44(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), -1, 0) == unk_0x9B0761B4C3EB8BC7())
							{
								if (unk_0xAA5B806352173DEA(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
								{
									if (!unk_0x1758275D343D5BA3(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
									{
										unk_0x4F3C4F457D44BB0F(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), false, 0);
									}
								}
								else
								{
									unk_0xDE298EE8EAAC0776(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false));
									return;
								}
							}
						}
						...
						{
							unk_0xFCB8008752260F77(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false));
							return;
						}
					}
				}
					...
					if (func_548())
					{
						if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
						{
							if (unk_0x4349BF35C5B9A49B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
							{
								if (unk_0xAA5B806352173DEA(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
								{
									unk_0x69B8739B0B73352F(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), true);
									unk_0x5DC21979EC6C531F(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 4);
									unk_0x1491D110B8361BFE(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 1);
								}
							}
						}
					}
				}
				unk_0x8579A8624726DC76(iLocal_90);
				iLocal_292 = 2;
			}
			break;
		...
		case 2:
			...
			if (func_366(unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (func_364(&sVar1, 0))
				{
					iLocal_48 = unk_0x1075BD5031B0682E();
					iVar2 = unk_0xA860C15A1C027CBB();
		...
		case 3:
			...
			if (((unk_0x1BD7199394D7F19A(2, 187) || (unk_0xC1F43F8D0D5EB664(2) && unk_0x1BD7199394D7F19A(2, 242))) || (unk_0xC1F43F8D0D5EB664(2) && unk_0x79800E51B3B6D197(0, 33))) || (((unk_0xF8EDFF98A9C94C74() && !unk_0xC1F43F8D0D5EB664(2)) && iVar4 > 100) && (unk_0x578C4EF320340AF7() - iLocal_87) > 300))
			{
				unk_0xC4CC25B68A91D144(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			...
			else if (((unk_0x1BD7199394D7F19A(2, 188) || (unk_0xC1F43F8D0D5EB664(2) && unk_0x1BD7199394D7F19A(2, 241))) || (unk_0xC1F43F8D0D5EB664(2) && unk_0x79800E51B3B6D197(0, 32))) || (((unk_0xF8EDFF98A9C94C74() && !unk_0xC1F43F8D0D5EB664(2)) && iVar4 < -100) && (unk_0x578C4EF320340AF7() - iLocal_87) > 300))
			{
				unk_0xC4CC25B68A91D144(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
				func_489("UP pressed!");
				if (iLocal_68 > 0)
		...
		case 4:
			iVar7 = unk_0x205CACAFF6AED46B(iLocal_90);
			if (iLocal_288 == 3)
			{
				func_376(1, -1);
				func_284();
				...
				else
				{
					if (func_278() >= 20)
					{
						iVar7 += 20;
						func_234(20);
						unk_0x055A73D4AFD214F1(iLocal_90, iVar7);
					}
					func_471(1);
					return;
				}
...
void func_234(int iParam0)
{
	...
	{
		unk_0xA4501C03DC8F9AF5(iParam0, 0, 0);
	}
	else
	{
...
int func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!unk_0x5053392075AA583C(func_140()) || unk_0x701B05C16EF4F48E())
		{
			Global_4265553 = 1;
			return 0;
		}
...
void func_252(int iParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, iParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_254() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		unk_0xD2459066EA58CE43(&(Global_111858.f_20560.f_471), iParam0);
		unk_0xD2459066EA58CE43(&(Global_2097152[func_254() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x5B8DD855EAFD33B5("COUP_RED");
		unk_0x6A826E35A3096ED0(func_253(iParam0));
...
bool func_256(int iParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_254() /*10931*/].f_6175.f_10, iParam0);
}
...
int func_278()
{
	if (func_548())
	{
		return func_280(unk_0x460153A63B9477BC());
	}
...
{
	if (unk_0x9301B13EC408DE79() != 255)
	{
		unk_0x8F125D76F29885E2(iParam0);
		unk_0x759283FEF4AB96B3(iParam0);
	}
}
...
void func_286()
{
	...
	else
	{
		...
		if (iLocal_289 == 0)
		{
			...
			unk_0x8B917081F9836EDD("PROSTITUTE_BLOWJOB", false, -1);
			iLocal_288 = 0;
		}
		...
		if (iVar5 == 1 && Global_22550.f_5728)
		{
			...
			if (unk_0x856D5567211886A2(&(Global_22550.f_4690)) != 0 && Global_22550.f_4766 != -1)
			{
				...
				if (Global_22550.f_4768 != 0)
				{
					...
					unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4768), func_318(Global_22550.f_4768, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
			...
			if (unk_0x856D5567211886A2(&(Global_4269680.f_21)) != 0 && Global_4269680.f_65 != -1)
			{
				...
				if (Global_4269680.f_67 != 0)
				{
					...
					unk_0x177AA645FB4B3A38(func_321(Global_4269680.f_67), func_318(Global_4269680.f_67, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((unk_0xBA269EB4693A8C47(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_327(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_327(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													unk_0x177AA645FB4B3A38(func_321(26), func_318(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
										if (func_327(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_327(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													unk_0x177AA645FB4B3A38(func_321(27), func_318(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
									}
												...
												if (func_327(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_327(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_22550.f_5083[iVar8] == 2)
															{
																unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4433[(iVar22 + iVar28)]), func_318(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4433[(iVar22 + iVar28)]), func_318(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
									...
									if (unk_0x856D5567211886A2(&(Global_22550.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_302() && unk_0x7B70881748D166CD(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
												...
												if (func_327(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_327(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4433[(iVar22 + iVar14)]), func_318(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (Global_22547 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else if (Global_22550.f_5083[iVar8] == 2)
															{
																unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4433[(iVar22 + iVar14)]), func_318(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4433[(iVar22 + iVar14)]), func_318(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
													}
									...
									if (func_327(Global_22550.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_327(Global_22550.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												unk_0x177AA645FB4B3A38(func_321(Global_22550.f_4433[iVar22]), func_318(Global_22550.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_299(Global_22550.f_4433[iVar22])), (fVar37 * func_299(Global_22550.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0);
											}
										}
									}
								}
...
var func_318(int iParam0, bool bParam1)
{
	...
	if (!unk_0x7BCC91F3C1CF24E8(&(Global_22550.f_7029[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_320(unk_0x460153A63B9477BC()) };
...
char* func_321(int iParam0)
{
	...
	if (!unk_0x7BCC91F3C1CF24E8(&(Global_22550.f_6020[iParam0 /*16*/])))
	{
		...
		{
			Var1 = { func_320(unk_0x460153A63B9477BC()) };
...
int func_329(bool bParam0, bool bParam1)
{
	...
	if ((((((((!unk_0x87F0CB19476706C3() || (func_30(8, -1) && func_330() != 65)) || (unk_0xCFB49FF4012D7C68() != 0 && !bParam1)) || (unk_0x9CC4D06F5338CA6B() && !bParam0)) || unk_0x954BAB46FBB90036()) || Global_77093) || Global_22550.f_8416) || unk_0x06EBE4F22EC30D45()) || Global_99007.f_1425)
	{
		return 0;
	}
	return 1;
...
void func_332()
{
	...
	{
		iLocal_295 = func_350();
		func_341(&iLocal_295, 0, 0, unk_0x344C570D6F8700DF(1, 2), 0, 0, 0);
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_167(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_350()
{
	...
	func_348(&uVar0, unk_0x1D3A3697182AD8B3());
	func_347(&uVar0, unk_0x81F2E25F8C019191());
	func_346(&uVar0, unk_0x1F596C965B00E290());
	func_344(&uVar0, unk_0x371CFD525753F70C());
	func_345(&uVar0, unk_0xF225116F449A5CC6());
	func_343(&uVar0, unk_0x2E48CFA70ABFC06A());
	return uVar0;
}
...
int func_364(char* sParam0, int iParam1)
{
	...
	if (unk_0x25DDB354A40FFCDB() && func_365(unk_0x460153A63B9477BC()))
	{
...
int func_366(int iParam0, bool bParam1)
{
	...
	else if (!unk_0x9934470AA0A08B57(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_110(bParam1), 3) && unk_0x16BC17A8EDC701A2(iParam0, -2017877118) != 1)
	{
		if (func_548())
		{
			if (iParam0 == unk_0x9B0761B4C3EB8BC7())
			{
				if (!func_205(unk_0x460153A63B9477BC()))
				{
					iVar0 = unk_0x3FB4D40A857CEA77(unk_0x9B0761B4C3EB8BC7(), 6);
					if (!func_521(256))
					{
						func_196(256);
						iLocal_84 = iVar0;
						iLocal_85 = unk_0x79AFA009D186C4FB(unk_0x9B0761B4C3EB8BC7(), 6);
						unk_0x45F588C0DD767737(unk_0x9B0761B4C3EB8BC7(), 6, 1, 0, 0);
						func_196(1024);
					}
				}
				unk_0x756D74A3EF0AB788(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_367(bParam1), 2f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else
			{
				unk_0x756D74A3EF0AB788(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_367(bParam1), 2f, -8f, -1, 0, 0, 0, 0, 0);
	...
	{
		if (unk_0x9934470AA0A08B57(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_367(bParam1), 3))
		{
			if (unk_0x4C06B15B376AA145(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_367(bParam1)) >= 0.95f)
			{
				unk_0x756D74A3EF0AB788(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_110(bParam1), 8f, -2f, -1, 1, 0, 0, 0, 0);
			}
		}
		if (unk_0x9934470AA0A08B57(iParam0, func_50(unk_0x9B0761B4C3EB8BC7(), 0, 0), func_110(bParam1), 3))
		{
			return 1;
		}
	}
...
void func_370()
{
	...
	unk_0xC4B63A43FAB1F06F(iLocal_90);
	if (!unk_0xF282AA6FECA1EF23(iLocal_90))
	{
		if (iLocal_70 < 1)
		{
			unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_OFFER_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_OFFER_AGAIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
int func_371()
{
	if (func_372(0, -1, 0) && unk_0x8B917081F9836EDD("SCRIPT\HUD_321_GO", true, -1))
	{
		return 1;
	}
	return 0;
...
void func_374()
{
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_90))
	{
		iLocal_58 = unk_0x4F5F2FB7AE0EB7AB(iLocal_90);
	}
}
...
void func_375()
{
	...
	if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
		{
			...
			if (unk_0xAE06B9E39EBDE049(iVar0))
			{
				Local_56 = { unk_0x3E4D3CCC220BDFB1(iVar0, true) };
			}
		}
	}
}
	...
	if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
	{
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
		{
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
			{
				...
				if (!iLocal_93 == 0)
				{
					if ((unk_0x80FF6C016CDB0FAF(iLocal_93, 0) && !unk_0x0922C2E075A5F18C(iLocal_93)) && !unk_0x50F857464DE13ED2(iLocal_93))
					{
...
int func_380(int iParam0)
{
	...
	Var1 = { unk_0x3E4D3CCC220BDFB1(iLocal_93, true) };
	if (iLocal_299[iParam0] == 0)
	{
		if (unk_0x36FE6D3220816ADA(iLocal_93) == joaat("tyrant"))
		{
			iLocal_299[iParam0] = unk_0xFEFC406F4702C938(Var0, Var1, 0.1f, 511, iLocal_93, 3);
		}
		else if ((unk_0x36FE6D3220816ADA(iLocal_93) == joaat("casco") || unk_0x36FE6D3220816ADA(iLocal_93) == joaat("feltzer3")) || unk_0x36FE6D3220816ADA(iLocal_93) == joaat("fagaloa"))
		{
			iLocal_299[iParam0] = unk_0xFEFC406F4702C938(Var0, Var1, 0.15f, 511, iLocal_93, 3);
		}
		else
		{
			iLocal_299[iParam0] = unk_0xFEFC406F4702C938(Var0, Var1, 0.25f, 511, iLocal_93, 3);
		}
	}
	else
	{
		switch (unk_0x0F0E6A09A9C90474(iLocal_299[iParam0], &iVar2, &uVar3, &uVar4, &uVar5))
		{
			case 2:
...
void func_382()
{
	if (func_387() && !unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), true))
	{
		iLocal_286 = 9;
		func_385(iLocal_90);
...
void func_383()
{
	...
	if (!unk_0x40397A9A17EEC1C5(iLocal_96))
	{
		iLocal_96 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", true);
	}
	if (!unk_0x40397A9A17EEC1C5(iLocal_97))
	{
		iLocal_97 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", true);
	}
	func_384(&Var0, &Var1);
	unk_0x8A3898631CCEC253(iLocal_96, Var0);
	unk_0xBF92D2A60C7C686E(iLocal_96, Var0.f_3, 2);
	unk_0xD64C2E5B5BA2D347(iLocal_96, Var0.f_6);
	unk_0x8A3898631CCEC253(iLocal_97, Var1);
	unk_0xBF92D2A60C7C686E(iLocal_97, Var1.f_3, 2);
	unk_0xD64C2E5B5BA2D347(iLocal_97, Var1.f_6);
	unk_0x856549C07003344B(iLocal_96, true);
	unk_0x856549C07003344B(iLocal_97, false);
	unk_0x3ED9330214992278(true, false, 3000, true, 0, 0);
}
...
void func_385(int iParam0)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		unk_0x3C1B180EE30D36EF(0, func_386(), 1f, -1, 0.5f, 8192, 1193033728);
		unk_0x19F29730874AD6F1(iVar0);
		unk_0x9B6EC2CECE1010EF(iParam0, iVar0);
		unk_0x4F83FEE4454169D4(&iVar0);
	}
...
bool func_387()
{
	return vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), func_389()) < (func_388() * func_388());
}
...
void func_390()
{
	...
	if (func_378() && unk_0xE0B3BC41DDA88DF0(iLocal_90, iLocal_93, false))
	{
		if (unk_0xFD7B900D58065E3B(iLocal_93) && unk_0xFEB73FC16397E7DC(iLocal_93))
		{
			if ((func_397() && !func_387()) && !func_396())
			{
				...
				{
					iLocal_83 = unk_0x5700FF65A7E1B390(unk_0x3E4D3CCC220BDFB1(iLocal_93, false), 40f, 40f, 40f, unk_0xEF7858F25585F853(iLocal_93), 0, 7);
					unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 896);
					func_480(&iLocal_49, 2048);
					iLocal_94 = 0;
					unk_0xDE8F8016287F771F("ProstituteInPlay", &iLocal_298);
					unk_0xEFBCE8F8316F89EA(1, iLocal_298, 1862763509);
					unk_0xD3D9D7C84656DAE5(iLocal_90, iLocal_298);
			...
			{
				if ((!unk_0xF282AA6FECA1EF23(unk_0x9B0761B4C3EB8BC7()) && func_7(&iLocal_101) > 15f) && func_393())
				{
...
void func_392()
{
	...
	if (!unk_0xF282AA6FECA1EF23(iLocal_90))
	{
		unk_0xFDCFA91E51EDB61F(iLocal_90, "HOOKER_SECLUDED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_394()
{
	if (func_548())
	{
		unk_0x694113444F21E39F(iLocal_90, 229, true);
		unk_0x694113444F21E39F(iLocal_90, 26, true);
		unk_0x694113444F21E39F(iLocal_90, 115, true);
		unk_0x4E65320BC9AD521C(iLocal_90, true);
	}
}
...
void func_395()
{
	...
	{
		if (unk_0x578C4EF320340AF7() > iLocal_82)
		{
			if (iLocal_94 == 0)
			{
				Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_93, true) };
				unk_0xE5CC8E2D904E42CE(Var0, &fVar2, 0, 0);
				Var0.f_2 = (fVar2 + 0.15f);
				Var1 = { unk_0x7EC595B99EA7C4B1(iLocal_93, 0f, 0f, -2f) };
				iLocal_94 = unk_0x8C487ECF9D628D82(Var0, Var1, 2f, 511, iLocal_93, 7);
			}
			else if (unk_0x572B1A4916CDD492(iLocal_94, &iVar4, &uVar5, &uVar6, &iVar3, &uVar7) == 2)
			{
				if (iVar4 != 0)
				{
				...
				iLocal_82 = unk_0x578C4EF320340AF7() + 1500;
				iLocal_94 = 0;
			}
		}
	}
...
int func_396()
{
	...
	if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
	{
		if (!unk_0xB064AF9925F5537B(iVar0, 0, 0))
		{
			if (unk_0xE72C9284B5143451(unk_0x9B0761B4C3EB8BC7()) || unk_0xE72C9284B5143451(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
			{
				return 1;
			}
		}
...
int func_397()
{
	...
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (unk_0x54F52A5BEDE97CCE(Var1, func_65(0), 12f, 0) || unk_0x54F52A5BEDE97CCE(Var1, func_65(1), 12f, 0))
		{
			return 0;
		}
		if (func_403())
		...
		if (func_90(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), (30f * 0.5f)))
		{
			return 0;
		}
		if (!unk_0xC7C55C82599F980F(iLocal_90, iLocal_93, 0, 0, false))
		{
			return 0;
		}
		unk_0xD2E53219EC6962DD(1);
		if (unk_0x3BC72261A2457EAF(Var1, 20f, 1, 1, &iVar0, 0, 1, -1))
		{
			if (unk_0xAE06B9E39EBDE049(iVar0))
			{
				if (!unk_0xA59F96B50B97E63C(iVar0, 0))
				{
					if (unk_0xD44D03437956A1ED(iVar0, iLocal_93, 17))
					{
						return 0;
					}
				}
		...
		iVar3 = unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7());
		if (!iVar3 == 0)
		{
...
{
	if (((((((((vdist(Param0, 491.76f, -515.73f, 29.51f) <= 12f || vdist(Param0, -1453.385f, -594.2627f, 29.7966f) <= 12f) || vdist(Param0, -633.6086f, -332.3337f, 33.81f) <= 25f) || vdist(Param0, -1493.191f, -693.9906f, 26.0665f) <= 25f) || vdist(Param0, -1512.938f, -675.6082f, 27.4202f) <= 25f) || vdist(Param0, -1388.642f, -1342.266f, 3.1626f) <= 25f) || vdist(Param0, 50.2024f, -1392.306f, 28.4166f) <= 12f) || vdist(Param0, 25.9811f, -1392.289f, 28.3356f) <= 12f) || vdist(Param0, 10.0435f, -1391.596f, 28.3074f) <= 12f) || vdist(Param0, -1196.6f, -519.6772f, 31.9742f) <= 12f)
	{
		return 1;
	}
	return 0;
...
{
	if ((((((vdist(Param0, -1582.782f, 5168.163f, 18.5615f) <= 15f || vdist(Param0, -1445.73f, -640.8375f, 28.7804f) <= 15f) || vdist(Param0, -348.7544f, 292.5813f, 83.9843f) <= 15f) || vdist(Param0, -273f, 317.8898f, 92.2549f) <= 15f) || vdist(Param0, -1627.935f, -1083.443f, 3.2819f) <= 40f) || vdist(Param0, -1661.098f, -1057.73f, 2.5729f) <= 40f) || vdist(Param0, -1518.358f, -553.8981f, 32.1463f) <= 15f)
	{
...
int func_401(struct<3> Param0)
{
	...
	iVar0 = unk_0xBD67304F930F21E4(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), 1, 1, 1077936128, 0);
	unk_0x1EFE169AA25C75A7(iVar0, &Param0);
	if (unk_0x061CA1649D051C95(iVar0))
	{
		if (!unk_0xEF445D270DD603D8(iVar0))
		{
			if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), Param0) > 400f)
			{
				return 1;
			}
		}
		else if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), Param0) > 56.25f)
		{
			return 1;
		}
	}
	else if (!unk_0xEF445D270DD603D8(iVar0))
	{
		if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), Param0) > 400f)
		{
			return 1;
	...
	{
		iVar0 = unk_0xBD67304F930F21E4(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), 1, 8, 1077936128, 0);
		unk_0x1EFE169AA25C75A7(iVar0, &Param0);
		if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), Param0) > 400f)
		{
			return 1;
...
int func_402(int iParam0, var uParam1)
{
	...
	Var0[0 /*3*/] = { unk_0x7EC595B99EA7C4B1(iParam0, 2f, 0f, 0f) };
	Var0[1 /*3*/] = { unk_0x7EC595B99EA7C4B1(iParam0, -2f, 0f, 0f) };
	Var0[2 /*3*/] = { unk_0x7EC595B99EA7C4B1(iParam0, 0f, 2f, 0f) };
	Var0[3 /*3*/] = { unk_0x7EC595B99EA7C4B1(iParam0, 0f, -2f, 0f) };
	if (unk_0x839A6C79727042B3(Var0[0 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x839A6C79727042B3(Var0[1 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x839A6C79727042B3(Var0[2 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x839A6C79727042B3(Var0[3 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	return 0;
...
int func_404()
{
	if (unk_0x7B70881748D166CD(joaat("carwash1")) > 0 || unk_0x7B70881748D166CD(joaat("carwash2")) > 0)
	{
		return 1;
	}
	return 0;
...
int func_410(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x25DDB354A40FFCDB())
	{
		if (func_153() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_141(func_408(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_412()
{
	if (!unk_0xA59F96B50B97E63C(iLocal_90, 0))
	{
		if (unk_0x910DFF8E55ABB8EC(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 5f, 5f, 5f, 0, 1, 0) || func_488(iLocal_49, 8192))
		{
			unk_0x779660A9E5364C4D(0, 101, 1);
			unk_0x779660A9E5364C4D(0, 74, 1);
			unk_0x26A60F42A1132477(0, 51);
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false) && unk_0x47DBF174A0CB9D55(iLocal_90, false))
			{
				unk_0x1CCBC799127EA27B(iLocal_90, 50);
				unk_0x5725FB9B2BC1D6B6(iLocal_90, 5f);
				if (func_488(iLocal_49, 16))
				{
					if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
					{
				...
				if (unk_0x80FF6C016CDB0FAF(iLocal_93, 0))
				{
					if (unk_0xACBCFA3095C5A434(iLocal_90, iLocal_93) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_93, false))
					{
						...
						if (func_488(iLocal_49, 8))
						{
							if (unk_0x8FBC2B79465DEB9E(func_92()))
							{
								...
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_RESTRICTED_PASSENGER"));
								}
								else if (func_425(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_RESTRICTED_NOAMBIENT_PASSENGER"));
								}
								else if (func_424(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_LOWRIDER_PASSENGER"));
								}
								else if (func_423(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_LOWRIDER2_PASSENGER"));
								}
								else if (func_422(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_INFERNUS2_PASSENGER"));
								}
								else if (func_421(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_SC1_PASSENGER"));
								}
								else if (func_420(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_TEZERACT_PASSENGER"));
								}
								else if (func_419(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_DOMINATOR3_PASSENGER"));
								}
								else if (func_418(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_ITALIGTO_PASSENGER"));
								}
								else if (func_417(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_RESTRICTED_SCHLAGEN_PASSENGER"));
								}
								else if (func_416(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_NEO_PASSENGER"));
								}
								else if (func_415(iLocal_93))
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_PEYOTE2_PASSENGER"));
								}
								else
								{
									unk_0x63AC84DDF7661604(iLocal_90, unk_0x856D5567211886A2("MINI_PROSTITUTE_LOW_PASSENGER"));
								}
							}
						}
						if (func_548())
						{
							unk_0x4F3C4F457D44BB0F(iLocal_90, false, 0);
						}
						else
						{
							unk_0x4F3C4F457D44BB0F(iLocal_90, true, 1);
						}
						func_182(iLocal_90, 0);
						func_392();
						iLocal_62 = unk_0x578C4EF320340AF7();
			...
			{
				if ((func_414(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 1) > 11f || func_413(20f)) || !unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_93, false))
				{
					func_115(&iLocal_107);
					if (!unk_0x47DBF174A0CB9D55(iLocal_90, false))
					{
						unk_0x9B94F6169B0DAEFD(iLocal_90);
						func_471(0);
				...
				if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
				{
					...
					else if (!unk_0xC7C55C82599F980F(iLocal_90, iLocal_93, 0, 0, false))
					{
						if (!func_112())
						{
...
void func_427(var uParam0)
{
	...
	if (func_121(&iLocal_107) >= 20f || !unk_0x910DFF8E55ABB8EC(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 3f, 3f, 3f, 0, 1, 0))
	{
		if (func_488(iLocal_73, 524288))
		{
			func_115(&iLocal_107);
	...
	func_69(iLocal_90);
	if (((unk_0x910DFF8E55ABB8EC(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 3f, 3f, 3f, 0, 1, 0) || func_488(iLocal_73, 1)) && !func_217(0)) && !func_403())
	{
		if (!unk_0xC7C55C82599F980F(iLocal_90, iLocal_93, 0, 0, false))
		{
			if (!func_112())
	...
	else if (func_468("PROS_ACCEPT"))
	{
		...
		if (func_548())
		{
			iVar0 = unk_0x16BC17A8EDC701A2(iLocal_90, -2017877118);
			if (iVar0 != 1 && iVar0 != 0)
			{
				func_539();
				func_533(uParam0);
...
void func_428()
{
	...
	{
		func_431();
		if (func_429(iLocal_72, 1) || unk_0x99BF74E1D085CEA6(unk_0x460153A63B9477BC()))
		{
			unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "HOOKER_REQUEST", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		...
		if (func_488(iLocal_49, 8192))
		{
			func_466();
			Global_31118 = 1;
			Global_2425869[unk_0x460153A63B9477BC() /*443*/].f_415 = 1;
			func_131("PROSTITUTES_SOLICIT_SCENE");
			func_87("PROSTITUTES_DRIVE_SCENE");
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
			{
				if (unk_0x16BC17A8EDC701A2(iLocal_90, -1794415470) != 1 && !unk_0xE0B3BC41DDA88DF0(iLocal_90, unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), true))
				{
					unk_0xC584E49FC3559A86(iLocal_90, iLocal_93, -1, 0, 1f, 8388609, 0);
				}
			}
			sLocal_61 = func_50(unk_0x9B0761B4C3EB8BC7(), 1, 0);
			unk_0x131ED02492676000(sLocal_61);
...
int func_435()
{
	...
	if (!func_548())
	{
		...
		{
			iVar0 = unk_0x344C570D6F8700DF(8, 11);
			unk_0x9DC06E2A59C5AEBB(&iVar1);
			unk_0x756D74A3EF0AB788(0, func_67(iLocal_284), func_66(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, func_67(iLocal_284), func_66(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0x19F29730874AD6F1(iVar1);
			unk_0x9B6EC2CECE1010EF(iLocal_90, iVar1);
			unk_0x4F83FEE4454169D4(&iVar1);
		}
	...
	switch (iLocal_55)
	{
		...
		case 1:
			if (unk_0xAA5B806352173DEA(iLocal_90))
			{
				unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
				iLocal_55 = 2;
			}
			else
			{
		...
		case 2:
			if (unk_0xAA5B806352173DEA(iLocal_90))
			{
				...
				{
					iVar0 = unk_0x344C570D6F8700DF(8, 11);
					unk_0x756D74A3EF0AB788(iLocal_90, func_67(iLocal_284), func_66(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
					iLocal_55 = 3;
				}
			}
			else
...
int func_436(bool bParam0)
{
	...
	if (func_414(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 1) > 11f)
	{
		return 0;
	}
	if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
	...
	if (func_548())
	{
		if (unk_0xBFBFB3EA52D66EB5(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)) > 1)
		{
			return 0;
		}
	}
	if (bParam0)
	{
		if (unk_0xF3A639BEE7AADF55(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)) > 2f)
		{
			return 0;
		}
	}
	if (func_90(unk_0x3E4D3CCC220BDFB1(iLocal_90, true), 1106247680))
	{
...
void func_437()
{
	...
	{
		if (!unk_0xF282AA6FECA1EF23(unk_0x9B0761B4C3EB8BC7()) && !unk_0xF282AA6FECA1EF23(iLocal_90))
		{
			unk_0xFDCFA91E51EDB61F(unk_0x9B0761B4C3EB8BC7(), "HOOKER_CAR_INCORRECT", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
...
void func_439()
{
	...
	{
		func_428();
		if (unk_0x16BC17A8EDC701A2(iLocal_90, 242628503) == 7 && !func_488(iLocal_49, 8192))
		{
			if (func_72(1))
			{
				func_115(&iLocal_107);
...
void func_441(var uParam0)
{
	...
	if (!unk_0xAE06B9E39EBDE049(iLocal_93))
	{
		return;
	}
	unk_0x140662B520844E45(unk_0x36FE6D3220816ADA(iLocal_93), &Var2, &Var1);
	Var0 = { Var1 - Var2 };
	Var0 = { Var0 / Vector(2f, 2f, 2f) };
	Var3 = { unk_0x7EC595B99EA7C4B1(iLocal_93, -(Var0.x + 0.2f), 0f, 0f) };
	Var4 = { unk_0x7EC595B99EA7C4B1(iLocal_93, (Var0.x + 0.2f), 0f, 0f) };
	Var5 = { unk_0x3E4D3CCC220BDFB1(iLocal_90, true) };
	if (vdist(Var5, Var4) < vdist(Var5, Var3))
	{
		Var3 = { Var4 };
	}
	if ((unk_0x16BC17A8EDC701A2(iLocal_90, -1794415470) != 1 || !func_488(iLocal_49, 8192)) && vdist2(Local_89, Var3) > 0f)
	{
		if (func_548())
		{
			if (!unk_0x1758275D343D5BA3(iLocal_90))
			{
				unk_0x4F3C4F457D44BB0F(iLocal_90, false, 1);
			}
		...
		unk_0x3C1B180EE30D36EF(0, Var3.x, Var3.f_1, Var3.f_2, 1f, -1, 1f, 8192, 1193033728);
		unk_0xB53E642F4F50E7C0(0, unk_0x1D5C49FCA9BC5B02(unk_0x9B0761B4C3EB8BC7(), 31086, 0f, 0f, 0f), 0);
		unk_0x19F29730874AD6F1(iVar6);
		unk_0x9B6EC2CECE1010EF(iLocal_90, iVar6);
	...
	if (func_436(1))
	{
		...
		if (func_469(&iLocal_107, 2f) || func_488(iLocal_49, 8192))
		{
			...
			if (func_364(&sVar0, 0))
			{
				...
				unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_90, -1, 2048, 4);
				func_441(uParam0);
				func_480(&iLocal_49, 4);
				Global_31118 = 1;
				Global_2425869[unk_0x460153A63B9477BC() /*443*/].f_415 = 1;
			...
			{
				if (unk_0xF005CCA4263DF67F(func_465(&sVar0), "PIM_HHIDCR"))
				{
				...
				if (!unk_0x7BCC91F3C1CF24E8(&sVar0) && unk_0xF005CCA4263DF67F(&sVar0, "PROS_NO_MONEY"))
				{
					func_454();
				}
				func_96(0);
				...
				func_5(&iLocal_49, 4);
				Global_31118 = 0;
				Global_2425869[unk_0x460153A63B9477BC() /*443*/].f_415 = 0;
			}
		}
	}
	else
...
void func_455(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x25DDB354A40FFCDB() && func_459(unk_0x460153A63B9477BC(), 1, 0))
	{
		return;
	}
...
void func_462(int iParam0)
{
	...
	if (iParam0 && !func_463())
	{
		unk_0xC4CC25B68A91D144(-1, "Event_Message_Purple", "GTAO_FM_Events_Soundset", false);
	}
}
...
int func_483()
{
	...
	iLocal_92 = unk_0x84F0027A508D7D7D(unk_0x3E4D3CCC220BDFB1(iLocal_90, true), 15f, 0, 6);
	if (unk_0xAE06B9E39EBDE049(iLocal_92) && !unk_0xA59F96B50B97E63C(iLocal_92, 0))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_92, 0))
		{
			if (func_91(&iLocal_92))
			{
				iLocal_91 = unk_0x10D3F7E169A49C44(iLocal_92, -1, 0);
				if (!iLocal_91 == 0)
				{
					if (func_484(&iLocal_91))
					{
						iVar0 = unk_0x36FE6D3220816ADA(iLocal_92);
						if (!iVar0 == joaat("taxi") && !iVar0 == joaat("taxi"))
						{
							if (!unk_0x1758275D343D5BA3(iLocal_91))
							{
								unk_0x4F3C4F457D44BB0F(iLocal_91, true, 0);
							}
							if (!unk_0x1758275D343D5BA3(iLocal_92))
							{
								unk_0x4F3C4F457D44BB0F(iLocal_92, true, 0);
							}
							unk_0x4E65320BC9AD521C(iLocal_91, true);
							unk_0xA5EAD2ACE2C8BBB2(iLocal_91, false, 1);
							unk_0xA5EAD2ACE2C8BBB2(iLocal_92, false, 1);
							return 1;
						}
					}
				}
...
int func_485()
{
	if (unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0) || unk_0xA59F96B50B97E63C(iLocal_90, 0))
	{
		return 0;
	}
	return 1;
...
int func_486()
{
	if ((!func_485() || !unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false)) || func_488(iLocal_49, 4096))
	{
		return 0;
	}
	if (func_488(iLocal_49, 32))
...
void func_487()
{
	if (!unk_0xA59F96B50B97E63C(iLocal_90, 0))
	{
		if (!unk_0xA26A1295C5145A11(iLocal_90))
		{
			if (unk_0x16BC17A8EDC701A2(iLocal_90, 1805844857) != 1)
			{
				unk_0x4E65320BC9AD521C(iLocal_90, false);
				unk_0x6AC7395A8E313A46(iLocal_90, 196628, true);
				unk_0x1210730BDCD39CB4(iLocal_90);
				unk_0x8B18A80E8EB15510(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 1, 0);
				unk_0xCBA6B2B569DCAFD8(iLocal_90, true);
				func_96(15);
			}
		}
	}
...
int func_490()
{
	...
	if (unk_0x16BC17A8EDC701A2(iLocal_90, 1435919172) == 1)
	{
		return 0;
	}
	if (unk_0x72F0AF5428620E43(iLocal_90))
	{
		return 0;
	}
	return 1;
	...
	switch (iLocal_291)
	{
		...
		case 3:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_90))
			{
				...
				{
					unk_0x4E65320BC9AD521C(iLocal_90, false);
					unk_0x161DCD5F8BF8AA2B(iLocal_90, 0);
				...
				else
				{
					...
					func_467(&uLocal_116, 4, iLocal_90, "Prostitutes", 0, 1);
					unk_0x161DCD5F8BF8AA2B(iLocal_90, 0);
					unk_0x3F9A37A55C9B9654(iLocal_90);
					return 1;
				}
			}
			break;
...
int func_496()
{
	if (unk_0x9CC4D06F5338CA6B())
	{
		if (func_23() == 0)
		{
			...
			{
				if (!unk_0x1D2A3118784C0272(iLocal_90, 1))
				{
					if (func_548())
					{
						unk_0x4F3C4F457D44BB0F(iLocal_90, false, 0);
...
int func_498()
{
	if (unk_0xA91FE8E813825AD4(iLocal_90, func_65(0)))
	{
		if (unk_0xFEEF7B4AD52D9C78(iLocal_90, "amb@world_human_prostitute@crackhooker@base", "base"))
		{
			return 0;
		}
		if (unk_0xFEEF7B4AD52D9C78(iLocal_90, "amb@world_human_prostitute@cokehead@base", "base"))
		{
			return 1;
		}
	}
	if (unk_0xA91FE8E813825AD4(iLocal_90, func_65(1)))
	{
		if (unk_0xFEEF7B4AD52D9C78(iLocal_90, "amb@world_human_prostitute@french@base", "base"))
		{
			return 3;
		}
		if (unk_0xFEEF7B4AD52D9C78(iLocal_90, "amb@world_human_prostitute@hooker@base", "base"))
		{
			return 2;
		}
	}
...
void func_500(int iParam0)
{
	...
	{
		if (!unk_0x60D775F2D5B6439B(iLocal_90, iParam0))
		{
			if (func_548())
			{
				if (unk_0xAA5B806352173DEA(iLocal_90))
				{
					unk_0xE2348E4036041923(iLocal_90);
					unk_0xA785552633ED203B(iLocal_90, iParam0, -1, 2048, 4);
				}
			}
			else
			{
	...
	else if (unk_0x60D775F2D5B6439B(iLocal_90, iParam0))
	{
		if (func_548())
		{
			if (unk_0xAA5B806352173DEA(iLocal_90))
...
void func_501()
{
	if (Global_31118)
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_93, 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_90, iLocal_93, false))
			{
				func_502();
			}
		}
	...
	if (unk_0xA59F96B50B97E63C(iLocal_90, 0) || !unk_0xAE06B9E39EBDE049(iLocal_90))
	{
		if (Global_31122 != unk_0x354AD085195C5FA6() && func_488(iLocal_49, 32))
		{
			func_5(&iLocal_49, 32);
		}
		return;
	}
	if ((vdist2(unk_0x3E4D3CCC220BDFB1(iLocal_90, true), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true)) < Global_31121 || Global_31121 == 0f) && iLocal_287 != 4)
	{
		Global_31121 = vdist2(unk_0x3E4D3CCC220BDFB1(iLocal_90, true), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true));
		Global_31122 = unk_0x354AD085195C5FA6();
		func_480(&iLocal_49, 32);
	}
	else if (Global_31122 == unk_0x354AD085195C5FA6())
	{
		Global_31121 = vdist2(unk_0x3E4D3CCC220BDFB1(iLocal_90, true), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true));
	}
	else
...
void func_502()
{
	if (func_548())
	{
		if (unk_0xAA5B806352173DEA(iLocal_90))
		{
			unk_0x8342E6CB98CD545C(iLocal_90, 323, true);
		}
	}
	else
	{
...
void func_503(var uParam0)
{
	if (!iLocal_286 == 12)
	{
		if (!unk_0xA59F96B50B97E63C(iLocal_90, 0) && !unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_507())
			{
				if (func_548())
				{
					...
					if (!unk_0x1758275D343D5BA3(iLocal_90))
					{
						unk_0x4F3C4F457D44BB0F(iLocal_90, true, 0);
					}
					unk_0x8B18A80E8EB15510(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 0, 0);
					unk_0xCBA6B2B569DCAFD8(iLocal_90, true);
					unk_0x9B94F6169B0DAEFD(unk_0x9B0761B4C3EB8BC7());
					func_539();
					func_533(uParam0);
			...
			else if (unk_0xCDF860E56BBCC6B4(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				iLocal_65++;
				if (iLocal_65 >= 2)
				{
				...
				else
				{
					...
					unk_0xBB7976F6FB9C9DD2(iLocal_90);
				}
			}
			else if (func_505())
			{
...
void func_504()
{
	...
	unk_0xC4B63A43FAB1F06F(iLocal_90);
	unk_0xFDCFA91E51EDB61F(iLocal_90, "APOLOGY_NO_TROUBLE", "SPEECH_PARAMS_FORCE_SHOUTED_CRITICAL", 1);
}
...
int func_505()
{
	...
	{
		return unk_0xDCD47F31CE777FDC(iVar0);
	}
	return 0;
}
...
int func_506()
{
	...
	else if (unk_0xAE06B9E39EBDE049(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
	{
		if (unk_0x4349BF35C5B9A49B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
		{
			if (unk_0x10D3F7E169A49C44(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), -1, 0) == unk_0x9B0761B4C3EB8BC7())
...
int func_507()
{
	...
	if (!func_488(iLocal_49, 4096))
	{
		if (func_414(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 1) < 30f)
		{
			Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_90, true) };
			if ((((((unk_0xCA6B45BED95917BD(88, Var0, 30f) || unk_0xCA6B45BED95917BD(91, Var0, 30f)) || unk_0xCA6B45BED95917BD(90, Var0, 30f)) || unk_0xCA6B45BED95917BD(104, Var0, 30f)) || unk_0xCA6B45BED95917BD(116, Var0, 30f)) || (unk_0xCA6B45BED95917BD(114, Var0, 30f) && !func_548())) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!func_548())
				{
					unk_0x4E65320BC9AD521C(iLocal_90, false);
...
int func_508()
{
	if ((unk_0xAE06B9E39EBDE049(iLocal_90) && !unk_0xA59F96B50B97E63C(iLocal_90, 0)) && !unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (func_548())
		{
			if (func_550(unk_0x460153A63B9477BC(), 0))
			{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_90))
		{
			if (!unk_0x47DBF174A0CB9D55(iLocal_90, false))
			{
				if (!func_510(9))
				{
					if (!unk_0xA59F96B50B97E63C(iLocal_90, 0) && !unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (unk_0x910DFF8E55ABB8EC(iLocal_90, unk_0x9B0761B4C3EB8BC7(), 100f, 100f, 50f, 0, 1, 0))
						{
							return 1;
						}
						else
				...
				else if (!(func_509() || unk_0x9CC4D06F5338CA6B()))
				{
			...
			else if (!(func_509() || (unk_0x9CC4D06F5338CA6B() && !func_404())))
			{
				func_489("prostitute SCRIPT SHOULD EXIT - PLAYER ON MISSION");
				func_106(0);
				func_96(15);
...
void func_513()
{
	...
	while (iVar0 < unk_0x2AC1C68C7CCA90E5(1))
	{
		...
		if (iVar1 == 174)
		{
			...
			if (Var2 == -1287716800)
			{
				if (Var2.f_1 == unk_0x460153A63B9477BC())
				{
					func_196(128);
				}
			}
...
void func_514()
{
	...
	if (unk_0x199928B287E7CD6A(false, 0) != 1)
	{
		if (func_515(1, 0, 1))
		{
			if (unk_0x96A99F3A4198A1B3(0) <= 1)
			{
				unk_0x9CAB3AADEB4C2F8D(1);
			}
		}
...
void func_526()
{
	...
	if (!unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) || unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		func_2(0);
...
void func_533(var uParam0)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_90))
	{
		if (unk_0x1758275D343D5BA3(iLocal_90))
		{
			if ((func_548() && unk_0x16BC17A8EDC701A2(iLocal_90, 1805844857) != 1) && unk_0x16BC17A8EDC701A2(iLocal_90, -251125078) != 1)
			{
				unk_0x30291E2E564E9B47(iLocal_90, 1193033728, 0);
				if (unk_0xAA5B806352173DEA(iLocal_90))
				{
				...
				if (unk_0x0AA24CBDD7C7F44D(iLocal_90))
				{
					unk_0x2481907DEE6B85EA(&iLocal_90);
				}
				unk_0xC4B63A43FAB1F06F(iLocal_90);
			}
			else
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_91))
	{
		unk_0x9B94F6169B0DAEFD(iLocal_91);
	}
	iLocal_91 = 0;
	iLocal_287 = 0;
	...
	if (func_548())
	{
		if (unk_0x357560AE34564BFA(iLocal_83))
		{
			unk_0x9142D74AFE3ACF6B(iLocal_83);
		}
	}
	iLocal_92 = 0;
	func_537();
	...
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (func_521(256))
		{
			unk_0x45F588C0DD767737(unk_0x9B0761B4C3EB8BC7(), 6, iLocal_84, iLocal_85, 0);
			func_196(1024);
		}
	}
	...
	if (Global_31122 == unk_0x354AD085195C5FA6())
	{
		Global_31118 = 0;
		Global_2425869[unk_0x460153A63B9477BC() /*443*/].f_415 = 0;
	}
...
void func_538(bool bParam0)
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_90))
	{
		if (unk_0x47DBF174A0CB9D55(iLocal_90, false))
		{
			if (unk_0x16BC17A8EDC701A2(iLocal_90, -828834893) != 1)
			{
				unk_0x0AB756271BADC8DF(iLocal_90, 0, 65536);
			}
		}
		if (bParam0)
		{
...
void func_539()
{
	...
	if (!unk_0xA59F96B50B97E63C(iLocal_90, 0))
	{
		...
		unk_0xA880FA9C4E5BCA17(iLocal_90, 0);
	}
	if (unk_0x80FF6C016CDB0FAF(iLocal_93, 0) && !unk_0xA59F96B50B97E63C(iLocal_93, 0))
	{
		if (func_548())
		{
			if (unk_0xAA5B806352173DEA(iLocal_93))
			{
				if (Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_28 <= 0 && !unk_0xCE990E643CD9D0E5(Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_274.f_26, 11))
				{
					unk_0xAAA20773FBB4CFA4(iLocal_93, false);
					unk_0x289D342D7C2DA52A(iLocal_93, 3);
					unk_0x0155E49186C056FA(iLocal_93, 0);
				}
				unk_0x74172B5AFD503628(iLocal_93, true, 0);
			}
		}
		else
		{
	...
	func_5(&iLocal_49, 2048);
	unk_0x047901495C0572C0(2, 19, 1);
	unk_0x047901495C0572C0(2, 37, 1);
	if (!func_536())
	{
		func_535();
	}
		...
		if (func_521(2))
		{
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
			{
				if (unk_0x4349BF35C5B9A49B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
				{
					if (unk_0xAA5B806352173DEA(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false)))
					{
						unk_0x69B8739B0B73352F(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), false);
						unk_0x5DC21979EC6C531F(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 1);
					}
				}
			}
			else if (unk_0x4349BF35C5B9A49B(iLocal_93))
			{
				if (unk_0xAA5B806352173DEA(iLocal_93))
				{
					unk_0x5DC21979EC6C531F(iLocal_93, 1);
					unk_0x69B8739B0B73352F(iLocal_93, false);
					unk_0x1491D110B8361BFE(iLocal_93, 0);
				}
				else
				{
					unk_0xDE298EE8EAAC0776(iLocal_93);
					unk_0x5DC21979EC6C531F(iLocal_93, 1);
					unk_0x69B8739B0B73352F(iLocal_93, false);
					unk_0x1491D110B8361BFE(iLocal_93, 0);
				}
...
void func_540()
{
	...
	{
		unk_0x5DFCCEA807F4355D(131, func_543(), 0f);
		unk_0x5DFCCEA807F4355D(117, func_542(), 0f);
		unk_0x5DFCCEA807F4355D(118, func_541(), 0f);
	}
}
...
int func_545()
{
	if ((unk_0x0EB6C63A09FD9DF1() && unk_0x011A67D2B195B6EB()) && unk_0x70E5C9630A26FB40())
	{
		return 1;
	}
	return 0;
...
void func_547(int iParam0)
{
	if (func_548())
	{
		if (func_219(iParam0))
		{
			unk_0x71B9CAADD460F7CC(iParam0);
		}
	}
}
...
int func_550(int iParam0, bool bParam1)
{
	...
	if (func_208(iParam0, 1, 1))
	{
		...
		if (unk_0x47DBF174A0CB9D55(iVar0, bParam1))
		{
			iVar3 = unk_0xA5D5B1042E8F47BD(iVar0, false);
			iVar1 = 0;
			while (iVar1 < 32)
			{
				...
				{
					if (unk_0x1FA7B77001D60F9D(iVar2) != iVar0)
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x1FA7B77001D60F9D(iVar2), iVar3, bParam1))
						{
							return 1;
						}
					}
