...
void func_3(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	iLocal_29[iParam0] = unk_0xB1C0B7CD03D4467D(iParam1, func_4(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_29[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	iLocal_27[iParam0] = unk_0xB1C0B7CD03D4467D(iParam1, func_8(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	iLocal_24[iParam0] = unk_0xB1C0B7CD03D4467D(iParam1, func_12(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_24[iParam0], 600000);
}
...
void func_14()
{
	switch (Global_31211)
	{
		...
		case 1:
			...
			{
				case 0:
					if (unk_0xF10E878C0879E7E9(iLocal_20[Global_31213]) && unk_0xE348A5F4E28E9348(iLocal_20[Global_31213]))
					{
						Global_31214 = 0;
					}
					else
				...
				case 1:
					if (unk_0xF10E878C0879E7E9(iLocal_22[Global_31213]) && unk_0xE348A5F4E28E9348(iLocal_22[Global_31213]))
					{
						Global_31214 = 0;
					}
					else
				...
				case 2:
					if (unk_0xF10E878C0879E7E9(iLocal_23[Global_31213]) && unk_0xE348A5F4E28E9348(iLocal_23[Global_31213]))
					{
						Global_31214 = 0;
					}
					else
...
void func_16()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_29[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_29[iVar0]);
		}
		iVar0++;
	}
	iLocal_30 = 0;
...
void func_17()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_27[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_27[iVar0]);
		}
		iVar0++;
	}
	iLocal_28 = 0;
...
void func_18()
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_24[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_24[iVar0]);
		}
		iVar0++;
	}
	iLocal_25 = 0;
...
void func_19()
{
	...
	while (iVar0 < 102)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_23[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_23[iVar0]);
		}
		iVar0++;
	}
}
...
void func_20()
{
	...
	while (iVar0 < 76)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_22[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_22[iVar0]);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	while (iVar0 < 19)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_21[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_21[iVar0]);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	while (iVar0 < 45)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_20[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_20[iVar0]);
		}
		iVar0++;
	}
}
...
void func_26(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	iLocal_23[iParam0] = unk_0xB1C0B7CD03D4467D(iParam1, func_28(iParam0, 0), Param2, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_23[iParam0], 600000);
	if (bParam4)
	{
		unk_0x75D61761E9E63196(iLocal_23[iParam0], func_27(iParam0));
	}
}
...
void func_30(int iParam0, struct<3> Param1, bool bParam2, bool bParam3)
{
	...
	iLocal_22[iParam0] = unk_0xB1C0B7CD03D4467D(joaat("pickup_health_standard"), func_32(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_22[iParam0], 600000);
	if (bParam3)
	{
		unk_0x75D61761E9E63196(iLocal_22[iParam0], func_31(iParam0));
	}
}
...
void func_34(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	iLocal_21[iParam0] = unk_0xB1C0B7CD03D4467D(joaat("pickup_weapon_petrolcan"), func_35(iParam0), Param1, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_21[iParam0], 600000);
}
...
void func_37(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_20[iParam0] = unk_0xB1C0B7CD03D4467D(joaat("pickup_armour_standard"), func_39(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
	unk_0xDE9491586AA5642B(iLocal_20[iParam0], 600000);
	if (bParam3)
	{
		unk_0x75D61761E9E63196(iLocal_20[iParam0], func_38(iParam0));
	}
}
