...
void func_6()
{
	...
	{
		if (func_10(Global_111858.f_2359.f_539.f_4321) != unk_0x36FE6D3220816ADA(unk_0x9B0761B4C3EB8BC7()))
		{
			iVar0 = func_9(unk_0x9B0761B4C3EB8BC7());
...
void func_13(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_15(Global_111858.f_18529[iVar0], &Var2, &fVar3))
			{
