...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { unk_0x3E4D3CCC220BDFB1(iLocal_68, false) };
		fVar2 = vdist2(Local_170 + Local_173, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0xD8C1C38EE8BC2AC6(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
	{
	}
	else
	{
	...
	if (unk_0x80FF6C016CDB0FAF(iLocal_70, 0))
	{
	}
	else
	{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xFC5D6FB6EECB392F(Global_96285))
		{
			...
			if (!func_5(Global_98676, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0x13A4BD6CC31F7B8F(Global_98676, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0x6A8F948698B360B4(iLocal_68, false);
				iLocal_172 = 1;
			}
			unk_0xDC3073F7CC12181D(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_98676, iLocal_70, 2))
			...
			unk_0x1CD098484842AE0B(iLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0x9DC06E2A59C5AEBB(&iVar2);
				unk_0xDC3073F7CC12181D(0, iLocal_70, 24, 50);
				unk_0xC67F9BF03C2472AB(0, 2000);
				unk_0xDEFE57D3575A1A8A(0, iLocal_70, Local_170 + Local_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x19F29730874AD6F1(iVar2);
				unk_0x9B6EC2CECE1010EF(iLocal_68, iVar2);
...
void func_22()
{
	...
	unk_0x410A1E7AD7D5C774(iLocal_69, true);
	iLocal_70 = unk_0x84F0027A508D7D7D(Local_173 + Local_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0xAE06B9E39EBDE049(Global_98676) || !unk_0xAE06B9E39EBDE049(iLocal_70)) || (!unk_0x7D167B9A0CCDA347(iLocal_69) && iVar0 < 400))
	{
	...
	{
		unk_0xD3D9D7C84656DAE5(Global_98676, Global_93959);
		unk_0x3A2AAE59B4681DAF(Global_98676, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!unk_0xA59F96B50B97E63C(iLocal_70, 0))
	{
		unk_0xC160551F55D6365A(iLocal_70, true, true, 0);
		unk_0x5DC21979EC6C531F(iLocal_70, 2);
		unk_0xB11D151E210D4FAC(iLocal_70, 1084227584);
		iLocal_68 = unk_0x6A7A2C83BD302BA4(iLocal_70, 4, iLocal_69, -1, 1, true);
		unk_0xD93D982926D0D8B3(iLocal_68, 0);
...
void func_23()
{
	...
	func_42(iLocal_66, &Local_173, &uLocal_174, &cVar0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 43, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_50()
{
	if (!unk_0xA59F96B50B97E63C(iLocal_68, 0) && unk_0x1D2A3118784C0272(iLocal_68, 1))
	{
		unk_0x2481907DEE6B85EA(&iLocal_68);
	}
	if (!unk_0xA59F96B50B97E63C(iLocal_70, 0) && unk_0x1D2A3118784C0272(iLocal_70, 1))
	{
		unk_0xE730EAF558C97567(&iLocal_70);
	}
	unk_0x410A1E7AD7D5C774(iLocal_69, false);
	unk_0x74528AC0906CBABE(iLocal_69);
