...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0x578C4EF320340AF7() - iLocal_187) > 5000 && unk_0xCDF860E56BBCC6B4(iLocal_188, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0xBB7976F6FB9C9DD2(iLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0x578C4EF320340AF7() - iLocal_187) > 12000 && vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iLocal_188, true)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
		...
		case 1:
			if (!func_2())
			{
				iLocal_187 = unk_0x578C4EF320340AF7();
				iLocal_21 = 0;
			}
			break;
	}
...
{
	iLocal_187 = unk_0x578C4EF320340AF7();
	func_21(&uLocal_22, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
...
int func_22()
{
	...
	fVar0 = 200f;
	if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iLocal_188, true)) >= (fVar0 * fVar0) && !unk_0xA38BFCB05DBE439D(iLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_24()
{
	...
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_188))
		{
			return 1;
		}
	}
...
int func_31()
{
	...
	if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar2 <= (iVar1 - 1))
		{
			if (uVar0[iVar2] != 0 && unk_0xAE06B9E39EBDE049(uVar0[iVar2]))
			{
				if (unk_0x36FE6D3220816ADA(uVar0[iVar2]) == joaat("u_m_m_aldinapoli"))
				{
...
void func_32()
{
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_188))
	{
		unk_0x2481907DEE6B85EA(&iLocal_188);
	}
