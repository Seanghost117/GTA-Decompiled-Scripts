...
void __EntryFunction__()
{
	...
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
		{
			if (unk_0xFE6F151E15A69B3A(iLocal_67, unk_0x14A1FF4316FA17CB(unk_0x460153A63B9477BC())))
			{
				unk_0x59478CBBF96AF7D1(iLocal_67);
			}
			unk_0x30291E2E564E9B47(iLocal_67, 1193033728, 0);
			unk_0xCBA6B2B569DCAFD8(iLocal_67, true);
			wait(0);
		}
...
void func_1()
{
	switch (iLocal_269)
	{
		case 0:
			...
			{
				unk_0x4E65320BC9AD521C(iLocal_67, true);
				if (!func_339())
				{
					...
					iLocal_270 = unk_0x578C4EF320340AF7() + 6000;
					if (bLocal_272)
					{
					...
					unk_0x694113444F21E39F(iLocal_67, 137, true);
					iLocal_269++;
				}
			}
			else
		...
		case 1:
			if (func_25(iLocal_67))
			{
				if (func_9(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0) || unk_0x578C4EF320340AF7() > iLocal_270)
				{
					iLocal_269++;
				}
			}
		...
		case 2:
			if (!func_339())
			{
				...
				iLocal_270 = unk_0x578C4EF320340AF7() + 500;
				iLocal_269++;
			}
			break;
		
		case 3:
			if (unk_0x578C4EF320340AF7() > iLocal_270 && unk_0x87F0CB19476706C3())
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
				{
					if (unk_0x47DBF174A0CB9D55(iLocal_67, false))
					{
						unk_0xDC11FE19D8A60393(iLocal_67, 1);
						unk_0xB6A979DBF557908B(iLocal_67, 200, 0, 0);
					}
					else
					{
						unk_0xF3FE01181D2D2479(iLocal_67, 500, 1000, 0, 0, 0, 0);
						unk_0x697DA7132EE43ABC(iLocal_67, 0, 0);
					}
					iLocal_270 = unk_0x578C4EF320340AF7() + 2000;
					iLocal_269++;
				}
			}
			break;
		...
		case 4:
			if ((unk_0x578C4EF320340AF7() > iLocal_270 && func_9(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0)) || unk_0x578C4EF320340AF7() > iLocal_270 + 6000)
			{
				func_322();
			}
			break;
		...
		case 5:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
			{
				...
				unk_0x9B94F6169B0DAEFD(iLocal_67);
				unk_0xF3FE01181D2D2479(iLocal_67, 500, 1000, 0, 0, 0, 0);
				unk_0xB6A979DBF557908B(iLocal_67, 200, 0, 0);
				func_322();
			}
...
void func_26()
{
	...
	{
		case 0:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67) && !unk_0x5AEB5DDFFAD43CA5(iLocal_68))
			{
				if (unk_0x7DA97DBB7F7D2DE5(iLocal_67) || unk_0xC2169C00B643278B(iLocal_67, Local_56, Global_22, false, true, 0))
				{
					func_208(1, 0, 1, 0);
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
					{
						if (func_206(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 5f, 1, 1056964608, 0, 1, 0))
						{
							iVar0 = 1;
						}
					}
			...
			if (iVar0 == 1)
			{
				...
				unk_0x555EE41D7C7078E6(unk_0x3E4D3CCC220BDFB1(iLocal_68, true), 20f, 1, 0, 0, false);
				unk_0x801B883D25479F23(unk_0x3E4D3CCC220BDFB1(iLocal_68, true), 20f, 0);
				wait(0);
				iLocal_53 = 1;
			}
			break;
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67) && !unk_0x5AEB5DDFFAD43CA5(iLocal_68))
			{
				...
				{
					unk_0x697DA7132EE43ABC(iLocal_67, 200, 0);
					...
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
					{
						...
						if (func_67(iVar1))
						{
							unk_0x03D382CB0B44E2FC(iVar1, 1738.655f, 3836.227f, 33.879f, 1, false, 0, 1);
							unk_0xE922BAA80E8F9324(iVar1, 119f);
						}
						else
						{
							unk_0x03D382CB0B44E2FC(iVar1, Local_56, 1, false, 0, 1);
							unk_0xE922BAA80E8F9324(iVar1, 119f);
						}
					...
					else
					{
						...
						unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), 1734.259f, 3840.59f, 33.7883f, 1, false, 0, 1);
						unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 0, 0);
					}
					unk_0x03D382CB0B44E2FC(iLocal_67, 1738.047f, 3842.438f, 33.7707f, 1, false, 0, 1);
					unk_0xE922BAA80E8F9324(iLocal_67, 36.8203f);
					unk_0x1322CA891C5DF18A(iLocal_67, 0, 0);
					unk_0x555EE41D7C7078E6(Local_56, 4f, 1, 0, 0, false);
					func_66(&iVar1);
					iLocal_259 = unk_0xF341A134A5B8D4F6(Local_72, Local_73, 2);
					unk_0xDFDB9C533700BC17(iLocal_67, iLocal_259, sLocal_257, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0xDFDB9C533700BC17(iLocal_68, iLocal_259, sLocal_257, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
					iLocal_75 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", false);
					unk_0x00736EE41CC355ED(iLocal_75, iLocal_259, "HELPING_FRIEND_INSIDE_CAM", sLocal_257);
					unk_0x8430A80C3E4F5F98(iLocal_259, fLocal_267);
		...
		case 4:
			if ((iLocal_274 && unk_0xFC5D6FB6EECB392F(iLocal_259)) && unk_0x369E69441C066912(iLocal_259) > 0.97f)
			{
			...
			if ((unk_0xFC5D6FB6EECB392F(iLocal_259) && unk_0x369E69441C066912(iLocal_259) >= fLocal_268) || func_63())
			{
				...
				unk_0x586DDC617E714637(&iLocal_67);
...
void func_31(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_48(iParam0))
	{
		...
		{
			func_33(func_39(iParam0, iParam1), Local_48.x, Local_48.f_1);
		}
...
void func_34()
{
	...
	{
		func_36(13, floor(Global_111858.f_10190.f_3853));
	}
...
void func_57(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		unk_0x39E1440587355CC1(sVar1, sVar1, 0, iVar0, "", 0);
		if (!func_46(45))
		{
...
int func_63()
{
	if (func_64(1000))
	{
		...
		if (unk_0x369E69441C066912(iLocal_259) < 1f)
		{
			unk_0x8430A80C3E4F5F98(iLocal_259, 1f);
		}
		return 1;
	}
	return 0;
...
void func_77(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_90(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
		...
		while (iVar4 < Var1.f_4)
		{
			if (unk_0xCFA068E582501862(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_114(Var2.f_2)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_114(Var2.f_2)] = func_107(iParam1, Var2.x, func_114(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_90(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_197(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_198(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_198(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (unk_0xAE06B9E39EBDE049(iVar0))
	{
		...
		if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_202(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_202(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		if (((((((((((((((func_203(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_203(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_203(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_203(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_203(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_203(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_203(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_203(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_203(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_203(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_203(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_203(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_203(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_203(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_203(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_203(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
void func_209()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
	{
		if (unk_0xB3770DEEECFB052B(iLocal_67))
		{
			bLocal_272 = true;
			iLocal_52 = 2;
			iLocal_269 = 5;
		}
		else if (unk_0x578C4EF320340AF7() < iLocal_270)
		{
			unk_0x59DF7D162BF6D02E(iLocal_67, 0);
			if (!unk_0xA26A1295C5145A11(iLocal_67))
			{
				func_233();
			}
			if (func_221())
			{
				if (iLocal_70)
				{
					if (!func_220(unk_0x9B0761B4C3EB8BC7(), 1935.53f, 6291.888f, 41.144f, 100f))
					{
						...
						func_66(&iLocal_71);
						if (unk_0x88649E9A3DFA79EA(iLocal_265))
						{
							unk_0x994BE8B44E53ECFA(iLocal_265, 0);
						}
						iLocal_70 = 0;
					}
					else
				...
				if (bLocal_244)
				{
					...
					else if (unk_0xCDF860E56BBCC6B4(iLocal_68, unk_0x9B0761B4C3EB8BC7(), 1) || func_214(iLocal_68, unk_0x9B0761B4C3EB8BC7(), 1.25f, 1))
					{
						unk_0x9B94F6169B0DAEFD(iLocal_68);
						unk_0x4E65320BC9AD521C(iLocal_68, false);
						unk_0xF3FE01181D2D2479(iLocal_68, 250, 500, 0, 0, 0, 0);
						unk_0x8B18A80E8EB15510(iLocal_68, unk_0x9B0761B4C3EB8BC7(), 500f, -1, 0, 0);
						unk_0xCBA6B2B569DCAFD8(iLocal_68, true);
						bLocal_272 = true;
						iLocal_52 = 2;
						iLocal_269 = 0;
					}
					else if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_56, Global_19, true, true, 0) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, true, 0))
					{
						iLocal_52 = 1;
						iLocal_53 = 0;
					}
				...
				if (unk_0x6E0C5E7AAF8B6214(iLocal_67) && unk_0x6E0C5E7AAF8B6214(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!unk_0xE4B70EFD14220305(iLocal_67))
					{
						...
						if (unk_0x16BC17A8EDC701A2(iLocal_67, -2017877118) == 7)
						{
							unk_0x756D74A3EF0AB788(iLocal_67, sLocal_256, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
						}
					}
				}
			}
			else
			{
				...
				if (!func_214(unk_0x9B0761B4C3EB8BC7(), iLocal_67, 200f, 1))
				{
					iLocal_52 = 2;
					iLocal_269 = 5;
				}
...
int func_210()
{
	...
	if (unk_0x47DBF174A0CB9D55(iLocal_67, false))
	{
		iVar0 = unk_0xA5D5B1042E8F47BD(iLocal_67, false);
...
void func_212()
{
	if (!bLocal_244 && func_220(unk_0x9B0761B4C3EB8BC7(), Local_56, 150f))
	{
		unk_0x78FCB2E22C41B9D5(iLocal_246);
		unk_0x131ED02492676000(sLocal_257);
		if ((unk_0x7D167B9A0CCDA347(iLocal_246) && unk_0xC614DDE265D18415(sLocal_257)) && unk_0x8865B8E834909D76(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0))
		{
			iLocal_245 = unk_0x5BBA0055476D633A(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 1, 0, 1);
			unk_0x6A8F948698B360B4(iLocal_245, true);
			Local_72 = { 1730.038f, 3853.562f, 34.661f };
			Local_73 = { 0f, 0f, 36f };
			iLocal_68 = unk_0xB3116B49FE00E2F1(26, iLocal_246, 1728.778f, 3851.287f, 33.7826f, 211.7722f, 1, true);
			unk_0x4E65320BC9AD521C(iLocal_68, true);
			func_213(&uLocal_76, 5, iLocal_68, "CrashSafehouse", 0, 1);
			iLocal_259 = unk_0xF341A134A5B8D4F6(Local_72, Local_73, 2);
			unk_0xDFDB9C533700BC17(iLocal_68, iLocal_259, sLocal_257, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_244 = true;
		}
	}
}
...
int func_215(struct<3> Param0, bool bParam1)
{
	return func_216(Param0, bParam1);
}

int func_216(struct<3> Param0, bool bParam1)
{
	int iVar0;
...
void func_218()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_71))
	{
		if (unk_0x80FF6C016CDB0FAF(iLocal_71, 0))
		{
			iLocal_61 = unk_0x578C4EF320340AF7();
			if ((iLocal_61 - iLocal_62) < 1000)
			{
				unk_0xFD13BD5261D4B71A(iLocal_71, 1);
			}
			else if ((iLocal_61 - iLocal_62) > 2000)
			{
				unk_0xFD13BD5261D4B71A(iLocal_71, 0);
...
int func_221()
{
	unk_0x94D1A5176CE89859(iLocal_67, 1f);
	if (unk_0xFE6F151E15A69B3A(iLocal_67, unk_0x14A1FF4316FA17CB(unk_0x460153A63B9477BC())))
	{
		...
		else if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_67, 20f, 20f, 20f, 0, 1, 0) || !func_230())
		{
			unk_0x59478CBBF96AF7D1(iLocal_67);
		}
		else if (unk_0xEEB37DB9533AA764(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!unk_0xEEB37DB9533AA764(iLocal_67))
			{
				if (unk_0x16BC17A8EDC701A2(iLocal_67, -828834893) == 7)
				{
					unk_0x9B94F6169B0DAEFD(iLocal_67);
					unk_0x0AB756271BADC8DF(iLocal_67, 0, 0);
				}
			}
		}
		return 1;
	}
	else if (unk_0x8F678487EEBD8CE4(iLocal_65))
	{
		if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_67, Global_19, 0, 1, 0) && func_230())
		{
			unk_0xE19B69814D61BBA5(iLocal_67, unk_0x14A1FF4316FA17CB(unk_0x460153A63B9477BC()));
		}
	}
	else
	{
...
int func_230()
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
		{
			...
			{
				if (((unk_0xB064AF9925F5537B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 0, 0) || unk_0xB064AF9925F5537B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), -1, 0)) || unk_0xB064AF9925F5537B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 1, 0)) || unk_0xB064AF9925F5537B(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), 2, 0))
				{
					iLocal_264 = 0;
					return 1;
				}
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
			{
				if (unk_0xE0B3BC41DDA88DF0(iLocal_67, unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), false))
				{
					iLocal_264 = 0;
					return 1;
				}
...
int func_232()
{
	...
	iVar0 = unk_0x36FE6D3220816ADA(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false));
...
void func_233()
{
	switch (iLocal_54)
	{
		case 0:
			iLocal_59 = 0;
			iLocal_54 = 1;
			iLocal_58 = unk_0x578C4EF320340AF7() + 1000;
			break;
		...
		case 2:
			...
			{
				iLocal_58 = unk_0x578C4EF320340AF7() + 1500;
				iLocal_59 = 0;
				iLocal_54 = 3;
			}
			break;
		...
		case 3:
			...
			{
				iLocal_58 = unk_0x578C4EF320340AF7() + 6000;
				iLocal_59 = 0;
				iLocal_54 = 4;
			}
			break;
		...
		case 4:
			if (iLocal_59 == 0)
			{
				if (unk_0x578C4EF320340AF7() > iLocal_58 && !func_339())
				{
					if (func_221())
					{
						if (func_230() && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
						{
			...
			else if (iLocal_59 == 3)
			{
				if (!func_339())
				{
					...
					if (iLocal_64 < 3)
					{
						iLocal_58 = unk_0x578C4EF320340AF7() + 20000;
						iLocal_59 = 0;
					}
					else
					{
...
void func_234(int iParam0, bool bParam1)
{
	if (!func_339())
	{
		...
		else
		{
			...
			iLocal_58 = (unk_0x578C4EF320340AF7() + iParam0);
		}
	}
}
...
void func_236()
{
	...
	switch (iLocal_63)
	{
		case 0:
			...
			if (unk_0xC614DDE265D18415(sLocal_251))
			{
				iLocal_63++;
			}
			break;
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
			{
				...
				Local_72 = { unk_0x7EC595B99EA7C4B1(iLocal_67, 0f, 0f, 5f) };
				unk_0xE5CC8E2D904E42CE(Local_72, &(Local_72.f_2), 0, 0);
				Local_73 = { func_241() };
				Local_73.f_2 = func_240((fLocal_261 + 180f), 0f, 360f);
				iLocal_258 = unk_0xF341A134A5B8D4F6(Local_72, Local_73, 2);
				iLocal_74 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", false);
				unk_0x00736EE41CC355ED(iLocal_74, iLocal_258, "HELPING_VICTIM_TO_FEET_CAM", sLocal_251);
				unk_0x856549C07003344B(iLocal_74, true);
				unk_0x3ED9330214992278(true, false, 3000, true, 0, 0);
				if (func_239())
				{
				...
				unk_0x555EE41D7C7078E6(unk_0x3E4D3CCC220BDFB1(iLocal_67, true), 5f, 1, 0, 0, false);
				unk_0x801B883D25479F23(unk_0x3E4D3CCC220BDFB1(iLocal_67, true), 20f, 0);
				unk_0x6D5673CA7E01D619(unk_0x3E4D3CCC220BDFB1(iLocal_67, true), 7f);
				iLocal_266 = unk_0xF00FBB09122693FC(1110, Local_260, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
				if (unk_0x48238AD298F1A5F0(unk_0x9B0761B4C3EB8BC7()) == 1)
				{
					unk_0x912105796D275F9C(unk_0x9B0761B4C3EB8BC7(), 0, 0);
				}
				unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
				unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), iLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
				unk_0xDFDB9C533700BC17(iLocal_67, iLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
				unk_0x882281B10B0A5932(iLocal_258, false);
				unk_0x8430A80C3E4F5F98(iLocal_258, 0.25f);
		...
		case 2:
			...
			else if (unk_0x369E69441C066912(iLocal_258) > 0.5f)
			{
				iLocal_63++;
			}
			break;
		...
		case 3:
			...
			else if (unk_0x369E69441C066912(iLocal_258) > 0.99f)
			{
				iLocal_63++;
			}
			break;
		...
		case 4:
			...
			unk_0x1082C25039B168F8(sLocal_251);
			unk_0x1082C25039B168F8(sLocal_249);
			if (func_25(iLocal_67))
			{
				unk_0x5A5A1DD32AC33C2B(iLocal_67, 1);
				unk_0x4E65320BC9AD521C(iLocal_67, false);
				unk_0x694113444F21E39F(iLocal_67, 172, false);
			}
			unk_0x5A3D1AC3A88E03C3(iLocal_266);
			func_69(0, 1, 1, 0, 0, 0, 0);
			if (unk_0x40397A9A17EEC1C5(iLocal_74))
			{
				unk_0xB8B0F7C8C1548C5B(iLocal_74, 0);
			}
			unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), true, 0);
			unk_0x98EFE9ABE449C2A3(unk_0x9B0761B4C3EB8BC7(), false);
			unk_0x98EFE9ABE449C2A3(unk_0x9B0761B4C3EB8BC7(), false);
			unk_0xD3D9D7C84656DAE5(iLocal_67, 1862763509);
			if (iLocal_242)
			{
				if (unk_0x03DB5C6AABF8DA46())
				{
				...
				unk_0x4C4FC7841A5FB983(0f);
				unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
				unk_0x2BB0EF9DE445EA13(iLocal_67);
				unk_0x854FB153F2EA838B(unk_0x9B0761B4C3EB8BC7(), -1871534317, false, 0, 0);
				unk_0x854FB153F2EA838B(iLocal_67, -1871534317, false, 0, 0);
				unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 0, 0);
				unk_0x1322CA891C5DF18A(iLocal_67, 0, 0);
				Var0 = { unk_0xD7D25254A712E758(sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", Local_72, Local_73, 1f, 2) };
				unk_0xE5CC8E2D904E42CE(Var0, &(Var0.f_2), 0, 0);
				unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), Var0, 1, false, 0, 1);
				Var0 = { unk_0xD78F5800B90C4843(sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", Local_72, Local_73, 1f, 2) };
				unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), Var0.f_2);
				Var0 = { unk_0xD7D25254A712E758(sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", Local_72, Local_73, 1f, 2) };
				unk_0xE5CC8E2D904E42CE(Var0, &(Var0.f_2), 0, 0);
				unk_0x03D382CB0B44E2FC(iLocal_67, Var0, 1, false, 0, 1);
				Var0 = { unk_0xD78F5800B90C4843(sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", Local_72, Local_73, 1f, 2) };
				unk_0xE922BAA80E8F9324(iLocal_67, Var0.f_2);
			}
			else
			{
				if (!bLocal_243)
				{
					...
					unk_0x756D74A3EF0AB788(unk_0x9B0761B4C3EB8BC7(), sVar1, "idle_intro", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				unk_0x47012CDD5C524D7B(0, 0, 3, 0);
			}
			iLocal_242 = 0;
			iLocal_270 = (unk_0x578C4EF320340AF7() + 180000);
			iLocal_58 = unk_0x578C4EF320340AF7() + 3000;
			unk_0x1E337EE68290597A(iLocal_241, 0);
			iLocal_241 = unk_0xC08A186299DFDA0A(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f), Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), 0, 1, 1, 1);
...
int func_237(int iParam0, float fParam1)
{
	...
	{
		fVar4 = unk_0x369E69441C066912(iParam0);
		if (fVar4 >= fParam1)
		{
			return 1;
		}
...
void func_242()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67) && !func_260())
	{
		if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_67, 80f, 80f, 15f, 0, 1, 0))
		{
			unk_0x131ED02492676000(sLocal_251);
			if (!iLocal_273)
			{
			...
			if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_67, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_257(1, 0, 1))
			{
				unk_0xE19B69814D61BBA5(iLocal_67, unk_0x14A1FF4316FA17CB(unk_0x460153A63B9477BC()));
				unk_0xF5230D38AD1D873D(iLocal_67, 0);
				unk_0x694113444F21E39F(iLocal_67, 206, true);
				iLocal_51 = 2;
			}
			else if (func_214(unk_0x9B0761B4C3EB8BC7(), iLocal_67, 15f, 1) && unk_0xF3A639BEE7AADF55(unk_0x9B0761B4C3EB8BC7()) < 4f)
			{
				if (func_339())
				{
					func_255();
				...
				switch (iLocal_60)
				{
					...
					case 1:
						if (!func_339())
						{
							...
							{
								iLocal_65 = func_254(iLocal_67, 1, 1, 5);
								unk_0x3DBD102E8C35EA16(iLocal_65, false);
							}
							func_9(&uLocal_76, "RECRAAU", "RECRA_PLEAD", 3, 0, 0, 0);
							unk_0xA785552633ED203B(iLocal_67, unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
							iLocal_58 = unk_0x578C4EF320340AF7() + 18000;
							iLocal_60 = 2;
						}
						break;
					...
					case 2:
						if (unk_0x578C4EF320340AF7() > iLocal_58 && !func_339())
						{
							...
							iLocal_58 = unk_0x578C4EF320340AF7() + 12000;
							iLocal_60 = 3;
						}
						break;
					...
					case 3:
						if (unk_0x578C4EF320340AF7() > iLocal_58 && !func_339())
						{
							...
							iLocal_58 = unk_0x578C4EF320340AF7() + 9500;
						}
						break;
					}
				}
...
int func_260()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67))
	{
		if (unk_0xC7EB33BFDB436C87(unk_0x1D5C49FCA9BC5B02(iLocal_67, 31086, 0f, 0f, 0f), 1f, 1))
		{
			return 1;
		}
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
			{
				if (unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_67))
				{
					return 1;
				}
			}
		}
		if (unk_0x3628D28B8671F14F(-1, unk_0x1D5C49FCA9BC5B02(iLocal_67, 31086, 0f, 0f, 0f), 8f))
		{
			return 1;
		}
		if (unk_0xCDF860E56BBCC6B4(iLocal_67, unk_0x9B0761B4C3EB8BC7(), 1))
		{
			return 1;
		}
		if (unk_0xCED6B5226244381C(iLocal_67))
		{
			return 1;
		}
	}
...
void func_261()
{
	...
	unk_0x78FCB2E22C41B9D5(iLocal_246);
	unk_0x78FCB2E22C41B9D5(iLocal_248);
	unk_0x78FCB2E22C41B9D5(iLocal_247);
	unk_0x131ED02492676000(sLocal_249);
	unk_0x08E33007524DAD35(sLocal_250);
	unk_0x131ED02492676000(sLocal_253);
	...
	if (((((((((unk_0x7D167B9A0CCDA347(iLocal_246) && unk_0x7D167B9A0CCDA347(iLocal_248)) && unk_0x7D167B9A0CCDA347(iLocal_247)) && unk_0xC614DDE265D18415(sLocal_249)) && unk_0x8FBC2B79465DEB9E(sLocal_250)) && unk_0xC614DDE265D18415(sLocal_253)) && unk_0xC614DDE265D18415(sLocal_254)) && unk_0xC614DDE265D18415(sLocal_255)) && unk_0xC614DDE265D18415(sLocal_252)) && unk_0x4F144789C4312F35())
	{
		bLocal_262 = false;
		iLocal_273 = 0;
		unk_0x40ECEB892E6BDDDB(5, false);
		iLocal_71 = unk_0xCE4780E24AFDFBF9(iLocal_248, 1932.98f, 6291.91f, 41.08f, 350.85f, true, true, false);
		unk_0x74528AC0906CBABE(iLocal_248);
		unk_0xC160551F55D6365A(iLocal_71, false, false, 0);
		unk_0x289D342D7C2DA52A(iLocal_71, 1);
		unk_0xAD1128A569D59CFC(iLocal_71, 0, 0, 1148846080);
		unk_0x140662B520844E45(iLocal_248, &uVar0, &Var1);
		unk_0x9CC6357234EC5D4A(iLocal_71, 0);
		unk_0x9CC6357234EC5D4A(iLocal_71, 2);
		unk_0x9CC6357234EC5D4A(iLocal_71, 3);
		unk_0x24D2E71AD24A6512(iLocal_71);
		unk_0x89A44C36E0B61C3B(iLocal_71, 0f, Var1.f_1, 0f, 500f, 10000f, 1);
		unk_0x89A44C36E0B61C3B(iLocal_71, Var1.x, (Var1.f_1 * 0.75f), 0f, 500f, 10000f, 1);
		unk_0x89A44C36E0B61C3B(iLocal_71, Var1.x, 0f, 0f, 500f, 10000f, 1);
		unk_0x89A44C36E0B61C3B(iLocal_71, 0f, 0f, Var1.f_2, 500f, 10000f, 1);
		unk_0xFF90B7B5F1AF504A(iLocal_71, 5, 1, true);
		unk_0x463F70A7E1EF1482(iLocal_71, 12f);
		unk_0xF30D696BD72C52EA(iLocal_71);
		unk_0x52090984B5C8A3E4(iLocal_71, false, true, false, false, false, false, 0, false);
		unk_0xC82085403E46A869(iLocal_71, 0f, 180f, 0f, 2, 1);
		unk_0x430613D76B5175B8(iLocal_71, true);
		unk_0x1515637D39F697C4(iLocal_71, true);
		iLocal_265 = unk_0xF245B4695C9BEF04("scr_recrash_rescue_fire", iLocal_71, -0.45f, -1.25f, -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
		if (bLocal_262)
		{
			iLocal_67 = unk_0xB3116B49FE00E2F1(26, iLocal_247, Local_260, (fLocal_261 - 180f), 1, true);
		}
		else
		{
			iLocal_67 = unk_0xB3116B49FE00E2F1(26, iLocal_247, Local_260, fLocal_261, 1, true);
		}
		unk_0x8CD0D18BBDEA2635(iLocal_67, 0, 0.7f, 0.5f, 2);
		Local_57 = { unk_0x3E4D3CCC220BDFB1(iLocal_67, true) };
		unk_0x79F8EF9CAC6E94EF(Local_57.x, (Local_57.f_1 + 0.1f), (Local_57.f_2 + 0.1f), Local_57.x, (Local_57.f_1 - 0.1f), (Local_57.f_2 - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		unk_0x756D74A3EF0AB788(iLocal_67, sLocal_249, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
		if (func_25(iLocal_67))
		{
			unk_0x5A5A1DD32AC33C2B(iLocal_67, 0);
		}
		unk_0x4E65320BC9AD521C(iLocal_67, true);
		unk_0x697DA7132EE43ABC(iLocal_67, 115, 0);
		unk_0x44EEDB6E2FB6904F(iLocal_67, true);
		unk_0xCBA6B2B569DCAFD8(iLocal_67, true);
		unk_0xDC11FE19D8A60393(iLocal_67, 1);
		unk_0x83BBFE5E96C64FBA(iLocal_67, 0);
		unk_0x6673CC701BC8E9C1(iLocal_67, 13, false);
		unk_0x6673CC701BC8E9C1(iLocal_67, 17, true);
		unk_0xA3AB9D48A7E8EA48(iLocal_67, sLocal_250, 1048576000);
		unk_0x694113444F21E39F(iLocal_67, 229, true);
		func_213(&uLocal_76, 3, iLocal_67, "TALINA", 0, 1);
		unk_0xE8709DEF4918D8E0(iLocal_67, 3, 0f, 0f, 0f, "wound_sheet");
		unk_0x0DC39BE87E4C5599(iLocal_67, false);
		iLocal_69 = unk_0xB3116B49FE00E2F1(26, iLocal_246, 1935.53f, 6291.888f, 41.144f, -28.44f, 1, true);
		iLocal_70 = 1;
		Local_57 = { unk_0x3E4D3CCC220BDFB1(iLocal_69, true) };
		unk_0xE8709DEF4918D8E0(iLocal_69, 3, 0f, 0f, 0f, "wound_sheet");
		unk_0x79F8EF9CAC6E94EF(Local_57.x, (Local_57.f_1 + 0.1f), (Local_57.f_2 + 0.1f), Local_57.x, (Local_57.f_1 - 0.1f), (Local_57.f_2 - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		unk_0x694113444F21E39F(iLocal_69, 227, true);
		unk_0x81DCDE42A0B23C21(iLocal_69, sLocal_252, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x697DA7132EE43ABC(iLocal_69, 0, 0);
		unk_0x74528AC0906CBABE(iLocal_246);
		if (func_2() == 0)
		{
			func_213(&uLocal_76, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
		}
		else if (func_2() == 1)
		{
			func_213(&uLocal_76, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
		}
		else if (func_2() == 2)
		{
			func_213(&uLocal_76, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
		}
		iLocal_241 = unk_0xC08A186299DFDA0A(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f), Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), 0, 1, 1, 1);
		iLocal_51 = 1;
	}
}
...
int func_262()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (vmag2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_269())
		{
			return 0;
		}
	}
...
void func_265(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_274()
{
	...
	{
		if (vdist2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), Local_48) < (75f * 75f))
		{
			return 1;
		}
		if (vmag2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_269())
...
int func_279(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_314(Global_111858.f_24991.f_43[iParam1]))
		{
			return 0;
		}
...
bool func_280(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
{
	return (shift_right(iParam0, 26) & 31 * func_292(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_320()
{
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
	{
		if (unk_0x68AEFA37A65085FD(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), false), joaat("taxi")))
		{
...
void func_322()
{
	...
	{
		unk_0x52090984B5C8A3E4(iLocal_71, false, false, false, false, false, false, 0, false);
		unk_0x0FC504FAF5EB94FB(iLocal_71, -400f);
		unk_0x4A9F6CA267EF14FE(iLocal_71, -100f);
	}
	if (unk_0x88649E9A3DFA79EA(iLocal_265))
	{
		unk_0x994BE8B44E53ECFA(iLocal_265, 0);
	...
	{
		unk_0x6A8F948698B360B4(iLocal_245, false);
	...
	unk_0xC336C6497DDA81B4(Local_55 - Vector(3f, 3f, 3f), Local_55 + Vector(3f, 3f, 3f), true);
