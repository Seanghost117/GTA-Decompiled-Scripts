...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0x1116855A2A7A342C() || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1503.54f, 4934.923f, 114.2284f, 100f, 100f, 100f, false, true, 0)) || iLocal_45 == 2)
		{
			if (!func_134())
			{
				if (func_133())
				...
				case 2:
					switch (iLocal_44)
					{
						...
						case 1:
								...
								if (!func_80())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_110)
										{
											...
											func_74(iLocal_88[0], unk_0xB0919F8F7C8097BD(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_88[1], unk_0xB0919F8F7C8097BD(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_107)
										{
											...
											func_74(iLocal_86[0], unk_0xB0919F8F7C8097BD(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_86[1], unk_0xB0919F8F7C8097BD(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_108)
										{
											...
											func_74(iLocal_87[0], unk_0xB0919F8F7C8097BD(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_87[1], unk_0xB0919F8F7C8097BD(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
							...
							if (((unk_0xEEB37DB9533AA764(unk_0x9B0761B4C3EB8BC7()) || unk_0x642A35A076CECC5A(unk_0x9B0761B4C3EB8BC7())) && !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_100, 100f, 100f, 100f, false, true, 0)) && iLocal_46 < 2)
							{
								func_46();
							}
							break;
...
void func_1()
{
	...
	if (iLocal_282 && !iLocal_105)
	{
		...
		if (unk_0x8F678487EEBD8CE4(iLocal_89))
		{
			unk_0x93370FA10F15BE44(&iLocal_89);
		}
		...
		while (iVar0 < 4)
		{
			...
			if (unk_0x8F678487EEBD8CE4(uLocal_95[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_95[iVar0]));
			}
			if (iLocal_46 >= 6)
			{
				if (unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar0]))
					{
						if (unk_0x910DFF8E55ABB8EC(iLocal_83[iVar0], unk_0x9B0761B4C3EB8BC7(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_109 = true;
						}
					}
		...
		while (iVar0 < 4)
		{
			if (unk_0x8F678487EEBD8CE4(iLocal_94[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(iLocal_94[iVar0]));
			}
			if (unk_0x8F678487EEBD8CE4(uLocal_96[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_96[iVar0]));
			}
			if (iLocal_46 >= 6)
			{
				if (unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
				{
					...
					{
						if (unk_0x910DFF8E55ABB8EC(iLocal_84[iVar0], unk_0x9B0761B4C3EB8BC7(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_109 = true;
						}
					}
	...
	if (!unk_0x9A70B1BD2A5BA09C(Local_100, 30f) && vdist(func_2(unk_0x460153A63B9477BC()), Local_100) > 300f)
	{
		func_180();
	}
}
...
void func_53()
{
	...
	{
		func_35(13, floor(Global_111858.f_10190.f_3853));
	}
...
void func_69(var uParam0, int iParam1, var uParam2, int iParam3)
{
	...
	if (unk_0xAE06B9E39EBDE049(*uParam2))
	{
		if (unk_0x80FF6C016CDB0FAF(*uParam2, 0))
		{
			...
			{
				if (unk_0xE0B3BC41DDA88DF0(*uParam0, *uParam2, false))
				{
			...
			if (!unk_0x8F678487EEBD8CE4(*iParam3))
			{
				if (iVar0 == 1)
				{
					*iParam3 = func_70(unk_0x3E4D3CCC220BDFB1(*uParam2, true), 0);
					unk_0xECC9A00CF1181EC2(*iParam3, 1);
					unk_0xE346A71235BB8065(*iParam3, 9);
					unk_0xB023F5C66F5716C7(*iParam3, "BLIP_VEH");
				}
			}
			else
			{
				Var1 = { unk_0x41A1ED9BB4ED4772(*iParam3) };
				Var2 = { unk_0x3E4D3CCC220BDFB1(*uParam2, true) };
				Var1.x = (Var1.x + (((Var2.x - Var1.x) / 1f) * timestep()));
				Var1.f_1 = (Var1.f_1 + (((Var2.f_1 - Var1.f_1) / 1f) * timestep()));
				Var1.f_2 = (Var1.f_2 + (((Var2.f_2 - Var1.f_2) / 1f) * timestep()));
				unk_0xC96DB2548BD4EDDD(*iParam3, Var1);
				if (iVar0 == 0)
				{
					unk_0x93370FA10F15BE44(iParam3);
				}
			}
		}
		else
...
int func_70(struct<3> Param0, bool bParam1)
{
	int iVar0;
	
	iVar0 = unk_0x6820C712C1DD618A(Param0);
	unk_0xFA81E0FBD7F5ACA0(iVar0, func_71(unk_0x25DDB354A40FFCDB(), 1f, 1f));
...
int func_73(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(iVar0, func_71(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
		unk_0x3060C53EAE54BBE7(iVar0, bParam1);
	}
...
void func_74(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, var uParam6, struct<3> Param7, int iParam8, float fParam9)
{
	struct<3> Var0;
	...
	if (unk_0xAE06B9E39EBDE049(iParam0) && unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		{
			if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam1, true), *uParam4, true) > 20f)
			{
				*uParam2 = { *uParam4 };
				*uParam3 = *fParam5;
			...
			else if ((unk_0x578C4EF320340AF7() - *uParam6) > iParam8)
			{
				if (func_76(iParam0, iParam1, 1) > fParam9 && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam1, true), *uParam2, true) > 20f)
				{
					if (!func_75(*uParam2))
					{
						if (!unk_0x9A70B1BD2A5BA09C(*uParam2, 3f))
						{
							...
							unk_0xF27E737981AFB47D(*uParam2, 3f, 0, 0, 0, 0, false, 0);
							unk_0x03D382CB0B44E2FC(iParam0, *uParam2, 1, false, 0, 1);
						...
						{
							Var0 = { unk_0x1BAE5C94E38E44FE(Local_61, fLocal_60, Param7) };
							if (!func_75(Var0))
							{
								if (!unk_0x9A70B1BD2A5BA09C(Var0, 2f))
								{
									unk_0x773B9DEB93E81B2F(Var0, 1.5f, 0);
									unk_0xF27E737981AFB47D(Var0, 3f, 0, 0, 0, 0, false, 0);
									unk_0x03D382CB0B44E2FC(iParam0, Var0, 1, false, 0, 1);
									unk_0xE922BAA80E8F9324(iParam0, fLocal_60);
									unk_0xB11D151E210D4FAC(iParam0, 1084227584);
									unk_0x316E0389ADF56E20(iParam0, 10f);
									unk_0xC160551F55D6365A(iParam0, true, true, 0);
									*uParam6 = unk_0x578C4EF320340AF7();
...
void func_77(int iParam0, var uParam1, var uParam2)
{
	if (unk_0xAE06B9E39EBDE049(iParam0))
	{
		if (!unk_0xA59F96B50B97E63C(iParam0, 0))
		{
			*uParam1 = { unk_0x3E4D3CCC220BDFB1(iParam0, true) };
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (unk_0xAE06B9E39EBDE049(*iParam0))
	{
		...
		else
		{
			...
			else if (unk_0xAE06B9E39EBDE049(*iParam2))
			{
				if (unk_0x80FF6C016CDB0FAF(*iParam2, 0))
				{
					if (unk_0xE0B3BC41DDA88DF0(*iParam0, *iParam2, false))
					{
						iVar1 = 1;
					}
				}
	...
	if (unk_0xAE06B9E39EBDE049(*iParam2))
	{
		if (unk_0x80FF6C016CDB0FAF(*iParam2, 0))
		{
			...
			{
				unk_0x02BA7DA24BAFE458(*iParam2);
				unk_0x54123F77C25DD02B(*iParam2);
				unk_0xA880FA9C4E5BCA17(*iParam2, 0);
				unk_0xE730EAF558C97567(iParam2);
				if (unk_0x8F678487EEBD8CE4(*iParam3))
				{
					unk_0x93370FA10F15BE44(iParam3);
				}
...
int func_80()
{
	...
	while (iVar1 < 4)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_83[iVar1]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar1]))
			{
				if (unk_0x910DFF8E55ABB8EC(iLocal_83[iVar1], unk_0x9B0761B4C3EB8BC7(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < 4)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_84[iVar1]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[iVar1]))
			{
				if (unk_0x910DFF8E55ABB8EC(iLocal_84[iVar1], unk_0x9B0761B4C3EB8BC7(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
...
void func_81()
{
	...
	if (bLocal_283)
	{
		...
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[0]) && !unk_0xA59F96B50B97E63C(iLocal_86[0], 0))
			{
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[1]) && !unk_0xA59F96B50B97E63C(iLocal_86[1], 0))
			{
			}
		}
		else
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[0]) && !unk_0xA59F96B50B97E63C(iLocal_87[0], 0))
			{
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[1]) && !unk_0xA59F96B50B97E63C(iLocal_87[1], 0))
			{
			}
		}
		iVar0 = 0;
		while (iVar0 < 4)
		{
			unk_0x5A3D1AC3A88E03C3(iLocal_99[iVar0]);
			if (unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar0]))
			{
				if (unk_0x8F678487EEBD8CE4(iLocal_93[iVar0]))
				{
			...
			else if (!unk_0x47DBF174A0CB9D55(iLocal_83[iVar0], false))
			{
				if (!unk_0x8F678487EEBD8CE4(iLocal_93[iVar0]))
				{
		...
		while (iVar0 < 4)
		{
			...
			else if (!unk_0x47DBF174A0CB9D55(iLocal_84[iVar0], false))
			{
				if (!unk_0x8F678487EEBD8CE4(iLocal_94[iVar0]))
				{
	...
	{
		case 0:
			if (((unk_0xE09CB6F04E38432F(unk_0x460153A63B9477BC()) || !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_100 + Vector(0f, 20f, 0f), 170f, 270f, 50f, false, true, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, false, true, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, false, true, 0))
			{
				if (!bLocal_110)
				{
					if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, false, true, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, false, true, 0))
					{
						bLocal_110 = true;
					}
				}
				if (unk_0x30EE2C844B9C410B(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), &Local_102, 1, 1077936128, 0))
				{
					if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_102, 20f, 20f, 20f, false, true, 0))
					{
						unk_0x40ECEB892E6BDDDB(5, true);
						unk_0x40ECEB892E6BDDDB(3, true);
						settimera(0);
		...
		case 2:
			if (bLocal_110)
			{
				if (timera() > 3500)
				{
					if (((!unk_0xA59F96B50B97E63C(iLocal_88[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_88[1], 0)) && !unk_0x5AEB5DDFFAD43CA5(iLocal_83[0])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_83[1]))
					{
						unk_0x13A4BD6CC31F7B8F(iLocal_83[0], iLocal_88[0], -1);
						unk_0x13A4BD6CC31F7B8F(iLocal_83[1], iLocal_88[1], -1);
						unk_0x6673CC701BC8E9C1(iLocal_83[0], 3, false);
						unk_0x6673CC701BC8E9C1(iLocal_83[1], 3, false);
						unk_0x6A4846EF125EA7E6(iLocal_83[0], 0);
						unk_0x6A4846EF125EA7E6(iLocal_83[1], 0);
						iLocal_46 = 5;
					}
				}
			}
		...
		case 3:
			Local_103 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
			iLocal_76 = unk_0x344C570D6F8700DF(10, 15);
			if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, false, true, 0))
			{
				if (unk_0x204D69DA02AB1105(Local_103, iLocal_76, &(Local_280[0 /*3*/]), 1, 3f, 0f))
				{
					Local_280[1 /*3*/] = { Local_280[0 /*3*/] + Vector(0f, 5f, 0f) };
					if (!unk_0x9A70B1BD2A5BA09C(Local_280[0 /*3*/], 7f) && !unk_0x9A70B1BD2A5BA09C(Local_280[1 /*3*/], 7f))
					{
						if (unk_0x80FF6C016CDB0FAF(iLocal_86[0], 0))
						{
							unk_0x03D382CB0B44E2FC(iLocal_86[0], Local_280[0 /*3*/], 1, false, 0, 1);
							func_98(iLocal_86[0], iLocal_83[0]);
						}
						if (unk_0x80FF6C016CDB0FAF(iLocal_86[1], 0))
						{
							unk_0x03D382CB0B44E2FC(iLocal_86[1], Local_280[1 /*3*/], 1, false, 0, 1);
		...
		case 4:
			Local_103 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
			iLocal_76 = unk_0x344C570D6F8700DF(30, 35);
			if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, false, true, 0))
			{
				if (unk_0x204D69DA02AB1105(Local_103, iLocal_76, &(Local_280[0 /*3*/]), 1, 3f, 0f))
				{
					...
					if (!unk_0x9A70B1BD2A5BA09C(Local_280[0 /*3*/], 7f) && !unk_0x9A70B1BD2A5BA09C(Local_280[1 /*3*/], 7f))
					{
						if (unk_0x80FF6C016CDB0FAF(iLocal_87[0], 0))
						{
							unk_0x03D382CB0B44E2FC(iLocal_87[0], Local_280[0 /*3*/], 1, false, 0, 1);
							func_98(iLocal_87[0], iLocal_84[0]);
						}
						if (unk_0x80FF6C016CDB0FAF(iLocal_87[1], 0))
						{
							unk_0x03D382CB0B44E2FC(iLocal_87[1], Local_280[1 /*3*/], 1, false, 0, 1);
		...
		case 5:
			Local_103 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
			iLocal_76 = unk_0x344C570D6F8700DF(5, 10);
			if (unk_0x204D69DA02AB1105(Local_103, iLocal_76, &(Local_280[0 /*3*/]), 1, 3f, 0f))
			{
				Local_280[1 /*3*/] = { Local_280[0 /*3*/] + Vector(0f, 5f, 0f) };
				if (!unk_0x9A70B1BD2A5BA09C(Local_280[0 /*3*/], 7f) && !unk_0x9A70B1BD2A5BA09C(Local_280[1 /*3*/], 7f))
				{
					if (unk_0x80FF6C016CDB0FAF(iLocal_88[0], 0))
					{
						unk_0x03D382CB0B44E2FC(iLocal_88[0], Local_280[0 /*3*/], 1, false, 0, 1);
						func_98(iLocal_88[0], iLocal_83[0]);
					}
					if (unk_0x80FF6C016CDB0FAF(iLocal_88[1], 0))
					{
						unk_0x03D382CB0B44E2FC(iLocal_88[1], Local_280[1 /*3*/], 1, false, 0, 1);
		...
		case 6:
			if (func_68())
			{
				fLocal_64 = unk_0x658086F2B3C5E4E4(1.5f, 2.5f);
				fLocal_65 = unk_0x658086F2B3C5E4E4(2f, 4f);
				fLocal_66 = unk_0x658086F2B3C5E4E4(0.1f, 2f);
				if (iLocal_78 < 5 && iLocal_79 < unk_0x578C4EF320340AF7())
				{
					Local_50 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true) };
					unk_0x79F8EF9CAC6E94EF((Local_50.x + fLocal_64), (Local_50.f_1 + fLocal_65), (Local_50.f_2 + fLocal_66), (Local_50.x - fLocal_64), (Local_50.f_1 - fLocal_65), Local_50.f_2, 10, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
					iLocal_79 = (unk_0x578C4EF320340AF7() + unk_0x344C570D6F8700DF(200, 500));
					iLocal_78++;
				}
			}
			if (iLocal_78 > 4)
...
void func_98(int iParam0, int iParam1)
{
	...
	unk_0xB11D151E210D4FAC(iParam0, 1084227584);
	Local_279 = { unk_0x3E4D3CCC220BDFB1(iParam0, true) };
	Local_281 = { Local_103 - Local_279 };
	unk_0xE922BAA80E8F9324(iParam0, unk_0x9075769DD4F148B7(Local_281.x, Local_281.f_1));
	if (bLocal_110)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iParam1))
		{
			if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
			{
				unk_0xEC71E62C67C34867(iParam1, unk_0x9B0761B4C3EB8BC7());
				wait(1);
				if (!unk_0x5AEB5DDFFAD43CA5(iParam1))
				{
					unk_0xE6277D9431F82B04(iParam1, 32, 1);
				}
			}
			else
			{
				unk_0xBD204892D76E6303(iParam1, iParam0, unk_0x9B0761B4C3EB8BC7(), 6, 20f, 786469, -1f, -1f, 1);
			}
			if (!unk_0xA59F96B50B97E63C(iParam0, 0))
			{
	...
	else if (!unk_0x5AEB5DDFFAD43CA5(iParam1))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false))
		{
			unk_0xEC71E62C67C34867(iParam1, unk_0x9B0761B4C3EB8BC7());
		...
		{
			unk_0xBD204892D76E6303(iParam1, iParam0, unk_0x9B0761B4C3EB8BC7(), 2, 100f, 786469, -1f, -1f, 1);
		}
		unk_0x316E0389ADF56E20(iParam0, unk_0xF3A639BEE7AADF55(unk_0x9B0761B4C3EB8BC7()));
	}
}
...
void func_99()
{
	...
	iLocal_86[0] = unk_0xCE4780E24AFDFBF9(joaat("rebel"), -1595.964f, 4732.479f, 0f, 305f, true, true, false);
	unk_0x4F3C4F457D44BB0F(iLocal_86[0], true, 0);
	unk_0xC160551F55D6365A(iLocal_86[0], true, true, 0);
	unk_0x289D342D7C2DA52A(iLocal_86[0], 2);
	unk_0xDAE36360F0F8C1ED(iLocal_86[0], true);
	unk_0x6A8F948698B360B4(iLocal_86[0], true);
	unk_0xC29A9E1088D83B1B(iLocal_86[0], "49GNL112");
	iLocal_86[1] = unk_0xCE4780E24AFDFBF9(joaat("rebel"), -1570.34f, 4733.755f, 0f, 305f, true, true, false);
	unk_0x4F3C4F457D44BB0F(iLocal_86[1], true, 0);
	unk_0xC160551F55D6365A(iLocal_86[1], true, true, 0);
	unk_0x289D342D7C2DA52A(iLocal_86[1], 2);
	unk_0xDAE36360F0F8C1ED(iLocal_86[1], true);
	unk_0x6A8F948698B360B4(iLocal_86[1], true);
	unk_0xC29A9E1088D83B1B(iLocal_86[1], "47TMS703");
	iLocal_88[0] = unk_0xCE4780E24AFDFBF9(joaat("sanchez"), Vector(0f, 4732.479f, -1595.964f) + Vector(10f, 10f, 10f), 305f, true, true, false);
	unk_0x4F3C4F457D44BB0F(iLocal_88[0], true, 0);
	unk_0xC160551F55D6365A(iLocal_88[0], true, true, 0);
	unk_0x289D342D7C2DA52A(iLocal_88[0], 2);
	unk_0xDAE36360F0F8C1ED(iLocal_88[0], true);
	unk_0x6A8F948698B360B4(iLocal_88[0], true);
	unk_0xC29A9E1088D83B1B(iLocal_88[0], "49GNL112");
	iLocal_88[1] = unk_0xCE4780E24AFDFBF9(joaat("sanchez"), Vector(0f, 4733.755f, -1570.34f) + Vector(10f, 10f, 10f), 305f, true, true, false);
	unk_0x4F3C4F457D44BB0F(iLocal_88[1], true, 0);
	unk_0xC160551F55D6365A(iLocal_88[1], true, true, 0);
	unk_0x289D342D7C2DA52A(iLocal_88[1], 2);
	unk_0xDAE36360F0F8C1ED(iLocal_88[1], true);
	unk_0x6A8F948698B360B4(iLocal_88[1], true);
	unk_0xC29A9E1088D83B1B(iLocal_88[1], "47TMS703");
	iLocal_83[0] = unk_0x6A7A2C83BD302BA4(iLocal_86[0], 26, joaat("g_m_m_chigoon_02"), -1, 1, true);
	iLocal_83[1] = unk_0x6A7A2C83BD302BA4(iLocal_86[1], 26, joaat("g_m_m_chigoon_02"), -1, 1, true);
	if (!bLocal_110)
	{
		iLocal_83[2] = unk_0x6A7A2C83BD302BA4(iLocal_86[0], 26, joaat("g_m_m_chigoon_02"), 0, 1, true);
		iLocal_83[3] = unk_0x6A7A2C83BD302BA4(iLocal_86[1], 26, joaat("g_m_m_chigoon_02"), 0, 1, true);
	}
	iLocal_87[0] = unk_0xCE4780E24AFDFBF9(joaat("bobcatxl"), -1356.281f, 5000f, 0f, 125.2811f, true, true, false);
	unk_0x4F3C4F457D44BB0F(iLocal_87[0], true, 0);
	unk_0xC160551F55D6365A(iLocal_87[0], true, true, 0);
	unk_0x289D342D7C2DA52A(iLocal_87[0], 2);
	unk_0xDAE36360F0F8C1ED(iLocal_87[0], true);
	unk_0x6A8F948698B360B4(iLocal_87[0], true);
	unk_0xC29A9E1088D83B1B(iLocal_87[0], "49GNL112");
	iLocal_87[1] = unk_0xCE4780E24AFDFBF9(joaat("bobcatxl"), -1373.589f, 5000f, 0f, 125.459f, true, true, false);
	unk_0x4F3C4F457D44BB0F(iLocal_87[1], true, 0);
	unk_0xC160551F55D6365A(iLocal_87[1], true, true, 0);
	unk_0x289D342D7C2DA52A(iLocal_87[1], 2);
	unk_0xDAE36360F0F8C1ED(iLocal_87[1], true);
	unk_0x6A8F948698B360B4(iLocal_87[1], true);
	unk_0xC29A9E1088D83B1B(iLocal_87[1], "47TMS703");
	iLocal_84[0] = unk_0x6A7A2C83BD302BA4(iLocal_87[0], 26, joaat("g_m_y_salvagoon_03"), -1, 1, true);
	iLocal_84[1] = unk_0x6A7A2C83BD302BA4(iLocal_87[1], 26, joaat("g_m_y_salvagoon_03"), -1, 1, true);
	iLocal_84[2] = unk_0x6A7A2C83BD302BA4(iLocal_87[0], 26, joaat("g_m_y_salvagoon_03"), 0, 1, true);
	iLocal_84[3] = unk_0x6A7A2C83BD302BA4(iLocal_87[1], 26, joaat("g_m_y_salvagoon_03"), 0, 1, true);
	unk_0xDE8F8016287F771F("RE_deal1", &iLocal_111);
	unk_0xDE8F8016287F771F("RE_deal2", &iLocal_112);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar0]))
		{
			unk_0xD3D9D7C84656DAE5(iLocal_83[iVar0], iLocal_111);
			unk_0x4F3C4F457D44BB0F(iLocal_83[iVar0], true, 0);
			if (bLocal_110)
			{
				unk_0x92BD213E6A0E666B(iLocal_83[0], joaat("weapon_sawnoffshotgun"), -1, true, true);
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[1]))
				{
					unk_0x92BD213E6A0E666B(iLocal_83[1], joaat("weapon_pistol"), -1, true, true);
				}
				unk_0xF94DFEAE3DD1EE7E(iLocal_83[iVar0], 15);
				unk_0x6673CC701BC8E9C1(iLocal_83[iVar0], 3, false);
			}
			else
			{
				unk_0x92BD213E6A0E666B(iLocal_83[iVar0], joaat("weapon_pistol"), -1, true, true);
				unk_0xF94DFEAE3DD1EE7E(iLocal_83[iVar0], 13);
			}
			unk_0x6673CC701BC8E9C1(iLocal_83[iVar0], 13, true);
			unk_0x6673CC701BC8E9C1(iLocal_83[iVar0], 2, true);
			unk_0x6673CC701BC8E9C1(iLocal_83[iVar0], 1, true);
	...
	while (iVar0 < 4)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar0]))
		{
			unk_0xD3D9D7C84656DAE5(iLocal_84[iVar0], iLocal_112);
			unk_0x4F3C4F457D44BB0F(iLocal_84[iVar0], true, 0);
			if (bLocal_110)
			{
				unk_0x92BD213E6A0E666B(iLocal_83[0], joaat("weapon_sawnoffshotgun"), -1, true, true);
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[1]))
			...
			{
				unk_0x92BD213E6A0E666B(iLocal_84[iVar0], joaat("weapon_pistol"), -1, true, true);
				unk_0xF94DFEAE3DD1EE7E(iLocal_84[iVar0], 13);
				func_100(&uLocal_114, 5, iLocal_84[iVar0], "REDGWSalvadoran", 0, 1);
			}
			unk_0x6673CC701BC8E9C1(iLocal_84[iVar0], 13, true);
			unk_0x6673CC701BC8E9C1(iLocal_84[iVar0], 2, true);
			unk_0x6673CC701BC8E9C1(iLocal_84[iVar0], 1, true);
		}
		iVar0++;
	}
	unk_0xEFBCE8F8316F89EA(3, iLocal_111, iLocal_112);
	unk_0xEFBCE8F8316F89EA(3, iLocal_112, iLocal_111);
	unk_0xEFBCE8F8316F89EA(3, iLocal_111, 1862763509);
	unk_0xEFBCE8F8316F89EA(3, iLocal_112, 1862763509);
...
void func_101()
{
	...
	switch (iLocal_74)
	{
		case 0:
			if (bLocal_107)
			{
				...
				while (iVar0 < 4)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar0]))
					{
						if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_83[iVar0], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_74 = 3;
						}
					}
			...
			if (bLocal_108)
			{
				...
				while (iVar1 < 4)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[iVar1]))
					{
						if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_84[iVar1], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_74 = 3;
						}
					}
		...
		case 3:
			unk_0xEFBCE8F8316F89EA(5, iLocal_111, iLocal_112);
			unk_0xEFBCE8F8316F89EA(5, iLocal_112, iLocal_111);
			unk_0xEFBCE8F8316F89EA(5, iLocal_111, 1862763509);
			unk_0xEFBCE8F8316F89EA(5, iLocal_112, 1862763509);
			if (bLocal_107)
			{
				iVar2 = 0;
				while (iVar2 < 4)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_83[iVar2]))
					{
						if ((!unk_0xF83D0A2EC884A4DD(iLocal_83[iVar2], 0) && unk_0x16BC17A8EDC701A2(iLocal_83[iVar2], 579380604) != 1) && unk_0x16BC17A8EDC701A2(iLocal_83[iVar2], 579380604) != 0)
						{
							unk_0x9B94F6169B0DAEFD(iLocal_83[iVar2]);
							unk_0x8FF9CE1C0F94F59A(iLocal_83[iVar2], unk_0x9B0761B4C3EB8BC7(), 0, 16);
							unk_0xCBA6B2B569DCAFD8(iLocal_83[iVar2], true);
						}
					}
					iVar2++;
				}
			...
			if (bLocal_108)
			{
				...
				while (iVar3 < 4)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[iVar3]))
					{
						if ((!unk_0xF83D0A2EC884A4DD(iLocal_84[iVar3], 0) && unk_0x16BC17A8EDC701A2(iLocal_84[iVar3], 579380604) != 1) && unk_0x16BC17A8EDC701A2(iLocal_84[iVar3], 579380604) != 0)
						{
							unk_0x9B94F6169B0DAEFD(iLocal_84[iVar3]);
							unk_0x8FF9CE1C0F94F59A(iLocal_84[iVar3], unk_0x9B0761B4C3EB8BC7(), 0, 16);
							unk_0xCBA6B2B569DCAFD8(iLocal_84[iVar3], true);
						}
					}
					iVar3++;
				}
...
void func_102()
{
	...
	{
		case 0:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_80))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_101, 7f, 7f, 10f, false, true, 0))
				{
					func_104();
					wait(0);
					func_82(&uLocal_114, "REDGWAU", "REDGW_NTOUCH", 4, 0, 0, 0);
					unk_0xA785552633ED203B(iLocal_80, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					if (!unk_0x8F678487EEBD8CE4(iLocal_90))
					{
	...
	switch (iLocal_73)
	{
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_80))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_80, 10f, 10f, 6f, 0, 1, 0))
				{
					if (!func_68())
					{
		...
		case 2:
			if (!func_68() || timerb() > 4000)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_80))
				{
					unk_0x697DA7132EE43ABC(iLocal_80, 0, 0);
					unk_0x93370FA10F15BE44(&iLocal_91);
				}
				if (timerb() > 7000)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[6]))
					{
						unk_0x697DA7132EE43ABC(iLocal_81[6], 0, 0);
						unk_0x93370FA10F15BE44(&(iLocal_92[6]));
					}
				}
				if (timerb() > 9000)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[7]))
					{
						unk_0x697DA7132EE43ABC(iLocal_81[7], 0, 0);
						unk_0x93370FA10F15BE44(&(iLocal_92[7]));
					}
					iLocal_73++;
				}
			}
...
void func_106()
{
	...
	if (unk_0x73DBD7E437DA0553(iLocal_97))
	{
		if (unk_0x8F678487EEBD8CE4(iLocal_89))
		{
			unk_0x93370FA10F15BE44(&iLocal_89);
	...
	else
	{
		...
		while (iVar0 < 9)
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_81[iVar0]))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[iVar0]))
				{
					if (iVar0 == 0)
					{
					}
				}
				else if (unk_0x8F678487EEBD8CE4(iLocal_92[iVar0]))
				{
					unk_0x93370FA10F15BE44(&(iLocal_92[iVar0]));
				}
			}
			iVar0++;
		}
		...
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_82[iVar0]))
			{
			}
			iVar0++;
		}
		if (!func_134())
		{
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_48[7 /*3*/], 110f, 95f, 40f, false, true, 0))
			{
				if (unk_0x8F678487EEBD8CE4(iLocal_89))
				{
					unk_0x93370FA10F15BE44(&iLocal_89);
				}
				if ((!unk_0x8F678487EEBD8CE4(iLocal_91) && !unk_0x8F678487EEBD8CE4(iLocal_92[6])) && !unk_0x8F678487EEBD8CE4(iLocal_92[7]))
				{
					iLocal_91 = func_72(iLocal_80, 1, 145);
					iLocal_92[6] = func_72(iLocal_81[6], 1, 145);
					iLocal_92[7] = func_72(iLocal_81[7], 1, 145);
				}
				unk_0x3DBD102E8C35EA16(iLocal_91, false);
				unk_0x3DBD102E8C35EA16(iLocal_92[6], false);
				unk_0x3DBD102E8C35EA16(iLocal_92[7], false);
				func_107(1);
			}
		}
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[6]))
		{
			if (((((unk_0x16BC17A8EDC701A2(iLocal_81[6], 1785177548) != 1 && unk_0x16BC17A8EDC701A2(iLocal_81[6], 1785177548) != 0) || unk_0x0922C2E075A5F18C(iLocal_81[6])) || unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_81[6])) || unk_0xB3770DEEECFB052B(iLocal_81[6])) || unk_0x8F8BC946B0876552(iLocal_81[6]))
			{
				unk_0x697DA7132EE43ABC(iLocal_81[6], 0, 0);
			}
		}
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[7]))
		{
			if (((((unk_0x16BC17A8EDC701A2(iLocal_81[7], 1785177548) != 1 && unk_0x16BC17A8EDC701A2(iLocal_81[7], 1785177548) != 0) || unk_0x0922C2E075A5F18C(iLocal_81[7])) || unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_81[7])) || unk_0xB3770DEEECFB052B(iLocal_81[7])) || unk_0x8F8BC946B0876552(iLocal_81[7]))
			{
				unk_0x697DA7132EE43ABC(iLocal_81[7], 0, 0);
			}
		}
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_80))
		{
			if (((((unk_0x16BC17A8EDC701A2(iLocal_80, 1785177548) != 1 && unk_0x16BC17A8EDC701A2(iLocal_80, 1785177548) != 0) || unk_0x0922C2E075A5F18C(iLocal_80)) || unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_80)) || unk_0xB3770DEEECFB052B(iLocal_80)) || unk_0x8F8BC946B0876552(iLocal_80))
			{
				unk_0x697DA7132EE43ABC(iLocal_80, 0, 0);
			}
		}
	...
	switch (iLocal_75)
	{
		case 0:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[6]))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x3E4D3CCC220BDFB1(iLocal_81[6], true) + Vector(0f, 2.5f, 0f), 9f, 5f, 5f, false, true, 0) && unk_0x67E2125E6EC33DB7(unk_0x9B0761B4C3EB8BC7(), iLocal_81[6]))
				{
					unk_0xA785552633ED203B(iLocal_81[6], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_81[6], 4000, 2048, 2);
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_81[7]))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x3E4D3CCC220BDFB1(iLocal_81[7], true) + Vector(0f, 3f, 0f), 9f, 7f, 5f, false, true, 0) && unk_0x67E2125E6EC33DB7(unk_0x9B0761B4C3EB8BC7(), iLocal_81[7]))
				{
					unk_0xA785552633ED203B(iLocal_81[7], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_81[7], 4000, 2048, 2);
					func_82(&uLocal_114, "REDGWAU", "REDGW_NDIE1", 4, 0, 0, 0);
					iLocal_71 = unk_0x578C4EF320340AF7();
					iLocal_75 = 1;
				}
			}
			if (unk_0x5AEB5DDFFAD43CA5(iLocal_81[6]) && unk_0x5AEB5DDFFAD43CA5(iLocal_81[7]))
			{
				iLocal_75 = 2;
			}
			break;
		...
		case 1:
			...
			if (unk_0x8F678487EEBD8CE4(iLocal_92[6]))
			{
				unk_0x3DBD102E8C35EA16(iLocal_92[6], true);
			}
			if (unk_0x8F678487EEBD8CE4(iLocal_92[7]))
			{
				unk_0x3DBD102E8C35EA16(iLocal_92[7], true);
			}
...
void func_117()
{
	...
	if (!unk_0xA59F96B50B97E63C(iLocal_85[0], 0))
	{
		if (unk_0x10D3F7E169A49C44(iLocal_85[0], -1, 0) == iLocal_81[8])
		{
			unk_0x1E862E30A84FAC6A(iLocal_85[0], 60000f);
			unk_0x8FA89B998CFE359C(iLocal_85[0]);
		}
	}
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_80))
	{
		if (unk_0xCED6B5226244381C(iLocal_80))
		{
			unk_0x697DA7132EE43ABC(iLocal_80, 0, 0);
		}
	}
	...
	while (iVar0 < 9)
	{
		if (!unk_0x9A70B1BD2A5BA09C(Local_100, 30f) && vdist(func_2(unk_0x460153A63B9477BC()), Local_100) > 300f)
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_81[iVar0]))
			{
				unk_0x2481907DEE6B85EA(&(iLocal_81[iVar0]));
			}
		}
		if (unk_0x5AEB5DDFFAD43CA5(iLocal_81[iVar0]))
		{
			if (unk_0x8F678487EEBD8CE4(iLocal_92[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(iLocal_92[iVar0]));
			}
		}
...
void func_118()
{
	...
	{
		unk_0xC08A186299DFDA0A(Local_100 - Vector(150f, 150f, 150f), Local_100 + Vector(150f, 150f, 150f), 0, 1, 1, 1);
		unk_0x410A1E7AD7D5C774(joaat("bobcatxl"), true);
		unk_0x410A1E7AD7D5C774(joaat("rebel"), true);
		unk_0x40ECEB892E6BDDDB(5, false);
		unk_0x40ECEB892E6BDDDB(3, false);
		iLocal_85[0] = unk_0xCE4780E24AFDFBF9(joaat("bobcatxl"), -1626.94f, 4729.889f, 51.3463f, 347.1188f, true, true, false);
		unk_0x4F3C4F457D44BB0F(iLocal_85[0], true, 0);
		unk_0xB11D151E210D4FAC(iLocal_85[0], 1084227584);
		unk_0xC160551F55D6365A(iLocal_85[0], true, true, 0);
		unk_0x289D342D7C2DA52A(iLocal_85[0], 2);
		unk_0x0FC504FAF5EB94FB(iLocal_85[0], 500f);
		unk_0x4A9F6CA267EF14FE(iLocal_85[0], 500f);
		unk_0xF242CEB863060ABC(iLocal_85[0], 1, true);
		unk_0xAD1128A569D59CFC(iLocal_85[0], 0, 0, 1148846080);
		unk_0x9CC6357234EC5D4A(iLocal_85[0], 6);
		unk_0xE096849E490C2EC2(iLocal_85[0], "RADIO_06_COUNTRY");
		unk_0xC29A9E1088D83B1B(iLocal_85[0], "76JON418");
		unk_0x0A9768A52FEE2064(iLocal_85[0], true);
		iLocal_85[1] = unk_0xCE4780E24AFDFBF9(joaat("rebel"), -1619.432f, 4747.792f, 52.7502f, 146.6017f, true, true, false);
		unk_0x4F3C4F457D44BB0F(iLocal_85[1], true, 0);
		unk_0xB11D151E210D4FAC(iLocal_85[1], 1084227584);
		unk_0xC160551F55D6365A(iLocal_85[1], true, true, 0);
		unk_0x289D342D7C2DA52A(iLocal_85[1], 2);
		unk_0x0FC504FAF5EB94FB(iLocal_85[1], 600f);
		unk_0x4A9F6CA267EF14FE(iLocal_85[1], 400f);
		unk_0xF242CEB863060ABC(iLocal_85[1], 1, true);
		unk_0xF242CEB863060ABC(iLocal_85[1], 2, true);
		unk_0xF242CEB863060ABC(iLocal_85[1], 3, false);
		unk_0xF242CEB863060ABC(iLocal_85[1], 4, false);
		unk_0x9CC6357234EC5D4A(iLocal_85[1], 6);
		unk_0xE096849E490C2EC2(iLocal_85[1], "RADIO_06_COUNTRY");
		unk_0xC29A9E1088D83B1B(iLocal_85[1], "79ERK121");
		unk_0x0A9768A52FEE2064(iLocal_85[1], true);
		unk_0xC4DB45F7A0864686(iLocal_85[1], 1);
		iLocal_85[2] = unk_0xCE4780E24AFDFBF9(joaat("bobcatxl"), -1636.216f, 4748.061f, 51.5484f, 199.3236f, true, true, false);
		unk_0xC29A9E1088D83B1B(iLocal_85[2], "83JOH802");
		unk_0x4F3C4F457D44BB0F(iLocal_85[2], true, 0);
		unk_0xB11D151E210D4FAC(iLocal_85[2], 1084227584);
		unk_0xC160551F55D6365A(iLocal_85[2], true, true, 0);
		unk_0x289D342D7C2DA52A(iLocal_85[2], 2);
		unk_0x0FC504FAF5EB94FB(iLocal_85[2], 60f);
		unk_0x4A9F6CA267EF14FE(iLocal_85[2], 1000f);
		unk_0xF242CEB863060ABC(iLocal_85[2], 1, false);
		unk_0xAD1128A569D59CFC(iLocal_85[2], 1, 0, 1148846080);
		iLocal_85[3] = unk_0xCE4780E24AFDFBF9(joaat("rebel"), -1641.578f, 4736.783f, 52.5984f, 278.1865f, true, true, false);
		unk_0xC29A9E1088D83B1B(iLocal_85[3], "85TOR114");
		unk_0x4F3C4F457D44BB0F(iLocal_85[3], true, 0);
		unk_0xB11D151E210D4FAC(iLocal_85[3], 1084227584);
		unk_0xC160551F55D6365A(iLocal_85[3], true, true, 0);
		unk_0x289D342D7C2DA52A(iLocal_85[3], 2);
		unk_0x0FC504FAF5EB94FB(iLocal_85[3], 500f);
		unk_0x4A9F6CA267EF14FE(iLocal_85[3], 500f);
		unk_0xF242CEB863060ABC(iLocal_85[3], 1, false);
		unk_0xF242CEB863060ABC(iLocal_85[3], 2, false);
		unk_0xF242CEB863060ABC(iLocal_85[3], 3, false);
		unk_0xF242CEB863060ABC(iLocal_85[3], 4, false);
		unk_0xAD1128A569D59CFC(iLocal_85[3], 0, 0, 1148846080);
		unk_0xAD1128A569D59CFC(iLocal_85[3], 5, 0, 1148846080);
		if (!unk_0xF10E878C0879E7E9(iLocal_97))
		{
			iVar0 = 0;
			unk_0xBE20AB8238688965(&iVar0, 1);
			unk_0xBE20AB8238688965(&iVar0, 3);
			unk_0xBE20AB8238688965(&iVar0, 4);
			iLocal_97 = unk_0xB1C0B7CD03D4467D(joaat("pickup_money_case"), Local_101, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
		...
		while (iVar1 < 5)
		{
			if (!unk_0xF10E878C0879E7E9(iLocal_98[iVar1]))
			{
				iVar2 = 0;
				...
				if (iVar1 < 2)
				{
					iLocal_98[iVar1] = unk_0x745986B99A8C6D46(joaat("pickup_weapon_sawnoffshotgun"), Local_104[iVar1 /*3*/], iVar2, -1, 1, 0);
				}
				else if (iVar1 == 4)
				{
					iLocal_98[iVar1] = unk_0xB1C0B7CD03D4467D(joaat("pickup_weapon_assaultrifle"), Local_104[iVar1 /*3*/], 90f, 50f, 0f, 0, 50, 2, 1, 0);
				}
				else
				{
					iLocal_98[iVar1] = unk_0x745986B99A8C6D46(joaat("pickup_weapon_pistol"), Local_104[iVar1 /*3*/], iVar2, -1, 1, 0);
				}
			}
			iVar1++;
		}
		...
		while (iVar1 < 6)
		{
			if (iVar1 <= 3)
			{
				iLocal_81[iVar1] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_y_salvagoon_03"), Local_48[iVar1 /*3*/], fLocal_49[iVar1], 1, true);
				unk_0x694113444F21E39F(iLocal_81[iVar1], 227, true);
			}
			else
			{
				iLocal_81[iVar1] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_m_chigoon_02"), Local_48[iVar1 /*3*/], fLocal_49[iVar1], 1, true);
			}
			iVar1++;
		}
		iLocal_82[0] = unk_0xB3116B49FE00E2F1(26, joaat("a_c_rottweiler"), -1635.005f, 4737.181f, 53.4995f, 33.4155f, 1, true);
		iLocal_82[1] = unk_0xB3116B49FE00E2F1(26, joaat("a_c_rottweiler"), -1625.215f, 4741.119f, 52.5762f, 316.2733f, 1, true);
		iVar1 = 0;
		while (iVar1 < iLocal_82)
		{
			unk_0x4478D8ED4673EF14(iLocal_82[iVar1], 1);
			unk_0x58ADF88C51AAFDC5(iLocal_82[iVar1], true, 0);
			unk_0x694113444F21E39F(iLocal_82[iVar1], 227, true);
			Local_50 = { unk_0x3E4D3CCC220BDFB1(iLocal_82[iVar1], true) };
			Local_51 = { Local_50.x, (Local_50.f_1 - 2f), (Local_50.f_2 - 0.5f) };
			Local_52 = { Local_50.x, (Local_50.f_1 + 50f), (Local_50.f_2 - 0.5f) };
			unk_0x79F8EF9CAC6E94EF(Local_51, Local_52, 100, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			iVar1++;
		}
		unk_0x81DCDE42A0B23C21(iLocal_81[0], "random@dealgonewrongdead_peds", "ped_b", -1635.928f, 4707.941f, 46.383f, -29.25f, 12.25f, 171.75f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_81[1], "random@dealgonewrongdead_peds", "ped_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_81[2], "random@dealgonewrongdead_peds", "ped_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_81[3], "random@dealgonewrongdead_peds", "ped_c", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_81[4], "random@dealgonewrongdead_peds", "ped_d", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_81[5], "random@dealgonewrongdead_peds", "ped_e", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_82[0], "random@dealgonewrongdead_peds", "dog_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x81DCDE42A0B23C21(iLocal_82[1], "random@dealgonewrongdead_peds", "dog_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x7E3782F0FA252F95(50f);
		func_120();
		unk_0x7E3782F0FA252F95(1f);
		if (unk_0x80FF6C016CDB0FAF(iLocal_85[0], 0))
		{
			iLocal_81[8] = unk_0x6A7A2C83BD302BA4(iLocal_85[0], 26, joaat("g_m_y_salvagoon_03"), -1, 1, true);
			unk_0x4F3C4F457D44BB0F(iLocal_81[8], true, 0);
			unk_0x503A0C9176F8BB0C(iLocal_81[8], 1);
			unk_0x697DA7132EE43ABC(iLocal_81[8], 0, 0);
		}
		if (!unk_0x8F678487EEBD8CE4(iLocal_89))
		{
		}
		unk_0xDE8F8016287F771F("re_DealGoneWrong", &iLocal_113);
		iLocal_81[6] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_m_chigoon_02"), Local_48[6 /*3*/], fLocal_49[6], 1, true);
		func_100(&uLocal_114, 4, iLocal_81[6], "REDGWChinese", 0, 1);
		unk_0x4E65320BC9AD521C(iLocal_81[6], true);
		unk_0xDAE36360F0F8C1ED(iLocal_81[6], true);
		unk_0xD3D9D7C84656DAE5(iLocal_81[6], iLocal_113);
		iVar3 = unk_0xF341A134A5B8D4F6(Local_48[6 /*3*/] + Vector(1.05f, 0f, 0f), -7f, 0f, 34.1111f, 0);
		unk_0xDFDB9C533700BC17(iLocal_81[6], iVar3, "random@dealgonewrong", "base", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x81493F39713559B1(iVar3, true);
		unk_0xCBA6B2B569DCAFD8(iLocal_81[6], true);
		unk_0x694113444F21E39F(iLocal_81[6], 227, true);
		iLocal_81[7] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_y_salvagoon_03"), -1640.311f, 4738.4f, 50.2f, fLocal_49[7], 1, true);
		func_100(&uLocal_114, 5, iLocal_81[7], "REDGWSalvadoran", 0, 1);
		unk_0x4E65320BC9AD521C(iLocal_81[7], true);
		unk_0xDAE36360F0F8C1ED(iLocal_81[7], true);
		unk_0xD3D9D7C84656DAE5(iLocal_81[7], iLocal_113);
		iVar4 = unk_0xF341A134A5B8D4F6(Local_48[7 /*3*/] + Vector(0.92f, 0.65f, -0.65f), 0f, 0f, 34.1111f, 0);
		unk_0xDFDB9C533700BC17(iLocal_81[7], iVar4, "random@dealgonewrong", "idle_a", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x81493F39713559B1(iVar4, true);
		unk_0x8430A80C3E4F5F98(iVar4, 0.5f);
		unk_0xCBA6B2B569DCAFD8(iLocal_81[7], true);
		unk_0x694113444F21E39F(iLocal_81[7], 227, true);
		iLocal_80 = unk_0xB3116B49FE00E2F1(22, joaat("g_m_m_chigoon_02"), Local_63, fLocal_67, 1, true);
		func_100(&uLocal_114, 4, iLocal_80, "REDGWChinese", 0, 1);
		unk_0x4E65320BC9AD521C(iLocal_80, true);
		unk_0xD3D9D7C84656DAE5(iLocal_80, iLocal_113);
		iVar5 = unk_0xF341A134A5B8D4F6(Local_63, 7.5f, -12.75f, 51.5f, 0);
		unk_0xDFDB9C533700BC17(iLocal_80, iVar5, "random@dealgonewrong", "idle_b", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x81493F39713559B1(iVar5, true);
		unk_0xC82085403E46A869(iLocal_80, 4f, 18f, 326.7277f, 0, 1);
		unk_0xCBA6B2B569DCAFD8(iLocal_80, true);
		unk_0x694113444F21E39F(iLocal_80, 227, true);
		unk_0xEFBCE8F8316F89EA(5, iLocal_113, 1862763509);
		if (func_40() == 0)
		{
			func_100(&uLocal_114, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
		}
		if (func_40() == 1)
		{
			func_100(&uLocal_114, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
		}
		if (func_40() == 2)
		{
			func_100(&uLocal_114, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
		}
		iLocal_99[0] = unk_0xF00FBB09122693FC(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[1] = unk_0xF00FBB09122693FC(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[2] = unk_0xF00FBB09122693FC(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[3] = unk_0xF00FBB09122693FC(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[4] = unk_0xF00FBB09122693FC(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[5] = unk_0xF00FBB09122693FC(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[6] = unk_0xF00FBB09122693FC(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[7] = unk_0xF00FBB09122693FC(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[8] = unk_0xF00FBB09122693FC(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[9] = unk_0xF00FBB09122693FC(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[10] = unk_0xF00FBB09122693FC(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar1 = 0;
		while (iVar1 < 6)
		{
			if (!unk_0xA59F96B50B97E63C(iLocal_81[iVar1], 0))
			{
				unk_0x4478D8ED4673EF14(iLocal_81[iVar1], 1);
				unk_0x8CD0D18BBDEA2635(iLocal_81[iVar1], 0, 0.3f, 0.6f, 3);
				unk_0x8CD0D18BBDEA2635(iLocal_81[iVar1], 0, 0.65f, 0.6f, 3);
				wait(unk_0x344C570D6F8700DF(100, 500));
				if (iVar1 <= 5)
				{
					if (unk_0x8F678487EEBD8CE4(iLocal_92[iVar1]))
					{
						unk_0x93370FA10F15BE44(&(iLocal_92[iVar1]));
					}
				}
			}
			iVar1++;
...
void func_120()
{
	...
	{
		wait(0);
		if (unk_0xAE06B9E39EBDE049(iLocal_85[iVar0]))
		{
			Local_53 = { unk_0x7EC595B99EA7C4B1(iLocal_85[iVar0], 0f, 0f, 0.5f) };
		}
		iLocal_77 = 0;
		while (iLocal_77 < 5)
		{
			...
			unk_0x79F8EF9CAC6E94EF(Local_54, Local_55, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			Local_54 = { (Local_53.x + fLocal_64), (Local_53.f_1 + fLocal_65), (Local_53.f_2 + fLocal_66) };
			Local_55 = { (Local_53.x - fLocal_64), (Local_53.f_1 - fLocal_65), Local_53.f_2 };
			unk_0x79F8EF9CAC6E94EF(Local_54, Local_55, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			Local_54 = { (Local_53.x + fLocal_64), (Local_53.f_1 - fLocal_65), (Local_53.f_2 + fLocal_66) };
