...
int func_1()
{
	...
	else if (iLocal_46 == 1)
	{
		...
		{
			func_49(unk_0x9B0761B4C3EB8BC7(), -347.4067f, -93.5801f, 44.6639f, 306.0178f);
		}
...
int func_35()
{
	...
	iVar0 = unk_0x36FE6D3220816ADA(unk_0x9B0761B4C3EB8BC7());
	switch (iVar0)
	{
...
void func_40(int iParam0)
{
	...
	while (iVar1 < Global_111858.f_7684.f_198)
	{
		...
		{
			func_41(Global_111858.f_7684.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
void func_51()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_58[iVar1] = unk_0x79CC07752E7432A1(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, true, true, false);
				unk_0xCBF81D3222C77066(iLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0xC82085403E46A869(iLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				iLocal_58[iVar1] = unk_0x79CC07752E7432A1(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, true, true, false);
				unk_0xCBF81D3222C77066(iLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0xC82085403E46A869(iLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				iLocal_58[iVar1] = unk_0x79CC07752E7432A1(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, true, true, false);
				unk_0xCBF81D3222C77066(iLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0xC82085403E46A869(iLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_55()
{
	...
	else if (iLocal_46 == 1)
	{
		if (func_50(unk_0x9B0761B4C3EB8BC7()))
		{
			func_49(unk_0x9B0761B4C3EB8BC7(), -366.6139f, -79.7531f, 44.6616f, 230.7299f);
		}
		unk_0x4C4FC7841A5FB983(0f);
		unk_0x7965943E39128B42(0f, 1065353216);
		unk_0xFD45D90342D2A0CD(250);
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0x7C4984752F886E92(iLocal_48, 1))
			{
				func_150();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (unk_0x33DA7244053AB66E(30f, 31086, 0.8f, 0.7f, 0.25f, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0x578C4EF320340AF7() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0x578C4EF320340AF7())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_57()
{
	...
	{
		unk_0x78FCB2E22C41B9D5(joaat("u_m_m_streetart_01"));
		if (unk_0x7D167B9A0CCDA347(joaat("u_m_m_streetart_01")))
		{
			iLocal_48 = unk_0xB3116B49FE00E2F1(26, joaat("u_m_m_streetart_01"), Local_49, fLocal_50, 1, true);
			unk_0x74528AC0906CBABE(joaat("u_m_m_streetart_01"));
			iLocal_58[0] = unk_0x79CC07752E7432A1(joaat("prop_cs_spray_can"), Local_59, true, true, false);
			unk_0xF8A652CE310FFC53(iLocal_58[0], iLocal_48, unk_0xE6B87C42793036AA(iLocal_48, 28422), 0f, -0.01f, -0.02f, Local_66, 1, 1, 0, 0, 2, 1);
			unk_0xCBA6B2B569DCAFD8(iLocal_48, true);
			unk_0x694113444F21E39F(iLocal_48, 42, true);
			iLocal_53 = func_68(iLocal_48, 0, 145);
			func_58(1);
			unk_0xD3D9D7C84656DAE5(iLocal_48, 1862763509);
			unk_0x5725FB9B2BC1D6B6(iLocal_48, 2.5f);
		}
	}
	return 0;
}
...
int func_62()
{
	switch (func_63(&Global_31027, 0, 5, 0, unk_0x354AD085195C5FA6()))
	{
		case 1:
			return 1;
			break;
...
int func_69(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(iVar0, func_70(unk_0x25DDB354A40FFCDB(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(iVar0, func_70(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
		unk_0x3060C53EAE54BBE7(iVar0, bParam1);
	}
...
{
	func_72();
	if (!unk_0x1116855A2A7A342C() && iLocal_51 < 3)
	{
		func_150();
	}
}
...
void func_72()
{
	...
	if (func_50(iLocal_48))
	{
		...
		bVar1 = func_50(unk_0x9B0761B4C3EB8BC7());
		Var2 = { unk_0x3E4D3CCC220BDFB1(iLocal_48, false) };
		fVar4 = 7.5f;
		Var5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			Var3 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false) };
			bVar6 = unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false);
			bVar7 = unk_0x94BF5C4EB0D40E9E(unk_0x9B0761B4C3EB8BC7());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0xC7EB33BFDB436C87(Var2, fVar4, 0) || unk_0x5AC0C31BB5BC0343(Var2 - Var5, Var2 + Var5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x131ED02492676000(sLocal_62);
				if (unk_0xC614DDE265D18415(sLocal_62))
				{
					unk_0x4E65320BC9AD521C(iLocal_48, true);
					unk_0x756D74A3EF0AB788(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_82(unk_0x9B0761B4C3EB8BC7(), iLocal_48, 35f))
				{
					unk_0x9DC06E2A59C5AEBB(&iLocal_68);
					unk_0x756D74A3EF0AB788(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x756D74A3EF0AB788(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x19F29730874AD6F1(iLocal_68);
					unk_0x9B6EC2CECE1010EF(iLocal_48, iLocal_68);
					unk_0x4F83FEE4454169D4(&iLocal_68);
					unk_0x1082C25039B168F8(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_82(unk_0x9B0761B4C3EB8BC7(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0x6AC7395A8E313A46(iLocal_48, 8, true);
				unk_0x6AC7395A8E313A46(iLocal_48, 32, true);
				unk_0x9DC06E2A59C5AEBB(&iLocal_68);
				unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), 800);
				unk_0x8B18A80E8EB15510(0, unk_0x9B0761B4C3EB8BC7(), 9999f, -1, 1, 0);
				unk_0x19F29730874AD6F1(iLocal_68);
				unk_0x9B6EC2CECE1010EF(iLocal_48, iLocal_68);
				unk_0x4F83FEE4454169D4(&iLocal_68);
				iLocal_51++;
			...
			case 5:
				...
				if (!unk_0xA38BFCB05DBE439D(iLocal_48) && vdist2(Var2, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false)) > 2500f)
				{
					iLocal_67 = unk_0xF898EA06B9458004(Var3, Var2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0x0F0E6A09A9C90474(iLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0xAE06B9E39EBDE049(iLocal_48))
	{
		unk_0x6A8F948698B360B4(iLocal_48, false);
	}
}
...
int func_73()
{
	...
	{
		case 0:
			if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				Local_57 = { Var0 };
			...
			else if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0x4C06B15B376AA145(iLocal_48, sLocal_62, sLocal_64);
				fLocal_54 = func_77(fLocal_54, 0.2f, 0.349f);
				if (fLocal_54 != 0.2f)
				{
					fVar2 = ((1f / (0.349f - 0.161f)) * to_float(900));
					iLocal_55 = round(((fLocal_54 - 0.161f) * fVar2));
					Local_57 = { unk_0x3E4D3CCC220BDFB1(iLocal_48, false) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0x756D74A3EF0AB788(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0x578C4EF320340AF7();
			func_76(&iLocal_53);
			func_75();
			if (unk_0xAE06B9E39EBDE049(iLocal_58[0]))
			{
				unk_0x1F8106DB8796859F(iLocal_58[0], 1, true);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0x578C4EF320340AF7() - iLocal_69);
				fVar4 = (to_float(iVar3) / to_float(iLocal_55));
				fVar5 = (fLocal_54 - ((fLocal_54 - 0.161f) * fVar4));
				fVar5 = func_77(fVar5, 0.161f, fLocal_54);
				unk_0xFC4EDD7B55A807F1(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_77(fVar6, 0f, 0.8f);
				Var7 = { func_74(Local_57, Var1, fVar6) };
				unk_0x03D382CB0B44E2FC(iLocal_48, Var7, 0, true, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0x6A8F948698B360B4(iLocal_48, false);
					return 1;
...
void func_75()
{
	if (iLocal_60 != 0)
	{
		unk_0x994BE8B44E53ECFA(iLocal_60, 0);
		iLocal_60 = 0;
	}
}
...
void func_78()
{
	...
	if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0x4C06B15B376AA145(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_75();
		}
	...
	else if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0x4C06B15B376AA145(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_75();
		}
...
void func_79()
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0xF245B4695C9BEF04(sLocal_61, iLocal_58[0], Local_66, Local_66, 1f, 0, 0, 0);
		unk_0xC313709BC7ED51D7(iLocal_60, 1f, 1f, 1f, false);
		unk_0xF8B3E22FA17FA0B3(iLocal_60, 0.2f);
	}
}
...
bool func_81()
{
	return (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, true, 0) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, true, 0));
}
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0xAE06B9E39EBDE049(iParam0) && unk_0xAE06B9E39EBDE049(iParam1))
	{
		...
		return vdist2(unk_0x3E4D3CCC220BDFB1(iParam0, false), unk_0x3E4D3CCC220BDFB1(iParam1, false)) <= fVar0;
	}
	return 0;
}
...
int func_83(int iParam0)
{
	...
	{
		func_76(&iLocal_53);
		unk_0x8B18A80E8EB15510(iLocal_48, unk_0x9B0761B4C3EB8BC7(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (vmag2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_149())
			{
				return 0;
			}
		}
		...
		if (!func_133(Global_111858.f_24991.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xD5EAF42B1EAE828F(unk_0x460153A63B9477BC(), 1) || func_130()) || Global_30970) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x117A56F7403FC6D2(unk_0x460153A63B9477BC()) || unk_0xA16974805191D19C(unk_0x9B0761B4C3EB8BC7())) || unk_0x11B7C25143EE2F29(unk_0x9B0761B4C3EB8BC7())) || unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7())) || unk_0xEC787E1D3B804A72(unk_0x9B0761B4C3EB8BC7())) || unk_0xD5EAF42B1EAE828F(unk_0x460153A63B9477BC(), 1)) || unk_0x5197F8CD4A72E68F(unk_0x460153A63B9477BC())) || unk_0xF83D0A2EC884A4DD(unk_0x9B0761B4C3EB8BC7(), 0)) || func_130()) || Global_110905) || Global_30970) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7()) || unk_0xEC787E1D3B804A72(unk_0x9B0761B4C3EB8BC7())) || unk_0xD5EAF42B1EAE828F(unk_0x460153A63B9477BC(), 1)) || unk_0xF83D0A2EC884A4DD(unk_0x9B0761B4C3EB8BC7(), 0)) || func_130()) || Global_110905) || Global_30970) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_124()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_130() || unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0) || func_128(8, -1)) || func_124()) || func_123()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
