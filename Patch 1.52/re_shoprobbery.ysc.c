...
void __EntryFunction__()
{
	...
	if (func_204(Local_48, 5, iLocal_73, 0, 0))
	{
		func_201(5);
	}
	else
	...
	{
		wait(0);
		if (unk_0x1116855A2A7A342C() || iLocal_99)
		{
			if (!func_200())
			{
				if (func_199())
					...
					case 1:
						switch (iLocal_44)
						{
							case 0:
								...
								{
									func_184();
									if (unk_0xEF928B5F0219FDF7(iLocal_88))
									{
										func_178();
										iLocal_76 = 1;
									}
								...
								else
								{
									...
									func_175();
									unk_0x1F083D57FD823427(iLocal_88);
									if (func_174())
									{
										if (!iLocal_94)
										{
									...
									if (func_172())
									{
										if (unk_0x8F678487EEBD8CE4(iLocal_122))
										{
											unk_0x93370FA10F15BE44(&iLocal_122);
										}
										...
										{
											if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar0]))
											{
												unk_0x8FF9CE1C0F94F59A(iLocal_66[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
												unk_0xCBA6B2B569DCAFD8(iLocal_66[iVar0], true);
												if (!unk_0x8F678487EEBD8CE4(uLocal_116[iVar0]))
												{
										...
										if (iLocal_47 == 2)
										{
											...
											{
												if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[iVar0]))
												{
													unk_0xAEC92B0DA8075AC9(iLocal_67[iVar0], -1);
													unk_0xCBA6B2B569DCAFD8(iLocal_67[iVar0], true);
												}
												iVar0++;
											}
											iVar0 = 0;
											...
											{
												if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[iVar0]))
												{
													unk_0xAEC92B0DA8075AC9(iLocal_68[iVar0], -1);
													unk_0xCBA6B2B569DCAFD8(iLocal_68[iVar0], true);
												}
												iVar0++;
											}
										}
										unk_0x315F7D8C33F0AB37(&iLocal_102);
										bLocal_79 = true;
										iLocal_44 = 1;
										iLocal_45 = 3;
									}
									if (func_170())
									{
										func_163(1);
										settimera(0);
										unk_0x077EB65374D89330(90, Local_123, 15000f);
										iLocal_44 = 1;
									}
								}
								break;
							...
							case 1:
								...
								{
									if (unk_0xAE06B9E39EBDE049(iLocal_67[iVar1]))
									{
										if (unk_0xCDF860E56BBCC6B4(iLocal_67[iVar1], unk_0x9B0761B4C3EB8BC7(), 1))
										{
											func_162();
										}
									}
								...
								{
									if (unk_0xAE06B9E39EBDE049(iLocal_68[iVar1]))
									{
										if (unk_0xCDF860E56BBCC6B4(iLocal_68[iVar1], unk_0x9B0761B4C3EB8BC7(), 1))
										{
											func_162();
										}
									}
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										if (timerb() > 500)
										{
											if (unk_0xAE06B9E39EBDE049(iLocal_102))
											{
												if (!unk_0xB77B1396EAA80D8F(iLocal_102))
												{
													func_151();
													unk_0x69C71C91F56D82B9(iLocal_66[0], joaat("weapon_unarmed"), true);
													unk_0xF8A652CE310FFC53(iLocal_102, iLocal_66[0], unk_0xE6B87C42793036AA(iLocal_66[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1);
												}
											}
										}
										if (unk_0x5AC0C31BB5BC0343(Local_123 - Vector(20f, 20f, 20f), Local_123 + Vector(20f, 20f, 20f), 0))
										{
											if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[1]))
											{
												unk_0xD66FADEF7D42D49B(iLocal_67[1], Local_59, 150f, -1, 0, 0);
												unk_0x4E65320BC9AD521C(iLocal_67[1], false);
												unk_0x2481907DEE6B85EA(&(iLocal_67[1]));
											}
											if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[2]))
											{
												unk_0xD66FADEF7D42D49B(iLocal_67[2], Local_59, 150f, -1, 0, 0);
												unk_0x4E65320BC9AD521C(iLocal_67[2], false);
												unk_0x2481907DEE6B85EA(&(iLocal_67[2]));
											}
											iVar2 = 0;
											while (iVar2 <= (iLocal_65 - 1))
											{
												if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[iVar2]))
												{
													unk_0xA5EAD2ACE2C8BBB2(iLocal_68[iVar2], true, 1);
													unk_0x9DC06E2A59C5AEBB(&iLocal_87);
													if (iLocal_47 == 1)
													{
													...
													unk_0xD66FADEF7D42D49B(0, Local_59, 150f, -1, 0, 0);
													unk_0x19F29730874AD6F1(iLocal_87);
													unk_0x9B6EC2CECE1010EF(iLocal_68[iVar2], iLocal_87);
													unk_0x4F83FEE4454169D4(&iLocal_87);
													unk_0xCBA6B2B569DCAFD8(iLocal_68[iVar2], true);
													unk_0x4E65320BC9AD521C(iLocal_68[iVar2], false);
													unk_0x0DC39BE87E4C5599(iLocal_68[iVar2], true);
													unk_0x2481907DEE6B85EA(&(iLocal_68[iVar2]));
												}
												iVar2++;
											}
										}
										if (func_150() || timera() > 20000)
										{
											if (!iLocal_99)
											{
												if (!unk_0xA59F96B50B97E63C(iLocal_66[0], 0))
												{
													...
													unk_0x756D74A3EF0AB788(unk_0x9B0761B4C3EB8BC7(), "random@shop_robbery", "kneel_getup_p", 2f, -2f, 2700, 0, 0, 0, 0, 0);
													if (iLocal_47 == 1)
													{
														if (unk_0xAE06B9E39EBDE049(iLocal_102))
														{
															unk_0x80250B8368A4E611(iLocal_102, false, 0);
															unk_0x58ADF88C51AAFDC5(iLocal_102, false, 0);
														}
													}
													else if (iLocal_47 == 2)
													{
													...
													while (iVar1 < iLocal_67)
													{
														if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[iVar1]))
														{
															unk_0x4E65320BC9AD521C(iLocal_67[iVar1], false);
														}
														iVar1++;
													}
													iVar1 = 0;
													while (iVar1 < iLocal_68)
													{
														if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[iVar1]))
														{
															unk_0x4E65320BC9AD521C(iLocal_68[iVar1], false);
														}
														iVar1++;
													}
													if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
													{
														unk_0x4E65320BC9AD521C(iLocal_67[0], true);
														unk_0x9DC06E2A59C5AEBB(&iLocal_87);
														unk_0x756D74A3EF0AB788(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0, 0, 0, 0);
														unk_0x19F29730874AD6F1(iLocal_87);
														unk_0x9B6EC2CECE1010EF(iLocal_67[0], iLocal_87);
														unk_0x4F83FEE4454169D4(&iLocal_87);
														unk_0xCBA6B2B569DCAFD8(iLocal_67[0], true);
													}
													if (!func_134())
													{
										...
										if (iLocal_47 == 1)
										{
											...
											if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]) && unk_0x80FF6C016CDB0FAF(iLocal_106, 0))
											{
												if (unk_0xE0B3BC41DDA88DF0(iLocal_66[0], iLocal_106, false))
												{
													if (unk_0xAE06B9E39EBDE049(iLocal_102))
													{
														unk_0x315F7D8C33F0AB37(&iLocal_102);
											...
											{
												if (unk_0x8F678487EEBD8CE4(uLocal_116[0]))
												{
													unk_0x93370FA10F15BE44(&(uLocal_116[0]));
												}
												if (unk_0x8F678487EEBD8CE4(uLocal_116[1]))
												{
													unk_0x93370FA10F15BE44(&(uLocal_116[1]));
												}
												if (!unk_0x8F678487EEBD8CE4(iLocal_120))
												{
													iLocal_120 = func_113(iLocal_106, 1, 0);
												}
												bLocal_96 = true;
												if (!unk_0x5AEB5DDFFAD43CA5(iLocal_115))
												{
													unk_0x6673CC701BC8E9C1(iLocal_115, 17, true);
													unk_0x6673CC701BC8E9C1(iLocal_115, 6, true);
													unk_0x6673CC701BC8E9C1(iLocal_115, 1, true);
													unk_0xBD204892D76E6303(iLocal_115, iLocal_106, unk_0x9B0761B4C3EB8BC7(), 8, 16f, 786469, -1f, -1f, 1);
													unk_0xCBA6B2B569DCAFD8(iLocal_115, true);
													iLocal_97 = 1;
												}
											}
											if (iLocal_97 && !iLocal_143)
											{
												if (unk_0x80FF6C016CDB0FAF(iLocal_106, 0) && !unk_0x5AEB5DDFFAD43CA5(iLocal_115))
												{
													if (!unk_0xC2169C00B643278B(iLocal_106, Local_51[0 /*3*/], 20f, 20f, 10f, false, true, 0))
													{
														unk_0xBD204892D76E6303(iLocal_115, iLocal_106, unk_0x9B0761B4C3EB8BC7(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_143 = 1;
													}
												}
											}
											if (func_112())
											{
												if (!unk_0x5AEB5DDFFAD43CA5(iLocal_115))
												{
													if (unk_0x80FF6C016CDB0FAF(iLocal_106, 0))
													{
														if (!iLocal_98)
														{
															unk_0x6673CC701BC8E9C1(iLocal_115, 17, true);
															unk_0x6673CC701BC8E9C1(iLocal_115, 6, true);
															unk_0x6673CC701BC8E9C1(iLocal_115, 1, true);
															unk_0xBD204892D76E6303(iLocal_115, iLocal_106, unk_0x9B0761B4C3EB8BC7(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_98 = 1;
														}
														if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
														{
															if (unk_0xE0B3BC41DDA88DF0(iLocal_66[0], iLocal_106, false))
															{
																if (unk_0x8F678487EEBD8CE4(uLocal_116[0]))
												...
												while (iVar3 <= (iLocal_63 - 1))
												{
													if (!iLocal_80[iVar3])
													{
														if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar3]))
														{
															if (unk_0x47DBF174A0CB9D55(iLocal_66[iVar3], false) && !unk_0x5AEB5DDFFAD43CA5(iLocal_115))
															{
																unk_0x4E8B7920F3D6B9EE(iLocal_66[iVar3], unk_0x9B0761B4C3EB8BC7(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
																iLocal_80[iVar3] = 1;
															}
															else if (!unk_0x8F678487EEBD8CE4(iLocal_121))
															{
																unk_0x8FF9CE1C0F94F59A(iLocal_66[iVar3], unk_0x9B0761B4C3EB8BC7(), 0, 16);
																unk_0xCBA6B2B569DCAFD8(iLocal_66[iVar3], true);
																if (unk_0x8F678487EEBD8CE4(iLocal_120))
																{
																	unk_0x93370FA10F15BE44(&iLocal_120);
																}
																if (!unk_0x8F678487EEBD8CE4(uLocal_116[iVar3]))
																{
													...
													if (!iLocal_81[iVar3])
													{
														if (unk_0x80FF6C016CDB0FAF(iLocal_106, 0))
														{
															if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar3]))
															{
																if ((unk_0x5AEB5DDFFAD43CA5(iLocal_115) || unk_0xB064AF9925F5537B(iLocal_106, -1, 0)) || unk_0x0922C2E075A5F18C(iLocal_66[iVar3]))
																{
																	unk_0xA5EAD2ACE2C8BBB2(iLocal_66[iVar3], true, 1);
																	unk_0x9DC06E2A59C5AEBB(&iLocal_87);
																	unk_0x0AB756271BADC8DF(0, 0, 0);
																	unk_0x8B18A80E8EB15510(0, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 0, 0);
																	unk_0x19F29730874AD6F1(iLocal_87);
																	unk_0x9B6EC2CECE1010EF(iLocal_66[iVar3], iLocal_87);
																	unk_0x4F83FEE4454169D4(&iLocal_87);
																	unk_0xCBA6B2B569DCAFD8(iLocal_66[iVar3], true);
																	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_115))
																	{
																		unk_0xA5EAD2ACE2C8BBB2(iLocal_115, true, 1);
																		unk_0x9DC06E2A59C5AEBB(&iLocal_87);
																		unk_0x0AB756271BADC8DF(0, 0, 0);
																		unk_0x8B18A80E8EB15510(0, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 0, 0);
																		unk_0x19F29730874AD6F1(iLocal_87);
																		unk_0x9B6EC2CECE1010EF(iLocal_115, iLocal_87);
																		unk_0x4F83FEE4454169D4(&iLocal_87);
																		unk_0xCBA6B2B569DCAFD8(iLocal_115, true);
																	}
																	if (!unk_0x8F678487EEBD8CE4(iLocal_121))
																	{
																		if (unk_0x8F678487EEBD8CE4(iLocal_120))
																		{
																			unk_0x93370FA10F15BE44(&iLocal_120);
										...
										else if (iLocal_47 == 2)
										{
											...
											if (unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
											{
												if (unk_0x8F678487EEBD8CE4(uLocal_116[1]))
												{
											...
											if (unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
											{
												if (unk_0xAE06B9E39EBDE049(iLocal_102))
												{
													if (unk_0xB77B1396EAA80D8F(iLocal_102))
													{
														unk_0x1F8106DB8796859F(iLocal_102, 1, true);
													}
													unk_0x315F7D8C33F0AB37(&iLocal_102);
													func_110();
													func_107();
											...
											else if (unk_0xCDF860E56BBCC6B4(iLocal_66[0], unk_0x9B0761B4C3EB8BC7(), 1))
											{
												if (unk_0xAE06B9E39EBDE049(iLocal_102))
												{
													if (unk_0xB77B1396EAA80D8F(iLocal_102))
									...
									case 10:
										...
										if (iLocal_47 == 1)
										{
											if (!iLocal_95)
											{
												...
												else if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
												{
													unk_0x03D382CB0B44E2FC(iLocal_67[0], -818.5553f, -185.4815f, 36.5689f, 1, false, 0, 1);
													unk_0xE922BAA80E8F9324(iLocal_67[0], 47.0582f);
													unk_0x756D74A3EF0AB788(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0, 0, 0, 0);
													if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[1]))
													{
														unk_0xD66FADEF7D42D49B(iLocal_67[1], Local_59, 150f, -1, 0, 0);
														unk_0x4E65320BC9AD521C(iLocal_67[1], false);
													...
													{
														if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[iVar4]))
														{
															unk_0x9DC06E2A59C5AEBB(&iLocal_87);
															unk_0x756D74A3EF0AB788(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
															unk_0xD66FADEF7D42D49B(0, Local_59, 150f, -1, 0, 0);
															unk_0x19F29730874AD6F1(iLocal_87);
															unk_0x9B6EC2CECE1010EF(iLocal_68[iVar4], iLocal_87);
															unk_0x4F83FEE4454169D4(&iLocal_87);
															unk_0xCBA6B2B569DCAFD8(iLocal_68[iVar4], true);
															unk_0x4E65320BC9AD521C(iLocal_68[iVar4], false);
															unk_0x0DC39BE87E4C5599(iLocal_68[iVar4], true);
															unk_0x2481907DEE6B85EA(&(iLocal_68[iVar4]));
														}
														iVar4++;
													}
													iLocal_95 = 1;
										...
										else if (iLocal_47 == 2)
										{
											if (!iLocal_95)
											{
												...
												{
													unk_0x03D382CB0B44E2FC(iLocal_67[0], -1197.455f, -776.0289f, 16.3254f, 1, false, 0, 1);
													unk_0xE922BAA80E8F9324(iLocal_67[0], 205.7753f);
													unk_0x756D74A3EF0AB788(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0, 0, 0, 0);
													if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[1]))
													{
														unk_0xD66FADEF7D42D49B(iLocal_67[1], Local_59, 150f, -1, 0, 0);
													...
													{
														if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[iVar5]))
														{
															unk_0xD66FADEF7D42D49B(iLocal_68[iVar5], Local_59, 150f, -1, 0, 0);
															unk_0x4E65320BC9AD521C(iLocal_68[iVar5], false);
															unk_0x0DC39BE87E4C5599(iLocal_68[iVar5], true);
															unk_0x2481907DEE6B85EA(&(iLocal_68[iVar5]));
														}
														iVar5++;
													}
													iLocal_95 = 1;
										...
										if ((func_170() && !unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false)) && !unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7()))
										{
											settimera(0);
											iLocal_45 = 11;
										}
										if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), func_250()) > (fLocal_124 + 150f))
										{
											iLocal_45 = 12;
										}
										if (timera() > 120000)
										...
										else if (unk_0xCDF860E56BBCC6B4(iLocal_67[0], unk_0x9B0761B4C3EB8BC7(), 1))
										{
											func_75(2);
											func_55();
										}
									...
									case 13:
										if (!iLocal_144)
										{
											if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
											{
												unk_0x9B94F6169B0DAEFD(iLocal_67[0]);
												if (iLocal_47 == 1)
												{
												...
												unk_0xC02F1FF16ABCEA26(iLocal_67[0], 20000);
												unk_0xCBA6B2B569DCAFD8(iLocal_67[0], true);
												unk_0x4E65320BC9AD521C(iLocal_67[0], false);
												iLocal_144 = 1;
											}
										}
										if (!func_134())
...
void func_1()
{
	if (func_170())
	{
		...
		if (!iLocal_113)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
			{
				...
				unk_0x801B883D25479F23(unk_0x3E4D3CCC220BDFB1(iLocal_67[0], true), 20f, 0);
	...
	if (bLocal_112)
	{
		if (!iLocal_114)
		{
			...
			Local_125 = { unk_0x3E4D3CCC220BDFB1(iLocal_67[0], false) };
			if (iLocal_47 == 1)
			{
			...
			iLocal_135 = unk_0xF341A134A5B8D4F6(Local_125, Local_127, 2);
			iLocal_129 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", false);
			unk_0x00736EE41CC355ED(iLocal_129, iLocal_135, sLocal_134, sLocal_130);
			unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
			unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), iLocal_135, sLocal_130, sLocal_131, 1000f, -2f, 5, 0, 1148846080, 0);
			unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 0, 0);
			unk_0x2BB0EF9DE445EA13(iLocal_67[0]);
			unk_0xDFDB9C533700BC17(iLocal_67[0], iLocal_135, sLocal_130, sLocal_132, 1000f, -2f, 4, 0, 1148846080, 0);
			unk_0x1322CA891C5DF18A(iLocal_67[0], 0, 0);
			iLocal_102 = unk_0x79CC07752E7432A1(joaat("prop_cs_duffel_01"), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), true, true, false);
			unk_0x1FEB07A1AF22700F(iLocal_102, iLocal_135, sLocal_133, sLocal_130, 1000f, 8f, 0, 1148846080);
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
			{
				func_54();
				unk_0x856549C07003344B(iLocal_129, true);
	...
	if (unk_0x369E69441C066912(iLocal_135) > fLocal_136 && iLocal_114)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
		{
			unk_0x055A73D4AFD214F1(iLocal_67[0], iLocal_118);
			unk_0x9B94F6169B0DAEFD(iLocal_67[0]);
			unk_0x9DC06E2A59C5AEBB(&iLocal_87);
			unk_0x756D74A3EF0AB788(0, "random@robbery", "stand_worried_female", 2f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x19F29730874AD6F1(iLocal_87);
			unk_0x9B6EC2CECE1010EF(iLocal_67[0], iLocal_87);
			unk_0x4F83FEE4454169D4(&iLocal_87);
			unk_0xCBA6B2B569DCAFD8(iLocal_67[0], true);
		...
		unk_0xF0C2AEEDB4BDCF16(unk_0x460153A63B9477BC(), 1f, 650, 0, 1, false);
		func_142(0, 1, 1, 0, 0, 0, 0);
		unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), true, 4);
		unk_0x644F1D0C5427A242(true);
		unk_0x8CFF639CEFF5CF16(true);
		unk_0x98EFE9ABE449C2A3(unk_0x9B0761B4C3EB8BC7(), false);
		unk_0x4C4FC7841A5FB983(0f);
		unk_0x47012CDD5C524D7B(0, 0, 3, 0);
		unk_0xB8B0F7C8C1548C5B(iLocal_129, 0);
		func_51();
...
void func_51()
{
	if (iLocal_47 == 1)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_67[0]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
			{
				unk_0x4E65320BC9AD521C(iLocal_67[0], false);
				unk_0x2481907DEE6B85EA(&(iLocal_67[0]));
			}
		}
		if (unk_0xAE06B9E39EBDE049(iLocal_67[1]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[1]))
			{
				unk_0x4E65320BC9AD521C(iLocal_67[1], false);
		...
		if (unk_0xAE06B9E39EBDE049(iLocal_68[0]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[0]))
			{
				unk_0x4E65320BC9AD521C(iLocal_68[0], false);
				unk_0x2481907DEE6B85EA(&(iLocal_68[0]));
			}
		}
		if (unk_0xAE06B9E39EBDE049(iLocal_68[1]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[1]))
			{
				unk_0x4E65320BC9AD521C(iLocal_68[1], false);
				unk_0x2481907DEE6B85EA(&(iLocal_68[1]));
			}
		}
		if (unk_0xAE06B9E39EBDE049(iLocal_68[2]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[2]))
			{
				unk_0x03D382CB0B44E2FC(iLocal_68[2], -820.424f, -181.9059f, 36.5687f, 1, false, 0, 1);
				unk_0xE922BAA80E8F9324(iLocal_68[2], 167.7909f);
				unk_0x4E65320BC9AD521C(iLocal_68[2], false);
				unk_0x2481907DEE6B85EA(&(iLocal_68[2]));
			}
		}
	}
}
...
void func_54()
{
	if (iLocal_47 == 1)
	{
		...
		{
			if (unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), 8f, 8f, 8f, false, true, 0) || unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), -823.1281f, -187.9591f, 36.6189f, 8f, 8f, 8f, false, true, 0))
			{
				unk_0x03D382CB0B44E2FC(unk_0xA5D3CD332CD10EE9(), -831.9709f, -192.0823f, 36.5008f, 0, false, 0, 1);
				unk_0xB11D151E210D4FAC(unk_0xA5D3CD332CD10EE9(), 1084227584);
			}
		}
		unk_0x555EE41D7C7078E6(-823.1281f, -187.9591f, 36.6189f, 3f, 1, 0, 0, false);
	}
	else if (iLocal_47 == 2)
	{
		if (unk_0x80FF6C016CDB0FAF(unk_0xA5D3CD332CD10EE9(), 0))
		{
			if (unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), 8f, 8f, 8f, false, true, 0) || unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), -1201.017f, -777.5527f, 16.3398f, 8f, 8f, 8f, false, true, 0))
			{
				unk_0x03D382CB0B44E2FC(unk_0xA5D3CD332CD10EE9(), -1205.936f, -781.2014f, 16.0088f, 0, false, 0, 1);
				unk_0xB11D151E210D4FAC(unk_0xA5D3CD332CD10EE9(), 1084227584);
			}
		}
		unk_0x555EE41D7C7078E6(-1201.017f, -777.5527f, 16.3398f, 8f, 1, 0, 0, false);
	}
}
...
void func_61()
{
	...
	{
		func_40(13, floor(Global_111858.f_10190.f_3853));
	}
...
void func_78(int iParam0)
{
	...
	bVar1 = false;
	bVar2 = false;
	fVar4 = unk_0x272784C60C397DB6(Var0, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), true);
	if ((unk_0xCE990E643CD9D0E5(Global_37427[(iParam0 / 32)], (iParam0 % 32)) && Global_37890[iParam0] == 2) && fVar4 > 210f)
	{
	...
	if (unk_0x7B70881748D166CD(joaat("startup_positioning")) == 0)
	{
		if (unk_0xCE990E643CD9D0E5(Global_37663[(iParam0 / 32)], (iParam0 % 32)))
		{
			if (fVar4 < 25f)
			{
				...
				iVar5 = Global_99007.f_349;
				iVar6 = unk_0xD5C5CDCF5230F2BA(Var0);
	...
	{
		iVar3 = Global_111858.f_7257[iParam0];
	}
	if (Global_38117[iParam0] != iVar3)
	{
		bVar1 = true;
	}
	if (unk_0xCE990E643CD9D0E5(Global_37418[(iParam0 / 32)], (iParam0 % 32)))
	...
	if (bVar1)
	{
		...
		else
		{
			if (!unk_0x60C47897C07F44B1(Var0.f_5))
			{
				unk_0x6ADE529A7C2BA641(Var0.f_5, Var0.f_3, Var0, 0, false, 0);
			}
			switch (iVar3)
			{
				case 1:
					...
					else if (fVar4 > 3f || unk_0x0D77CDCF403AEBD2(unk_0x07773546A24F4560(Var0.f_5)) <= 0.015f)
					{
						iVar8 = unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7());
						iVar9 = unk_0xD5C5CDCF5230F2BA(Var0);
					...
					if (bVar7)
					{
						if (Var0.f_6 != 0f)
						{
							unk_0xF5F9F0152F398CDE(Var0.f_5, Var0.f_6, false, 0);
						}
						unk_0xDC5C33A98881772F(Var0.f_5, iVar3, false, true);
						bVar2 = true;
					}
					break;
				...
				case 0:
					if (Var0.f_6 != 0f)
					{
						unk_0xF5F9F0152F398CDE(Var0.f_5, Var0.f_6, false, 1);
					}
					unk_0xDC5C33A98881772F(Var0.f_5, iVar3, false, true);
					bVar2 = true;
					break;
				...
				case 3:
					...
					unk_0xDC5C33A98881772F(Var0.f_5, 0, false, true);
					bVar2 = true;
					break;
...
int func_81(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				iVar0 = unk_0x36FE6D3220816ADA(func_82(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), true)));
				switch (iVar0)
				{
...
void func_83(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 202:
			if (func_84(iParam0))
			{
				if (iVar1 < 19)
				{
					if (iVar1 >= 7)
					{
						...
						unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], true, true);
					}
				}
				else
				{
			...
			{
				if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), *uParam1) >= 12f)
				{
		...
		case 142:
			...
			else if (unk_0x7B70881748D166CD(joaat("jewelry_heist")) == 0 && unk_0x7B70881748D166CD(joaat("jewelry_setup1")) == 0)
			{
				if (iVar1 >= 21)
				{
					if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), *uParam1) >= 18f)
					{
						Global_111858.f_7257[iParam0] = 1;
						unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], true, true);
					}
		...
		case 144:
			...
			{
				if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false), *uParam1) >= 40f)
				{
					Global_111858.f_7257[iParam0] = 1;
					unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], true, true);
				}
...
bool func_84(int iParam0)
{
	...
	Var0 = { func_97(iParam0) };
	iVar1 = unk_0x606DAD1002B048F0(Var0.f_5);
...
{
	return (shift_right(iParam0, 26) & 31 * func_92(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_104()
{
	if (unk_0x73DBD7E437DA0553(iLocal_62))
	{
		...
		func_105(&uLocal_148);
		fLocal_124 = vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), func_250());
		settimera(0);
		iLocal_45 = 10;
	}
	if (unk_0xF10E878C0879E7E9(iLocal_62))
	{
		if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0xC8C0D624848783ED(iLocal_62)) > 200f)
		{
			func_162();
		}
	}
...
void func_107()
{
	...
	if (!unk_0xF10E878C0879E7E9(iLocal_62))
	{
		unk_0xBE20AB8238688965(&iLocal_60, 3);
		unk_0xBE20AB8238688965(&iLocal_60, 4);
		unk_0xBE20AB8238688965(&iLocal_60, 1);
		if (!bLocal_96)
		{
			if (unk_0xA59F96B50B97E63C(iLocal_66[0], 0))
			{
				if (unk_0xAE06B9E39EBDE049(iLocal_66[0]))
				{
					Local_61 = { unk_0x0FA535C0DBE5FD02(iLocal_66[0], 1067030938, 1069547520) };
				}
			}
			else
			{
				Local_61 = { unk_0xEDE1ACBAFB1C36AE(unk_0x3E4D3CCC220BDFB1(iLocal_66[0], true), 1.2f, 1.5f) };
			}
		}
		else if (unk_0xAE06B9E39EBDE049(iLocal_106))
		{
			Local_61 = { unk_0xEDE1ACBAFB1C36AE(unk_0x3E4D3CCC220BDFB1(iLocal_106, false), 1.2f, 1.5f) };
		}
		Local_61 = { Local_61.x, Local_61.f_1, (Local_61.f_2 + 0.25f) };
		iLocal_62 = unk_0x745986B99A8C6D46(joaat("pickup_money_med_bag"), Local_61, iLocal_60, iLocal_118, 1, joaat("prop_cs_duffel_01"));
		...
		if (iLocal_47 == 1)
		{
			...
			while (iVar0 <= (iLocal_63 - 1))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar0]))
				{
					unk_0xA5EAD2ACE2C8BBB2(iLocal_66[iVar0], true, 1);
					unk_0x9B94F6169B0DAEFD(iLocal_66[iVar0]);
					unk_0x9DC06E2A59C5AEBB(&iLocal_87);
					unk_0x0AB756271BADC8DF(0, 0, 0);
					unk_0x8B18A80E8EB15510(0, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 0, 0);
					unk_0x19F29730874AD6F1(iLocal_87);
					unk_0x9B6EC2CECE1010EF(iLocal_66[iVar0], iLocal_87);
					unk_0x4F83FEE4454169D4(&iLocal_87);
					unk_0xCBA6B2B569DCAFD8(iLocal_66[iVar0], true);
				}
				iVar0++;
		...
		else if (iLocal_47 == 2)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
			{
				unk_0x0C095242BA4786C7(iLocal_66[0]);
				if (!unk_0x4FCA2ADE072802D1(iLocal_66[0]))
				{
					func_52();
					wait(0);
...
int func_108(int iParam0)
{
	...
	unk_0xFA81E0FBD7F5ACA0(iVar0, func_109(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
	return iVar0;
}
...
void func_110()
{
	if (unk_0x8F678487EEBD8CE4(iLocal_121))
	{
		unk_0x93370FA10F15BE44(&iLocal_121);
	}
	if (unk_0x8F678487EEBD8CE4(iLocal_122))
	{
		unk_0x93370FA10F15BE44(&iLocal_122);
...
int func_111()
{
	...
	else if (unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
	{
		iLocal_84 = 1;
	}
	if (!bLocal_96)
	{
		if (!unk_0xAE06B9E39EBDE049(iLocal_66[1]))
		{
			iLocal_85 = 1;
		}
		else if (unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
		{
			iLocal_85 = 1;
		}
	}
	...
	if (!unk_0xAE06B9E39EBDE049(iLocal_115))
	{
		iLocal_86 = 1;
	}
	else if (unk_0x5AEB5DDFFAD43CA5(iLocal_115) || !unk_0x47DBF174A0CB9D55(iLocal_115, false))
	{
		iLocal_86 = 1;
	}
...
int func_112()
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_66[iVar0]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar0]) || unk_0xA59F96B50B97E63C(iLocal_66[iVar0], 0))
			{
				if (unk_0xCDF860E56BBCC6B4(iLocal_66[iVar0], unk_0x9B0761B4C3EB8BC7(), 1))
				{
					return 1;
				}
			}
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_66[iVar0]))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar0]))
			{
				if (unk_0xC0736D5851285045(iLocal_66[iVar0]))
				{
					if (unk_0x754A4975FB27D0BA(iLocal_66[iVar0]) == unk_0x9B0761B4C3EB8BC7())
					{
						unk_0xA5EAD2ACE2C8BBB2(iLocal_66[iVar0], true, 1);
						unk_0x8B18A80E8EB15510(iLocal_66[iVar0], unk_0x9B0761B4C3EB8BC7(), 250f, -1, 0, 0);
						unk_0xCBA6B2B569DCAFD8(iLocal_66[iVar0], true);
						wait(0);
						unk_0x2481907DEE6B85EA(&(iLocal_66[iVar0]));
						return 1;
					}
				}
			}
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_115))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_115) || unk_0xA59F96B50B97E63C(iLocal_115, 0))
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_115, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_115))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_115))
		{
			if (unk_0xC0736D5851285045(iLocal_115))
			{
				if (unk_0x754A4975FB27D0BA(iLocal_115) == unk_0x9B0761B4C3EB8BC7())
				{
					unk_0xA5EAD2ACE2C8BBB2(iLocal_115, true, 1);
					unk_0x8B18A80E8EB15510(iLocal_115, unk_0x9B0761B4C3EB8BC7(), 250f, -1, 0, 0);
					unk_0xCBA6B2B569DCAFD8(iLocal_115, true);
					wait(0);
					unk_0x2481907DEE6B85EA(&iLocal_115);
					return 1;
				}
			}
		}
	...
	{
		if (!unk_0xA59F96B50B97E63C(iLocal_106, 0) || unk_0xA59F96B50B97E63C(iLocal_106, 0))
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_106, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				return 1;
			}
		}
...
int func_114(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(iVar0, func_109(unk_0x25DDB354A40FFCDB(), 1f, 1f));
		if (!bParam2)
		{
	...
	if (unk_0x80FF6C016CDB0FAF(iLocal_106, 0))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_66[0], iLocal_106, false))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
				{
					if (unk_0xE0B3BC41DDA88DF0(iLocal_66[1], iLocal_106, false))
					{
						return 1;
					}
				}
...
int func_150()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
	{
		if (iLocal_47 == 1)
		{
			if (!iLocal_100)
			{
				if (!unk_0x1037B9D45CE6B788(iLocal_66[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, true, 0))
				{
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if (!unk_0x1037B9D45CE6B788(iLocal_66[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, true, 0))
				{
					iLocal_101 = 1;
				}
			}
		...
		else if (iLocal_47 == 2)
		{
			if (!iLocal_100)
			{
				if ((!unk_0x1037B9D45CE6B788(iLocal_66[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, true, 0) || unk_0x1037B9D45CE6B788(iLocal_66[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, true, 0)) || unk_0x1037B9D45CE6B788(iLocal_66[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, true, 0))
				{
					unk_0x8B18A80E8EB15510(iLocal_66[0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if ((!unk_0x1037B9D45CE6B788(iLocal_66[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, true, 0) || unk_0x1037B9D45CE6B788(iLocal_66[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, true, 0)) || unk_0x1037B9D45CE6B788(iLocal_66[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, true, 0))
				{
					unk_0x8B18A80E8EB15510(iLocal_66[1], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
					iLocal_101 = 1;
				}
			}
		}
...
void func_151()
{
	...
	Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_102, true) };
	Var1 = { unk_0x090239DEAF625B17(iLocal_102, 2) };
	unk_0x315F7D8C33F0AB37(&iLocal_102);
	iLocal_102 = unk_0x79CC07752E7432A1(joaat("prop_cs_duffel_01"), Var0, true, true, false);
	unk_0xC82085403E46A869(iLocal_102, Var1, 2, 1);
}
...
void func_152()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_66[0]))
	{
		if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iLocal_66[0], false)) > 200f && unk_0x1D88F87079AF2FA7(iLocal_66[0]))
		{
			if (unk_0x8F678487EEBD8CE4(uLocal_116[0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_116[0]));
			}
			unk_0x2481907DEE6B85EA(&(iLocal_66[0]));
			bLocal_82 = true;
		}
	}
	else
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_106))
	{
		if (vdist(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), unk_0x3E4D3CCC220BDFB1(iLocal_106, false)) > 200f && unk_0x1D88F87079AF2FA7(iLocal_106))
		{
			if (unk_0x8F678487EEBD8CE4(iLocal_120))
			{
				unk_0x93370FA10F15BE44(&iLocal_120);
			}
			unk_0xE730EAF558C97567(&iLocal_106);
			bLocal_83 = true;
		}
	}
	else
...
void func_153()
{
	...
	{
		if (unk_0x4F5F2FB7AE0EB7AB(iLocal_106) < 800)
		{
			unk_0x697DA7132EE43ABC(iLocal_106, 0, 0);
			unk_0x0FC504FAF5EB94FB(iLocal_106, 10f);
		}
	}
}
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_66[iVar0]))
		{
			if (unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar0]))
			{
				if (unk_0x8F678487EEBD8CE4(uLocal_116[iVar0]))
				{
					unk_0x93370FA10F15BE44(&(uLocal_116[iVar0]));
				}
			}
		}
		iVar0++;
...
void func_155()
{
	...
	if (unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!bLocal_79)
		{
			...
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar1]))
				{
					unk_0x8FF9CE1C0F94F59A(iLocal_66[iVar1], unk_0x9B0761B4C3EB8BC7(), 0, 16);
				}
				iVar1++;
			}
			bLocal_79 = true;
	...
	if (!bLocal_79)
	{
		...
		else if (iLocal_47 == 2)
		{
			...
			if (unk_0xAE06B9E39EBDE049(iLocal_102) && !unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
			{
				if (!iLocal_109)
				{
					iLocal_109 = 1;
		...
		if (!iLocal_77)
		{
			if (iLocal_47 == 1)
			{
				if (timera() > 14100)
				{
					unk_0x315F7D8C33F0AB37(&(iLocal_103[0]));
					unk_0x315F7D8C33F0AB37(&(iLocal_103[1]));
					if (unk_0x80FF6C016CDB0FAF(iLocal_106, 0))
					{
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
						{
							unk_0x9B94F6169B0DAEFD(iLocal_66[0]);
							unk_0x9DC06E2A59C5AEBB(&iLocal_87);
							unk_0xE2348E4036041923(0);
							unk_0xC584E49FC3559A86(0, iLocal_106, -1, 0, 2f, 1, 0);
							unk_0x19F29730874AD6F1(iLocal_87);
							unk_0x9B6EC2CECE1010EF(iLocal_66[0], iLocal_87);
							unk_0x4F83FEE4454169D4(&iLocal_87);
						}
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
						{
							unk_0x854FB153F2EA838B(iLocal_66[1], -530524, true, 0, 0);
							unk_0x9DC06E2A59C5AEBB(&iLocal_87);
							unk_0xE2348E4036041923(0);
							unk_0xC584E49FC3559A86(0, iLocal_106, -1, 1, 2f, 1, 0);
							unk_0x19F29730874AD6F1(iLocal_87);
							unk_0x9B6EC2CECE1010EF(iLocal_66[1], iLocal_87);
							unk_0x4F83FEE4454169D4(&iLocal_87);
						}
						iLocal_45 = 2;
						iLocal_77 = 1;
					...
					else
					{
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]))
						{
							unk_0xA5EAD2ACE2C8BBB2(iLocal_66[0], true, 1);
							unk_0x2BB0EF9DE445EA13(iLocal_66[0]);
							unk_0x9DC06E2A59C5AEBB(&iLocal_87);
							unk_0xE2348E4036041923(0);
						...
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
						{
							unk_0xA5EAD2ACE2C8BBB2(iLocal_66[1], true, 1);
							unk_0x2BB0EF9DE445EA13(iLocal_66[1]);
							unk_0x9DC06E2A59C5AEBB(&iLocal_87);
							unk_0xE2348E4036041923(0);
							unk_0x8B18A80E8EB15510(0, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
							unk_0x19F29730874AD6F1(iLocal_87);
			...
			{
				if (unk_0x369E69441C066912(iLocal_135) > 0.453f)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[0]))
					{
						unk_0x4E65320BC9AD521C(iLocal_67[0], true);
					...
					{
						unk_0x9B94F6169B0DAEFD(iLocal_66[0]);
						unk_0x6AC7395A8E313A46(iLocal_66[0], 128, true);
						unk_0x6AC7395A8E313A46(iLocal_66[0], 1, true);
						unk_0x6673CC701BC8E9C1(iLocal_66[0], 17, true);
						unk_0x94D1A5176CE89859(iLocal_66[0], 1.6f);
						unk_0xA5EAD2ACE2C8BBB2(iLocal_66[0], true, 1);
						unk_0x9DC06E2A59C5AEBB(&iLocal_87);
						unk_0x756D74A3EF0AB788(0, "random@robbery", "run", 2f, -2f, -1, 49, 0, 0, 0, 0);
						unk_0xCFF8B016586CE0B7(0, "re_shoprobbery", 0, 0, 16);
						unk_0xE2348E4036041923(0);
						unk_0x19F29730874AD6F1(iLocal_87);
						unk_0x9B6EC2CECE1010EF(iLocal_66[0], iLocal_87);
						unk_0x4F83FEE4454169D4(&iLocal_87);
						unk_0xCBA6B2B569DCAFD8(iLocal_66[0], true);
						settimerb(0);
					}
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
					{
						unk_0x6AC7395A8E313A46(iLocal_66[1], 128, true);
						unk_0x6AC7395A8E313A46(iLocal_66[1], 1, true);
						unk_0x6673CC701BC8E9C1(iLocal_66[1], 17, true);
						unk_0x94D1A5176CE89859(iLocal_66[1], 1.6f);
						unk_0xA5EAD2ACE2C8BBB2(iLocal_66[1], true, 1);
						unk_0x9DC06E2A59C5AEBB(&iLocal_87);
						unk_0xE2348E4036041923(0);
						...
						unk_0x9B6EC2CECE1010EF(iLocal_66[1], iLocal_87);
						unk_0x4F83FEE4454169D4(&iLocal_87);
						unk_0xCBA6B2B569DCAFD8(iLocal_66[1], true);
					}
					iLocal_45 = 2;
					iLocal_77 = 1;
				}
...
void func_156()
{
	switch (iLocal_146)
	{
		case 0:
			...
			iLocal_145 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", false);
			unk_0x856549C07003344B(iLocal_145, true);
			unk_0x00736EE41CC355ED(iLocal_145, iLocal_135, "robbery_action_cam", "random@shop_robbery");
			if (iLocal_47 == 1)
			{
				unk_0xE5BA4356D796BAD0("Hair_room");
			}
			unk_0x3ED9330214992278(true, false, 3000, true, 0, 0);
			iLocal_147 = unk_0x578C4EF320340AF7() + 3500;
			iLocal_146++;
			break;
		
		case 1:
			if (iLocal_147 < unk_0x578C4EF320340AF7())
			{
				if (iLocal_47 == 1)
				{
				...
				unk_0x856549C07003344B(iLocal_145, false);
...
void func_158()
{
	...
	if (!iLocal_75 && func_161(1, 0, 1))
	{
		...
		if (iLocal_47 == 1)
		{
			if (!iLocal_108)
			{
				iLocal_135 = unk_0xF341A134A5B8D4F6(Local_126, Local_128, 2);
				unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
				unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), iLocal_135, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
				unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 1, 0);
				if (((!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_66[1])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_67[0])) && unk_0xAE06B9E39EBDE049(iLocal_102))
				{
					unk_0xDFDB9C533700BC17(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0xDFDB9C533700BC17(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0xDFDB9C533700BC17(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
					unk_0x1FEB07A1AF22700F(iLocal_102, iLocal_135, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
				}
				unk_0x8430A80C3E4F5F98(iLocal_135, 0.06f);
				iLocal_108 = 1;
			}
		}
		else if (iLocal_47 == 2)
		{
			...
			{
				unk_0x9B94F6169B0DAEFD(iLocal_67[0]);
				unk_0x756D74A3EF0AB788(iLocal_67[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0, 0, 0, 0);
			}
			unk_0xF16CDD1D05F4411A(-1195.062f, -773.2098f, 16.324f, 20f, 4);
			iLocal_135 = unk_0xF341A134A5B8D4F6(Local_126, Local_128, 2);
			if (((!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_66[1])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_67[0])) && unk_0xAE06B9E39EBDE049(iLocal_102))
			{
				unk_0xDFDB9C533700BC17(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0xDFDB9C533700BC17(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
				if (unk_0xAE06B9E39EBDE049(iLocal_103[0]) && unk_0xAE06B9E39EBDE049(iLocal_103[1]))
				{
					unk_0xF8A652CE310FFC53(iLocal_103[0], iLocal_67[0], unk_0xE6B87C42793036AA(iLocal_67[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					unk_0xF8A652CE310FFC53(iLocal_103[1], iLocal_67[0], unk_0xE6B87C42793036AA(iLocal_67[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
				}
			}
			unk_0x8430A80C3E4F5F98(iLocal_135, 0.05f);
			Local_126 = { -1199.369f, -776.1991f, 16.3235f };
			Local_128 = { 0f, 0f, -60f };
			iLocal_135 = unk_0xF341A134A5B8D4F6(Local_126, Local_128, 2);
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
			{
				unk_0xDFDB9C533700BC17(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
			}
			unk_0x8430A80C3E4F5F98(iLocal_135, 0.06f);
			unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -1200.455f, -777.6201f, 16.3244f, 1, false, 0, 1);
			...
			unk_0x756D74A3EF0AB788(0, "random@shop_robbery", "kneel_loop_p", 2f, -4f, -1, 134217737, 0, 0, 0, 0);
			unk_0x19F29730874AD6F1(iLocal_87);
			unk_0x9B6EC2CECE1010EF(unk_0x9B0761B4C3EB8BC7(), iLocal_87);
			unk_0x4F83FEE4454169D4(&iLocal_87);
			unk_0x1322CA891C5DF18A(unk_0x9B0761B4C3EB8BC7(), 0, 0);
		}
		iLocal_75 = 1;
	...
	if ((iLocal_47 == 1 && unk_0xAE06B9E39EBDE049(iLocal_106)) || iLocal_47 == 2)
	{
		settimera(0);
		iLocal_45 = 1;
	}
...
void func_159()
{
	...
	else if (unk_0x7D167B9A0CCDA347(iVar0))
	{
		if (func_160())
		{
			if (unk_0x1037B9D45CE6B788(iLocal_104, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, true, 0))
			{
		...
		iLocal_106 = unk_0xCE4780E24AFDFBF9(iVar0, Local_105, 31.9252f, true, true, false);
		unk_0xA5EAD2ACE2C8BBB2(iLocal_106, true, 1);
		unk_0xB11D151E210D4FAC(iLocal_106, 1084227584);
		unk_0xC160551F55D6365A(iLocal_106, true, true, 0);
		iLocal_115 = unk_0x6A7A2C83BD302BA4(iLocal_106, 26, joaat("g_m_y_korean_01"), -1, 1, true);
		unk_0x694113444F21E39F(iLocal_115, 134, true);
		unk_0x4E65320BC9AD521C(iLocal_115, true);
		unk_0xD3D9D7C84656DAE5(iLocal_115, iLocal_119);
		unk_0x6673CC701BC8E9C1(iLocal_115, 8, false);
		unk_0x3EA9EB775DF15E76(iLocal_115, 0);
		unk_0xF94DFEAE3DD1EE7E(iLocal_115, 13);
		unk_0x92BD213E6A0E666B(iLocal_115, joaat("weapon_pistol"), -1, true, true);
		unk_0x82FF25D1808866E5(iLocal_115, 1, 0);
		unk_0x694113444F21E39F(iLocal_115, 42, true);
		iLocal_107 = 1;
	}
}
...
int func_160()
{
	...
	{
		if (unk_0xC2169C00B643278B(iVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, false, true, 0))
		{
			iLocal_104 = iVar0;
			if (!unk_0x1758275D343D5BA3(iLocal_104))
			{
				unk_0x4F3C4F457D44BB0F(iLocal_104, true, 0);
			}
			return 1;
		}
	}
...
int func_170()
{
	if (iLocal_47 == 1)
	{
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -803.4598f, -175.8135f, 36.28367f, -823.0242f, -187.0462f, 40.53547f, 11.9375f, 0, true, 0) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -823.3706f, -188.0602f, 36.62162f, -822.8361f, -187.7466f, 39.06914f, 1.5f, 0, true, 0))
		{
			return 1;
		}
	}
	...
	{
		if (((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, true, 0) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1203.899f, -776.9178f, 20.16803f, -1201.289f, -780.4698f, 15.61526f, 3.9375f, 0, true, 0)) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, true, 0)) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, true, 0))
		{
			return 1;
		}
	}
...
int func_172()
{
	...
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, false, true, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, false, true, 0))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_66[0], unk_0x9B0761B4C3EB8BC7(), 1) || unk_0xCDF860E56BBCC6B4(iLocal_66[1], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				return 1;
			}
			if (unk_0xD5E14AF69C7C4DA9(iLocal_66[0], unk_0x9B0761B4C3EB8BC7()) || unk_0xD5E14AF69C7C4DA9(iLocal_66[1], unk_0x9B0761B4C3EB8BC7()))
			{
				if (((unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_66[0]) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iLocal_66[0])) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_66[1])) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iLocal_66[1]))
				{
					if (iLocal_69 == -1)
					{
				...
				if (iLocal_69 != -1 && unk_0x578C4EF320340AF7() > iLocal_69 + 1500)
				{
					return 1;
				}
			}
	...
	if (unk_0xEA84479CCF7AA647(-1, Local_123 - Vector(20f, 20f, 20f), Local_123 + Vector(20f, 20f, 20f)))
	{
		return 1;
	}
	if (unk_0xA59F96B50B97E63C(iLocal_66[0], 0) || unk_0xA59F96B50B97E63C(iLocal_66[1], 0))
	{
		return 1;
	}
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), false) && func_170())
	{
		return 1;
	}
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_66[1]))
	{
		if (((unk_0x183773B390B31AAA(unk_0x9B0761B4C3EB8BC7(), unk_0x3E4D3CCC220BDFB1(iLocal_66[1], true) - Vector(12f, 12f, 12f), unk_0x3E4D3CCC220BDFB1(iLocal_66[1], true) + Vector(12f, 12f, 12f), 0, 1) && !unk_0xEBFC112B3EEB18E5(unk_0x9B0761B4C3EB8BC7())) || unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(iLocal_66[0], true), 3f, 1)) || unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(iLocal_66[1], true), 3f, 1))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_67)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_67[iVar0]))
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_67[iVar0], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_68)
	{
		...
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_68[iVar0], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				return 1;
			}
		}
...
int func_174()
{
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -823.1281f, -187.9591f, 36.6189f, 4f, 4f, 4f, false, true, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1201.017f, -777.5527f, 16.3398f, 4f, 4f, 4f, false, true, 0))
	{
...
void func_175()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[1]))
	{
		if (unk_0xE080FA9EB010F041(iLocal_67[1]))
		{
		...
		unk_0x798BC6477B831DCB(iLocal_67[1], 26, 0f, 0);
	}
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[1]))
	{
		func_176(iLocal_68[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
		unk_0x798BC6477B831DCB(iLocal_68[1], 3, 0f, 0);
	}
}

void func_176(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	unk_0x1A454EFB8BC73430(iParam0, sParam1, sParam2, func_177(iParam3), 0);
}
...
void func_178()
{
	...
	unk_0xDE8F8016287F771F("ROBBERS", &iLocal_119);
	iVar0 = 0;
	while (iVar0 <= (iLocal_63 - 1))
	{
		iLocal_66[iVar0] = unk_0xB3116B49FE00E2F1(26, iLocal_141, Local_51[iVar0 /*3*/], fLocal_52[iVar0], 1, true);
		unk_0x4E65320BC9AD521C(iLocal_66[iVar0], true);
		unk_0xD3D9D7C84656DAE5(iLocal_66[iVar0], iLocal_119);
		unk_0x6673CC701BC8E9C1(iLocal_66[iVar0], 8, false);
		unk_0x3EA9EB775DF15E76(iLocal_66[iVar0], 0);
		unk_0xF94DFEAE3DD1EE7E(iLocal_66[iVar0], 13);
		unk_0x92BD213E6A0E666B(iLocal_66[iVar0], joaat("weapon_pistol"), -1, true, true);
		unk_0x82FF25D1808866E5(iLocal_66[iVar0], 1, 0);
		unk_0x694113444F21E39F(iLocal_66[iVar0], 42, true);
		unk_0x694113444F21E39F(iLocal_66[iVar0], 269, true);
		unk_0x694113444F21E39F(iLocal_66[iVar0], 188, true);
		unk_0x5A5A1DD32AC33C2B(iLocal_66[iVar0], 0);
		unk_0x6AC7395A8E313A46(iLocal_66[iVar0], 128, true);
		unk_0x6AC7395A8E313A46(iLocal_66[iVar0], 8, true);
		iVar0++;
	}
	unk_0x14EFF93E9B692DAD(iLocal_66[0], "pedRobber[0]");
	unk_0x14EFF93E9B692DAD(iLocal_66[1], "pedRobber[1]");
	unk_0xEFBCE8F8316F89EA(5, iLocal_119, 1862763509);
	unk_0xEFBCE8F8316F89EA(5, 1862763509, iLocal_119);
	unk_0xEFBCE8F8316F89EA(5, iLocal_119, joaat("COP"));
	unk_0xEFBCE8F8316F89EA(5, joaat("COP"), iLocal_119);
	if (func_44() == 0)
	{
		func_183(&uLocal_151, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
	}
	else if (func_44() == 1)
	{
		func_183(&uLocal_151, 0, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	else if (func_44() == 2)
	{
		func_183(&uLocal_151, 0, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
	}
	iLocal_102 = unk_0x79CC07752E7432A1(iLocal_117, Local_57, true, true, false);
	if (iLocal_47 == 1)
	{
		unk_0xC08A186299DFDA0A(Local_71 - Vector(20f, 20f, 20f), Local_71 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0x410A1E7AD7D5C774(joaat("baller"), true);
		iLocal_103[0] = unk_0x79CC07752E7432A1(joaat("prop_anim_cash_pile_01"), Local_57, true, true, false);
		iLocal_103[1] = unk_0x79CC07752E7432A1(joaat("prop_anim_cash_pile_01"), Local_57 - Vector(0.1f, 0f, 0f), true, true, false);
		unk_0x3A2AAE59B4681DAF(iLocal_66[0], "G_M_Y_KorLieut_01_Korean_MINI_01");
		unk_0x3A2AAE59B4681DAF(iLocal_66[1], "G_M_Y_Korean_01_Korean_MINI_02");
		Local_126 = { -821.565f, -186.467f, 36.6f };
		Local_128 = { 0f, 0f, -59.96f };
		iLocal_135 = unk_0xF341A134A5B8D4F6(Local_126, Local_128, 2);
		unk_0x81493F39713559B1(iLocal_135, true);
		unk_0xDFDB9C533700BC17(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0x1FEB07A1AF22700F(iLocal_102, iLocal_135, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 8f, 0, 1148846080);
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
			iLocal_67[iVar0] = unk_0xB3116B49FE00E2F1(26, iLocal_138, Local_53[iVar0 /*3*/], fLocal_54[iVar0], 1, true);
			unk_0x6673CC701BC8E9C1(iLocal_67[iVar0], 17, true);
			unk_0x4E65320BC9AD521C(iLocal_67[iVar0], true);
			unk_0x0DC39BE87E4C5599(iLocal_67[iVar0], false);
			unk_0x694113444F21E39F(iLocal_67[iVar0], 269, true);
			iVar0++;
		}
		unk_0x14EFF93E9B692DAD(iLocal_67[0], "pedWorker[0]");
		unk_0x14EFF93E9B692DAD(iLocal_67[1], "pedWorker[1]");
		unk_0x14EFF93E9B692DAD(iLocal_67[2], "pedWorker[2]");
		iLocal_68[0] = unk_0xB3116B49FE00E2F1(26, iLocal_139, Local_55[0 /*3*/], fLocal_56[0], 1, true);
		unk_0x6673CC701BC8E9C1(iLocal_68[0], 17, true);
		unk_0x4E65320BC9AD521C(iLocal_68[0], true);
		unk_0x0DC39BE87E4C5599(iLocal_68[0], false);
		unk_0x694113444F21E39F(iLocal_68[0], 269, true);
		iVar0 = 1;
		while (iVar0 <= 2)
		{
			iLocal_68[iVar0] = unk_0xB3116B49FE00E2F1(26, iLocal_140, Local_55[iVar0 /*3*/], fLocal_56[iVar0], 1, true);
			unk_0x6673CC701BC8E9C1(iLocal_68[iVar0], 17, true);
			unk_0x4E65320BC9AD521C(iLocal_68[iVar0], true);
			unk_0x0DC39BE87E4C5599(iLocal_68[iVar0], false);
			unk_0x694113444F21E39F(iLocal_68[iVar0], 269, true);
			iVar0++;
		}
		unk_0x14EFF93E9B692DAD(iLocal_68[0], "pedShopper[0]");
		unk_0x14EFF93E9B692DAD(iLocal_68[1], "pedShopper[1]");
		unk_0x14EFF93E9B692DAD(iLocal_68[2], "pedShopper[2]");
		unk_0x45F588C0DD767737(iLocal_67[0], 0, 0, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[0], 2, 1, 1, 0);
		unk_0x45F588C0DD767737(iLocal_67[0], 3, 1, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[0], 4, 0, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[0], 5, 0, 0, 0);
		unk_0xDFDB9C533700BC17(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0x3A2AAE59B4681DAF(iLocal_67[0], "A_M_Y_BevHills_01_White_Mini_01");
		func_183(&uLocal_151, 5, iLocal_67[0], "REROBShopworker", 0, 1);
		unk_0x45F588C0DD767737(iLocal_67[1], 0, 1, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[1], 2, 0, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[1], 3, 0, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[1], 4, 1, 2, 0);
		unk_0x45F588C0DD767737(iLocal_67[1], 5, 0, 0, 0);
		unk_0xAEC92B0DA8075AC9(iLocal_67[1], -1);
		unk_0xCBA6B2B569DCAFD8(iLocal_67[1], true);
		unk_0x45F588C0DD767737(iLocal_67[2], 0, 1, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[2], 2, 1, 0, 0);
		unk_0x45F588C0DD767737(iLocal_67[2], 3, 0, 2, 0);
		unk_0x45F588C0DD767737(iLocal_67[2], 4, 1, 2, 0);
		unk_0x45F588C0DD767737(iLocal_67[2], 5, 0, 0, 0);
		unk_0xAEC92B0DA8075AC9(iLocal_67[2], -1);
		unk_0xCBA6B2B569DCAFD8(iLocal_67[2], true);
		iLocal_135 = unk_0xF341A134A5B8D4F6(-812.37f, -185.65f, 37.5804f, 0f, 0f, 30f, 2);
		unk_0x81493F39713559B1(iLocal_135, true);
		unk_0x45F588C0DD767737(iLocal_68[0], 0, 0, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[0], 2, 0, 0, 0);
		unk_0x45F588C0DD767737(iLocal_68[0], 3, 0, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[0], 4, 0, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[0], 8, 0, 0, 0);
		unk_0xDFDB9C533700BC17(iLocal_68[0], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_68[0], true);
		iLocal_135 = unk_0xF341A134A5B8D4F6(-817.5606f, -190.8273f, 37.6114f, 0f, 0f, 25.8399f, 2);
		unk_0x81493F39713559B1(iLocal_135, true);
		unk_0x45F588C0DD767737(iLocal_68[1], 0, 0, 0, 0);
		unk_0x45F588C0DD767737(iLocal_68[1], 2, 0, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[1], 3, 1, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[1], 4, 1, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[1], 8, 0, 0, 0);
		unk_0xDFDB9C533700BC17(iLocal_68[1], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_68[1], true);
		iLocal_135 = unk_0xF341A134A5B8D4F6(-816.1862f, -182.897f, 37.68f, 0f, 0f, 30f, 2);
		unk_0x81493F39713559B1(iLocal_135, true);
		unk_0x45F588C0DD767737(iLocal_68[2], 0, 1, 0, 0);
		unk_0x45F588C0DD767737(iLocal_68[2], 2, 0, 2, 0);
		unk_0x45F588C0DD767737(iLocal_68[2], 3, 0, 1, 0);
		unk_0x45F588C0DD767737(iLocal_68[2], 4, 1, 0, 0);
		unk_0x45F588C0DD767737(iLocal_68[2], 8, 0, 0, 0);
		unk_0xDFDB9C533700BC17(iLocal_68[2], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_68[2], true);
		unk_0xDEA135D03FA041A8(iLocal_66[0], iLocal_67[0], -1, 0);
		unk_0x27E543EDE9AEA8F2(-871f, -246f, 0f, -798f, -163f, 50f, false, 1);
	...
	{
		unk_0xC08A186299DFDA0A(Local_72 - Vector(20f, 20f, 20f), Local_72 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0xC82085403E46A869(iLocal_102, Local_58, 2, 1);
		iLocal_67[0] = unk_0xB3116B49FE00E2F1(26, iLocal_138, Local_53[0 /*3*/], fLocal_54[0], 1, true);
		unk_0x14EFF93E9B692DAD(iLocal_67[0], "pedWorker[0]");
		unk_0x3A2AAE59B4681DAF(iLocal_67[0], "A_M_Y_BeachVesp_01_White_Mini_01");
		func_183(&uLocal_151, 6, iLocal_67[0], "REROBShopworker2", 0, 1);
		iLocal_67[1] = unk_0xB3116B49FE00E2F1(26, iLocal_137, Local_53[1 /*3*/], fLocal_54[1], 1, true);
		unk_0x14EFF93E9B692DAD(iLocal_67[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
		...
		iLocal_68[0] = unk_0xB3116B49FE00E2F1(26, iLocal_139, Local_55[0 /*3*/], fLocal_56[0], 1, true);
		unk_0x14EFF93E9B692DAD(iLocal_68[0], "pedShopper[0]");
		iLocal_68[1] = unk_0xB3116B49FE00E2F1(26, iLocal_140, Local_55[1 /*3*/], fLocal_56[1], 1, true);
		unk_0x14EFF93E9B692DAD(iLocal_68[1], "pedShopper[1]");
		iVar0 = 0;
		...
		unk_0x756D74A3EF0AB788(iLocal_67[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0, 0, 0, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_67[0], true);
		unk_0x756D74A3EF0AB788(iLocal_67[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0, 0, 0, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_67[1], true);
		unk_0xAEC92B0DA8075AC9(iLocal_68[0], -1);
		unk_0xCBA6B2B569DCAFD8(iLocal_68[0], true);
		unk_0x756D74A3EF0AB788(iLocal_68[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0, 0, 0, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_68[1], true);
		Local_126 = { -1192.01f, -768.929f, 16.358f };
		Local_128 = { 0f, 0f, -59.5f };
		iLocal_135 = unk_0xF341A134A5B8D4F6(Local_126, Local_128, 2);
		unk_0x81493F39713559B1(iLocal_135, true);
		unk_0xDFDB9C533700BC17(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0xDFDB9C533700BC17(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0x756D74A3EF0AB788(iLocal_66[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0, 0, 0, 0);
		func_182(14, 1);
		func_181(14);
		wait(500);
		func_179(14, 0, 0);
...
void func_184()
{
	if (!iLocal_74)
	{
		iLocal_88 = unk_0xD5C5CDCF5230F2BA(Local_51[0 /*3*/]);
		unk_0x05549C0F30BB285D(iLocal_88);
		iLocal_74 = 1;
	}
}
...
void func_185()
{
	unk_0x78FCB2E22C41B9D5(iLocal_138);
	unk_0x78FCB2E22C41B9D5(iLocal_139);
	unk_0x78FCB2E22C41B9D5(iLocal_140);
	...
	if ((((((((((unk_0x7D167B9A0CCDA347(iLocal_138) && unk_0x7D167B9A0CCDA347(iLocal_139)) && unk_0x7D167B9A0CCDA347(iLocal_140)) && unk_0x7D167B9A0CCDA347(iLocal_141)) && unk_0x7D167B9A0CCDA347(joaat("prop_anim_cash_pile_01"))) && unk_0x7D167B9A0CCDA347(joaat("prop_cs_duffel_01"))) && unk_0x338C0BA03A21B0DB("re_shoprobbery")) && unk_0x338C0BA03A21B0DB("re_shoprobbery2")) && unk_0xC614DDE265D18415("random@robbery")) && unk_0xC614DDE265D18415("random@shop_robbery")) && unk_0x1BDBFE8EFF10BC95("RE51A_SHOP"))
	{
		iLocal_49 = 1;
	}
	else
...
int func_187()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (vmag2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_198())
		{
			return 0;
		}
	}
...
int func_204(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_228(Global_111858.f_24991.f_43[iParam1]))
		{
			return 0;
		}
...
void func_236()
{
	...
	if (iLocal_142)
	{
		...
		unk_0xC336C6497DDA81B4(-871f, -246f, 0f, -798f, -163f, 50f, true);
		...
		while (iVar0 <= (iLocal_63 - 1))
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_66[iVar0]))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_66[iVar0]) && !unk_0x47DBF174A0CB9D55(iLocal_66[iVar0], false))
				{
					unk_0xD66FADEF7D42D49B(iLocal_66[iVar0], Local_59, 150f, -1, 0, 0);
					unk_0xCBA6B2B569DCAFD8(iLocal_66[iVar0], true);
				}
				unk_0x2481907DEE6B85EA(&(iLocal_66[iVar0]));
			}
		...
		while (iVar0 <= (iLocal_65 - 1))
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_68[iVar0]))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68[iVar0]))
				{
					unk_0xA5EAD2ACE2C8BBB2(iLocal_68[iVar0], true, 1);
					unk_0x9DC06E2A59C5AEBB(&iLocal_87);
					if (iLocal_47 == 1)
					{
						unk_0x756D74A3EF0AB788(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
					...
					{
						unk_0x9B94F6169B0DAEFD(iLocal_68[iVar0]);
						unk_0x3C1B180EE30D36EF(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 1048576000, 0, 1193033728);
					}
					unk_0xD66FADEF7D42D49B(0, Local_59, 150f, -1, 0, 0);
					unk_0x19F29730874AD6F1(iLocal_87);
					unk_0x9B6EC2CECE1010EF(iLocal_68[iVar0], iLocal_87);
					unk_0x4F83FEE4454169D4(&iLocal_87);
					unk_0xCBA6B2B569DCAFD8(iLocal_68[iVar0], true);
				}
			}
		...
		while (iVar0 <= (iLocal_64 - 1))
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_67[iVar0]))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_67[iVar0]))
				{
					unk_0x694113444F21E39F(iLocal_67[iVar0], 317, true);
					unk_0xA5EAD2ACE2C8BBB2(iLocal_67[iVar0], true, 1);
					if (iVar0 == 0)
					{
						if (!iLocal_114)
						{
							unk_0x9B94F6169B0DAEFD(iLocal_67[iVar0]);
							unk_0xD66FADEF7D42D49B(iLocal_67[iVar0], Local_59, 150f, -1, 0, 0);
						}
						else
						{
							unk_0x4E65320BC9AD521C(iLocal_67[iVar0], false);
						}
					}
					else
					{
						...
						unk_0xD66FADEF7D42D49B(0, Local_59, 150f, -1, 0, 0);
						unk_0x19F29730874AD6F1(iLocal_87);
						unk_0x9B6EC2CECE1010EF(iLocal_67[iVar0], iLocal_87);
						unk_0x4F83FEE4454169D4(&iLocal_87);
					}
					unk_0x4E65320BC9AD521C(iLocal_67[iVar0], false);
					unk_0x0DC39BE87E4C5599(iLocal_67[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		if (unk_0xAE06B9E39EBDE049(iLocal_102))
		{
			...
			unk_0x95178967C65CAD85(&iLocal_102);
		}
		if (unk_0xAE06B9E39EBDE049(iLocal_106))
		{
			unk_0xE730EAF558C97567(&iLocal_106);
...
Vector3 func_250()
{
	...
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		fVar0 = unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), Local_71, true);
		iLocal_70 = 1;
		if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), Local_72, true) < fVar0)
		{
			fVar0 = unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), true), Local_72, true);
			iLocal_70 = 2;
		}
		if (iLocal_70 == 1)
		{
