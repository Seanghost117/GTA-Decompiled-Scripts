...
void __EntryFunction__()
{
	...
	func_24(Var0);
	bLocal_4 = func_4();
	Local_5 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), false) };
	func_1();
	while (true)
	{
		wait(0);
		...
		if (func_3(iVar0, &iVar1, &Var2, &Var3, &iVar5))
		{
			if (func_2(Var3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x745986B99A8C6D46(iVar1, Var2, iVar4, iVar5, 1, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0x745986B99A8C6D46(iVar1, Var2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0xB1C0B7CD03D4467D(iVar1, Var2, Var3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0xB1C0B7CD03D4467D(iVar1, Var2, Var3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()
{
	...
	while (iVar0 < 20)
	{
		if (unk_0xF10E878C0879E7E9(iLocal_3[iVar0]))
		{
			unk_0x73A2C4B5D6915500(iLocal_3[iVar0]);
		}
		iVar0++;
	}
}
