...
void func_177()
{
	if ((BitTest(uLocal_105, 0) && Global_43052 == 15) && !func_210())
	{
		if (iLocal_38 == 0)
		{
...
void func_226()
{
	...
	if (((((((Global_43052 == 15 && iLocal_37 != 3) && BitTest(uLocal_105, 5)) && !func_210()) && Global_78316 == -1) && !func_236()) && !func_86(9)) || func_105(35))
	{
		func_235();
		func_233();
		switch (iLocal_39)
