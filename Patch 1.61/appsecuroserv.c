...
int func_481(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = (unk_0xECF041186C5A94DC(uParam0) - 2018);
		if (iVar0 < -1)
		{
			iVar0 = -1;
		}
...
int func_689(int iParam0)
{
	...
	if (iParam0 != func_9())
	{
		...
		else if (func_559() || unk_0x807ABE1AB65C24D2())
		{
			if (NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0))
			{
				if (NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0))
...
void func_704(int iParam0, int iParam1, int iParam2, var uParam3, bool bParam4)
{
...
void func_705(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	int iVar0;
	var uVar1;
