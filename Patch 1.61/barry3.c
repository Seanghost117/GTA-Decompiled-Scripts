...
bool func_220(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
bool func_237(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
int func_277(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_282(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_284(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar65;
...
void func_290()
{
	...
	else if (iLocal_144 == 1)
	{
		...
		{
			if (!bLocal_161 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, false, true, 0) || func_291()))
			{
				bLocal_161 = true;
...
int func_306(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_311(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
...
bool func_313(int iParam0, float fParam1)
{
	return func_314(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_314(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_315(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
bool func_321(int iParam0, int iParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_322(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_326(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_335(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_337(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
struct<2> func_337(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
...
int func_346(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
int func_390(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
{
	if (!func_419() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
{
	return func_432(&(Global_106934.f_2890), Param0, fParam3, 0);
}
...
int func_464(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				if (func_467(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			{
				func_465(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
...
void func_473(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_475()
{
	...
	func_488(&uLocal_179, 1);
	func_488(&uLocal_179, 3);
	HUD::CLEAR_PRINTS();
	...
	func_487(&iLocal_152, 0);
	func_486(1);
	func_351(0);
	PED::SET_CREATE_RANDOM_COPS(true);
	func_476(&Local_81, 0, 0, 0);
...
void func_486(bool bParam0)
{
	...
	{
		func_485(&(iLocal_149[0]));
		func_485(&(iLocal_149[1]));
		func_481(&iLocal_148);
	}
}
