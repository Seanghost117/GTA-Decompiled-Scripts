...
void __EntryFunction__()
{
	...
	iVar1153 = -1;
	iVar1156 = -1;
	bVar1160 = Global_113386.f_18967;
	iVar1163 = 1;
	iVar1164 = -1;
	bVar1183 = false;
	bVar1188 = true;
	...
	if (BitTest(Global_113386.f_18967.f_1, bVar1160))
	{
		fVar1148 = 0.1f;
	}
	bVar872 = bVar1160;
	...
	while (true)
	{
		...
		switch (iVar719)
		{
			...
			case 5:
				...
				if (BitTest(Global_113386.f_18967.f_1, (func_366(&Var16) - 125)))
				{
			...
			case 9:
				...
				else if (func_328(&uVar101, 3, 1000) && !Global_23011.f_135)
				{
			...
			case 10:
				...
				if ((!bVar1179 && !bVar1180) && !bVar1182)
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, false)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar1089, Var1132, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_369(&Var16, iVar1154), Var1132, false, true, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (bVar1202)
							{
								if (func_328(&uVar101, 3, 1000) && !Global_23011.f_135)
								{
									ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true);
									PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 256);
									CAM::DO_SCREEN_FADE_OUT(800);
				...
				if (((bVar1179 || bVar1180) || bVar1182) || (func_462(&iVar890) && func_461(&iVar890) > 0.25f))
				{
					...
					if (bVar1179 || iVar720 == 1)
					{
						...
						{
							iVar1162 = 125;
							MISC::SET_BIT(&(Global_113386.f_18967.f_1), (func_366(&Var16) - iVar1162));
							...
							while (bVar1166 < 13)
							{
								if (!BitTest(Global_113386.f_18967.f_1, bVar1166))
								{
					...
					else if ((bVar1180 || bVar1182) || iVar720 >= 2)
					{
						...
						else
						{
							...
							func_214(&Var111, 0, 201, "BJ_CONTINUE", 203, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
						}
						iVar719 = 12;
					}
					func_458(&iVar881);
			...
			case 11:
				...
				if (!bVar1179 && !bVar1180)
				{
					if (func_213() && !func_263(&Var111, 26))
					{
						...
						{
							func_214(&Var111, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_384(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
