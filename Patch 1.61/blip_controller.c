							...
							if (BitTest(Global_32338[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_64)
								{
									...
									case 2:
										...
										{
											Global_32338[iVar2 /*23*/].f_19 = HUD::ADD_BLIP_FOR_COORD(Global_32338[iVar2 /*23*/][iLocal_64 /*3*/]);
											HUD::SET_BLIP_SPRITE(Global_32338[iVar2 /*23*/].f_19, Global_32338[iVar2 /*23*/].f_12[iLocal_64]);
										}
										break;
						...
						else
						{
							if (BitTest(Global_32338[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_64)
								{
									...
									case 0:
									case 2:
										HUD::SET_BLIP_COORDS(Global_32338[iVar2 /*23*/].f_19, Global_32338[iVar2 /*23*/][iLocal_64 /*3*/]);
										break;
...
void func_11()
{
	...
	while (iVar5 < 7)
	{
		...
		{
			if (HUD::DOES_BLIP_EXIST(Global_32338[iLocal_55[iVar5] /*23*/].f_19))
			{
				fVar6 = MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, HUD::GET_BLIP_COORDS(Global_32338[iLocal_55[iVar5] /*23*/].f_19), true);
				if (fVar6 < fVar4)
				{
					fVar4 = fVar6;
					iVar3 = iVar5;
	...
	while (iVar5 < 7)
	{
		if (iLocal_55[iVar5] != -1)
		{
			...
			else if (HUD::DOES_BLIP_EXIST(Global_32338[iLocal_55[iVar5] /*23*/].f_19))
			{
...
{
	if (iLocal_68 && BitTest(Global_32338[iParam0 /*23*/].f_11, 13))
	{
		MISC::SET_BIT(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_69 && ((BitTest(Global_32338[iParam0 /*23*/].f_11, 7) || BitTest(Global_32338[iParam0 /*23*/].f_11, 11)) || BitTest(Global_32338[iParam0 /*23*/].f_11, 16)))
	{
		MISC::SET_BIT(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_70 && BitTest(Global_32338[iParam0 /*23*/].f_11, 14))
	{
		MISC::SET_BIT(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_65 && ((BitTest(Global_32338[iParam0 /*23*/].f_11, 10) || BitTest(Global_32338[iParam0 /*23*/].f_11, 8)) || BitTest(Global_32338[iParam0 /*23*/].f_11, 19)))
	{
		MISC::SET_BIT(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	...
	if (iLocal_72 && BitTest(Global_32338[iParam0 /*23*/].f_11, 27))
	{
		MISC::SET_BIT(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if ((iLocal_73 && (BitTest(Global_32338[iParam0 /*23*/].f_11, 1) || BitTest(Global_32338[iParam0 /*23*/].f_11, 2))) || Global_32338[iParam0 /*23*/].f_16 == 1)
	{
		MISC::SET_BIT(&(Global_32338[iParam0 /*23*/].f_11), 18);
		return 1;
	}
