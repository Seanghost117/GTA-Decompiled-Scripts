...
bool func_262(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			else
			{
				...
				if ((func_310(242628503) && TASK::GET_SEQUENCE_PROGRESS(iLocal_156) > 0) && func_306())
				{
					func_298(3);
				}
			}
...
void func_315(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
int func_316(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_321(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_379(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_376(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_333(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_333(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
{
	return func_387(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}
...
int func_394(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_408(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
int func_432(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
