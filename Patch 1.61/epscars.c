...
void __EntryFunction__()
{
	...
	iLocal_99 = Global_113386.f_10049.f_103;
	func_93();
	if (func_92())
	{
		func_96();
	...
	while (true)
	{
		...
		if (func_48(&Local_43))
		{
			if (func_42(&Local_43))
			{
				...
				Global_113386.f_10049.f_103 = iLocal_99;
				func_40();
		...
		if (Global_113386.f_10049.f_104 != 0)
		{
			iLocal_97 = (Global_113386.f_10049.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
