		...
		case 3:
			if (iLocal_195 == 0)
			{
				...
				if (iLocal_234 == 0)
				{
					...
					if (!func_400(Local_182.f_0, -1519143300))
					{
						TASK::CLEAR_PED_TASKS(Local_182.f_0);
	...
	if (iLocal_194 == 2)
	{
		switch (iLocal_196)
		{
			...
			case 2:
				if (func_481(Local_182.f_0) && func_481(PLAYER::PLAYER_PED_ID()))
				{
					if (func_241(Local_182.f_0, PLAYER::PLAYER_PED_ID(), 1) < 5f || TASK::GET_SCRIPT_TASK_STATUS(Local_182.f_0, 242628503) == 7)
					{
						TASK::CLEAR_PED_TASKS(Local_182.f_0);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_182.f_0, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_196 = 0;
...
void func_441()
{
	if (func_481(Local_182.f_0))
	{
		switch (iLocal_197)
		{
			...
			case 1:
				if (!func_400(Local_182.f_0, 713668775))
				{
