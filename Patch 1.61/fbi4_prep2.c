		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(Global_96938.f_9[0]))
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_96938.f_9[0], true))
				{
					...
					Local_252.f_0 = Global_96938.f_9[0];
					if (func_449(Local_252.f_0))
					{
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_323(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_323(iVar10, 14, uVar69[iVar1], -1) };
			func_292(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_315(14);
			if (Global_78128 == 1)
			{
...
struct<10> func_302(int iParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
...
void func_304(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_305(int iParam0, int iParam1)
{
	int iVar0;
	struct<17> Var1;
...
void func_308(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_316(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_317(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
...
bool func_320(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
int func_321(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_323(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_386();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_325(int iParam0)
{
	...
	func_326(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_326(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
...
int func_330(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_332(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_326(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_326(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_392(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
int func_421(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
...
void func_467(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_468(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_470(var uParam0, struct<3> Param1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_472()
{
	Local_252 = { func_473(-409.7205f, -2175.858f, 9.31836f, 121.7754f, joaat("s_m_m_trucker_01")) };
}

struct<16> func_473(struct<3> Param0, float fParam3, int iParam4)
{
	struct<16> Var0;
...
void func_474()
{
	Local_282 = { func_475(-413.2349f, -2182.086f, 9.3184f, 83.9445f, joaat("towtruck")) };
	Local_270 = { func_475(-412.3477f, -2176.262f, 9.3184f, 281.0786f, joaat("peyote")) };
	Local_276 = { func_475(-386.5059f, -2168.738f, 9.3184f, 87.2085f, joaat("ruiner")) };
}

struct<6> func_475(struct<3> Param0, float fParam3, int iParam4)
{
	struct<6> Var0;
