...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_113386.f_18533[iVar0], &Var2, &fVar5))
			{
...
bool func_63(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
int func_82(int iParam0, struct<3> Param1, float fParam4)
{
	...
	switch (iParam0)
	{
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_96938.f_9[iVar0]))
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_96938.f_9[iVar0], true))
					{
						...
						Local_389[iVar0 /*22*/] = Global_96938.f_9[iVar0];
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				if (func_7(Global_96938[iVar6]))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96938[iVar6], true, true);
					Local_462[iVar7 /*6*/] = Global_96938[iVar6];
...
void func_298(int iParam0)
{
	...
	func_299(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_309(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_299(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_299(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_367()
{
	if (bLocal_374)
	{
		if (PED::IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, false, true, 0))
		{
			if (func_12(&uLocal_196, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
			{
				func_369(Global_41748[13 /*31*/], &fLocal_370);
				return;
			}
		}
		else
		{
			func_368(Global_41748[13 /*31*/], &fLocal_370);
		}
	}
...
void func_374()
{
	...
	{
		if (!func_63(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 100f, 1) && !bLocal_387)
		{
			func_376("PR_AREAWARN", &bLocal_387);
		}
		else if (!func_63(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 170f, 1) && bLocal_387)
		{
			func_375(3);
		}
	}
