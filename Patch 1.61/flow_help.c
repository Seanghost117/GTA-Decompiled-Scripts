...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (Global_113386.f_20410.f_145 > 0 || Global_112026)
		{
							...
							if (func_18(func_19()))
							{
								if (BitTest(Global_113386.f_20410[iLocal_37 /*16*/].f_11, func_12()))
								{
									if (Global_113386.f_20410[iLocal_37 /*16*/].f_12 == Global_113386.f_20410.f_146[func_12()])
									{
										...
										{
											if (MISC::GET_GAME_TIMER() > Global_113386.f_20410[iLocal_37 /*16*/].f_8)
											{
												if (MISC::ARE_STRINGS_EQUAL(&(Global_113386.f_20410[iLocal_37 /*16*/].f_4), ""))
												{
			...
			if (!MISC::ARE_STRINGS_EQUAL(&(Global_113386.f_20410[iLocal_37 /*16*/]), &Local_20) && !MISC::ARE_STRINGS_EQUAL(&(Global_113386.f_20410[iLocal_37 /*16*/]), ""))
			{
				if (Global_113386.f_20410[iLocal_37 /*16*/].f_10 != -1)
				{
					if (MISC::GET_GAME_TIMER() > Global_113386.f_20410[iLocal_37 /*16*/].f_10)
					{
						iVar2 = iLocal_37;
