...
void __EntryFunction__()
{
	...
	if (func_531())
	{
		Global_78564 = 1;
		iLocal_79 = 0;
		while (!func_520(&Local_92))
		{
			SYSTEM::WAIT(0);
		}
		func_519(&Local_92, 0, 1);
		Global_78564 = 0;
	}
	...
	func_518(25);
	func_517();
	func_516(&uLocal_153, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	func_516(&uLocal_153, 3, iLocal_734, "CLETUS", 0, 1);
	while (true)
	{
		RECORDING::_0x208784099002BC30("SF_TP", 0);
		func_499(Local_92.f_9, 0, 0, 0, 0, 0);
...
void func_234(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_305(&(Global_100441.f_3));
				if (iVar10 > -1)
				{
...
void func_235(int iParam0, var uParam1, int iParam2, int iParam3)
{
	func_236(&Global_106934, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_236(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_238(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_239(var uParam0, var uParam1, int iParam2, int iParam3)
{
...
int func_249(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_251(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
void func_260(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_262(Var11.f_1)) && iVar72 < 51)
			{
...
int func_276(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_292(iVar0))
		{
...
void func_317(bool bParam0, bool bParam1)
{
	...
	{
		iLocal_610 = func_318(iLocal_734, 1, 1, 5);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_610))
	{
		if (!bParam0)
...
void func_325()
{
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			...
			{
				if (!func_311(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
...
void func_326(int iParam0, int iParam1)
{
	...
	switch (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 6:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
			{
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_329(iParam0), false, false, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
			{
				if (iLocal_687[iParam0])
				{
					if (func_328(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], 1) >= 45f)
					{
				...
				else if (func_328(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >= 45f)
				{
					if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
					{
		...
		case 10:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
			{
				if (func_328(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], 0) < 2f)
				{
					TASK::CLEAR_PED_TASKS(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
		...
		case 13:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false))
				{
					if (func_327(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
					{
						iLocal_724++;
						iLocal_624 = 0;
					}
...
float func_328(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_330(int iParam0)
{
	...
	if (func_347())
	{
		...
		{
			func_344(767);
			if (func_331(&uLocal_153, cLocal_739, "HUNT1_KILL", "HUNT1_KILL_1", 7, 0, 0))
			{
				iLocal_614 = 1;
			}
		}
...
int func_332(char* sParam0, int iParam1, bool bParam2)
{
	Global_21606 = 0;
...
void func_348(int iParam0, int iParam1)
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0) && ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, false)) && iLocal_633) && iLocal_724 < 3)
	{
		...
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/] = func_318(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (HUD::DOES_BLIP_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
			{
...
void func_349(int iParam0, int iParam1)
{
	...
	if (!func_311(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		if (iParam1 == 1)
		{
...
void func_363()
{
	...
	else
	{
		...
		while (iVar0 < 2)
		{
			...
			while (iVar1 < 3)
			{
				func_365(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6);
				iVar1++;
			}
			iVar0++;
		}
...
void func_367()
{
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_353[iVar0 /*29*/].f_13)
		{
			...
			case 4:
				if (func_311(Local_353[iVar0 /*29*/].f_12) && func_380(Local_353[iVar0 /*29*/].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 10f, 10f, 10f, false, false, 0))
					{
						if (!func_379(Local_353[iVar0 /*29*/].f_12, -1817882002))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0 /*29*/].f_12, true);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
						}
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true))
						{
							if (func_327(Local_353[iVar0 /*29*/].f_28))
							{
								if (func_378(iVar0))
								{
			...
			case 5:
				...
				{
					TASK::CLEAR_PED_TASKS(Local_353[iVar0 /*29*/].f_12);
					Var1 = { func_371(Local_353[iVar0 /*29*/].f_28) };
			...
			case 6:
				if ((func_233(Local_353[iVar0 /*29*/].f_28) && func_311(Local_353[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true))
				{
			...
			case 7:
				if (func_311(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true))
				{
			...
			case 8:
				if ((func_311(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true)) && func_380(Local_353[iVar0 /*29*/].f_28))
				{
			...
			case 15:
				...
				if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_12))
				{
					...
					func_369(&(Local_353[iVar0 /*29*/].f_12), 1, 0, 1);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_28))
				{
		...
		if (func_380(Local_353[iVar0 /*29*/].f_28) && func_311(Local_353[iVar0 /*29*/].f_12))
		{
...
void func_370(int iParam0)
{
	...
	if (func_311(iVar0))
	{
		if (func_380(Local_353[iParam0 /*29*/].f_28))
		{
...
{
	if (func_311(Local_353[iParam0 /*29*/].f_12))
	{
...
void func_373()
{
	...
	else if (MISC::GET_GAME_TIMER() > iLocal_704)
	{
		...
		{
			if (func_374(&uLocal_153, cLocal_739, "HUNT1_CARH", 7, 0, 0, 0))
			{
				iLocal_625 = 0;
			}
		}
...
bool func_374(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_375()
{
	...
	if (func_311(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_311(iLocal_734))
		{
			...
			if (func_376(PLAYER::PLAYER_PED_ID(), iLocal_734, 0) <= 10f && MISC::ABSF((Var0.f_2 - Var3.f_2)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_390()
{
	Local_353[0 /*29*/] = { func_391(joaat("habanero"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), Local_794) };
	Local_353[1 /*29*/] = { func_391(joaat("dubsta"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), Local_797) };
	Local_353[2 /*29*/] = { func_391(joaat("patriot"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), Local_797) };
	Local_353[3 /*29*/] = { func_391(joaat("rebel"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), Local_794) };
	Local_353[4 /*29*/] = { func_391(joaat("sadler"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), Local_797) };
}

struct<29> func_391(int iParam0, struct<3> Param1, float fParam4, int iParam5, struct<3> Param6)
{
	struct<29> Var0;
...
void func_394()
{
	...
	{
		func_8(&iLocal_610);
		iLocal_609 = func_395(Local_745, 5, 1);
		func_322("HT_NXTLOC");
		iLocal_318 = 9;
	}
	if (func_364())
...
void func_396()
{
	...
	if (!bLocal_630)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_745, 5f, 5f, 5f, false, true, 0) && func_397(1077936128, 1))
		{
...
int func_397(float fParam0, int iParam1)
{
	int iVar0;
	...
	while (iVar0 < 3)
	{
		if (!HUD::DOES_BLIP_EXIST(Local_322[iVar0 /*10*/].f_9))
		{
			if (func_233(Local_322[iVar0 /*10*/]))
			{
				...
				{
					Local_322[iVar0 /*10*/].f_9 = func_404(Local_322[iVar0 /*10*/]);
...
float func_406(bool bParam0, float fParam1, float fParam2)
{
	if (bParam0)
	{
		return fParam1;
...
void func_407()
{
	...
	while (iVar0 < 3)
	{
		...
		if (Local_322[iVar0 /*10*/].f_7 == 1)
		{
			...
			{
				if (func_327(Local_322[iVar0 /*10*/]))
				{
...
int func_411()
{
	...
	else
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(Local_322[0 /*10*/]) && ENTITY::DOES_ENTITY_EXIST(Local_322[1 /*10*/])) && ENTITY::DOES_ENTITY_EXIST(Local_322[2 /*10*/])) && func_412())
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_726);
			iLocal_618 = 0;
			return 1;
				...
				case 0:
					if (func_443(1, 1093140480, 0))
					{
						...
						if (func_233(iLocal_734))
						{
							...
							iLocal_733 = func_439(iLocal_734, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_733))
						{
						...
						func_431(Local_826, Local_829, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						func_431(Local_832, Local_835, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						func_431(Local_838, Local_841, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						func_431(Local_844, Local_847, 5f, Local_850, fLocal_700, 1, 1, 1, 0, 0);
						...
						func_427(Local_807, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
						iLocal_706++;
					}
					break;
...
int func_425(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_427(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
int func_439(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (func_263(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			...
			{
				if (func_442(func_263(iVar2, iVar8)))
				{
	...
	while (func_263(iVar2, iVar10) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_263(iVar2, iVar10)))
			{
				...
				func_440(iVar1, func_263(iVar2, iVar10));
			}
		}
		iVar10++;
	}
...
int func_443(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = 0;
				if (!func_379(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
int func_446(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_449()
{
	if (!CAM::IS_GAMEPLAY_HINT_ACTIVE() && func_376(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) > 3f)
	{
	...
	else if (func_311(iLocal_734) && func_311(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_711 || func_376(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) <= 3f)
		{
			if (func_376(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) <= 3f)
			{
			}
			iLocal_706 = 0;
			iLocal_321 = 0;
...
void func_450()
{
	...
	if (func_531())
	{
		...
		{
			case 0:
				func_451(Local_810, fLocal_813, 1, 0);
				iLocal_318 = 3;
				break;
			
			case 1:
				func_451(Local_742, fLocal_690, 1, 0);
				iLocal_318 = 5;
				break;
			
			case 2:
				func_451(Local_748, fLocal_691, 1, 0);
				iLocal_318 = 12;
				break;
			
			case 3:
				func_451(Local_803, fLocal_806, 1, 0);
				iLocal_318 = 16;
				break;
			
			case 4:
				func_451(Local_913, fLocal_916, 1, 0);
				iLocal_318 = 20;
				break;
		...
		switch (iLocal_319)
		{
			...
			case 4:
				...
				else if (!iLocal_659[0])
				{
					...
					{
						if (func_374(&uLocal_153, cLocal_739, "HUNT1_1", 7, 0, 0, 0))
						{
							iLocal_659[0] = 1;
						}
					}
				...
				{
					func_490(&uLocal_995, &uLocal_153, cLocal_739, &sLocal_996, &cLocal_1002);
				}
				break;
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0) && func_375())
				{
					if (func_488())
					{
						func_383();
						if (func_374(&uLocal_153, cLocal_739, "HUNT1_DIARR", 7, 0, 0, 0))
						{
			...
			case 7:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0))
				{
					...
					if (func_488())
					{
						func_383();
						func_407();
						if (iLocal_637 && !func_401("HT_SHDISH", 0, 0))
						{
							func_483(0);
						}
						if (iLocal_724 == 1 && func_482())
						{
							if (!iLocal_646[0])
							{
								if (func_401("HT_SHDISH", 0, 0))
								{
									if (func_331(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_1", 7, 1, 0))
									{
										iLocal_616 = 0;
										func_493(0);
										iLocal_646[0] = 1;
								...
								else if (func_331(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0))
								{
									iLocal_616 = 0;
									func_493(0);
									iLocal_646[0] = 1;
						...
						else if (iLocal_724 == 2 && func_482())
						{
							if (!iLocal_646[1])
							{
								if (func_331(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_2", 7, 0, 0))
								{
									iLocal_616 = 0;
									func_493(0);
									iLocal_646[1] = 1;
						...
						else if (iLocal_724 == 3)
						{
							...
							{
								func_319();
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_1A", 7, 0, 0, 0))
								{
									RECORDING::_0x293220DA1B46CEBC(2f, 5f, 4);
									iLocal_616 = 0;
									iLocal_646[2] = 1;
				...
				{
					if (func_374(&uLocal_153, cLocal_739, "HUNT1_LAREA", 7, 1, 0, 0))
					{
						iLocal_659[2] = 1;
					}
				}
			...
			case 11:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), Local_823, false, true, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
						{
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_ENCAR", 7, 0, 0, 0))
							{
								func_8(&iLocal_610);
								func_229(1);
			...
			case 12:
				if (func_374(&uLocal_153, cLocal_739, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_719 == -1)
					{
			...
			case 14:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_781, 1.25f, 1.25f, 2.5f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_763, Local_766, 10f, false, true, 0))
					{
						if (func_488())
						{
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_714 == 1)
							{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_763, Local_766, 10f, false, true, 0))
				{
					...
					if (func_488())
					{
						...
						if (iLocal_629)
						{
							if (func_352())
							{
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_TYIN", 7, 0, 0, 0))
								{
									iLocal_629 = 0;
									iLocal_624 = 0;
								}
						...
						{
							if (func_331(&uLocal_153, cLocal_739, "HUNT1_TYRE", "HUNT1_TYRE_1", 7, 0, 0))
							{
								iLocal_646[0] = 1;
							}
						}
						...
						{
							if (func_331(&uLocal_153, cLocal_739, "HUNT1_TYRE", "HUNT1_TYRE_2", 7, 0, 0))
							{
								iLocal_646[1] = 1;
							}
						}
						else if (iLocal_724 == 3)
						{
							if (!iLocal_646[2])
							{
								if (iLocal_722 <= 6 && func_374(&uLocal_153, cLocal_739, "HUNT1_TYR2", 7, 0, 0, 0))
								{
									iLocal_646[2] = 1;
								}
								else if (iLocal_722 <= 10 && func_374(&uLocal_153, cLocal_739, "HUNT1_TRY3", 7, 0, 0, 0))
								{
									iLocal_646[2] = 1;
								}
								else if (func_374(&uLocal_153, cLocal_739, "HUNT1_TYR4", 7, 0, 0, 0))
								{
									iLocal_646[2] = 1;
								}
							}
			...
			case 17:
				...
				if (!iLocal_659[15])
				{
					if (func_375())
					{
						if (!func_226())
						{
							...
							{
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_3", 8, 0, 0, 0))
								{
									iLocal_659[15] = 1;
								}
							}
				...
				{
					case 0:
						if (func_328(iLocal_734, Local_946[0 /*3*/], 0) < 2f)
						{
					...
					case 1:
						if (func_328(iLocal_734, Local_946[1 /*3*/], 0) < 2f)
						{
					...
					case 2:
						if (func_328(iLocal_734, Local_946[2 /*3*/], 0) < 2f)
						{
					...
					case 3:
						if (func_328(iLocal_734, Local_946[3 /*3*/], 0) < 2f)
						{
			...
			case 18:
				if (func_311(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_374(&uLocal_153, cLocal_739, "HUNT_ROOF", 7, 0, 0, 0))
						{
							TASK::CLEAR_PED_TASKS(iLocal_734);
			...
			case 21:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7)
					{
						if ((func_374(&uLocal_153, cLocal_739, "HUNT1_COARR", 7, 0, 0, 0) || iLocal_724 > 0) || iLocal_714 == 1)
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 5f, 4);
							iLocal_714 = 0;
							iLocal_659[17] = 1;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, false, true, 0))
				{
					...
					if (func_488())
					{
						...
						if (iLocal_724 == 1 && !iLocal_659[18])
						{
							if (!func_226())
							{
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_FIRST", 7, 0, 0, 0))
								{
									if (iLocal_628)
									{
										iLocal_628 = 0;
						...
						if (iLocal_724 == 2 && !iLocal_659[19])
						{
							if (!func_226())
							{
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_SEC", 7, 0, 0, 0))
								{
									if (iLocal_628)
									{
										iLocal_628 = 0;
						...
						if (iLocal_628)
						{
							if (!func_226())
							{
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_COYMIS", 7, 0, 0, 0))
								{
									iLocal_628 = 0;
								}
							}
				...
				if (bLocal_626)
				{
					...
					{
						func_319();
						if (func_374(&uLocal_153, cLocal_739, "HUNT1_FIN", 8, 0, 0, 0))
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 4f, 4);
							func_493(0);
							iLocal_319 = 23;
			...
			case 25:
				if (!func_226())
				{
					if (!iLocal_659[21])
					{
						if (func_374(&uLocal_153, cLocal_739, "HUNT1_4", 7, 0, 0, 0))
						{
							iLocal_659[21] = 1;
						}
					}
				...
				if (func_233(iVar0) || !func_233(iVar0))
				{
					if (PED::IS_PED_MODEL(iVar0, iLocal_727))
					{
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), true))
						{
							...
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_COYTYR", 7, 0, 0, 0))
							{
								iLocal_659[12] = 1;
							}
						}
...
void func_466()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_993)
		{
			if (func_375())
			{
				if (func_374(&uLocal_153, cLocal_739, "HUNT1_TYRBAN", 7, 0, 0, 0))
				{
					iLocal_659[10] = 1;
				}
			}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_703)
			{
				if (!func_226())
				{
					if (!iLocal_659[8])
					{
						if (func_469(&uLocal_153, cLocal_739, "HUNT1_BANTER", &Local_982, 7, 0, 0))
						{
...
bool func_469(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_343(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_470()
{
	...
	if (func_311(PLAYER::PLAYER_PED_ID()) && func_311(iLocal_734))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_233(iLocal_980))
			{
				if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false) == iLocal_980 && PED::GET_VEHICLE_PED_IS_IN(iLocal_734, false) == iLocal_980)
				{
					...
					else
					{
						...
						{
							func_471();
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_DAMCAR", 8, 0, 0, 0))
							{
								iLocal_990 = 0;
							}
						}
		...
		if (!iLocal_659[7])
		{
			if (!func_226())
			{
				if (func_375())
				{
					...
					{
						if (func_374(&uLocal_153, cLocal_739, "HUNT1_CLVEH", 7, 0, 0, 0))
						{
							iLocal_659[7] = 1;
						}
					}
					...
					{
						if (func_374(&uLocal_153, cLocal_739, "HUNT1_OWNVEH", 7, 0, 0, 0))
						{
							iLocal_659[7] = 1;
						}
					}
	...
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_734, true) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, false) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
			{
				if (!iLocal_644)
				{
					if (!func_401("HT_NXTLOC", 0, 0) && iLocal_659[4])
					{
				...
				else if (MISC::GET_GAME_TIMER() > iLocal_718)
				{
					if (!func_226() && func_375())
					{
						if (!iLocal_659[6])
						{
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_NOVEH", 7, 0, 0, 0))
							{
								iLocal_659[6] = 1;
							}
						}
...
void func_477()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_734, true) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
	{
		if (!iLocal_988)
		{
			if (iLocal_683[1] && !func_401("HT_NXTLOC", 0, 0))
			{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_989)
		{
			if (!func_226() && func_375())
			{
				if (!iLocal_659[4])
				{
					if (func_374(&uLocal_153, cLocal_739, "HUNT1_2", 7, 0, 0, 0))
					{
						iLocal_659[4] = 1;
					}
				}
...
void func_478()
{
	...
	{
		if ((iLocal_683[1] && !func_401("HT_NXTLOC", 0, 0)) && !func_226())
		{
			if (!iLocal_643)
			{
			...
			{
				if (!iLocal_659[5] && func_375())
				{
					if (func_374(&uLocal_153, cLocal_739, "HUNT1_WAIT", 7, 0, 0, 0))
					{
						iLocal_643 = 0;
					}
				}
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, true))
			{
				if (!VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(iLocal_994))
				{
					if (func_375())
					{
						if (!func_226())
						{
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_NOCAR", 7, 0, 0, 0))
							{
								iLocal_620 = 1;
							}
						}
...
void func_481()
{
		...
		if (MISC::IS_BULLET_IN_AREA(Local_322[iVar0 /*10*/].f_1, 10f, true))
		{
			if (!func_226())
			{
				if (!func_401("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_322[iVar0 /*10*/].f_7)
					{
						if (func_374(&uLocal_153, cLocal_739, "HUNT_MISS", 7, 0, 0, 0))
						{
							iLocal_624 = 0;
						}
					}
	...
	if (MISC::IS_BULLET_IN_AREA(1793.305f, 3804.426f, 32.6374f, 10f, true))
	{
		if (!func_226())
		{
			if (!func_401("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				if (func_374(&uLocal_153, cLocal_739, "HUNT_MISS2", 6, 0, 0, 0))
				{
					iLocal_624 = 0;
				}
			}
...
void func_483(int iParam0)
{
	...
	if (((iLocal_724 < 3 && !func_401("HT_SHDISH", 0, 0)) && !func_401("HT_SHTYRE", 0, 0)) && !func_401("HT_SHCOY", 0, 0))
	{
		if (iLocal_624)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_712)
			{
				...
				{
					if ((func_352() || iLocal_709 > 2) || iLocal_724 == 0)
					{
						if (func_374(&uLocal_153, cLocal_739, sVar0, 7, 0, 0, 0))
						{
							iLocal_624 = 0;
						}
					}
					else
					{
						...
						{
							case 0:
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_SAT", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_709++;
								}
							...
							case 1:
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_SAT2", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_709++;
								}
							...
							case 2:
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_SAT3", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_709++;
								}
				...
				{
					if ((func_352() || iLocal_725 > 2) || iLocal_724 == 0)
					{
						if (func_374(&uLocal_153, cLocal_739, sVar0, 7, 0, 0, 0))
						{
							iLocal_624 = 0;
					...
					else
					{
						...
						{
							case 0:
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_BANT1", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_725++;
								}
							...
							case 1:
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_BANT2", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_725++;
								}
							...
							case 2:
								if (func_374(&uLocal_153, cLocal_739, "HUNT1_BANT3", 7, 0, 0, 0))
								{
									iLocal_624 = 0;
									iLocal_725++;
								}
				...
				else
				{
					...
					{
						case 0:
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_COYB1", 7, 0, 0, 0))
							{
								iLocal_624 = 0;
								iLocal_981++;
							}
						...
						case 1:
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_COYB2", 7, 0, 0, 0))
							{
								iLocal_624 = 0;
								iLocal_981++;
							}
						...
						case 2:
							if (func_374(&uLocal_153, cLocal_739, "HUNT1_COYB3", 7, 0, 0, 0))
							{
								iLocal_624 = 0;
								iLocal_981++;
							}
		...
		switch (iLocal_714)
		{
			case 0:
				switch (iParam0)
				{
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_781, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_485(iLocal_734, fLocal_691, 30f))
						{
							iLocal_714 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_788, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_485(iLocal_734, fLocal_699, 30f))
						{
							iLocal_714 = 1;
						}
						break;
...
int func_485(int iParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	...
	if (!func_226())
	{
		if (func_375())
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				if (!iLocal_635)
				{
					if (func_374(&uLocal_153, cLocal_739, "HUNT1_UGUN", 9, 0, 0, 0))
					{
						iLocal_635 = 1;
						iLocal_634 = 0;
					}
			...
			{
				if (func_374(&uLocal_153, cLocal_739, "HUNT_UGUN2", 9, 0, 0, 0))
				{
					iLocal_634 = 1;
					iLocal_635 = 0;
				}
...
void func_490(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
...
void func_494(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_311(iLocal_734) && func_311(PLAYER::PLAYER_PED_ID()))
	{
		if (func_465())
		{
			iVar1 = 0;
			...
			if (iLocal_707 == 1)
			{
				if (!iLocal_659[13])
				{
					if (func_331(&uLocal_153, cLocal_739, "HUNT1_INOC", "HUNT1_INOC_1", 8, 0, 0))
					{
						iLocal_659[13] = 1;
					}
				}
...
void func_495()
{
	if (!PED::IS_PED_INJURED(iLocal_734))
	{
		...
		if (!iLocal_619)
		{
			if (func_497() || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_734))
			{
				if (func_226())
				{
					func_319();
				}
				func_496(&uLocal_153, cLocal_739, "HUNT1_PTREAC", 6, 0, 0);
				iLocal_619 = 1;
			}
		}
		if (!bLocal_645)
...
void func_496(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_497()
{
	if (func_311(iLocal_734))
	{
		if (iLocal_319 != 25)
		{
			if ((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && func_376(iLocal_734, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_734, 30f)) && func_376(iLocal_734, PLAYER::PLAYER_PED_ID(), 1) <= 2f)
		{
			return 1;
		}
	}
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_501(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_516(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_521(int* iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	func_522(iParam0, iLocal_81, Param1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_522(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_523(iParam0);
...
int func_524(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_525(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_525(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_532()
{
	...
	func_533(&Local_92, 0, 0, 0);
	HUD::CLEAR_ADDITIONAL_TEXT(6, true);
}

void func_533(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
