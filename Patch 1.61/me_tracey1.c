...
void func_40()
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_186(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_533)
				{
		...
		case 1:
			...
			else if ((func_62(iLocal_289, Local_530, 2f, 1) || (MISC::GET_GAME_TIMER() - iLocal_474) > 5000) || bLocal_475)
			{
				if (bLocal_476)
				{
...
bool func_62(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
int func_186(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 0)
				{
					iLocal_297 = func_289(Local_527, 5, 1);
					iLocal_309 = 0;
					iLocal_310 = 0;
				}
				else
			...
			else
			{
				...
				{
					iLocal_298 = func_203(iLocal_273, 1, 5);
				}
				func_34(5);
				iLocal_305 = 1;
			}
		...
		case 1:
			...
			if (iLocal_305)
			{
				...
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
				{
					...
					if (!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
					{
						iLocal_306 = 1;
						iLocal_307 = 0;
						iLocal_298 = func_200(iLocal_289, 1, 1, 5);
					}
					else
					{
						iLocal_306 = 0;
				...
				else if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 160f, 1))
				{
					sLocal_573 = "MET1ABANDON";
					iLocal_92 = 11;
					iLocal_93 = 0;
				}
				else if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 60f, 1))
				{
					func_34(6);
				}
			}
			...
			else if (iLocal_306)
			{
				...
				{
					if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 60f, 1))
					{
						func_34(6);
					}
				}
...
int func_190()
{
	if (bLocal_533)
	{
		if (func_62(PLAYER::PLAYER_PED_ID(), Local_524, 30f, 1))
		{
			return 1;
		}
	}
...
void func_192()
{
	...
	else
	{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[3 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f, 1))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[4 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f, 1))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[5 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f, 1))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[6 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f, 1))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[7 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f, 1))
			{
...
int func_193()
{
	...
	while (iLocal_572 <= 8)
	{
		if (func_194(Local_341[iLocal_572 /*3*/].f_2, 0, 0))
		{
			return 1;
		}
		iLocal_572++;
...
bool func_198(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_205(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_279(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_113386.f_18574[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_278(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_100478, iParam0);
			}
			else
			{
				iVar10 = func_277(&(Global_100441.f_3));
				if (iVar10 > -1)
				{
...
int func_210(var uParam0, var uParam1, int iParam2, int iParam3)
{
...
int func_223(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
int func_224(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_225(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_225(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
void func_228(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_229(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_232(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_234(Var11.f_1)) && iVar72 < 51)
			{
...
int func_240(struct<3> Param0, char* sParam3, struct<3> Param4)
{
	int iVar0;
	int iVar1;
...
bool func_242(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
int func_249(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_264(iVar0))
		{
			if (!bParam5 || func_263(iVar0))
			{
...
int func_253(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (!func_258(iParam1, &Var6))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var12 = { func_256(iParam0) };
	}
	else
	{
	...
	Var18 = { Var12 - Var0 };
	Var18 = { func_254(Var18, -Var0.f_3.f_2) };
	Var18 = { func_254(Var18, Var6.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_254(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_281(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_286(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_289(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_32(iLocal_290))
			{
				...
				func_33(&iLocal_297);
				iLocal_297 = func_200(iLocal_290, 1, 0, 5);
				func_343(&iLocal_297, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_299, &iLocal_300, 1, 1);
				ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_290, true, 0f);
				func_314(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
				func_33(&iLocal_298);
				func_189(5);
				func_313();
				iLocal_93 = 1;
		...
		case 1:
			func_301(&iLocal_297, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_299, iLocal_300, 1);
			if (func_32(iLocal_290))
			{
				if (!func_198(iLocal_290, PLAYER::PLAYER_PED_ID(), 80f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_290))
				{
					func_39(&iLocal_290);
					bLocal_337 = func_302();
					iLocal_93 = 2;
...
void func_293()
{
	if (!bLocal_604)
	{
		...
		{
			func_296(1);
			if (((func_295(Local_584[0 /*3*/], Local_584[2 /*3*/], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(iLocal_290)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
			{
		...
		if (!bLocal_604)
		{
			...
			{
				if (((MISC::GET_GAME_TIMER() > uLocal_606[0] && func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
				{
					func_294(0, 0);
				}
...
void func_297()
{
	...
	if (func_300() && MISC::GET_GAME_TIMER() > iLocal_412)
	{
		if (iLocal_380 == 0 || iLocal_380 == 1)
		{
			if (func_32(iLocal_273) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false) || func_198(PLAYER::PLAYER_PED_ID(), iLocal_273, 15f, 1)))
			{
				iLocal_380 = 4;
			}
		}
	...
	switch (iLocal_417)
	{
		...
		case 1:
			...
			if (func_32(iLocal_290))
			{
				if (func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 25f, 1))
				{
				...
				{
					if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, (80f * 0.75f), 1))
					{
						if (!bLocal_414)
						{
							iLocal_417 = 8;
				...
				else if ((!bLocal_414 && !func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, (80f * 0.5f), 1)) && func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 15f, 1))
				{
					iLocal_417 = 8;
				}
			}
		...
		case 10:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, true) && !func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 25f, 1))
				{
					func_196();
				}
			}
...
void func_301(int* iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_302()
{
	...
	{
		if (func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 10f, 1))
		{
			return 1;
		}
		else if (func_62(iLocal_289, ENTITY::GET_ENTITY_COORDS(iLocal_290, false), 10f, 1))
		{
			return 1;
		}
		else if (func_303(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7))
		{
			return 1;
		}
		else if (func_303(iLocal_289, iLocal_290, 1126825984, 1, 250, 7))
		{
			return 1;
		}
	}
...
bool func_303(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_311(iParam0, iParam1);
	if (!func_32(iParam0) || !func_32(iParam1))
	{
		if (iVar4 != -1)
		{
			func_310(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_304(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_304(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_307(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_313()
{
	func_303(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7);
	func_303(iLocal_289, iLocal_290, 1126825984, 1, 250, 7);
}

void func_314(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_315(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_315(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
...
void func_316(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_317(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}
...
void func_343(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_345()
{
	switch (iLocal_93)
	{
		case 0:
			...
			{
				func_314(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
				if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 220f, 1))
				{
					func_33(&iLocal_297);
				...
				else
				{
					...
					func_361(&bLocal_609, &uLocal_610, &uLocal_611, &uLocal_612);
					iLocal_613 = MISC::GET_GAME_TIMER();
					if (HUD::DOES_BLIP_EXIST(iLocal_297))
					{
						func_360(iLocal_297, iLocal_290, 220f, 0.75f, 0);
					}
					iLocal_93 = 1;
				}
				if (iLocal_305)
		...
		case 1:
			if (func_32(iLocal_290))
			{
				...
				else if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 220f, 1))
				{
					func_33(&iLocal_297);
					sLocal_573 = "MET1ESCAPE";
					iLocal_92 = 11;
...
void func_346()
{
	...
	{
		case 0:
			if ((((MISC::GET_GAME_TIMER() - iLocal_374) > 4000 && func_32(iLocal_290)) && !func_193()) && !func_29())
			{
				func_27(&uLocal_96, 4, iLocal_290, "Stalker", 0, 1);
				iLocal_380 = 1;
			}
		...
		case 1:
			if (func_32(iLocal_290))
			{
				if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, (220f * 0.75f), 1))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false))
					{
						iLocal_380 = 8;
				...
				else if (func_347() && (MISC::GET_GAME_TIMER() - iLocal_331) > 6000)
				{
					iLocal_380 = 7;
				}
				else if (func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 50f, 1))
				{
...
int func_347()
{
	if (func_295(Local_320[0 /*3*/], Local_320[2 /*3*/], 2f))
	{
		return 1;
	}
	iLocal_331 = MISC::GET_GAME_TIMER();
...
int func_351()
{
	...
	if (func_32(Local_277.f_0))
	{
		fVar0 = func_352(ENTITY::GET_ENTITY_ROLL(Local_277.f_0), 0f, 360f);
...
void func_353()
{
	if (func_32(Local_277.f_0))
	{
		...
		{
			func_296(0);
			if (func_295(Local_584[3 /*3*/], Local_584[5 /*3*/], 2f) && func_354())
			{
				iLocal_92 = 6;
				iLocal_93 = 0;
			}
			else if (func_295(Local_584[0 /*3*/], Local_584[5 /*3*/], 2f))
			{
				iLocal_92 = 6;
				iLocal_93 = 0;
			}
...
int func_354()
{
	if (func_62(iLocal_273, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, 3.2f, 0.5f), 3f, 1) || func_62(iLocal_273, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, -3.2f, 0.5f), 3f, 1))
	{
		return 1;
	}
	return 0;
...
void func_355()
{
	...
	if (iLocal_617 == 1)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_356(1))
		{
	...
	if (iLocal_617 == 2)
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_356(0))
		{
...
int func_357()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_277.f_0))
	{
		...
		if (func_359(Local_277.f_0, &bLocal_609, &uLocal_610, &uLocal_611, &uLocal_612, 6, 1082130432))
		{
			return 1;
		}
		if (bLocal_609)
...
int func_359(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		*uParam4 = func_308(Var4, Var1);
	}
	return 0;
}

void func_360(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	switch (iLocal_93)
	{
		case 0:
			if (!func_367())
			{
				...
				if (func_363(Local_277.f_6, Local_277.f_9, 0))
				{
					iLocal_332 = 0;
					iLocal_333 = 0;
					iLocal_335 = 0;
				...
				if (func_32(Local_277.f_0))
				{
					if (!iLocal_335)
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("missmichael_event@tracy") && func_3(&uLocal_96, "MET1AUD", "MET1_TENDb", 7, 0, 0, 0))
						{
							...
							if (!HUD::DOES_BLIP_EXIST(iLocal_297))
							{
								iLocal_297 = func_203(Local_277.f_0, 0, 5);
					...
					else
					{
						...
						if (!iLocal_332)
						{
							...
							else if (func_198(PLAYER::PLAYER_PED_ID(), iLocal_290, 15f, 1))
							{
								iLocal_332 = 1;
							}
						}
...
void func_365()
{
	...
	if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[3 /*8*/], Local_487[3 /*8*/].f_3, 1))
	{
			...
			if (!func_367())
			{
				...
				if (iLocal_305)
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
					{
						...
						{
							iLocal_306 = 0;
							if (iLocal_316 == 5 && !func_62(PLAYER::PLAYER_PED_ID(), Local_487[iLocal_520 /*8*/], Local_487[iLocal_520 /*8*/].f_3, 1))
							{
								iLocal_297 = func_289(Local_487[iLocal_520 /*8*/], 5, 1);
							}
					...
					else if (func_371(iLocal_289, 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						TASK::CLEAR_PED_TASKS(iLocal_289);
				...
				else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
				{
					iLocal_305 = 1;
					func_33(&iLocal_297);
					iLocal_297 = func_203(iLocal_273, 1, 5);
					func_34(5);
					if (func_29())
					{
						func_196();
				...
				else if (!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
				{
					...
					iLocal_307 = 0;
					func_33(&iLocal_297);
					iLocal_297 = func_200(iLocal_289, 1, 1, 5);
					func_34(2);
					if (func_29())
					{
						func_60();
				...
				else
				{
					switch (iLocal_316)
					{
						...
						case 3:
							...
							if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[iLocal_520 /*8*/], Local_487[iLocal_520 /*8*/].f_3, 1))
							{
								iLocal_316 = 5;
							}
							else if (!func_29())
...
void func_369()
{
	if (((!func_29() && !func_195()) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
	{
		if (func_347() && (MISC::GET_GAME_TIMER() - iLocal_331) > 18000)
		{
...
int func_376(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_377(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_379(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_380(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (!func_367())
			{
				if (!func_2())
				{
					if (((func_396(&iLocal_289, Local_483, fLocal_486, 1) && func_384(&iLocal_273, 15, Local_479, fLocal_482, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_296)) && func_32(iLocal_273))
					{
						iLocal_293 = 1;
		...
		case 1:
			if (iLocal_95 == 0)
			{
				if (func_62(PLAYER::PLAYER_PED_ID(), Local_479, 200f, 1))
				{
					iLocal_95 = 1;
				}
			}
			else if (!func_62(PLAYER::PLAYER_PED_ID(), Local_479, 300f, 1))
			{
				iLocal_95 = 0;
			}
			if (!func_2())
			{
				if (!func_367())
				{
					switch (iLocal_304)
					{
						...
						case 2:
							if (((!iLocal_311 && !func_29()) && !func_194("MET1TCAR", 0, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							{
					...
					if (iLocal_304 != 0)
					{
						if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 100f, 1))
						{
							sLocal_573 = "MET1ABANDON";
							iLocal_92 = 11;
							iLocal_93 = 0;
						}
						else if (!func_198(PLAYER::PLAYER_PED_ID(), iLocal_289, 50f, 1))
						{
							func_34(6);
						}
					}
					if (func_371(iLocal_289, 1, 1116471296, 1126825984, 1, 0, 0, 0))
					{
						TASK::CLEAR_PED_TASKS(iLocal_289);
						TASK::TASK_SMART_FLEE_PED(iLocal_289, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
						if (func_29())
...
void func_382()
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_369) > 5000 && func_198(iLocal_289, PLAYER::PLAYER_PED_ID(), 25f, 1))
			{
				iLocal_371 = 9;
			}
			break;
...
int func_384(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	struct<98> Var0;
	int iVar98;
	int iVar99;
	...
	if (!func_17(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_113386.f_2363.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0.f_0) || (iParam1 == 15 && Global_113386.f_2363.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0.f_0))
		{
			...
			STREAMING::REQUEST_MODEL(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/]);
			if (STREAMING::HAS_MODEL_LOADED(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/], Param2, fParam5, false, false, false);
				...
				Var0.f_3 = 1250;
				VEHICLE::SET_VEHICLE_COLOURS(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_5, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_6);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_7, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_8);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(*iParam0, Var0.f_2);
				iVar99 = 0;
				while (iVar99 < 12)
				{
					VEHICLE::SET_VEHICLE_EXTRA(*iParam0, iVar99 + 1, !Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_11[iVar99]);
					iVar99++;
				}
				if (Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_24)
				{
					if (VEHICLE::IS_VEHICLE_A_CONVERTIBLE(*iParam0, false))
					{
						if (Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_24)
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*iParam0, &(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_27));
				if (Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26 >= 0 && Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26 < VEHICLE::GET_NUMBER_OF_VEHICLE_NUMBER_PLATES())
				{
					VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26);
				}
				VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_84, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_85, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_86);
				VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_88);
				VEHICLE::SET_VEHICLE_WINDOW_TINT(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_87);
				VEHICLE::_SET_VEHICLE_NEON_LIGHTS_COLOUR(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_93, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_94, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_95);
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 2, BitTest(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 28));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 3, BitTest(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 29));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 0, BitTest(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 30));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 1, BitTest(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 31));
				if (VEHICLE::GET_VEHICLE_LIVERY_COUNT(*iParam0) > 1 && Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_89 >= 0)
				{
					VEHICLE::SET_VEHICLE_LIVERY(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_89);
				}
				if (Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90 > -1)
				{
					if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(*iParam0)))
					{
						if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(*iParam0)))
						{
							if (Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90 == 6)
							{
								VEHICLE::SET_VEHICLE_WHEEL_TYPE(*iParam0, Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90);
							}
						}
						else
						{
				...
				func_388(iParam0, &(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var0.f_96);
				if (bParam6)
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/]);
				}
				func_387(*iParam0);
				return 1;
			}
...
void func_385(int iParam0, struct<98> Param1)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
{
	if (!func_394() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_93)
	{
		...
		case 1:
			if (!func_2())
			{
				...
				else if (func_62(PLAYER::PLAYER_PED_ID(), Local_479, 200f, 1))
				{
					iLocal_93 = 2;
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_433(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_430(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_402(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_402(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_423(iParam5, &Var0, Param1, fParam4, func_214(iParam0));
...
void func_446(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_448(Global_113386.f_18533[iVar0], &Var2, &fVar5))
			{
...
{
	func_466();
	while (!func_384(&iLocal_273, 15, Param0, fParam3, 1, 0))
	{
		SYSTEM::WAIT(0);
	}
	if (bParam4)
...
{
	return func_475(&(Global_106934.f_2890), Param0, fParam3, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_242(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
var func_490(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_503(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_514(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<3> Var0;
	float fVar3;
	...
	if (func_554() && func_551(iParam1, iParam2, iParam3, 1))
	{
		Var0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_515(iParam0, Var0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
void func_515(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_484(iParam12, 0);
			while (!func_516(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_516(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_388(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_517(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_518(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_519(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_519(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_547(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
void func_557()
{
	...
	func_561();
	func_560();
	func_559(&Local_534, 200.34f, -30.73f, 60.91f, 244.07f, -45.73f, 77.22f, 30f);
...
void func_559(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
void func_564()
{
	Local_341[0 /*3*/] = { func_565("MET1INITDRV", 1) };
	Local_341[1 /*3*/] = { func_565("MET1TCAR", 1) };
	Local_341[2 /*3*/] = { func_565("MET1WAIT", 1) };
	Local_341[3 /*3*/] = { func_565("MET1WANT", -1) };
	Local_341[4 /*3*/] = { func_565("MET1CHASE", 1) };
	Local_341[5 /*3*/] = { func_565("MET1GETBKT", 1) };
	Local_341[6 /*3*/] = { func_565("MET1DLT", 1) };
	Local_341[7 /*3*/] = { func_565("MET1HOME", 1) };
	Local_341[8 /*3*/] = { func_565("MET1HOTEL", 1) };
}

Vector3 func_565(char* sParam0, int iParam1)
{
	struct<3> Var0;
...
void func_571(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
