...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_83 = func_542(64);
	uLocal_84 = func_542(63);
...
void func_1()
{
	...
	if (func_284(iLocal_604) && func_284(PLAYER::PLAYER_PED_ID()))
	{
...
void func_46()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_604))
	{
		...
		{
			if (func_284(iLocal_604) && !PED::IS_PED_FLEEING(iLocal_604))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_604))
				{
					PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_604, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
			...
			if (func_284(iLocal_605) && !PED::IS_PED_FLEEING(iLocal_605))
			{
	...
	{
		if (func_284(iLocal_605) && func_284(PLAYER::PLAYER_PED_ID()))
		{
...
void func_72()
{
	...
	switch (iLocal_522)
	{
		...
		case 1:
			if (((iLocal_884 == 0 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_616)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_616) >= 0.75f) && func_284(iLocal_605))
			{
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_144(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_144(iVar10, 14, uVar69[iVar1], -1) };
			func_113(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_136(14);
			if (Global_78128 == 1)
			{
...
void func_146(int iParam0)
{
	...
	func_147(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_153(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_147(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_147(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_224()
{
	...
	switch (iLocal_522)
	{
		...
		case 1:
			func_241(iLocal_700, iLocal_605, 100f, 0.7f, 0);
			func_240();
			func_235();
			func_234();
			func_232();
...
int func_225(float fParam0)
{
	...
	if (func_284(PLAYER::PLAYER_PED_ID()) && func_284(iLocal_605))
	{
		...
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_605, Local_927, Local_930, fLocal_933, false, true, 0) && func_226(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_605, 0f, 1f, 0f), 1.5f)) && !ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_605))
		{
...
void func_227()
{
	if (Local_523[0 /*16*/].f_14)
	{
		if (iLocal_881 == 0)
		{
			if ((func_284(Local_523[0 /*16*/]) && func_284(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_523[0 /*16*/]))
			{
				if (func_229() || func_27(Local_523[0 /*16*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
	...
	if (iLocal_883 == 1)
	{
		if ((func_284(Local_523[2 /*16*/]) && func_284(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_523[2 /*16*/]))
		{
	...
	if (Local_523[1 /*16*/].f_14 == 1)
	{
		if (iLocal_887 == 1)
		{
			if ((func_284(Local_523[1 /*16*/]) && func_284(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_523[1 /*16*/]))
			{
...
void func_236()
{
	if ((func_284(Local_667.f_1) && func_35(Local_667.f_0)) && func_284(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_519)
		{
			case 0:
...
void func_241(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_246()
{
	if ((func_284(iLocal_604) && func_247(iLocal_604, Local_609, 1) < 5f) && func_247(PLAYER::PLAYER_PED_ID(), Local_609, 1) < 25f)
	{
		if (iLocal_613)
		{
...
float func_247(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_251()
{
	...
	switch (iLocal_522)
	{
		case 0:
			if (!HUD::DOES_BLIP_EXIST(iLocal_700))
			{
				iLocal_700 = func_253(iLocal_605, 1, 1, 5);
			}
		...
		case 1:
			...
			{
				bVar0 = false;
				if ((func_284(iLocal_604) && func_284(PLAYER::PLAYER_PED_ID())) && func_27(iLocal_604, PLAYER::PLAYER_PED_ID(), 35f, 1))
				{
...
void func_256()
{
	...
	switch (iLocal_517)
	{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > iLocal_949 && func_284(iLocal_604))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_604))
				{
					PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_604, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
		...
		case 5:
			func_258();
			if (MISC::GET_GAME_TIMER() > iLocal_949 && func_284(iLocal_605))
			{
...
bool func_257(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_265(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_281(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_314(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_144(iVar0, iParam1, uVar31[iParam1], -1) };
...
void func_319(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_274(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar32, 0, Global_100478, 0);
		func_320(&sVar32, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}
...
void func_368(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		if (!func_474(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_428(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
{
	if (!func_433() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_438(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
{
	return func_446(&(Global_106934.f_2890), Param0, fParam3, 0);
}
...
int func_448(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_450(iParam0, uVar1[iVar6], 1) && func_449(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_444(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_498(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
...
int func_501(var uParam0)
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (!func_502(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_82 = 2;
...
void func_515(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_516()
{
	...
	func_515(&iLocal_604, 1, 0, 1);
	func_515(&iLocal_605, 1, 0, 1);
	func_515(&iLocal_615, 0, 0, 1);
	func_512(&iLocal_699);
	func_518(Local_635);
	func_518(Local_651);
	func_518(Local_627);
...
void func_517(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_523[iParam0 /*16*/]))
	{
		func_515(&(Local_523[iParam0 /*16*/]), 0, 0, 1);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_523[iParam0 /*16*/].f_1);
	}
}

void func_518(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
int func_522(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_528())
	{
		...
		{
			iVar33 = func_523(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_525(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
