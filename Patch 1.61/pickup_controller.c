	...
	switch (Global_32203)
	{
		...
		case 1:
			switch (Global_32204)
			{
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_86[Global_32205]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_86[Global_32205]))
					{
						Global_32206 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_163[Global_32205]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_163[Global_32205]))
					{
						Global_32206 = 0;
					}
					else
