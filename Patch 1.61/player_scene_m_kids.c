...
void func_3(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		switch (iLocal_243[iParam1])
		{
			...
			case 5:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &sLocal_349, &(Local_430[iParam1 /*16*/]), 2))
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97771))
					{
						...
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_97771) > fLocal_481)
						{
			...
			case 1:
				if (iLocal_249[iParam1] != Global_95447[iLocal_246[iParam1]])
				{
					if (!ENTITY::DOES_ENTITY_EXIST(Global_100162))
					{
						Global_95447[iLocal_246[iParam1]] = 140;
						Global_95463 = iLocal_249[iParam1];
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97771))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_97771, &sLocal_349, &(Local_430[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
					iLocal_243[iVar0] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], false))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_97771, &(Local_302[iVar0 /*16*/]), &sLocal_349, 8f, 8f, 0, 1000f);
				}
				iVar0++;
			}
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_463) && iLocal_468)
...
int func_36()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97770))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_97770, &sLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], false))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_97770, &(Local_269[iVar0 /*16*/]), &sLocal_349, 8f, 8f, 0, 1000f);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_253[iVar0]))
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_463))
		{
			...
			if (iLocal_70 == 156)
			{
				func_37(&uLocal_71, 3, Global_100162, "JIMMY", 0, 1);
	...
	{
		PED::_DISPOSE_SYNCHRONIZED_SCENE(Global_97771);
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_463))
		{
			func_37(&uLocal_71, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			if (iLocal_70 == 156)
...
void func_72(int iParam0)
{
	...
	func_73(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_73(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_73(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_70(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_70(iVar10, 14, uVar69[iVar1], -1) };
			func_156(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_162(14);
			if (Global_78128 == 1)
			{
...
int func_172(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
