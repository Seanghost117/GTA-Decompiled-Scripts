		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97771))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_97771, &Local_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_240[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_253)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_97771, &(Local_559[iVar0 /*16*/]), &Local_345, 8f, -1000f, 0, 1000f);
					}
				}
				iVar0++;
			}
...
int func_38()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97770))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_97770, &Local_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_253)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_97770, &(Local_526[iVar0 /*16*/]), &Local_345, 8f, -1000f, 0, 1000f);
				}
			}
			iVar0++;
		}
