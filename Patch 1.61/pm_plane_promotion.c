...
void func_1()
{
	...
	switch (iLocal_47)
	{
		case 0:
			...
			{
				iLocal_241 = Global_112096.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_134(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_131(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_81(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
