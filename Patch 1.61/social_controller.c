...
void func_10()
{
	...
	switch (iLocal_332)
	{
		...
		case 1:
			if (iLocal_334 == 0)
			{
				SOCIALCLUB::_0x0F73393BAC7E6730(&(Global_110071[iLocal_333 /*4*/]), &iLocal_334);
			}
		...
		case 2:
			if (iLocal_334 == 0)
			{
				...
				SOCIALCLUB::_0x1989C6E6F67E76A8(&(Global_110071[iLocal_333 /*4*/]), &Var8, &iLocal_334);
			}
			...
			if (SOCIALCLUB::_0xF22CA0FD74B80E7A(iLocal_334))
			{
				if (!SOCIALCLUB::_0x9237E334F6E43156(iLocal_334))
				{
					...
					while (iVar26 < iVar25)
					{
						...
						if (!MISC::IS_STRING_NULL_OR_EMPTY(iVar27) && MISC::GET_HASH_KEY(iVar27) == MISC::GET_HASH_KEY(&(Global_110071[iLocal_333 /*4*/])))
						{
							iVar24 = iVar26;
							iVar26 = iVar25 + 1;
						}
		...
		if (SOCIALCLUB::_0xF22CA0FD74B80E7A(iLocal_334))
		{
			if (!SOCIALCLUB::_0x9237E334F6E43156(iLocal_334))
			{
				...
				while (iVar1 < iVar2)
				{
					...
					{
						StringCopy(&(Global_109919[iVar1 /*4*/]), SOCIALCLUB::_0x1D4446A62D35B0D0(iLocal_334, iVar1), 16);
				...
				if (Global_1585857[iVar228 /*142*/].f_66 == Var69.f_0)
				{
					if (Var69.f_37)
					{
						...
						else if (iLocal_108 == 1)
						{
							if (iLocal_107 == 0)
							{
								SOCIALCLUB::_0x0F73393BAC7E6730(&(Global_2359296[func_191() /*5567*/].f_593.f_28), &iLocal_107);
							}
			...
			if ((((((Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam0 /*98*/] == Var69.f_0 || Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam0 /*98*/] == Var69.f_0) || Global_113386.f_2363.f_539.f_2407[2 /*295*/][iParam0 /*98*/] == Var69.f_0) || Global_113386.f_2363.f_539.f_2407[3 /*295*/][iParam0 /*98*/] == Var69.f_0) || ((iParam0 == 1 && Var69.f_0 == joaat("buffalo2")) && !Global_113386.f_20118.f_281[iParam0])) || ((iParam0 == 0 && Var69.f_0 == joaat("tailgater")) && !Global_113386.f_20118.f_281[iParam0])) || ((iParam0 == 2 && Var69.f_0 == joaat("bodhi2")) && !Global_113386.f_20118.f_281[iParam0]))
			{
				if (Var69.f_37)
				{
					...
					else if (iLocal_108 == 1)
					{
						if (iLocal_107 == 0)
						{
							SOCIALCLUB::_0x0F73393BAC7E6730(&(Global_113386.f_20118.f_130[iParam0 /*41*/].f_28), &iLocal_107);
						}
						else if (!SOCIALCLUB::_0xD302E99EDF0449CF(iLocal_107))
						{
							switch (SOCIALCLUB::_0x5C4EBFFA98BDB41C(iLocal_107))
