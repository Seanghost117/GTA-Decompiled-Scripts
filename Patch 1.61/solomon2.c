...
void func_13(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_15(Global_113386.f_18533[iVar0], &Var2, &fVar5))
			{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_105(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_105(iVar10, 14, uVar69[iVar1], -1) };
			func_74(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_97(14);
			if (Global_78128 == 1)
			{
...
void func_107(int iParam0)
{
	...
	func_108(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_114(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_108(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_108(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_184(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_188(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
			...
			else if (func_225(1, Local_209, 0))
			{
				if (!func_463())
				{
					if ((((func_225(3, Local_237.f_1, Local_237.f_4) && func_225(4, Local_244.f_1, Local_244.f_4)) && func_225(8, Local_251.f_1, Local_251.f_4)) && func_225(5, Local_251.f_1, Local_251.f_4)) && func_225(6, Local_257.f_1, Local_257.f_4))
					{
						...
						iLocal_231 = 0;
						bLocal_232 = false;
						if (func_460(Local_237.f_0))
						{
							func_223(Local_237.f_0, 0);
						}
						if (func_460(Local_244.f_0))
						{
			...
			if (bParam1)
			{
				if ((((((func_225(3, Local_237.f_1, Local_237.f_4) && func_225(4, Local_244.f_1, Local_244.f_4)) && func_225(8, Local_251.f_1, Local_251.f_4)) && func_210(&Local_257, Local_257.f_5, Local_257.f_1, Local_257.f_4, 1)) && func_225(9, Local_209, 0)) && func_225(5, Local_251.f_1, Local_251.f_4)) && func_225(7, Local_209, 0))
				{
					...
					if (!func_209())
					{
						...
						iLocal_265 = func_208(-1176.525f, -550.9145f, 27.73062f, 15f);
...
void func_207(float fParam0, float fParam1)
{
	if (func_8(Local_251.f_0) && func_460(Local_237.f_0))
	{
	...
	switch (iParam0)
	{
		...
		case 3:
			if (func_460(Global_96938.f_9[0]))
			{
				...
				Local_237.f_0 = Global_96938.f_9[0];
				if (func_460(Local_237.f_0))
				{
		...
		case 4:
			if (func_460(Global_96938.f_9[1]))
			{
				...
				Local_244.f_0 = Global_96938.f_9[1];
				if (func_460(Local_244.f_0))
				{
...
int func_226(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_212(iParam1, "Loading", 0))
...
void func_238(int* iParam0, struct<3> Param1, bool bParam4)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_239(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
bool func_242(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
void func_248()
{
	if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_2_CAR_CHASE"))
	{
		if (iLocal_91 == 2)
		{
			if ((func_8(Local_251.f_0) && func_460(Local_237.f_0)) && PED::IS_PED_IN_VEHICLE(Local_237.f_0, Local_251.f_0, false))
			{
	...
	else if (func_460(Local_237.f_0))
	{
		if (func_8(Local_251.f_0))
		{
...
void func_269(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_335(&(Global_100441.f_3));
				if (iVar10 > -1)
				{
...
void func_290(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_292(Var11.f_1)) && iVar72 < 51)
			{
	...
	switch (iLocal_92)
	{
		case 0:
			if (func_197(iLocal_91, bLocal_202))
			{
				...
				if (func_406(0, &iLocal_451, "STOPROCCO", 1092616192, 7))
				{
					SYSTEM::SETTIMERA(0);
					func_405();
		...
		case 1:
			...
			if (!func_460(Local_237.f_0))
			{
				func_387(&uLocal_433, 0, 0);
				if (!bLocal_448)
				{
					if (func_406(0, &bLocal_448, "SOL2_MKT", 1092616192, 7))
					{
						if (AUDIO::PREPARE_MUSIC_EVENT("SOL2_STOP"))
						{
							AUDIO::TRIGGER_MUSIC_EVENT("SOL2_STOP");
				...
				if ((!func_460(Local_244.f_0) && bLocal_449) && bLocal_448)
				{
			...
			{
				func_381();
				func_380(Local_237.f_6, Local_237.f_0, 550f, 0.65f, 0);
				if (!func_31())
				{
					func_236("SOL2_KILL");
				}
				func_351(&uLocal_433, Local_237.f_0, 0, 0, 1, 1, 1);
			}
			break;
		...
		case 3:
			...
			func_349(&Local_237, 1, 0, 1);
			func_30(&(Local_237.f_6));
			func_30(&(Local_244.f_6));
			func_349(&Local_244, 1, 0, 1);
			func_229(1, 1, 1);
			iLocal_92 = 1;
			break;
	}
...
void func_351(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_352(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_352(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
...
void func_353(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_354(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_354(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	...
	if (func_377(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_372(uParam0, bParam7, bParam9, 0))
			{
				func_369(uParam0, iParam1, Param2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_369(var uParam0, int iParam1, struct<3> Param2, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_372(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
void func_381()
{
	if (iLocal_235 != -1)
	{
		if (func_385() > 20f)
		{
			...
			{
				if (func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 30f, 1))
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_235) > 5000)
					{
						if (func_383())
						{
							if (func_382(&uLocal_268, sLocal_267, "SOL2_CHASE", 7, 0, 0, 0))
							{
								iLocal_235 = -1;
							}
						}
						else if (func_382(&uLocal_268, sLocal_267, "SOL2_RGOA", 7, 0, 0, 0))
						{
							iLocal_235 = -1;
						}
					}
				}
				else if (!func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 365f, 1) && func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 480f, 1))
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_235) > 5000)
					{
						if (func_382(&uLocal_268, sLocal_267, "SOL2_LOSE", 7, 0, 0, 0))
						{
							iLocal_235 = -1;
						}
					}
				}
				else if ((!func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 260f, 1) && func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 365f, 1)) && func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 480f, 1))
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_235) > 12000)
					{
						if (func_382(&uLocal_268, sLocal_267, "SOL2_MLC", 7, 0, 0, 0))
						{
							iLocal_235 = -1;
						}
					}
...
float func_385()
{
	if (func_460(iLocal_263))
	{
		return func_386(iLocal_263, PLAYER::PLAYER_PED_ID(), 1);
	}
	return 50f;
}

float func_386(int iParam0, int iParam1, bool bParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_388()
{
	if (func_460(Local_244.f_0))
	{
		if (iLocal_91 == 4)
		{
			if (!func_384(PLAYER::PLAYER_PED_ID(), Local_244.f_0, 200f, 1))
			{
		...
		if (iLocal_95 != 3)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(Local_244.f_0, false))
			{
				...
				func_390(&(Local_244.f_6), Local_244.f_0, 0, 1);
				iLocal_95 = 3;
			}
			if (!func_460(Local_237.f_0))
			{
		...
		{
			case 1:
				if (!func_187(Local_244.f_0, 2104565373))
				{
					iLocal_95 = 2;
				}
				break;
			...
			case 2:
				...
				else if (func_384(Local_244.f_0, PLAYER::PLAYER_PED_ID(), 20f, 1))
				{
			...
			case 3:
				if (!bLocal_453)
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_244.f_0, false))
					{
						func_406(Local_244.f_0, &bLocal_453, "SOL2_GSG", 20f, 7);
					}
				}
				break;
		}
	...
	else
	{
		if (!bLocal_449)
		{
			func_406(0, &bLocal_449, "SOL2_MKT", 1092616192, 7);
			if (func_460(Local_237.f_0) && ENTITY::DOES_ENTITY_EXIST(Local_244.f_0))
			{
				if (func_384(Local_244.f_0, Local_237.f_0, 10f, 1) && func_384(Local_237.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1))
				{
					func_389(&uLocal_268, sLocal_267, "SOL2_GGK", 7, 0, 0);
				}
			}
		}
		func_30(&(Local_244.f_6));
...
void func_392()
{
	if (func_460(Local_237.f_0))
	{
		...
		switch (iLocal_94)
		{
			...
			case 2:
				if (func_8(Local_251.f_0))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_237.f_0, Local_251.f_0, false))
					{
						...
						{
							func_397(Local_237.f_0, "Sol1Roco1", 0, 520);
							iLocal_94 = 3;
						}
					}
					else
			...
			case 5:
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_237.f_0, false) && !func_187(Local_237.f_0, -828834893))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(Local_237.f_0, 0, 0);
				}
				else
				{
					func_396(Local_237.f_0, 0);
				}
				break;
	...
	{
		if (func_460(Local_244.f_0) && ENTITY::DOES_ENTITY_EXIST(Local_237.f_0))
		{
			if (func_384(Local_237.f_0, Local_244.f_0, 10f, 1) && func_384(Local_244.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1))
			{
				func_389(&uLocal_268, sLocal_267, "SOL2_GRK", 7, 0, 0);
			}
		}
		func_30(&(Local_237.f_6));
		func_349(&Local_237, 1, 0, 1);
...
int func_394()
{
	if (func_8(Local_251.f_0) && func_460(PLAYER::PLAYER_PED_ID()))
	{
...
void func_397(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	if (func_460(iParam0))
	{
		ENTITY::FREEZE_ENTITY_POSITION(iParam0, false);
...
void func_400()
{
	if (func_8(Local_251.f_0))
	{
		if (PED::IS_PED_IN_VEHICLE(Local_237.f_0, Local_251.f_0, true))
		{
			...
			{
				func_401(&(Local_237.f_6), Local_251.f_0, 0);
				iLocal_226 = 1;
			}
		}
		...
		{
			func_390(&(Local_237.f_6), Local_237.f_0, 0, 1);
		}
	}
	else if (HUD::DOES_BLIP_EXIST(Local_237.f_6))
	{
...
void func_403()
{
	if (!iLocal_231)
	{
		if (func_460(iLocal_263))
		{
			if (!func_384(PLAYER::PLAYER_PED_ID(), iLocal_263, 100f, 1))
			{
				iLocal_231 = 1;
				func_9(&iLocal_263);
			}
			...
			{
				if (func_384(PLAYER::PLAYER_PED_ID(), iLocal_263, 15f, 1))
				{
					if (iLocal_233 == -1)
					{
						if (!func_31())
					...
					else if (!func_31())
					{
						...
						{
							if (func_382(&uLocal_268, sLocal_267, "SOL2_GO", 7, 0, 0, 0))
							{
								iLocal_233 = MISC::GET_GAME_TIMER();
							}
						}
	...
	if (!bLocal_232)
	{
		if (func_8(Local_257.f_0))
		{
			if (!func_384(PLAYER::PLAYER_PED_ID(), Local_257.f_0, 100f, 1))
			{
				func_6(&Local_257);
			}
...
bool func_406(int iParam0, bool bParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*bParam1)
	{
		if (!func_31() && CAM::IS_SCREEN_FADED_IN())
		{
			...
			{
				*bParam1 = func_382(&uLocal_268, sLocal_267, sParam2, iParam4, 0, 0, 0);
			}
		}
	}
...
void func_411()
{
	...
	switch (iLocal_92)
	{
		case 0:
			if (!bLocal_202)
			{
				...
				if (func_196(1, 0, 1))
				{
					...
					if (func_184(1, 1093140480, 0))
					{
						if (((func_460(iLocal_263) && func_8(Local_251.f_0)) && func_460(Local_237.f_0)) && func_460(Local_244.f_0))
						{
		...
		case 1:
			...
			{
				if (func_460(Local_237.f_0) && func_8(Local_251.f_0))
				{
					PED::SET_PED_INTO_VEHICLE(Local_237.f_0, Local_251.f_0, -1);
			...
			{
				if (func_460(Local_244.f_0) && func_8(Local_251.f_0))
				{
					PED::SET_PED_INTO_VEHICLE(Local_244.f_0, Local_251.f_0, 0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_444(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_441(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_413(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_413(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_434(iParam5, &Var0, Param1, fParam4, func_278(iParam0));
...
void func_434(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_433(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
{
	func_349(&Local_237, 1, 0, 1);
	func_349(&iLocal_263, 1, 1, 1);
	func_349(&Local_244, 1, 1, 1);
	func_404(&Local_251);
	func_404(&Local_257);
	func_5(&iLocal_264, 0);
}
...
void func_458(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			if (func_382(&uLocal_268, sLocal_267, "SOL2_MLT", 7, 0, 0, 0))
			{
				iLocal_224 = 1;
			}
			break;
...
void func_459()
{
	if (func_460(Local_237.f_0))
	{
		if (!func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 550f, 1))
		{
			func_458(1);
		}
	}
...
void func_474(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_476(var uParam0, struct<3> Param1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_478()
{
	Local_237 = { func_479(-1032.97f, -544.14f, 35.3f, -103.17f, joaat("ig_roccopelosi")) };
	Local_244 = { func_479(-1031.72f, -543.42f, 35.26f, 110.43f, joaat("u_m_y_guido_01")) };
}

struct<7> func_479(struct<3> Param0, float fParam3, int iParam4)
{
	struct<7> Var0;
...
void func_480()
{
	Local_251 = { func_481(-1041.64f, -545.08f, 34.81f, 116.57f, joaat("fugitive")) };
	Local_257 = { func_481(-1046.186f, -554.2908f, 33.4636f, 101.5845f, joaat("baller2")) };
}

struct<6> func_481(struct<3> Param0, float fParam3, int iParam4)
{
	struct<6> Var0;
