...
BOOL func_108(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x71BF
{
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_2635559.f_45[i /*12*/].f_9 == true)
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x925D
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_156(iParam1)];
...
void func_161(var uParam0) // Position - 0x929A
{
	...
	for (i = 0; i < unk_0x1C57E792CD67EF97(); i = i + 1)
	{
		...
		if (unk_0x9A45DBB669E889B7(unk2))
		{
			...
			if (unk_0x4292F1DE8BA2D22E(player) != -1)
			{
				if (unk_0x4292F1DE8BA2D22E(player) == unk || func_163(unk_0x4292F1DE8BA2D22E(player), unk, 0, -1))
				{
					num = num + 1;
				
					if (player != unk_0x93E99A2DBCBA9CFA())
						if (func_37(unk_0x93E99A2DBCBA9CFA(), player))
							flag = true;
				}
			}
		}
...
void func_166(BOOL bParam0, var uParam1) // Position - 0x9836
{
	...
	else
	{
		for (i = 0; i < 32; i = i + 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, true, true))
			{
				if (player != unk_0x93E99A2DBCBA9CFA())
				{
					if (func_167(unk_0x93E99A2DBCBA9CFA(), player) <= 20f)
					{
						num = num + 1;
	...
	if (flag)
		num3 = SYSTEM::ROUND(func_162(*uParam1, 100) * 10f * Global_262145.f_4228);

	if (num > 4)
		num = 4;

	if (num >= 1)
		num4 = SYSTEM::ROUND(func_162(*uParam1, 100) * 20f * Global_262145.f_4221);
...
float func_167(var uParam0, Player plParam1) // Position - 0x994E
{
...
int func_182(var uParam0, var uParam1, int iParam2, Player plParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x9CB0
{
	BOOL flag;
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x18452
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_235(&Global_78341[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_235(&Global_78341[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x7FEA86016BC12607(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_235(&Global_78341[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x7FEA86016BC12607(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0xDAEB80C06A5C96B9(num2, 10, -1, 0, -1, func_69(iParam0));
...
void func_303(int iParam0) // Position - 0x31303
{
	iParam0->f_66 = 0;
	...
	*iParam0 = 0;
	...
	iParam0->f_13 = 0;
	iParam0->f_2 = 0;
	func_304(&(iParam0->f_14));
	func_304(&(iParam0->f_14.f_13));
...
BOOL func_347() // Position - 0x32306
{
	return Global_2683862.f_18;
}

BOOL func_348() // Position - 0x32314
{
...
BOOL func_392(int iParam0, int iParam1) // Position - 0x32F93
{
	...
	num = Global_2848280[iParam0 /*3*/][func_156(iParam1)];
