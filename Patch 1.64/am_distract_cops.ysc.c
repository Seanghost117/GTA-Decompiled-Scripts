...
void func_27(BOOL bParam0) // Position - 0xB02
{
...
BOOL func_70() // Position - 0x1DA8
{
	return Global_2683862.f_18;
}

BOOL func_71() // Position - 0x1DB6
{
...
void func_101(int iParam0) // Position - 0x2E74
{
	iParam0->f_66 = 0;
	...
	*iParam0 = 0;
	...
	iParam0->f_13 = 0;
	iParam0->f_2 = 0;
	func_102(&(iParam0->f_14));
	func_102(&(iParam0->f_14.f_13));
...
struct<13> func_167(Player plParam0) // Position - 0x44E1
{
	var unk;
...
void func_178(var uParam0) // Position - 0x53BA
{
	...
	for (i = 0; i < unk_0x1C57E792CD67EF97(); i = i + 1)
	{
		...
		if (unk_0x9A45DBB669E889B7(unk2))
		{
			...
			{
				if (unk_0x4292F1DE8BA2D22E(player) == unk || func_44(unk_0x4292F1DE8BA2D22E(player), unk, 0, -1))
				{
					num = num + 1;
				
					if (player != unk_0x93E99A2DBCBA9CFA())
						if (func_180(unk_0x93E99A2DBCBA9CFA(), player))
							flag = true;
				}
			}
		}
...
BOOL func_180(var uParam0, Player plParam1) // Position - 0x54C7
{
	if (unk_0xE52BCF7D5014E06E())
	{
		Global_2764201 = { func_167(uParam0) };
		Global_2764214 = { func_167(plParam1) };
...
void func_181(BOOL bParam0, var uParam1) // Position - 0x5534
{
	...
	else
	{
		for (i = 0; i < 32; i = i + 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, true, true))
			{
				if (player != unk_0x93E99A2DBCBA9CFA())
				{
					if (func_182(unk_0x93E99A2DBCBA9CFA(), player) <= 20f)
					{
						num = num + 1;
	...
	if (flag)
		num3 = SYSTEM::ROUND(func_179(*uParam1, 100) * 10f * Global_262145.f_4228);

	if (num > 4)
		num = 4;

	if (num >= 1)
		num4 = SYSTEM::ROUND(func_179(*uParam1, 100) * 20f * Global_262145.f_4221);
...
float func_182(var uParam0, Player plParam1) // Position - 0x564C
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x5C3B
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_18(iParam1)];
