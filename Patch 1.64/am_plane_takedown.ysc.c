...
void func_16(Vector3 vParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, var uParam5) // Position - 0x928
{
	int i;

	if (func_17(unk_0x93E99A2DBCBA9CFA(), vParam0, hParam4) > -1)
	{
...
int func_17(int iParam0, var uParam1, var uParam2, var uParam3, Hash hParam4) // Position - 0x9FB
{
	int num;
	int i;
	Vector3 vector;
...
void func_52(int iParam0) // Position - 0x1DFD
{
	iParam0->f_66 = 0;
	...
	*iParam0 = 0;
	...
	iParam0->f_13 = 0;
	iParam0->f_2 = 0;
	func_53(&(iParam0->f_14));
	func_53(&(iParam0->f_14.f_13));
					...
					if (_NETWORK_IS_PLAYER_VALID(unk_0xB850F932D03EF34D(num2), false, true))
						if (iParam1 > -1 && unk_0x1758F8A8511510AB() && iParam1 < 4)
							if (Global_4718592.f_108449[iParam1] != -1)
								...
								return func_90(plParam0, unk_0xB850F932D03EF34D(num2), iParam1, bParam2, bParam3);
						else
							return func_90(plParam0, unk_0xB850F932D03EF34D(num2), iParam1, bParam2, bParam3);
...
BOOL func_108() // Position - 0x3505
{
	return Global_2683862.f_18;
}

BOOL func_109() // Position - 0x3513
{
...
struct<13> func_153(Player plParam0) // Position - 0x42B8
{
	var unk;
...
void func_166(var uParam0) // Position - 0x54A3
{
	...
	for (i = 0; i < unk_0x1C57E792CD67EF97(); i = i + 1)
	{
		...
		if (unk_0x9A45DBB669E889B7(unk2))
		{
			...
			{
				if (unk_0x4292F1DE8BA2D22E(player) == unk || func_82(unk_0x4292F1DE8BA2D22E(player), unk, 0, -1))
				{
					num = num + 1;
				
					if (player != unk_0x93E99A2DBCBA9CFA())
						if (func_168(unk_0x93E99A2DBCBA9CFA(), player))
							flag = true;
				}
			}
		}
...
BOOL func_168(var uParam0, Player plParam1) // Position - 0x55B0
{
	if (unk_0xE52BCF7D5014E06E())
	{
		Global_2764201 = { func_153(uParam0) };
		Global_2764214 = { func_153(plParam1) };
...
void func_169(BOOL bParam0, var uParam1) // Position - 0x561D
{
	...
	else
	{
		for (i = 0; i < 32; i = i + 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, true, true))
			{
				if (player != unk_0x93E99A2DBCBA9CFA())
				{
					if (func_170(unk_0x93E99A2DBCBA9CFA(), player) <= 20f)
					{
						num = num + 1;
	...
	if (flag)
		num3 = SYSTEM::ROUND(func_167(*uParam1, 100) * 10f * Global_262145.f_4228);

	if (num > 4)
		num = 4;

	if (num >= 1)
		num4 = SYSTEM::ROUND(func_167(*uParam1, 100) * 20f * Global_262145.f_4221);
...
float func_170(var uParam0, Player plParam1) // Position - 0x5735
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x5A12
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_46(iParam1)];
