...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0xA26A9A07F761D8F8())
		{
			...
			if (!func_27() || func_24(unk_0x93E99A2DBCBA9CFA(), 0))
				if (!Global_1836156 && !func_23(3) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x93E99A2DBCBA9CFA(), 0) && !unk_0xB53553DC4AAC7D8A() && unk_0x1B82EF141CC65934(unk_0x93E99A2DBCBA9CFA()) && !func_18(unk_0x93E99A2DBCBA9CFA()) && !func_16(func_17(unk_0x93E99A2DBCBA9CFA())) && !func_14(unk_0x93E99A2DBCBA9CFA(), 146) && !func_10(unk_0x93E99A2DBCBA9CFA()))
					if (func_9(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), 4, 100, false))
...
void func_5(var uParam0) // Position - 0x2FA
{
	if (!func_8(uParam0))
		func_6(uParam0);
...
void func_6(var uParam0) // Position - 0x312
{
	func_7(uParam0, 0f);
	return;
}

void func_7(var uParam0, float fParam1) // Position - 0x321
{
...
BOOL func_9(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x359
{
	var unk;
	var unk47;
	var unk93;
...
BOOL func_13(int iParam0, BOOL bParam1) // Position - 0x1108
{
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x1143
{
...
BOOL func_15(int iParam0) // Position - 0x1163
{
	int num;
...
BOOL func_18(int iParam0) // Position - 0x11E3
{
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x1230
{
	BOOL flag;
...
BOOL func_24(int iParam0, int iParam1) // Position - 0x12D7
{
	int num;
...
BOOL func_25(int iParam0) // Position - 0x1310
{
	if (iParam0 == -1)
		return false;
	else
...
BOOL func_27() // Position - 0x133D
{
	...
	if (Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/] == -1)
		return false;
	...
	switch (iLocal_130)
	{
		case 0:
			if (Global_1836156 || func_23(3))
				iLocal_130.f_4 = unk_0x54ECDA2DAB9CFB10(1413.7028f, 2341.5168f, -232.3945f, 2016.2095f, 2998.893f, 161.0299f, 0, 1, 1, 1);
		
			func_30(&uLocal_97[unk_0xD378D2332270959A()], 1);
			iLocal_130 = 1;
			break;
	
		case 1:
			if (SYSTEM::VDIST2(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), 1693.1636f, 2559.6162f, 44.5649f) >= 1030225f)
				iLocal_130 = 2;
			break;
	
		case 2:
			if (Global_1836156 || func_23(3))
				unk_0x17D46728E18012D3(iLocal_130.f_4, 0);
...
int _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x14F9
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x157D
{
	switch (func_26())
	{
		case 0:
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x163A
{
	...
	unk_0xAC5E62CB7808A363(&iLocal_95, 2, 0);
	unk_0x10BF12101F9D80A4(&uLocal_97, 33, 0);
