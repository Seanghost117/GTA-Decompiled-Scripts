...
eCharacter func_33(int iParam0) // Position - 0x295E
{
	int i;
...
int func_34(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x29C1
{
	int i;
...
int func_150(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xAF56
{
	int i;
...
void func_151(int iParam0, int iParam1) // Position - 0xB08D
{
	int i;
