...
void func_56(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x21CF
{
	int num;
	int num2;
	...
	func_57(func_73(echParam0), 1, iParam1, iParam2, false);
...
int func_73(eCharacter echParam0) // Position - 0x323B
{
