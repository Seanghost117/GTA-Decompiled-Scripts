...
void func_28(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2770
{
	...
	if (func_43(iParam2, &num, iParam3, iParam5))
		func_29(uParam0, uParam1, num, iParam4);
...
void func_31(var uParam0, int iParam1, int iParam2) // Position - 0x2866
{
	...
	uParam0->f_7 = func_34(iParam1, _CHAR_NULL, 0);
...
eCharacter func_33(int iParam0) // Position - 0x2984
{
	int i;
...
int func_34(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x29E7
{
	int i;
		...
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
			if (Global_98012[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98022[i])
					if (iParam2 == 0 || unk_0x504B9BB48D41C264(iParam0) == func_35(echParam1, iParam2))
						return 1;
	}
...
int func_149(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xAF60
{
	int i;
...
void func_150(int iParam0, int iParam1) // Position - 0xB097
{
	int i;
