...
void func_120(char* sParam0, BOOL bParam1) // Position - 0xA409
{
	int i;
	int j;
...
BOOL func_231() // Position - 0xF399
{
	return Global_2683862.f_18;
}

BOOL func_232() // Position - 0xF3A7
{
...
void func_237(BOOL bParam0) // Position - 0x10738
{
					...
					if (_NETWORK_IS_PLAYER_VALID(unk_0xB850F932D03EF34D(num2), false, true))
						if (iParam1 > -1 && unk_0x1758F8A8511510AB() && iParam1 < 4)
							if (Global_4718592.f_108449[iParam1] != -1)
								...
								return func_252(plParam0, unk_0xB850F932D03EF34D(num2), iParam1, bParam2, bParam3);
						else
							return func_252(plParam0, unk_0xB850F932D03EF34D(num2), iParam1, bParam2, bParam3);
...
void func_280(Hash hParam0) // Position - 0x11CD2
{
	hParam0->f_66 = 0;
	...
	*hParam0 = 0;
	...
	hParam0->f_13 = 0;
	hParam0->f_2 = 0;
	func_281(&(hParam0->f_14));
	func_281(&(hParam0->f_14.f_13));
		...
		if (_NETWORK_IS_PLAYER_VALID(player, false, true))
		{
			if (num2 == 0)
			{
				if (!player == unk_0x93E99A2DBCBA9CFA())
				{
					...
					func_300(unk_0x1D25117F71EE3811(player));
					num = num + 1;
				}
			}
		}
				...
				if (unk_0xC979ABB49E689182(unk_0xC5D4FFA2FB6BD937(i)))
				{
					...
					if (!unk_0xB4D0EFD6A033F949(&unk))
					{
						if (num2 == 0)
						{
							if (num < 100)
							{
								uLocal_306.f_34[num /*29*/] = { unk };
							
								if (func_181())
									TEXT_LABEL_ASSIGN_STRING(&(uLocal_306.f_34[num /*29*/].f_13), unk_0x3AA475A7768E1C81(i), 64);
								else
									TEXT_LABEL_ASSIGN_STRING(&(uLocal_306.f_34[num /*29*/].f_13), unk_0xC5D4FFA2FB6BD937(i), 64);
...
BOOL func_303(int iParam0, int iParam1) // Position - 0x12B22
{
	...
	num = Global_2848280[iParam0 /*3*/][func_67(iParam1)];
