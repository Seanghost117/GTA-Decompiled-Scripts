...
int func_12(eCharacter echParam0) // Position - 0xA6D
{
	...
	{
		if (func_18(echParam0, Global_20383) == 1)
		{
			func_17(echParam0, Global_20383, 0);
		
			if (func_16(echParam0, Global_20383) == 0)
			{
...
{
	func_59(iParam1);
	Global_113648.f_7690.f_915 = *iParam1;
...
int func_58(int iParam0) // Position - 0x1E74
{
	...
	for (i = 0; i < Global_113648.f_7690.f_910; i = i + 1)
	{
		if (Global_113648.f_7690.f_867[i /*14*/] == iParam0)
			return i;
	}
	...
	if (Global_43804 != -1)
	{
		...
		else
		{
			...
			if (IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 15))
			{
				...
				func_13(Global_113648.f_7690[Global_43804 /*15*/].f_6, character);
...
int func_151(var uParam0, int iParam1, int iParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, int iParam9, int iParam10) // Position - 0x67F6
{
	var unk;
...
void func_176(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x7725
{
				...
				if (func_245(CHAR_BLIMP))
				{
					if (func_244() || func_243() || func_242() || func_241() || _IS_EXCLUSIVE_CONTENT_UNLOCKED())
					{
						if (!unk_0x7DE17ACDD8BA2642(func_239(60)) && !unk_0x7DE17ACDD8BA2642(func_239(61)) && Global_78554 == -1 && !func_238() && !func_237())
						{
							...
							if (func_233(5, &uLocal_59, CHAR_BLIMP, "BLIMPAU", &unk, &unk, 11, 1, 0, 0, false))
...
BOOL func_233(int iParam0, var uParam1, eCharacter echParam2, char* sParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD289
{
...
BOOL func_245(eCharacter echParam0) // Position - 0xD82C
{
...
BOOL func_248(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0xDAA7
{
...
BOOL func_257(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11) // Position - 0xE395
{
...
BOOL func_264(int iParam0) // Position - 0xE9BE
{
	int i;
...
void func_268(eCharacter echParam0, char* sParam1, BOOL bParam2, int iParam3) // Position - 0xF25A
{
	if (!func_166())
		return;
...
BOOL func_287(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x108B8
{
...
BOOL func_288(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x10906
{
	func_176(uParam0, echParam1, sParam2, iParam5, iParam6, 0);
	Global_21773 = false;
	Global_21732 = true;
...
BOOL func_289(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x10954
{
