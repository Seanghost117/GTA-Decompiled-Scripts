...
eCharacter func_34(int iParam0) // Position - 0x2DED
{
	int i;
...
int func_35(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2E50
{
	int i;
...
void func_137(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x9BFE
{
...
BOOL func_155() // Position - 0xA329
{
	if (!func_58(0))
		if (Global_113648.f_9087)
			if (func_157(0, 14) && func_156(0) == CHAR_FRANKLIN)
				return true;
		else
			return true;
	else
...
eCharacter func_156(int iParam0) // Position - 0xA36D
{
