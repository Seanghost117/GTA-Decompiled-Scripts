...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x1F0E
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_10(iParam1)];
...
{
	func_71(uParam0, _CHAR_NULL, sParam1, iParam5, iParam6, 0);
...
void func_71(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x3283
{
...
BOOL func_158(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x9046
{
	int num;
	int num2;
	eMPStat stat;
	...
	if (func_159(iParam0, iParam1, &stat, &num2, bParam2, bParam3))
	{
...
void func_161(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB968
{
	...
	else
	{
		...
		if (num11 >= 0)
		{
			num12 = unk_0xDAEB80C06A5C96B9(num2, 10, -1, 0, -1, func_144(iParam0));
...
BOOL func_220(int iParam0, int iParam1) // Position - 0x1D3B4
{
	...
	num = Global_2848280[iParam0 /*3*/][func_10(iParam1)];
...
void func_270(int iParam0, BOOL bParam1) // Position - 0x2306E
{
	if (iParam0 == 146 || iParam0 == -1)
		return;
