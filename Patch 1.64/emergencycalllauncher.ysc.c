...
void func_30(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xBC1
{
...
BOOL func_35(eCharacter echParam0) // Position - 0xCF0
{
