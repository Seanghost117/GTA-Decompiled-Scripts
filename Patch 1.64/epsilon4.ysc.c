...
void func_176(int iParam0, BOOL bParam1) // Position - 0x208CF
{
...
BOOL func_300(int iParam0, int iParam1) // Position - 0x2B5F9
{
	...
	num = Global_2848280[iParam0 /*3*/][func_87(iParam1)];
...
void func_324(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2D8E7
{
