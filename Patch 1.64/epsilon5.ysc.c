...
BOOL func_31(int iParam0, int iParam1, int iParam2) // Position - 0x1562
{
	int num;
	int i;
	var unk;
...
BOOL func_74(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x91BE
{
	int num;
...
void func_158(int iParam0, BOOL bParam1) // Position - 0x1FED1
{
...
void func_272(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29C0C
{
