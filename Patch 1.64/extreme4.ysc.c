...
BOOL func_39(int iParam0, int iParam1, int iParam2) // Position - 0x184E
{
	int num;
	int i;
	var unk;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x5D73
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_77(iParam1)];
...
BOOL func_82(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x94AC
{
	int num;
...
BOOL func_156(int iParam0, int iParam1, int iParam2) // Position - 0x1F975
{
	int num;
	int num2;
	int i;
...
void func_166(int iParam0, BOOL bParam1) // Position - 0x20263
{
...
{
	func_230(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
...
void func_230(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27656
{
