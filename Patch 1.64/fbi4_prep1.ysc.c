...
{
	if (!unk_0x7DE17ACDD8BA2642(iParam0) || !unk_0xFBD273FDBCF0C5BD(iParam0, 0) || func_305(iParam0, 0, false) || func_305(iParam0, 1, false) || func_305(iParam0, 2, false) || func_328(iParam0) != _CHAR_NULL || func_304(iParam0) || func_303(iParam0) || func_302(iParam0) || func_301(iParam0) || !func_289(unk_0x504B9BB48D41C264(iParam0)))
	{
		func_303(iParam0);
		func_303(iParam0);
...
void func_322(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x101A8
{
	if (func_319(&Global_77348.f_555[0 /*21*/], iParam0))
	{
...
eCharacter func_328(int iParam0) // Position - 0x1049C
{
	int i;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x11023
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_349(iParam1)];
...
void func_388(BOOL bParam0) // Position - 0x12880
{
