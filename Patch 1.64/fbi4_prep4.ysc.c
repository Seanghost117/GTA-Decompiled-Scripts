...
void func_74(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x296A
{
...
BOOL func_121(int iParam0, BOOL bParam1, var uParam2) // Position - 0x6D13
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_153(num, bParam1, uParam2) && !func_152(unk_0x93E99A2DBCBA9CFA()) && !func_133(iParam0))
		return false;
	...
	if (unk_0xCC4A4E244DA78599(iParam0) && !func_127(iParam0) && !flag && !(func_126(unk_0x504B9BB48D41C264(iParam0)) && func_123(unk_0x93E99A2DBCBA9CFA())))
	{
...
BOOL func_122(int iParam0) // Position - 0x6E81
{
	int i;
...
BOOL func_127(int iParam0) // Position - 0x7459
{
	switch (unk_0x504B9BB48D41C264(iParam0))
	{
...
BOOL func_133(int iParam0) // Position - 0x765C
{
...
BOOL func_134(int iParam0) // Position - 0x768B
{
...
BOOL func_135(int iParam0) // Position - 0x773C
{
	int num;
	...
	if (unk_0x7DE17ACDD8BA2642(iParam0) && unk_0xFBD273FDBCF0C5BD(iParam0, 0))
	{
		...
		if (unk_0xCC4A4E244DA78599(iParam0) && !func_127(iParam0) || func_136(num))
			return true;
...
BOOL func_138(int iParam0, BOOL bParam1) // Position - 0x783C
{
	switch (unk_0x504B9BB48D41C264(iParam0))
	{
...
void func_155(int iParam0, eCharacter echParam1) // Position - 0x8731
{
	var unk;
	int i;
	int j;
...
BOOL func_160(int iParam0) // Position - 0x8D5E
{
	if (!unk_0x7DE17ACDD8BA2642(iParam0) || !unk_0xFBD273FDBCF0C5BD(iParam0, 0) || func_177(iParam0, 0, false) || func_177(iParam0, 1, false) || func_177(iParam0, 2, false) || func_176(iParam0) != _CHAR_NULL || func_175(iParam0) || func_174(iParam0) || func_122(iParam0) || func_173(iParam0) || !func_161(unk_0x504B9BB48D41C264(iParam0)))
	{
		func_174(iParam0);
		func_174(iParam0);
...
BOOL func_173(int iParam0) // Position - 0xC99B
{
	Hash hash;
	var unk;
	...
	if (!func_162(hash, false, -1))
		return true;

	return false;
}

BOOL func_174(int iParam0) // Position - 0xC9E2
{
	int i;
...
BOOL func_175(int iParam0) // Position - 0xCA5E
{
	int i;
...
eCharacter func_176(int iParam0) // Position - 0xCB46
{
	int i;
...
BOOL func_177(int iParam0, int iParam1, BOOL bParam2) // Position - 0xCBA9
{
	int i;
	var unk;
	int num;
...
void func_179(int iParam0, eCharacter echParam1) // Position - 0xCCEF
{
	int i;
...
int func_203(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF0A3
{
	return func_204(&(Global_107196.f_2890), uParam0, fParam3, false);
}

int func_204(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF0BD
{
	int num;
	Vector3 vector;
	BOOL flag;
	...
	if (func_227(uParam0))
	{
		...
		if (func_226(uParam0))
		{
			...
			if (unk_0x7DE17ACDD8BA2642(num))
			{
				...
				func_208(num, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_179(num, uParam0->f_11);
				}
				else if (!func_206(num, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && unk_0x4310A0DB886F9FED(unk_0x688846D56810779A(), "startup_positioning"))
				{
					num2 = func_205(num);
...
BOOL func_206(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xF432
{
	int num;
	var unk;
	int num2;
	...
	{
		case joaat("cargobob"):
			if (func_207(iParam0, Global_77348.f_139[38], false))
			{
				func_194(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_207(iParam0, Global_77348.f_139[43], true))
			{
				func_194(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_207(iParam0, unk[i], true) && func_98(unk_0x30BE8A934C020461(unk[i], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_202(uParam1, 0f, 0f, 0f, false) || unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(iParam0, 1), unk_0x30BE8A934C020461(unk[i], 1), 1) < 10f)
					{
...
BOOL func_207(int iParam0, int iParam1, BOOL bParam2) // Position - 0xF63A
{
	var unk;
	var unk2;
	var unk3;
...
void func_208(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF69B
{
	...
	if (unk_0xFBD273FDBCF0C5BD(iParam0, 0))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_216(iParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_215())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
BOOL func_210(Player plParam0) // Position - 0xFE11
{
	Player player;
...
BOOL func_211(Player plParam0) // Position - 0xFE35
{
	Player player;
...
void func_214(int iParam0, var uParam1) // Position - 0xFE8A
{
	int num;
	int num2;
...
BOOL func_216(int iParam0) // Position - 0xFF13
{
	int num;
...
BOOL func_219(int iParam0) // Position - 0xFFCE
{
...
BOOL func_296(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x15378
{
	int num;
	int num2;
	eMPStat stat;
	...
	if (func_297(iParam0, iParam1, &stat, &num2, bParam2, bParam3))
	{
...
void func_299(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x17C9A
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_292(&Global_78341[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_292(&Global_78341[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x7FEA86016BC12607(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_292(&Global_78341[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x7FEA86016BC12607(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0xDAEB80C06A5C96B9(num2, 10, -1, 0, -1, func_300(iParam0));
