...
void func_6() // Position - 0x1F6
{
	...
	if (unk_0x7DE17ACDD8BA2642(num))
		if (!func_115(num, CHAR_FRANKLIN, 1))
	...
	while (unk_0x2FECE8D166B3056B() || !flag)
	{
		...
		if (!unk_0x7DE17ACDD8BA2642(uLocal_30))
		{
			...
			if (unk_0x7DE17ACDD8BA2642(num))
				if (!func_115(num, CHAR_FRANKLIN, 1) && !func_86(CHAR_FRANKLIN, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
...
BOOL func_14(int iParam0, BOOL bParam1, var uParam2) // Position - 0x36C3
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_47(num, bParam1, uParam2) && !func_46(unk_0x93E99A2DBCBA9CFA()) && !func_27(iParam0))
		return false;
	...
	if (unk_0xCC4A4E244DA78599(iParam0) && !func_21(iParam0) && !flag && !(func_20(unk_0x504B9BB48D41C264(iParam0)) && func_16(unk_0x93E99A2DBCBA9CFA())))
	{
...
BOOL func_15(int iParam0) // Position - 0x3831
{
	int i;
...
BOOL func_21(int iParam0) // Position - 0x3E12
{
	switch (unk_0x504B9BB48D41C264(iParam0))
	{
...
BOOL func_27(int iParam0) // Position - 0x4016
{
...
BOOL func_28(int iParam0) // Position - 0x4045
{
...
BOOL func_29(int iParam0) // Position - 0x40F6
{
	int num;
	...
	if (unk_0x7DE17ACDD8BA2642(iParam0) && unk_0xFBD273FDBCF0C5BD(iParam0, 0))
	{
		...
		if (unk_0xCC4A4E244DA78599(iParam0) && !func_21(iParam0) || func_30(num))
			return true;
...
BOOL func_32(int iParam0, BOOL bParam1) // Position - 0x41F6
{
	switch (unk_0x504B9BB48D41C264(iParam0))
	{
...
void func_49(int iParam0, eCharacter echParam1) // Position - 0x50EB
{
	var unk;
	int i;
	int j;
...
BOOL func_54(int iParam0) // Position - 0x5719
{
	if (!unk_0x7DE17ACDD8BA2642(iParam0) || !unk_0xFBD273FDBCF0C5BD(iParam0, 0) || func_71(iParam0, CHAR_MICHAEL, false) || func_71(iParam0, CHAR_FRANKLIN, false) || func_71(iParam0, CHAR_TREVOR, false) || func_70(iParam0) != _CHAR_NULL || func_69(iParam0) || func_68(iParam0) || func_15(iParam0) || func_67(iParam0) || !func_55(unk_0x504B9BB48D41C264(iParam0)))
	{
		func_68(iParam0);
		func_68(iParam0);
		func_71(iParam0, CHAR_MICHAEL, false);
		func_71(iParam0, CHAR_FRANKLIN, false);
		func_71(iParam0, CHAR_TREVOR, false);
		func_70(iParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_67(int iParam0) // Position - 0x9358
{
	Hash hash;
	var unk;
	...
	if (!func_56(hash, false, -1))
		return true;

	return false;
}

BOOL func_68(int iParam0) // Position - 0x939F
{
	int i;
...
BOOL func_69(int iParam0) // Position - 0x941B
{
	int i;
...
eCharacter func_70(int iParam0) // Position - 0x9503
{
	int i;
...
BOOL func_71(int iParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x9566
{
	int i;
	var unk;
	int num;
...
void func_73(int iParam0, eCharacter echParam1) // Position - 0x96AD
{
	int i;
...
BOOL func_115(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xC58B
{
	int i;
		...
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
			if (Global_98012[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98022[i])
					if (iParam2 == 0 || unk_0x504B9BB48D41C264(iParam0) == func_114(echParam1, iParam2))
						return true;
	}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0xF595
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_137(iParam1)];
...
BOOL func_141(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x108B2
{
	int num;
	int num2;
	eMPStat stat;
	...
	if (func_142(iParam0, iParam1, &stat, &num2, bParam2, bParam3))
	{
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x131D4
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_133(&Global_78341[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_133(&Global_78341[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x7FEA86016BC12607(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_133(&Global_78341[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x7FEA86016BC12607(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0xDAEB80C06A5C96B9(num2, 10, -1, 0, -1, func_124(iParam0));
...
BOOL func_203(int iParam0, int iParam1) // Position - 0x24C20
{
	...
	num = Global_2848280[iParam0 /*3*/][func_137(iParam1)];
