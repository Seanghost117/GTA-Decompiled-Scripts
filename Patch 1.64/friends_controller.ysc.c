...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0xB890
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_154(iParam1)];
...
void func_168(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11586
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_162(&Global_78341[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_162(&Global_78341[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x7FEA86016BC12607(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_162(&Global_78341[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x7FEA86016BC12607(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0xDAEB80C06A5C96B9(num2, 10, -1, 0, -1, func_118(iParam0));
...
eCharacter func_247(int iParam0) // Position - 0x245B9
{
	int i;
...
BOOL func_284(int iParam0) // Position - 0x25C3D
{
	int i;

	for (i = 0; i < Global_100606; i = i + 1)
	{
		if (Global_100606[i] == iParam0)
			return true;
	}
...
void func_328(eCharacter echParam0, char* sParam1, BOOL bParam2, int iParam3) // Position - 0x27B99
{
	if (!func_74())
		return;
...
void func_333(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2826A
{
	unk_0x9FD96C5DE6EDFC15(iParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
void func_370(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x29832
{
	if (*uParam1 != 0)
	{
		...
		if (unk_0x7DE17ACDD8BA2642(uParam1->f_2) && unk_0xAE770DDB34967EC3(uParam1->f_2, 0) && !func_284(uParam1->f_2))
		{
			if (unk_0x66599E73DBA5A850(uParam1->f_2))
			{
				Global_113648.f_18535[uParam1->f_1] = CHAR_MICHAEL;
...
void func_384(var uParam0) // Position - 0x29C69
{
	...
	num2 = Global_113648.f_2365.f_539.f_2314[character];
	unk3 = { Global_113648.f_2365.f_539.f_2318[character /*3*/] };
	func_386(uParam0, false);

	if (!func_385(vector, 0f, 0f, 0f, false))
	{
		num3 = unk_0x2655A8EC638E4FD1(Global_113648.f_2365.f_539.f_2300[character /*3*/].f_2 - vector.f_2);
		num4 = SYSTEM::VDIST2(vector, Global_113648.f_2365.f_539.f_2300[character /*3*/]);
		num5 = SYSTEM::VMAG(Global_113648.f_2365.f_539.f_2318[character /*3*/]);
		flag = false;
		...
		if (flag)
		{
			...
			Global_113648.f_2365.f_539.f_2314[character] = num2;
...
{
	return Global_95982[0 /*18*/].f_17 != false;
}
...
BOOL func_464(int iParam0) // Position - 0x2D409
{
	...
	if (!func_465(character))
	{
		...
		else
		{
			...
			if (num3 < 3)
				if (unk_0x7DE17ACDD8BA2642(Global_96515[num3]))
					return false;
		}
	}
...
void func_475(BOOL bParam0) // Position - 0x2DFFA
{
	Global_95982[iLocal_94 /*18*/].f_17 = Global_95982[iLocal_94 /*18*/].f_17 || bParam0;
	return;
}

void func_476(BOOL bParam0) // Position - 0x2E019
{
	Global_95982[iLocal_94 /*18*/].f_17 = Global_95982[iLocal_94 /*18*/].f_17 || bParam0;
	return;
}
