...
int func_44(var uParam0, int iParam1, Hash hParam2) // Position - 0x1738
{
	switch (hParam2)
	{
		case 1:
...
int func_50(var uParam0, int iParam1, Hash hParam2) // Position - 0x3AEB
{
	switch (hParam2)
	{
		case 1:
...
BOOL func_61(int iParam0) // Position - 0x3E2F
{
	int i;
...
BOOL func_62(int iParam0) // Position - 0x3E5E
{
	int i;
...
BOOL func_70(int iParam0) // Position - 0x401C
{
	int i;
...
int func_75(Hash hParam0) // Position - 0x4162
{
	switch (hParam0)
	{
		case 0:
...
int func_81() // Position - 0x474D
{
	return Global_2621446.f_2;
}

int func_82() // Position - 0x475B
{
...
Hash func_101(Hash hParam0, BOOL bParam1) // Position - 0x4FA6
{
	Hash hash;
	Hash hash2;
...
void func_107(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x50EA
{
	if (hParam0 == 0)
		return;
...
void func_121(BOOL bParam0) // Position - 0x5289
{
...
Hash func_137(Hash hParam0) // Position - 0x556B
{
	Hash hash;
	Hash hash2;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x5951
{
	int num;
...
void func_256(BOOL bParam0) // Position - 0x927B
{
	*bParam0 = 0;
...
BOOL func_314(int iParam0) // Position - 0xC30E
{
	...
	num = Global_1665462[iParam0];
	num2 = num;

	if (unk_0x494B367FE0CBD765(num2, &num3, -1))
		return num3;
...
{
	if (uParam0->f_702 && Global_1968304 == false)
	{
...
char* func_368(char* sParam0) // Position - 0xF0C3
{
	return sParam0;
}
...
int func_399(Hash hParam0) // Position - 0xFB1E
{
	int num;
	int num2;

	if (func_400(hParam0, 9))
	{
		num = hParam0 - 89;
		return num + 13;
	}
	else if (func_400(hParam0, 17))
	{
		num2 = hParam0 - 128;
		return num2 + 22;
	}
...
BOOL func_400(Hash hParam0, int iParam1) // Position - 0xFB5C
{
	return func_75(hParam0) == iParam1;
}
...
void func_403(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xFBF1
{
	int num;
...
int func_404() // Position - 0xFC3B
{
	return Global_2793044.f_5225.f_346;
}

int func_405() // Position - 0xFC4D
{
...
int func_409(BOOL bParam0) // Position - 0xFCB4
{
	switch (bParam0)
	{
		case 153:
...
BOOL func_442() // Position - 0x10FDE
{
	if (func_443())
		return true;
...
void func_649(Hash hParam0) // Position - 0x1A7FE
{
	hParam0->f_66 = 0;
	...
	*hParam0 = 0;
	...
	hParam0->f_13 = 0;
	hParam0->f_2 = 0;
	func_650(&(hParam0->f_14));
	func_650(&(hParam0->f_14.f_13));
...
void func_688(int iParam0, int iParam1) // Position - 0x1C073
{
	func_689(iParam0, iParam1);
	return;
}

void func_689(int iParam0, int iParam1) // Position - 0x1C083
{
...
Hash func_707(Player plParam0) // Position - 0x1C4B7
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_736() // Position - 0x1D1FF
{
	...
	if (IS_BIT_SET(num2, 24))
	{
		unk_0x061B1200C95204CB(&num2, 24);
		flag = true;
	}

	if (IS_BIT_SET(num2, 25))
	{
		unk_0x061B1200C95204CB(&num2, 25);
		flag = true;
	}
	...
	if (flag)
		unk_0xB61FAFE7FDE57FC8(num2, hash);

	_MPCHAR_STAT_SET_INT(MP_STAT_OPPRESSOR_MG_HEADSHOTS, 0, -1, 1, false);
	return;
}

int func_737(Hash hParam0) // Position - 0x1D26E
{
	int num;
...
void func_774() // Position - 0x1F012
{
	...
	if (Global_1890444[unk_0xD056B8CB0E6A5169() /*129*/].f_38.f_28 == false)
...
int func_778(int iParam0, Hash hParam1) // Position - 0x1F584
{
	if (hParam1 == -1)
		hParam1 = func_102();
...
void func_822(BOOL bParam0) // Position - 0x20EA4
{
