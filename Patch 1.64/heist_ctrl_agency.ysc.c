...
void func_15(var uParam0, BOOL bParam1) // Position - 0xBC6
{
	int i;
	int j;
	...
	if (func_332(8))
	{
		if (func_332(7))
		{
			if (unk_0x834B5C5F458D6972("AH_2_EXT_P4") && unk_0x6CAF14BE58B4BFF8("lesterHandler") && unk_0x0CBB7C273DED26E7(joaat("prop_laptop_01a")))
			{
				...
				unk_0x970443E58680427C(iLocal_46, "LESTER", 2, joaat("IG_LesterCrest"), 0);
		...
		else if (unk_0x2FECE8D166B3056B())
		{
			...
			if (IS_BIT_SET(iLocal_41, 10))
			{
				...
				{
					iLocal_46 = unk_0x9C8D7679C15E75FF(unk_0x469E7057A437B05B("LESTER", joaat("IG_LesterCrest")));
			...
			{
				if (!unk_0x055111B11E6624FD(iLocal_46, 0))
				{
					args = iLocal_46;
...
int func_165(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7F2C
{
	eCharacter character;
	var unk;
	var unk99;
	...
	{
		character = Global_113648.f_18535[iParam1];
	...
	Global_113648.f_18535[iParam1] = echParam2;
	...
	{
		if (!func_181(Global_99120[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_166(int iParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x804B
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
BOOL func_182(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xF5C5
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
void func_194(var uParam0, int iParam1) // Position - 0x1021D
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_182(Global_113648.f_18535[i], &unk, &num))
			{
...
void func_206(eCharacter echParam0, int iParam1) // Position - 0x10CD0
{
	int num;
...
void func_207(eCharacter echParam0) // Position - 0x10DBD
{
...
void func_208(eCharacter echParam0) // Position - 0x10E08
{
	var unk;
	BOOL flag;
	BOOL flag2;
	...
	unk = { func_216(echParam0) };

	if (IS_BIT_SET(unk.f_4, 2))
		func_213(echParam0, &unk);
...
BOOL func_211(eCharacter echParam0) // Position - 0x11574
{
	int num;
...
int func_220(var uParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0x14C1C
{
	int i;
	float num;
	float num2;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x14DD0
{
	int num;
	int num2;
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_225(hParam1)];
...
Hash func_225(Hash hParam0) // Position - 0x14E0D
{
	Hash hash;
	Hash hash2;
...
Hash func_226() // Position - 0x14E41
{
...
void func_229(int iParam0, eCharacter echParam1, Hash hParam2) // Position - 0x1544A
{
	if (hParam2 == -1)
		hParam2 = func_226();
...
void func_230(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x15472
{
	eCharacter character;
	int i;
...
BOOL func_231(int iParam0, Hash hParam1) // Position - 0x15612
{
	int num;
	BOOL num2;

	num = Global_2848280[iParam0 /*3*/][func_225(hParam1)];
...
BOOL func_235(int iParam0) // Position - 0x15DE6
{
	return Global_1574538[iParam0];
}

BOOL func_236() // Position - 0x15DF6
{
...
void func_266(eCharacter echParam0) // Position - 0x17FC7
{
	eCharacter i;
	var unk;
...
void func_267(eCharacter echParam0) // Position - 0x18083
{
	eCharacter i;
	var unk;
...
int func_271(eCharacter echParam0) // Position - 0x18372
{
	eCharacter character;

	if (Global_117[echParam0 /*10*/].f_8 != 169)
	{
		if (func_277(echParam0, Global_20383) == 1)
		{
			func_276(echParam0, Global_20383, 0);
		
			if (func_275(echParam0, Global_20383) == 0)
			{
				character = Global_20383;
				func_272(echParam0, character);
			}
...
void func_272(eCharacter echParam0, eCharacter echParam1) // Position - 0x183C8
{
	eCharacter character;
	...
	if (Global_117[echParam0 /*10*/].f_8 != 169)
	{
		...
		{
			character = echParam1;
			func_274(echParam0, character, 0);
			func_273(echParam0, character, 0);
		}
	}
...
void func_273(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x183FD
{
...
void func_274(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x18442
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return;
...
int func_275(eCharacter echParam0, eCharacter echParam1) // Position - 0x18487
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_276(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x184B1
{
...
int func_277(eCharacter echParam0, eCharacter echParam1) // Position - 0x184E2
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
Hash func_285(Hash hParam0, BOOL bParam1) // Position - 0x18848
{
	Hash hash;
	Hash hash2;
				...
				if (func_310("AH_2_EXT_ALT") && unk_0x0CBB7C273DED26E7(joaat("prop_laptop_01a")))
				{
					if (!unk_0x2FECE8D166B3056B())
					{
						if (unk_0x7DE17ACDD8BA2642(Global_97178.f_9[0]) && !unk_0x055111B11E6624FD(Global_97178.f_9[0], 0))
						{
							...
							unk_0x85BAE84748AD1A23(iLocal_46, 0, 1);
							unk_0x970443E58680427C(iLocal_46, "LESTER", 1, joaat("IG_LesterCrest"), 0);
						}
						...
						if (unk_0x7DE17ACDD8BA2642(Global_97178.f_28[0]) && !unk_0x055111B11E6624FD(Global_97178.f_28[0], 0))
						{
							...
							unk_0x970443E58680427C(iLocal_47, "WALKINGSTICK_LESTER", 1, joaat("prop_cs_walking_stick"), 0);
						}
...
int func_293(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x191BB
{
	var unk;
	var unk2;
	...
	func_294(iParam0, echParam2);
	return 1;
}

void func_294(int iParam0, eCharacter echParam1) // Position - 0x191FB
{
	var unk;
	int i;
	int j;
...
BOOL func_300(int iParam0) // Position - 0x19A1B
{
	if (!unk_0x7DE17ACDD8BA2642(iParam0) || !unk_0xFBD273FDBCF0C5BD(iParam0, 0) || func_307(iParam0, 0, false) || func_307(iParam0, 1, false) || func_307(iParam0, 2, false) || func_306(iParam0) != _CHAR_NULL || func_305(iParam0) || func_304(iParam0) || func_303(iParam0) || func_302(iParam0) || !func_301(unk_0x504B9BB48D41C264(iParam0)))
	{
		func_304(iParam0);
		func_304(iParam0);
...
BOOL func_302(int iParam0) // Position - 0x19CAA
{
	int num;
	var unk;
...
BOOL func_303(int iParam0) // Position - 0x19CF1
{
	int i;
...
BOOL func_304(int iParam0) // Position - 0x19D2C
{
	int i;
...
BOOL func_305(int iParam0) // Position - 0x19DA8
{
	int i;
...
eCharacter func_306(int iParam0) // Position - 0x19E90
{
	int i;
...
BOOL func_307(int iParam0, int iParam1, BOOL bParam2) // Position - 0x19EF3
{
	int i;
	var unk;
	int num;
...
int func_331(eCharacter echParam0) // Position - 0x1ADD0
{
	int i;
	...
	if (Global_94666[echParam0 /*2*/])
		return 1;

	for (i = 0; i < Global_91433; i = i + 1)
	{
		if (Global_91433[i /*5*/] != -1)
			if (Global_78828.f_109[Global_91433[i /*5*/] /*4*/] == echParam0)
				return 1;
	}
...
void func_334(var uParam0, int iParam1) // Position - 0x1AF31
{
	func_344(uParam0, 1, "HEIST_AGENCY", "BOARD5", "AHFAUD", "CRWAUD", 3, 0, 6, 13, iParam1, 708.99567f, -965.25604f, 31.395329f, 5.5f, 6.25f, 2f);
...
void func_344(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x1B5F7
{
	uParam0->f_1 = iParam1;
