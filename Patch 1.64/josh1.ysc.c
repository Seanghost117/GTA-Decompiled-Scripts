...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0xE25
{
	if (hParam2 == -1)
		hParam2 = func_11();
...
BOOL func_32(int iParam0, int iParam1, Hash hParam2) // Position - 0x18F6
{
	int num;
	int i;
	var unk;
...
int func_35(int iParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1B7A
{
	int i;
	int j;
	int k;
...
void func_36(int iParam0, int iParam1, Hash hParam2) // Position - 0x238B
{
	Hash hash;
	int num;
...
BOOL func_37(int iParam0, int iParam1, Hash hParam2) // Position - 0x2415
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(int iParam0, int iParam1, Hash hParam2) // Position - 0x24F3
{
	Global_78341[1 /*14*/] = { func_84(iParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_39(int iParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x251B
{
	var unk;
	int i;
...
BOOL func_40(int iParam0, int iParam1, Hash hParam2) // Position - 0x2B1F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_41(var uParam0, int iParam1, int iParam2) // Position - 0x2BB8
{
	Hash i;
	Hash j;
...
int func_42(int iParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x2C59
{
	int num;
...
Hash func_43(var uParam0, int iParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x2F60
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_44(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x3B13
{
	int num;
...
Hash func_45(int iParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x3DF7
{
	int num;
...
Hash func_46(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x40BF
{
	Hash i;
	Hash hash;
...
BOOL func_47(var uParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x40F6
{
	Hash hash;
...
BOOL func_48(int iParam0, Hash hParam1, var uParam2) // Position - 0x411F
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x43E9
{
	int num;
...
Hash func_50(int iParam0, Hash hParam1, Hash hParam2) // Position - 0x4673
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(var uParam0, int iParam1, eCharacter echParam2, eCharacter echParam3) // Position - 0x47CA
{
	Hash hash;
...
BOOL func_52(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x4864
{
	switch (iParam0)
	{
...
int func_53(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4932
{
	var unk;
	int num;
	int num2;
...
Hash func_56(var uParam0, eCharacter echParam1, eCharacter echParam2, int iParam3) // Position - 0x4E54
{
	int num;
	int num2;
	int num3;
...
BOOL func_61(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x522E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x54AB
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x58D0
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_64(var uParam0, int iParam1) // Position - 0x5BC3
{
	int num;
	var unk;
...
Hash func_65(var uParam0, int iParam1) // Position - 0x5C0A
{
	int num;
	var unk;
	var unk2;
...
void func_68(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0x5D6D
{
	Hash hash;
	var unk;
	eMPStat stat;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x5DB7
{
	int num;
...
Hash func_70(Hash hParam0) // Position - 0x5DE7
{
	Hash hash;
	Hash hash2;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x5E1B
{
	int num;
	int num2;
...
BOOL func_75(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9554
{
	int num;
...
struct<10> func_77(int iParam0, Hash hParam1) // Position - 0x96AF
{
	int i;
	var unk;
...
struct<17> func_80(int iParam0, Hash hParam1) // Position - 0xA150
{
	int i;
	var unk;
...
void func_83(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC234
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_84(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0xC2A5
{
	func_148();
...
BOOL func_91(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0xE5FE
{
	Hash hash;
	int num;
	eMPStat stat;
...
BOOL func_149(int iParam0, int iParam1, Hash hParam2) // Position - 0x1FBBB
{
	int num;
	Hash hash;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x1FE14
{
	eCharacter i;
	int num;
...
void func_159(int iParam0, BOOL bParam1) // Position - 0x204AD
{
...
void func_233(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27F07
{
...
Hash func_241(Hash hParam0, BOOL bParam1) // Position - 0x282C5
{
	Hash hash;
	Hash hash2;
...
int func_306(int iParam0, eCharacter echParam1) // Position - 0x2AF53
{
	int num;
