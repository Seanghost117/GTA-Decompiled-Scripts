...
eCharacter func_32(int iParam0) // Position - 0x2ABD
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B20
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x375E
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x38FE
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x393B
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x396F
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x397B
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB0D2
{
	Hash hash;
	Hash hash2;
...
{
	func_195(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, 0);
...
void func_195(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD353
{
...
int func_263(int iParam0, eCharacter echParam1) // Position - 0xFEB8
{
	int num;
