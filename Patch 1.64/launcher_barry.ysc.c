...
eCharacter func_32(int iParam0) // Position - 0x2B4E
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2BB1
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x37EF
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x398F
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x39CC
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3A00
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x3A0C
{
	int num;
	BOOL num2;
...
Hash func_141(Hash hParam0, BOOL bParam1) // Position - 0xB142
{
	Hash hash;
	Hash hash2;
...
{
	func_205(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
...
void func_205(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD9FB
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDF43
{
	...
	if (func_256(*panParam0) || func_254(*panParam0) || Global_78804 == true)
		return true;
...
int func_278(int iParam0, eCharacter echParam1) // Position - 0x106E0
{
	int num;
