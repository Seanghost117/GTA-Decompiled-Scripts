...
eCharacter func_32(int iParam0) // Position - 0x2A73
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2AD6
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3714
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x38B4
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x38F1
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3925
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x3931
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB087
{
	Hash hash;
	Hash hash2;
...
void func_194(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCED5
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD2FD
{
	...
	if (func_241(*panParam0) || func_239(*panParam0) || Global_78804 == true)
		return true;
...
int func_257(int iParam0, eCharacter echParam1) // Position - 0x13480
{
	int num;
