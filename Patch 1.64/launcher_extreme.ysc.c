...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1B4D
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29F8
{
	int num;
...
int func_28(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2A80
{
...
BOOL func_29(int iParam0) // Position - 0x2AC0
{
	int i;
...
eCharacter func_32(int iParam0) // Position - 0x2C0C
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2C6F
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x38AD
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x3A4D
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x3A8A
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3ABE
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x3ACA
{
	int num;
	BOOL num2;
...
Hash func_141(Hash hParam0, BOOL bParam1) // Position - 0xB1FF
{
	Hash hash;
	Hash hash2;
...
void func_198(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD592
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDA21
{
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_78804 == true)
		return true;
...
int func_259(int iParam0, eCharacter echParam1) // Position - 0xF8F8
{
	int num;
