...
eCharacter func_32(int iParam0) // Position - 0x2AFB
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B5E
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x379C
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x393C
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x3979
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x39AD
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x39B9
{
	int num;
	BOOL num2;
...
Hash func_141(Hash hParam0, BOOL bParam1) // Position - 0xB0F2
{
	Hash hash;
	Hash hash2;
...
void func_197(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD5D2
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDB5B
{
	...
	if (func_249(*panParam0) || func_247(*panParam0) || Global_78804 == true)
		return true;
...
int func_255(int iParam0, eCharacter echParam1) // Position - 0xFA6E
{
	int num;
