...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_250(CHAR_PEGASUS_DELIVERY))
		{
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A2C
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28D7
{
	int num;
...
int func_28(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x295F
{
...
BOOL func_29(int iParam0) // Position - 0x299F
{
	int i;
...
eCharacter func_32(int iParam0) // Position - 0x2AEB
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B4E
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x378C
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x392C
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x3969
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x399D
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x39A9
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB103
{
	Hash hash;
	Hash hash2;
...
void func_190(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCE1A
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD6AB
{
	...
	if (func_240(*panParam0) || func_238(*panParam0) || Global_78804 == true)
		return true;
...
int func_248(int iParam0, eCharacter echParam1) // Position - 0xF30D
{
	int num;
...
BOOL func_250(eCharacter echParam0) // Position - 0xF384
{
	int i;
