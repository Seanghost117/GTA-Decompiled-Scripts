...
eCharacter func_32(int iParam0) // Position - 0x2AF0
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B53
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3791
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x3931
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x396E
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x39A2
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x39AE
{
	int num;
	BOOL num2;
...
void func_191(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCE44
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD2A6
{
	...
	if (func_239(*panParam0) || func_237(*panParam0) || Global_78804 == true)
		return true;
...
int func_247(int iParam0, eCharacter echParam1) // Position - 0xF106
{
	int num;
