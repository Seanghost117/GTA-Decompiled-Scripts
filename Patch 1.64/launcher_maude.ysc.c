...
eCharacter func_32(int iParam0) // Position - 0x2A09
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2A6C
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x36AA
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x384A
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x3887
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x38BB
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x38C7
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB021
{
	Hash hash;
	Hash hash2;
...
int func_240(int iParam0, eCharacter echParam1) // Position - 0xED68
{
	int num;
