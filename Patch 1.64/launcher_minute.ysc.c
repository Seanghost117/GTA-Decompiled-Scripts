...
eCharacter func_32(int iParam0) // Position - 0x2B9B
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2BFE
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x383C
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x39DC
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x3A19
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3A4D
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x3A59
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB1B2
{
	Hash hash;
	Hash hash2;
...
void func_194(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD409
{
...
int func_257(int iParam0, eCharacter echParam1) // Position - 0xF9CA
{
	int num;
