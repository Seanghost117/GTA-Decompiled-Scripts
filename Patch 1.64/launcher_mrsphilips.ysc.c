...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x19B8
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2863
{
	int num;
...
int func_28(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28EB
{
...
BOOL func_29(int iParam0) // Position - 0x292B
{
	int i;
...
eCharacter func_32(int iParam0) // Position - 0x2A77
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2ADA
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3715
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x38B5
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x38F2
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3926
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x3932
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xAFF8
{
	Hash hash;
	Hash hash2;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xCFE8
{
	...
	if (func_235(*panParam0) || func_233(*panParam0) || Global_78804 == true)
		return true;
