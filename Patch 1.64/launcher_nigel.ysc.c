...
eCharacter func_32(int iParam0) // Position - 0x2BA0
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2C03
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3841
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x39E1
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x3A1E
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3A52
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x3A5E
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB1B5
{
	Hash hash;
	Hash hash2;
...
void func_200(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD955
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE321
{
	...
	if (func_254(*panParam0) || func_252(*panParam0) || Global_78804 == true)
		return true;
...
int func_262(int iParam0, eCharacter echParam1) // Position - 0xFE62
{
	int num;
