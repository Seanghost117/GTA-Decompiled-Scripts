...
eCharacter func_32(int iParam0) // Position - 0x2A80
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2AE3
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3721
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x38C1
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x38FE
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x3932
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x393E
{
	int num;
	BOOL num2;
...
Hash func_142(Hash hParam0, BOOL bParam1) // Position - 0xB095
{
	Hash hash;
	Hash hash2;
...
void func_197(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD0BD
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD51F
{
	...
	if (func_245(*panParam0) || func_243(*panParam0) || Global_78804 == true)
		return true;
...
int func_254(int iParam0, eCharacter echParam1) // Position - 0xF329
{
	int num;
