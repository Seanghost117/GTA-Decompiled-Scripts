...
eCharacter func_32(int iParam0) // Position - 0x2ABC
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B1F
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x375D
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x38FD
{
	int num;
	int num2;
...
Hash func_50(Hash hParam0) // Position - 0x393A
{
	Hash hash;
	Hash hash2;
...
Hash func_51() // Position - 0x396E
{
	return Global_1574918;
}

BOOL func_52(int iParam0, Hash hParam1) // Position - 0x397A
{
	int num;
	BOOL num2;
...
void func_204(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD6C4
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD7B5
{
	...
	if (func_243(*panParam0) || func_241(*panParam0) || Global_78804 == true)
		return true;
...
int func_254(int iParam0, eCharacter echParam1) // Position - 0xFA52
{
	int num;
