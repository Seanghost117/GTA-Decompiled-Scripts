...
void func_28(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A5F
{
	int i;
	eCharacter j;

	*iParam0 = _GET_CURRENT_PLAYER_CHARACTER_0();
	iParam0->f_1 = func_100();
	unk_0x4AE338C69F2C7E27(&(iParam0->f_6), &(iParam0->f_7), &(iParam0->f_8));

	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		func_69(&(iParam0->f_2884), 0);
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_51(unk_0xC1A5EC5C986B98AD(), &iParam0->f_616[j /*65*/], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
...
void func_30(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x290A
{
	int num;
	...
	if (func_45(iParam2, &num, iParam3, iParam5))
		func_31(uParam0, iParam1, num, iParam4);
...
int func_31(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2992
{
...
BOOL func_32(int iParam0) // Position - 0x29D2
{
	int i;
...
void func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2A00
{
	...
	uParam0->f_7 = func_36(iParam1, _CHAR_NULL, 0);
...
eCharacter func_35(int iParam0) // Position - 0x2B1E
{
	int i;
...
int func_36(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B81
{
	int i;
		...
		if (unk_0x7DE17ACDD8BA2642(Global_98012[i]))
			if (Global_98012[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98022[i])
					if (iParam2 == 0 || unk_0x504B9BB48D41C264(iParam0) == func_37(echParam1, iParam2))
						return 1;
	}
...
void func_51(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x37BF
{
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x395F
{
	int num;
	int num2;
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_53(hParam1)];
...
Hash func_53(Hash hParam0) // Position - 0x399C
{
	Hash hash;
	Hash hash2;
...
Hash func_54() // Position - 0x39D0
{
	return Global_1574918;
}

BOOL func_55(int iParam0, Hash hParam1) // Position - 0x39DC
{
	int num;
	BOOL num2;

	num = Global_2848280[iParam0 /*3*/][func_53(hParam1)];
...
Hash func_143(Hash hParam0, BOOL bParam1) // Position - 0xB0F5
{
	Hash hash;
	Hash hash2;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xB2C6
{
	...
	if (func_195(*panParam0) || func_193(*panParam0) || Global_78804 == true)
		return true;
...
int func_210(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xD3D3
{
	int i;
...
void func_211(int iParam0, int iParam1) // Position - 0xD50A
{
	int i;
...
void func_247(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE9D7
{
...
BOOL func_306(int iParam0) // Position - 0x1A560
{
	return Global_1574538[iParam0];
}

BOOL func_307() // Position - 0x1A570
{
...
int func_310(int iParam0, eCharacter echParam1) // Position - 0x1A8E2
{
...
BOOL func_340(int iParam0, Hash hParam1) // Position - 0x1EE76
{
	if (hParam1 == -1)
		hParam1 = func_54();
