...
BOOL func_17(int iParam0, char* sParam1, var uParam2) // Position - 0x6A3
{
	unk_0x56C9BC27C0FF68D7(sParam1);
...
BOOL func_19(int iParam0, char* sParam1, char* sParam2, var uParam3) // Position - 0x6DB
{
	unk_0x56C9BC27C0FF68D7(sParam1);
	unk_0x48849374B34BB7B9(sParam2);
...
BOOL func_27(int iParam0, Hash hParam1) // Position - 0xC34
{
	if (hParam1 == -1)
		hParam1 = func_28();
...
void func_32(BOOL bParam0) // Position - 0xD0F
{
	if (Global_78826 != bParam0)
		Global_78826 = bParam0;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x1488
{
	if (hParam2 == -1)
		hParam2 = func_28();
...
void func_66(int iParam0, BOOL bParam1) // Position - 0x25A0
{
...
BOOL func_71(int iParam0) // Position - 0x2BEB
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
