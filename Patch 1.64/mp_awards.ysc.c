...
eCharacter func_6(Hash hParam0, BOOL bParam1) // Position - 0xC54
{
		...
		if (unk_0x9812897315C21146("MPAwards1") && unk_0x9812897315C21146("MPAwards2") && unk_0x9812897315C21146("MPAwards3") && unk_0x9812897315C21146("MPAwards4") && unk_0x9812897315C21146("MPAwards5") && unk_0x9812897315C21146("MPAwards6") && flag && flag2)
		{
			...
			switch (uParam0->f_6)
			{
				...
				case 8:
					...
					if (Global_262145.f_24231 == false)
						iLocal_111 = iLocal_111 - 1;
				
					if (Global_262145.f_24232 == false)
						iLocal_111 = iLocal_111 - 1;
				
					if (Global_262145.f_24233 == false)
						iLocal_111 = iLocal_111 - 1;
				
					if (Global_262145.f_24234 == false)
						iLocal_111 = iLocal_111 - 1;
				
					if (Global_262145.f_24231 == false || Global_262145.f_24233 == false || Global_262145.f_24232 == false || Global_262145.f_24234 == false)
						iLocal_111 = iLocal_111 - 1;
					break;
					...
					switch (uParam0->f_6)
					{
						...
						case 8:
							if (!Global_1652549.f_1[0])
							{
								...
								if (Global_262145.f_24231 == true)
									func_114(147, 8, num3, &Global_1652549);
							
								if (Global_262145.f_24233 == true)
									func_114(148, 8, num3, &Global_1652549);
							
								if (Global_262145.f_24232 == true)
									func_114(149, 8, num3, &Global_1652549);
							
								if (Global_262145.f_24234 == true)
									func_114(150, 8, num3, &Global_1652549);
							
								if (Global_262145.f_24231 == true && Global_262145.f_24233 == true && Global_262145.f_24232 == true && Global_262145.f_24234 == true)
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x49D0
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_45(hParam2)];
...
Hash func_45(Hash hParam0) // Position - 0x4A00
{
	Hash hash;
	Hash hash2;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x4A52
{
	int num;
	int num2;
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_45(hParam1)];
...
int func_48(int iParam0, Hash hParam1) // Position - 0x4A8F
{
	int num;
	int num2;

	num = Global_2850192[iParam0 /*3*/][func_45(hParam1)];
...
BOOL func_51(int iParam0, Hash hParam1) // Position - 0x7857
{
	int num;
	int num2;
...
int func_53(int iParam0, Hash hParam1) // Position - 0x7893
{
	int num;

	num = _MPCHAR_STAT_GET_INT(func_54(iParam0), hParam1, 0);
	return num;
}
...
int func_58(int iParam0, Hash hParam1) // Position - 0x80ED
{
	if (hParam1 == -1)
		hParam1 = func_7();
...
BOOL func_66(int iParam0, Hash hParam1) // Position - 0x8927
{
	if (hParam1 == -1)
		hParam1 = func_7();
...
int func_69(int iParam0) // Position - 0x8AD8
{
	...
	num = Global_1665454[iParam0];
	num2 = num;

	if (unk_0xDD7756E2742E0F6D(num2, &num3, -1))
		return num3;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0xB437
{
	...
	num = Global_2850649[iParam0 /*3*/][func_45(iParam1)];
...
BOOL func_129(int iParam0) // Position - 0x10553
{
	...
	hash = func_130(iParam0);
	num = iParam0;
	return IS_BIT_SET(hash, func_52(num));
}

Hash func_130(int iParam0) // Position - 0x10570
{
