...
int func_9(Hash hParam0, BOOL bParam1) // Position - 0x955
{
	bParam1;
	return func_10(hParam0, 0);
}

int func_10(Hash hParam0, int iParam1) // Position - 0x969
{
	int i;
	int value;
	int value2;
...
Hash func_11(int iParam0, BOOL bParam1) // Position - 0xA28
{
	bParam1;
	return func_12(iParam0);
}

Hash func_12(int iParam0) // Position - 0xA3B
{
...
Hash func_14(Hash hParam0) // Position - 0xABA
{
	Hash hash;
	Hash hash2;
...
BOOL func_28(int iParam0, Hash hParam1) // Position - 0x1008
{
	int num;
	BOOL num2;

	num = Global_2848280[iParam0 /*3*/][func_14(hParam1)];
...
int func_34(int iParam0, Hash hParam1) // Position - 0x1432
{
	int num;
	int num2;

	num = Global_2850192[iParam0 /*3*/][func_14(hParam1)];
...
BOOL func_36(int iParam0, Hash hParam1) // Position - 0x149B
{
	if (hParam1 == -1)
		hParam1 = func_15();
