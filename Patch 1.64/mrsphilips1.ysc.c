...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0xA68
{
	if (hParam2 == -1)
		hParam2 = func_11();
...
void func_22(int iParam0) // Position - 0xC47
{
	int i;
	int j;
...
BOOL func_32(int iParam0, int iParam1, Hash hParam2) // Position - 0x1534
{
	int num;
	int i;
	var unk;
...
BOOL func_33(int iParam0, int iParam1, var uParam2) // Position - 0x16F1
{
	int num;
...
int func_35(int iParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17B8
{
	int i;
	int j;
	int k;
...
void func_36(int iParam0, int iParam1, Hash hParam2) // Position - 0x1FC9
{
	Hash hash;
	int num;
...
BOOL func_37(int iParam0, int iParam1, Hash hParam2) // Position - 0x2053
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(int iParam0, int iParam1, Hash hParam2) // Position - 0x2131
{
	Global_78341[1 /*14*/] = { func_84(iParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_39(int iParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x2159
{
	var unk;
	int i;
...
BOOL func_40(int iParam0, int iParam1, Hash hParam2) // Position - 0x275D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_41(var uParam0, int iParam1, int iParam2) // Position - 0x27F6
{
	Hash i;
	Hash j;
...
int func_42(int iParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x2897
{
	int num;
...
Hash func_43(var uParam0, int iParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x2B9E
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_44(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x3751
{
	int num;
...
Hash func_45(int iParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x3A35
{
	int num;
...
Hash func_46(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3CFC
{
	Hash i;
	Hash hash;
...
BOOL func_47(var uParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x3D33
{
	Hash hash;
...
BOOL func_48(int iParam0, Hash hParam1, var uParam2) // Position - 0x3D5C
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x4027
{
	int num;
...
Hash func_50(int iParam0, Hash hParam1, Hash hParam2) // Position - 0x42B1
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(var uParam0, int iParam1, eCharacter echParam2, eCharacter echParam3) // Position - 0x4408
{
	Hash hash;
...
BOOL func_52(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x44A2
{
	switch (iParam0)
	{
...
int func_53(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4570
{
	var unk;
	int num;
	int num2;
...
Hash func_56(var uParam0, eCharacter echParam1, eCharacter echParam2, int iParam3) // Position - 0x4A92
{
	int num;
	int num2;
	int num3;
...
BOOL func_61(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x4E6C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x50E9
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x550E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_64(var uParam0, int iParam1) // Position - 0x5801
{
	int num;
	var unk;
...
Hash func_65(var uParam0, int iParam1) // Position - 0x5848
{
	int num;
	var unk;
	var unk2;
...
void func_68(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0x59AB
{
	Hash hash;
	var unk;
	eMPStat stat;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x59F5
{
	int num;
...
Hash func_70(Hash hParam0) // Position - 0x5A25
{
	Hash hash;
	Hash hash2;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, Hash hParam1, int iParam2) // Position - 0x5A59
{
	int num;
	int num2;
...
BOOL func_75(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9191
{
	int num;
...
struct<10> func_77(int iParam0, Hash hParam1) // Position - 0x92EC
{
	int i;
	var unk;
...
struct<17> func_80(int iParam0, Hash hParam1) // Position - 0x9D8D
{
	int i;
	var unk;
...
void func_83(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xBE6F
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_84(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0xBEE0
{
	func_148();
...
BOOL func_91(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0xE1F1
{
	Hash hash;
	int num;
	eMPStat stat;
...
BOOL _NETWORK_IS_PLAYER_IN_SCTV(int player, int bCheckTeam) // Position - 0x26E8F
{
	...
	if (player == unk_0x93E99A2DBCBA9CFA())
		flag = func_213(-1, false) == CHAR_MIKE_FRANK_CONF;
	else
...
eCharacter func_213(Hash hParam0, BOOL bParam1) // Position - 0x26EDA
{
	eCharacter character;
	Hash hash;
...
struct<2> func_238(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2799C
{
	var unk;
	eCharacter character;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (character)
			{
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_239(character), 8);
					break;
			}
			break;
...
char* func_239(eCharacter echParam0) // Position - 0x27A72
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
struct<2> func_246(eCharacter echParam0) // Position - 0x27D01
{
	var unk;
