...
void main() // Position - 0x0
{
	...
	if (unk_0x7DE17ACDD8BA2642(uScriptParam_0))
	{
		...
		hLocal_316 = Global_1853910[unk_0x93E99A2DBCBA9CFA() /*862*/].f_267.f_33;
		func_72(&Global_1567810, hLocal_316);
...
Hash func_17(Hash hParam0) // Position - 0x10B6
{
	Hash hash;
	Hash hash2;
...
eCharacter func_27(Hash hParam0, BOOL bParam1) // Position - 0x135A
{
...
void func_72(var uParam0, Hash hParam1) // Position - 0x241C
{
	var unk;
	int num;
...
void func_73(Hash hParam0, var uParam1, var uParam2, int iParam3) // Position - 0x4C01
{
	var unk;
	...
	switch (hParam0)
	{
		...
		case 42:
		case 43:
			func_84(hParam0, 40, &unk, -1, false);
			*uParam1 = { unk };
		...
		case 64:
		case 65:
			func_84(hParam0, 40, &unk, 61, false);
			*uParam1 = { unk };
		...
		case 75:
		case 76:
			func_84(hParam0, 40, &unk, 73, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 81:
		case 82:
			func_84(hParam0, 40, &unk, 77, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 84:
		case 85:
			func_84(hParam0, 40, &unk, 83, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 89:
		case 90:
			func_84(hParam0, 40, &unk, 88, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 95:
		case 96:
			func_84(hParam0, 40, &unk, 91, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 101:
		case 102:
			func_84(hParam0, 40, &unk, 97, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
	}
...
void func_79(var uParam0, Hash hParam1) // Position - 0x62BB
{
	var unk;
	...
	switch (hParam1)
	{
		...
		case 42:
		case 43:
			func_84(hParam1, 4, &unk, -1, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, -1, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 19f;
			func_84(hParam1, 276, &unk, -1, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, -1, false);
			uParam0->[1 /*8*/].f_3 = { unk };
		...
		case 64:
		case 65:
			func_84(hParam1, 4, &unk, 61, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 61, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 21f;
			func_84(hParam1, 276, &unk, 61, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, 61, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 14.5f;
			break;
		...
		case 75:
		case 76:
			func_84(hParam1, 4, &unk, 73, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 73, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 9.75f;
			func_84(hParam1, 276, &unk, 73, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, 73, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 10.25f;
			func_84(hParam1, 483, &unk, 73, false);
			uParam0->[2 /*8*/] = { unk };
			func_84(hParam1, 484, &unk, 73, false);
			uParam0->[2 /*8*/].f_3 = { unk };
		...
		case 81:
		case 82:
			func_84(hParam1, 4, &unk, 77, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 77, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 9.75f;
			func_84(hParam1, 276, &unk, 77, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, 77, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 5f;
			func_84(hParam1, 483, &unk, 77, false);
			uParam0->[2 /*8*/] = { unk };
			func_84(hParam1, 484, &unk, 77, false);
			uParam0->[2 /*8*/].f_3 = { unk };
		...
		case 84:
		case 85:
			func_84(hParam1, 4, &unk, 83, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 83, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 26.75f;
			func_84(hParam1, 276, &unk, 83, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, 83, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 18.25f;
			break;
	
		case 86:
			func_84(hParam1, 4, &unk, 86, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 86, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 14.75f;
			func_84(hParam1, 276, &unk, 86, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, 86, false);
			uParam0->[1 /*8*/].f_3 = { unk };
		...
		case 89:
		case 90:
			func_84(hParam1, 4, &unk, 88, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 88, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 27.25f;
			func_84(hParam1, 276, &unk, 88, false);
			uParam0->[1 /*8*/] = { unk };
			func_84(hParam1, 277, &unk, 88, false);
			uParam0->[1 /*8*/].f_3 = { unk };
		...
		case 95:
		case 96:
			func_84(hParam1, 4, &unk, 91, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 91, false);
			uParam0->[0 /*8*/].f_3 = { unk };
		...
		case 101:
		case 102:
			func_84(hParam1, 4, &unk, 97, false);
			uParam0->[0 /*8*/] = { unk };
			func_84(hParam1, 5, &unk, 97, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 22f;
			break;
	}
...
BOOL func_80(Hash hParam0) // Position - 0x69B7
{
	switch (hParam0)
	{
		case 87:
...
BOOL func_81(Hash hParam0, int iParam1) // Position - 0x69E6
{
	if (iParam1 == -1)
	{
		switch (hParam0)
...
// Unhandled jump detected. Output should be considered invalid
int func_82(Hash hParam0, int iParam1) // Position - 0x6AC3
{
	if (iParam1 == -1)
	{
		switch (hParam0)
...
int func_83(Hash hParam0) // Position - 0x6B7F
{
	switch (hParam0)
	{
		case 83:
...
void func_84(Hash hParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x6BA8
{
	var unk;
	var unk14;
	...
	unk[1 /*6*/] = { func_85(hParam0, bParam4) };
...
struct<6> func_85(Hash hParam0, BOOL bParam1) // Position - 0x8063
{
	var unk;
...
int func_86(Hash hParam0) // Position - 0x8C19
{
	switch (hParam0)
	{
		case 1:
