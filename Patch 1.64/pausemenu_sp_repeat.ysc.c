...
void func_1(eCharacter echParam0, int iParam1) // Position - 0x320
{
	Global_78805 = echParam0;
	Global_78805.f_1 = iParam1;

	if (iParam1 == 7)
		if (echParam0 >= CHAR_MICHAEL && echParam0 < CHAR_MRS_THORNHILL)
			Global_112735[echParam0 /*10*/].f_3 = 1;
...
Hash func_14(Hash hParam0) // Position - 0x6D1
{
	Hash hash;
	Hash hash2;
...
{
	if (Global_113648.f_9087.f_330[24 /*6*/] == true || Global_113648.f_9087.f_330[25 /*6*/] == true || Global_113648.f_9087.f_330[26 /*6*/] == true || Global_113648.f_9087.f_330[27 /*6*/] == true)
		return 1;
