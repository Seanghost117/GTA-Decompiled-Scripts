...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6) // Position - 0x517
{
	...
	if (num3 || func_31(sParam3, &unk5, uParam4))
	{
		if (num == 5)
			if (character == CHAR_MICHAEL)
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x295B
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_51(hParam2)];
...
Hash func_51(Hash hParam0) // Position - 0x298B
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x29BF
{
	return Global_1574918;
}

void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x29CB
{
	if (hParam2 == -1)
		hParam2 = func_52();
...
BOOL func_57(int iParam0, Hash hParam1) // Position - 0x2BEC
{
	if (hParam1 == -1)
		hParam1 = func_52();
...
void func_85(eCharacter echParam0, char* sParam1, BOOL bParam2, BOOL bParam3) // Position - 0x37F2
{
	if (!func_15())
		return;
...
BOOL func_86(int iParam0) // Position - 0x384F
{
...
void func_90(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3EC3
{
	unk_0x9FD96C5DE6EDFC15(iParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
int func_107(eCharacter echParam0) // Position - 0x49BE
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
int func_138(int iParam0) // Position - 0x5C3F
{
	return iParam0;
}
