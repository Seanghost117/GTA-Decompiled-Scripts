...
int func_10(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6) // Position - 0xCCD
{
	...
	if (!flag)
	{
		num2 = unk_0x846426CCFA47452B(iParam0);
	
		if (Global_100733.f_386 != num2)
			return 0;
	}

	unk9 = { unk5 };
	TEXT_LABEL_APPEND_STRING(&unk9, "_01", 16);

	if (unk_0x42FA33BDEDF21186(&unk9))
		num3 = 1;
	else
		num3 = 0;

	if (num3 || func_36(sParam3, &unk5, uParam4))
	{
		if (num == 5)
			if (character == CHAR_MICHAEL)
...
void func_32(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x192A
{
...
BOOL func_46(eCharacter echParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2427
{
	int num;
	int num2;
	int num3;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x31AE
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_56(hParam2)];
...
Hash func_56(Hash hParam0) // Position - 0x31DE
{
	Hash hash;
	Hash hash2;
...
Hash func_57() // Position - 0x3212
{
	return Global_1574918;
}

void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x321E
{
	if (hParam2 == -1)
		hParam2 = func_57();
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3402
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_56(iParam1)];
...
BOOL func_62(int iParam0, Hash hParam1) // Position - 0x343F
{
	if (hParam1 == -1)
		hParam1 = func_57();
...
void func_90(eCharacter echParam0, char* sParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4048
{
	if (!func_19())
		return;
...
BOOL func_91(int iParam0) // Position - 0x40A5
{
...
void func_95(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4719
{
	unk_0x9FD96C5DE6EDFC15(iParam0, sParam1);
	unk_0xC6A3EF6C4A3412C1(SYSTEM::ROUND(fParam2));
...
int func_112(eCharacter echParam0) // Position - 0x5213
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
int func_139(int iParam0) // Position - 0x5DB0
{
	return iParam0;
}
