...
void func_19(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x8CB
{
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xA28
{
