...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x2904
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_23(hParam2)];
...
Hash func_23(Hash hParam0) // Position - 0x2934
{
	Hash hash;
	Hash hash2;
...
Hash func_24() // Position - 0x2968
{
	return Global_1574918;
}

void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x2974
{
	if (hParam2 == -1)
		hParam2 = func_24();
...
BOOL func_29(int iParam0, Hash hParam1) // Position - 0x2B95
{
	if (hParam1 == -1)
		hParam1 = func_24();
...
void func_88(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x47EE
{
