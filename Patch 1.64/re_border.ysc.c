...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x99B
{
	if (hParam2 == -1)
		hParam2 = func_12();
...
void func_51(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x205D
{
