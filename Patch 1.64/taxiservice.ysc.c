#region Local Var
	...
	var uLocal_823 = 0;
	var uLocal_824 = 0;
	eCharacter echLocal_825 = CHAR_MICHAEL;
	int iLocal_826 = 0;
	int iLocal_827 = 0;
	int iLocal_828 = 0;
	var uLocal_829 = 40;
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x120F
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_17(hParam2)];
...
Hash func_17(Hash hParam0) // Position - 0x123F
{
	Hash hash;
	Hash hash2;
...
Hash func_18() // Position - 0x1273
{
	return Global_1574918;
}

void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x127F
{
	if (hParam2 == -1)
		hParam2 = func_18();
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x1463
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_17(iParam1)];
...
BOOL func_23(int iParam0, Hash hParam1) // Position - 0x14A0
{
	if (hParam1 == -1)
		hParam1 = func_18();
	...
	switch (iLocal_953)
	{
		...
		case 3:
			if (Global_78574 == -1)
			{
				...
				echLocal_825 = func_108(uLocal_43);
			
				if (echLocal_825 != -1)
					func_110(echLocal_825, true);
			...
			if (unk_0x58A962BEF2DDE1DF())
			{
				if (unk_0x16760C7780F48003())
				{
					if (echLocal_825 != -1)
					{
						unk_0xB942AB5E12BF630A();
						bLocal_59 = false;
						func_106(echLocal_825);
						func_110(echLocal_825, false);
					}
		...
		case 6:
			...
			if (echLocal_825 != -1)
			{
				...
				if (Global_91469[echLocal_825 /*34*/].f_13 == -1 && Global_91469[echLocal_825 /*34*/].f_14 == -1)
					flag2 = false;
			
				if (flag2)
					if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL && !IS_BIT_SET(Global_91469[echLocal_825 /*34*/].f_15, 8) || _GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN && !IS_BIT_SET(Global_91469[echLocal_825 /*34*/].f_15, 9) || _GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR && !IS_BIT_SET(Global_91469[echLocal_825 /*34*/].f_15, 10))
						flag2 = false;
			
				if (flag2)
					if (func_103(Global_91469[echLocal_825 /*34*/].f_13, Global_91469[echLocal_825 /*34*/].f_14))
						flag2 = false;
			
				if (flag2)
					unk_0xA3431CA4D3567A93(Global_91469[echLocal_825 /*34*/].f_13, 0, 0);
			}
		...
		case 7:
			...
			if (echLocal_825 != -1 && Global_97608)
				flag = false;
		...
		case 9:
			...
			{
				if (!Global_97609 && echLocal_825 != -1 && echLocal_825 != CHAR_MP_MEX_BOSS && echLocal_825 != CHAR_MP_STRIPCLUB_PR)
					func_109(echLocal_825);
...
void func_106(eCharacter echParam0) // Position - 0x5DCF
{
	if (func_107(echParam0))
	{
		Global_97604 = echParam0;
		Global_97608 = true;
		return;
	}
...
BOOL func_107(eCharacter echParam0) // Position - 0x5DEE
{
	switch (echParam0)
	{
		case CHAR_ANDREAS:
...
eCharacter func_108(var uParam0) // Position - 0x5E4D
{
	int i;
...
void func_109(eCharacter echParam0) // Position - 0x5EA7
{
	if (Global_97603 != -1)
	{
...
void func_110(eCharacter echParam0, BOOL bParam1) // Position - 0x5ECB
{
	if (bParam1)
...
void func_111(int iParam0) // Position - 0x5F09
{
	...
	if (!(func_114(89) || func_114(CHAR_DETONATEBOMB) || func_114(CHAR_DOMESTIC_GIRL) || func_114(CHAR_GAYMILITARY) || func_113() == CHAR_LS_CUSTOMS || func_113() == CHAR_DETONATEBOMB || func_113() == CHAR_DOMESTIC_GIRL || func_113() == CHAR_GAYMILITARY))
		return;
...
eCharacter func_113() // Position - 0x6066
{
	return Global_78821;
}

BOOL func_114(eCharacter echParam0) // Position - 0x6072
{
	int i;
...
eCharacter func_205(var uParam0) // Position - 0xEE7A
{
	int i;
