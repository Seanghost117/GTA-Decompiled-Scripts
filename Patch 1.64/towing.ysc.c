...
void func_36(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1B79
{
...
void func_53(int iParam0, int iParam1) // Position - 0x2848
{
	func_54(iParam0, iParam1);
	return;
}

void func_54(int iParam0, int iParam1) // Position - 0x2858
{
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x41F2
{
	int num;

	bParam4;
	num = Global_2805027[empsParam0 /*3*/][func_72(hParam2)];
...
Hash func_72(Hash hParam0) // Position - 0x4222
{
	Hash hash;
	Hash hash2;
...
Hash func_73() // Position - 0x4256
{
	return Global_1574918;
}

void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0x4262
{
	if (hParam2 == -1)
		hParam2 = func_73();
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x4446
{
	...
	{
		iParam2 == 0;
		num = Global_2805027[empsParam0 /*3*/][func_72(iParam1)];
...
BOOL func_78(int iParam0, Hash hParam1) // Position - 0x4483
{
	if (hParam1 == -1)
		hParam1 = func_73();
...
void func_122() // Position - 0x65E3
{
	...
	if (!bLocal_2940)
	{
		flag = SYSTEM::ROUND((300f - func_126(&uLocal_3100)) * 1000f);
	
		if (iLocal_420 == 3)
			if (flag / 1000 < 60)
				func_123(flag, "TOW_TIME", 0, 0, -1, 0, 2, 0, 6, 0, 0, 0, 0, 0, 0, 0, 0, -1);
			else
				func_123(flag, "TOW_TIME", 0, 0, -1, 0, 2, false, 1, 0, 0, false, 0, false, 0, 0, false, -1);
	}

	return;
}

void func_123(BOOL bParam0, char* sParam1, int iParam2, int iParam3, BOOL bParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, BOOL bParam13, int iParam14, int iParam15, BOOL bParam16, int iParam17) // Position - 0x6654
{
	int num;
	int i;
...
void func_300(int iParam0, int iParam1) // Position - 0x118F2
{
	func_301(iParam0, iParam1);
	return;
}

void func_301(int iParam0, int iParam1) // Position - 0x11902
{
